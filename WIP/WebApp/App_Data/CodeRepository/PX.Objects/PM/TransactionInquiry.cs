...
namespace PX.Objects.PM
{
	...
	public class TransactionInquiry : PXGraph<TransactionInquiry>
	{
		...
		protected virtual void _(Events.CacheAttached<PMTran.aRRefNbr> e)
		{
		}
		...
		public virtual IEnumerable ViewProforma(PXAdapter adapter)
		{
			...
			target.Clear();
			target.Document.Current = PXSelect<PMProforma, Where<PMProforma.refNbr, Equal<Current<PMTran.proformaRefNbr>>, And<PMProforma.corrected, NotEqual<True>>>>.Select(this);
