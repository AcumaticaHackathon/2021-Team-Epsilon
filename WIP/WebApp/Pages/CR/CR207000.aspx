...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Class"
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		Caption="Lead Class Summary" DataMember="Class" FilesIndicator="True" NoteIndicator="True"
			...
			<px:PXTabItem Text="Details">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Data Entry Settings" StartGroup="True"/>
						<px:PXDropDown ID="edDefaultSource" runat="server" DataField="DefaultSource"/>
					...
					<px:PXLayoutRule ID="PXLayoutRule3" runat="server" GroupCaption="Conversion Settings" StartGroup="True"/>
						<px:PXSelector ID="edTargetContactClassID" runat="server" DataField="TargetContactClassID" AllowEdit="True"/>
						<px:PXSelector ID="edTargetBAccountClassID" runat="server" DataField="TargetBAccountClassID" AllowEdit="True"/>
						<px:PXCheckBox ID="chkRequireBAccountCreation" runat="server" DataField="RequireBAccountCreation"/>
						...
						<Levels>
							<px:PXGridLevel DataMember="Mapping">
								...
								<Columns>
									...
									<px:PXGridColumn AllowNull="False" DataField="CSAttribute__ContainsPersonalData" TextAlign="Center" Type="CheckBox" />
