...
namespace PX.Objects.AR
{
	...
	public partial class ARSalesPerTran : PX.Data.IBqlTable
	{
		#region Keys
		/// <exclude/>
		public class PK : PrimaryKeyOf<ARSalesPerTran>.By<docType, refNbr, salespersonID, adjNbr, adjdDocType, adjdRefNbr>
		{
			public static ARSalesPerTran Find(PXGraph graph, string docType, string refNbr, Int32? salespersonID, Int32? adjNbr, String adjdDocType, String adjdRefNbr) 
												=> FindBy(graph, docType, refNbr, salespersonID, adjNbr, adjdDocType, adjdRefNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<ARSalesPerTran>.By<branchID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ARSalesPerTran>.By<curyInfoID> { }
		}
		#endregion
