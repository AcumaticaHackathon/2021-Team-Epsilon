...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <px:PXSmartPanel runat="server" ID="PanelPayBillJC" Height="430px" Width="950px" LoadOnDemand="True" CaptionVisible="True" Caption="Indicate Amounts to Pay" Key="JointPayees" CommandSourceID="ds" AutoCallBack-Command="Refresh" AutoCallBack-Target="PXGridJointCheck" AutoReload="True">
        <px:PXFormView runat="server" ID="frmVendor" SkinID="Transparent" DataSourceID="ds" DataMember="SelectedDocument">
            <Template>
                <px:PXLayoutRule runat="server" ID="PXLayoutRule7" StartColumn="True" LabelsWidth="S" ControlSize="M" />
                <px:PXSegmentMask runat="server" DataField="CurrentBill.VendorID" Enabled="False" ID="edUsrVendor" />
                <px:PXLayoutRule runat="server" ID="PXLayoutRule9" StartColumn="True" LabelsWidth="S" ControlSize="S" />
                <px:PXNumberEdit runat="server" DataField="CurrentBill.AmountToPay" ID="edAmountToPay" CommitChanges="True" />
                <px:PXLayoutRule runat="server" ID="PXLayoutRule11" StartColumn="True" LabelsWidth="M" ControlSize="S" />
                <px:PXNumberEdit runat="server" Enabled="False" DataField="CurrentBill.VendorBalance" ID="edUsrBalance" />
            </Template>
        </px:PXFormView>
