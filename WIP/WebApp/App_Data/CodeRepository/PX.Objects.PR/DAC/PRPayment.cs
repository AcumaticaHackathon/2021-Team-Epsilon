...
namespace PX.Objects.PR
{
	...
	[PXProjection(typeof(SelectFrom<PRPayment>.Where<MatchWithBranch<PRPayment.branchID>.And<MatchWithPayGroup<PRPayment.payGroupID>>>), Persistent = true)]
	public class PRPayment : IBqlTable
	{
		#region Keys
		public class PK : PrimaryKeyOf<PRPayment>.By<docType, refNbr>
		{
			public static PRPayment Find(PXGraph graph, string docType, string refNbr) =>
		...
		#endregion
		#region CopiedPayGroupID
		public abstract class copiedPayGroupID : PX.Data.BQL.BqlString.Field<copiedPayGroupID> { }
		[PXString]
		public string CopiedPayGroupID { get; set; }
		#endregion
		#region CopiedPayPeriodID
		public abstract class copiedPayPeriodID : PX.Data.BQL.BqlString.Field<copiedPayPeriodID> { }
		[PXString]
		public string CopiedPayPeriodID { get; set; }
		#endregion
		#region NoteID
