        ...
        <px:PXGrid ID="gridMatl" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" SyncPosition="True" TabIndex="2600" StatusField="Availability" >
            ...
            <ActionBar ActionsText="False">
                <CustomItems>
                    ...
                    <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LSAMProdMatl_binLotSerial" CommandSourceID="ds" 
...
<AutoSize Enabled="True" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="90%" Height="360px" Caption="Line Details" CaptionVisible="True" Key="lsSelectMatl"
