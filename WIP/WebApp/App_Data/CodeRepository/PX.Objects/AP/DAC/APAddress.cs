...
namespace PX.Objects.AP
{
	...
	public partial class APAddress : PX.Data.IBqlTable, IAddress, IAddressLocation
	{
		#region Keys
		public class PK : PrimaryKeyOf<APAddress>.By<addressID>
		{
			public static APAddress Find(PXGraph graph, Int32? addressID) => FindBy(graph, addressID);
		}
		public static class FK
		{
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APAddress>.By<vendorID> { }
			public class VendorAddress : CR.Address.PK.ForeignKeyOf<APAddress>.By<vendorAddressID> { }
			public class Country : CS.Country.PK.ForeignKeyOf<APAddress>.By<countryID> { }			
		}
		#endregion
