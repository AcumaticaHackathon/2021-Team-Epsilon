...
namespace PX.Objects.FS
{
    ...
    public class FSManufacturer : PX.Data.IBqlTable
    {
        ...
        {
            public static FSManufacturer Find(PXGraph graph, int? manufacturerID) => FindBy(graph, manufacturerID);
        }

        public class UK : PrimaryKeyOf<FSManufacturer>.By<manufacturerCD>
        {
            public static FSManufacturer Find(PXGraph graph, string manufacturerCD) => FindBy(graph, manufacturerCD);
        }
