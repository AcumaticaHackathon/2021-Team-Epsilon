<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormTab.master" AutoEventWireup="true"
    ...
    <%@ MasterType VirtualPath="~/MasterPages/FormTab.master" %>
        ...
        <asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
            ...
            TabIndex="900" DefaultControlID="edSrvOrdType" FilesIndicator="true" NoteIndicator="True">
                <Template>
                ...
                <Items>
                    <px:PXTabItem Text="Preferences">
                        <Template>
                            ...
                            <px:PXDropDown ID="edServiceOrderWorkflowTypeID" runat="server" CommitChanges="True" DataField="ServiceOrderWorkflowTypeID">
                            </px:PXDropDown>
                            <px:PXDropDown ID="edAppointmentWorkflowTypeID" runat="server" CommitChanges="True" DataField="AppointmentWorkflowTypeID">
                            </px:PXDropDown>
                            ...
                            <px:PXCheckBox ID="edSetLotSerialNbrInAppts" runat="server" DataField="SetLotSerialNbrInAppts" Size="XM"/>
