...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FALocationHistory>.By<assetID, revisionID>
		{
			public static FALocationHistory Find(PXGraph graph, Int32? assetID, Int32? revisionID) => FindBy(graph, assetID, revisionID);
		}
		public static class FK
		{
			public class FixedAsset : FA.FixedAsset.PK.ForeignKeyOf<FALocationHistory>.By<assetID> { }
			public class AssetClass : FA.FAClass.PK.ForeignKeyOf<FALocationHistory>.By<classID> { }
			// public class Building : CR.Building.PK.ForeignKeyOf<FALocationHistory>.By<branchID, buildingID> { } // TODO: Building
			public class Custodian : EP.EPEmployee.PK.ForeignKeyOf<FALocationHistory>.By<employeeID> { }
			public class FixedAssetsAccount : GL.Account.PK.ForeignKeyOf<FALocationHistory>.By<fAAccountID> { }
			public class FixedAssetsSubaccount : GL.Sub.PK.ForeignKeyOf<FALocationHistory>.By<fASubID> { }
			public class AccumulatedDepreciationAccount : GL.Account.PK.ForeignKeyOf<FALocationHistory>.By<accumulatedDepreciationAccountID> { }
			public class AccumulatedDepreciationSubaccount : GL.Sub.PK.ForeignKeyOf<FALocationHistory>.By<accumulatedDepreciationSubID> { }
			public class DepreciationExpenseAccount : GL.Account.PK.ForeignKeyOf<FALocationHistory>.By<depreciatedExpenseAccountID> { }
			public class DepreciationExpenseSubaccount : GL.Sub.PK.ForeignKeyOf<FALocationHistory>.By<depreciatedExpenseSubID> { }
			public class ProceedsAccount : GL.Account.PK.ForeignKeyOf<FALocationHistory>.By<disposalAccountID> { }
			public class ProceedsSubaccount : GL.Sub.PK.ForeignKeyOf<FALocationHistory>.By<disposalSubID> { }
			public class GainAccount : GL.Account.PK.ForeignKeyOf<FALocationHistory>.By<gainAcctID> { }
			public class GainSubaccount : GL.Sub.PK.ForeignKeyOf<FALocationHistory>.By<gainSubID> { }
			public class LossAccount : GL.Account.PK.ForeignKeyOf<FALocationHistory>.By<lossAcctID> { }
			public class LossSubaccount : GL.Sub.PK.ForeignKeyOf<FALocationHistory>.By<lossSubID> { }
		}
		#endregion
		#region AssetID
		...
		[PXUIRequired(typeof(CanBeDepreciated<FixedAsset.depreciable, FixedAsset.underConstruction>))]
