...
namespace PX.Objects.PO
{
	...
	public class POLandedCostTaxTran : TaxDetail, PX.Data.IBqlTable
	{
		...
		{
			public class LandedCostDocument : POLandedCostDoc.PK.ForeignKeyOf<POLandedCostTaxTran>.By<docType, refNbr> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<POLandedCostTaxTran>.By<taxID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<POLandedCostTaxTran>.By<curyInfoID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<POLandedCostTaxTran>.By<taxZoneID> { }
