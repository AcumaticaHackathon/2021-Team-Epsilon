...
namespace PX.Objects.AM.Attributes
{
    public class AMTranType 
    {
        ...
        /// </summary>
        public const string InventoryCostAdj = "ICA";
        /// <summary>
        /// <summary>
        /// MFG Disassembly
        /// </summary>
        ...
        public class ListDesc
        {
            ...
            public static string InventoryCostAdj { get { return Messages.GetLocal(Messages.InventoryCostAdj); } }
        }
        ...
        public class TranDesc
        {
            ...
            public static string InventoryCostAdj { get { return Messages.GetLocal(Messages.ProdGLEntry_WIPAdjustment); } }
        }
        ...
        public class inventoryCostAdj : PX.Data.BQL.BqlString.Constant<inventoryCostAdj>
        {
            public inventoryCostAdj() : base(InventoryCostAdj) { }
        }
        ...
        public class ListAttribute : PXStringListAttribute
        {
            ...
            : base(
                ...
                new[] {
                    ...
                    Messages.InventoryCostAdj       // InventoryCostAdj
                })
            {}
        }
