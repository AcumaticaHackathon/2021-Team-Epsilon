...
namespace PX.Objects.FS
{
    ...
    public abstract class ListField_Status_AppointmentDet : PX.Data.IBqlField
    {
        public class ListAttribute : PXStringListAttribute
        {
            public static List<Tuple<string, string>> FullList = new List<Tuple<string, string>>
            {
                new Tuple<string, string>(NOT_STARTED, TX.Status_AppointmentDet.NOT_STARTED),
                new Tuple<string, string>(IN_PROCESS, TX.Status_AppointmentDet.IN_PROCESS),
                new Tuple<string, string>(COMPLETED, TX.Status_AppointmentDet.COMPLETED),
                new Tuple<string, string>(NOT_FINISHED, TX.Status_AppointmentDet.NOT_FINISHED),
                new Tuple<string, string>(NOT_PERFORMED, TX.Status_AppointmentDet.NOT_PERFORMED),
                new Tuple<string, string>(CANCELED, TX.Status_AppointmentDet.CANCELED),
                new Tuple<string, string>(WaitingForPO, TX.Status_AppointmentDet.WaitingForPO),
                new Tuple<string, string>(RequestForPO, TX.Status_AppointmentDet.RequestForPO)
            };

            public ListAttribute()
                : base(FullList.ToArray())
            {
            }
        }

        public const string NOT_STARTED = ID.Status_AppointmentDet.NOT_STARTED;
        public const string IN_PROCESS = ID.Status_AppointmentDet.IN_PROCESS;
        public const string COMPLETED = ID.Status_AppointmentDet.COMPLETED;
        public const string NOT_FINISHED = ID.Status_AppointmentDet.NOT_FINISHED;
        public const string NOT_PERFORMED = ID.Status_AppointmentDet.NOT_PERFORMED;
        public const string CANCELED = ID.Status_AppointmentDet.CANCELED;
        public const string WaitingForPO = ID.Status_AppointmentDet.WaitingForPO;
        public const string RequestForPO = ID.Status_AppointmentDet.RequestForPO;

        public class NotStarted : PX.Data.BQL.BqlString.Constant<NotStarted>
        {
            public NotStarted() : base(NOT_STARTED)
            {
            }
        }
        ...
        {
            public InProcess() : base(IN_PROCESS)
            {
            }
        }
		...
		{
            public NotFinished() : base(NOT_FINISHED)
            {
            }
        }
        ...
        {
            public NotPerformed() : base(NOT_PERFORMED)
            {
            }
        }
        ...
        public class waitingForPO : PX.Data.BQL.BqlString.Constant<waitingForPO>
        {
            public waitingForPO() : base(WaitingForPO)
            {
            }
        }

        public class requestForPO : PX.Data.BQL.BqlString.Constant<requestForPO>
        {
            public requestForPO() : base(RequestForPO)
            {
            }
        }
    }
    ...
    public abstract class ListField_Status_Log : PX.Data.IBqlField
    {
        ...
        {
            public Paused() : base(ID.Status_Log.PAUSED)
            {
            }
        }
    }
    ...
    public abstract class ListField_LogAction_Type : ListField_Log_ItemType
    {
        public new class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
                : base(new[]
                {
                    Pair(Travel, TX.Type_Log.TRAVEL),
                    Pair(Staff, TX.Type_Log.STAFF),
                    Pair(ServBasedAssignment, TX.Type_Log.SERV_BASED_ASSIGMENT),
                    Pair(Service, TX.Type_Log.SERVICE),
                    Pair(NonStock, TX.Type_Log.NON_STOCK),
                })
            {
            }
        }

        public const string ServBasedAssignment = "SB";

        public class serviceBasedAssignment : PX.Data.BQL.BqlString.Constant<serviceBasedAssignment>
        {
            public serviceBasedAssignment() : base(ServBasedAssignment)
            {
            }
        }
    }
    ...
    #region Log_ItemType
    public abstract class ListField_Log_ItemType : PX.Data.IBqlField
    {
        public class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
        ...
        public class staff : PX.Data.BQL.BqlString.Constant<staff>
        {
    ...
    public abstract class ListField_LogActions : IBqlField
    {
        ...
        public class Resume : Data.BQL.BqlString.Constant<Resume>
        {
            public Resume() : base(ID.LogActions.RESUME)
            {
            }
        }

        public class Pause : Data.BQL.BqlString.Constant<Pause>
        {
            public Pause() : base(ID.LogActions.PAUSE)
            {
            }
        }
    }
    ...
    public abstract class ListField_PostDoc_EntityType : PX.Data.IBqlField
    {
        ...
        public const string SERVICE_ORDER = ID.PostDoc_EntityType.SERVICE_ORDER;
        public const string APPOINTMENT = ID.PostDoc_EntityType.APPOINTMENT;
		...
		{
            public Service_Order() : base(SERVICE_ORDER)
            {
            }
        }
    }
    ...
    #region FSCalendarComponentField_ComponentType
    public abstract class ListField_ComponentType
    {
        public class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
                : base(new[]
                {
                    Pair(AppointmentBox, AppointmentBox),
                    Pair(ServiceOrderGrid, ServiceOrderGrid)
                })
            {
            }
        }

        public const string AppointmentBox = "AP";
        public const string ServiceOrderGrid = "SO";
        public const string UnassignedAppGrid = "UA";

        public class appointmentBox : PX.Data.BQL.BqlString.Constant<appointmentBox>
        {
            public appointmentBox() : base(AppointmentBox)
            {
            }
        }

        public class serviceOrderGrid : PX.Data.BQL.BqlString.Constant<serviceOrderGrid>
        {
            public serviceOrderGrid() : base(ServiceOrderGrid)
            {
            }
        }

        public class unassignedAppGrid : PX.Data.BQL.BqlString.Constant<unassignedAppGrid>
        {
            public unassignedAppGrid() : base(UnassignedAppGrid)
            {
            }
        }
    }
    ...
    public abstract class ListField
    {
        ...
        #region CloningType_CloneAppointment
        [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
        public abstract class CloningType_CloneAppointment
        {
            public class ListAttribute : PXStringListAttribute
            {
                public ListAttribute() : base(
                    new[]
                    {
                    Pair(Single, TX.CloningType_CloneAppointment.Single),
                    Pair(Multiple, TX.CloningType_CloneAppointment.Multiple),
                    })
                {
                }
            }
        ...
        public abstract class ServiceOrderStatus
        {
            public class ListAttribute : PXStringListAttribute
            {
                public ListAttribute()
                    : base(new[]
                    {
                        Pair(Open, TX.Status_ServiceOrder.Open),
                        Pair(Hold, TX.Status_ServiceOrder.Hold),
                        Pair(Awaiting, TX.Status_ServiceOrder.Awaiting),
                        Pair(Completed, TX.Status_ServiceOrder.Completed),
                        Pair(Closed, TX.Status_ServiceOrder.Closed),
                        Pair(Canceled, TX.Status_ServiceOrder.Canceled),
                        Pair(Copied, TX.Status_ServiceOrder.Copied),
                        Pair(Confirmed, TX.Status_ServiceOrder.Confirmed)
                    })
                {
                }
            }
            ...
            public class copied : PX.Data.BQL.BqlString.Constant<copied>
            {
                public copied() : base(Copied)
                {
                }
            }
        ...
        #region ServiceOrder WorkflowTypes
        [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
        public abstract class ServiceOrderWorkflowTypes
        {
            public class ListAttribute : PXStringListAttribute
            {
                public ListAttribute()
                    : base(new[]
                    {
                        Pair(Quote, TX.ServiceOrderWorkflowTypes.Quote),
                        Pair(Simple, TX.ServiceOrderWorkflowTypes.Simple),
                    })
                {
                }
            }
            ...
            public class quote : PX.Data.BQL.BqlString.Constant<quote> { public quote() : base(Quote) { } }
        ...
        #region Appointment WorkflowTypes
        [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
        public abstract class AppointmentWorkflowTypes
        {
            public class ListAttribute : PXStringListAttribute
            {
                public ListAttribute()
                    : base(new[]
                    {
                        Pair(Simple, TX.AppointmentWorkflowTypes.Simple),
                    })
                {
                }
            }
        ...
        [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
        public abstract class AppointmentStatus : PX.Data.IBqlField
        {
            public class ListAttribute : PXStringListAttribute
            {
                public ListAttribute()
                    : base(new[]
                    {
                    Pair(NotStarted, TX.Status_Appointment.NotStarted),
                    Pair(InProcess, TX.Status_Appointment.IN_PROCESS),
                    Pair(Canceled, TX.Status_Appointment.CANCELED),
                    Pair(Completed, TX.Status_Appointment.COMPLETED),
                    Pair(Closed, TX.Status_Appointment.CLOSED),
                    Pair(Hold, TX.Status_Appointment.ON_HOLD),
                    Pair(Paused, TX.Status_Appointment.PAUSED),
                    Pair(Awaiting, TX.Status_Appointment.Awaiting),
                    Pair(Billed, TX.Status_Appointment.Billed)
                    })
                {
                }
            }
            ...
            public class notStarted : PX.Data.BQL.BqlString.Constant<notStarted> { public notStarted() : base(NotStarted) { } }

            public const string InProcess = "P";
            public class inProcess : PX.Data.BQL.BqlString.Constant<inProcess> { public inProcess() : base(InProcess) { } }

            public const string Canceled = "X";
            public class canceled : PX.Data.BQL.BqlString.Constant<canceled> { public canceled() : base(Canceled) { } }

            public const string Completed = "C";
            public class completed : PX.Data.BQL.BqlString.Constant<completed> { public completed() : base(Completed) { } }

            public const string Closed = "Z";
            public class closed : PX.Data.BQL.BqlString.Constant<closed> { public closed() : base(Closed) { } }

            public const string Hold = "H";
            public class hold : PX.Data.BQL.BqlString.Constant<hold> { public hold() : base(Hold) { } }

            public const string Paused = "U";
            public class paused : PX.Data.BQL.BqlString.Constant<paused> { public paused() : base(Paused) { } }

            public const string Awaiting = "W";
            public class awaiting : PX.Data.BQL.BqlString.Constant<awaiting> { public awaiting() : base(Awaiting) { } }

            public const string Billed = "B";
            public class billed : PX.Data.BQL.BqlString.Constant<billed> { public billed() : base(Billed) { } }
        }
        #endregion

        #region Appointment Status
        [System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
        public abstract class ServiceOrderTypeBehavior : PX.Data.IBqlField
        {
            public class ListAttribute : PXStringListAttribute
            {
                public ListAttribute()
                    : base(
                        Pair(RegularAppointment, TX.ServiceOrderTypeBehavior.RegularAppointment),
                        Pair(RouteAppointment, TX.ServiceOrderTypeBehavior.RouteAppointment),
                        Pair(InternalAppointment, TX.ServiceOrderTypeBehavior.InternalAppointment),
                        Pair(Quote, TX.ServiceOrderTypeBehavior.Quote))
                {
                }
            }

            public const string RegularAppointment = "RE";
            public class regularAppointment : PX.Data.BQL.BqlString.Constant<regularAppointment> { public regularAppointment() : base(RegularAppointment) { } }


            public const string RouteAppointment = "RO";
            public class routeAppointment : PX.Data.BQL.BqlString.Constant<routeAppointment> { public routeAppointment() : base(RouteAppointment) { } }


            public const string InternalAppointment = "IN";
            public class internalAppointment : PX.Data.BQL.BqlString.Constant<internalAppointment> { public internalAppointment() : base(InternalAppointment) { } }
    ...
    public abstract class ListField_FSPOSource
    {
        public class ListAttribute : PXStringListAttribute
        {
            public static List<Tuple<string, string>> FullList = new List<Tuple<string, string>>
            {
                new Tuple<string, string>(PurchaseToServiceOrder, TX.FSPOSource.PurchaseToServiceOrder),
                new Tuple<string, string>(PurchaseToAppointment, TX.FSPOSource.PurchaseToAppointment)
            };
        ...
        public const string PurchaseToServiceOrder = "O";
        public const string PurchaseToAppointment = "A";
        
        public class purchaseToServiceOrder : PX.Data.BQL.BqlString.Constant<purchaseToServiceOrder>
        {
            public purchaseToServiceOrder() : base(PurchaseToServiceOrder)
            {
            }
        }

        public class purchaseToAppointment : PX.Data.BQL.BqlString.Constant<purchaseToAppointment>
        {
            public purchaseToAppointment() : base(PurchaseToAppointment)
            {
            }
        }
    }
    #endregion
    #region Linked_Entity_Type
    public abstract class ListField_Linked_Entity_Type
    {
        public class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
                : base(new[]
                {
                    Pair(ExpenseReceipt, TX.Linked_Entity_Type.ExpenseReceipt),
                    Pair(SalesOrder, TX.Linked_Entity_Type.SalesOrder),
                    Pair(APBill, TX.Linked_Entity_Type.APBill)
                })
            {
            }
        }
        public const string ExpenseReceipt = "ER";
        public const string SalesOrder = "SO";
        public const string APBill = "AP";

        public class expenseReceipt : PX.Data.BQL.BqlString.Constant<expenseReceipt>
        {
            public expenseReceipt() : base(ListField_Linked_Entity_Type.ExpenseReceipt)
            {
            }
        }
        ...
        public class salesOrder : PX.Data.BQL.BqlString.Constant<salesOrder>
        {
            public salesOrder() : base(ListField_Linked_Entity_Type.SalesOrder)
            {
            }
        }

        public class apBill : PX.Data.BQL.BqlString.Constant<apBill>
        {
            public apBill() : base(ListField_Linked_Entity_Type.APBill)
            {
            }
        }
    }
    #endregion
    #region FSEntity_Type 
    public abstract class ListField_FSEntity_Type
    {
        public class ListAttribute : PXStringListAttribute
        {
            public ListAttribute()
                : base(new[]
                {
                    Pair(ServiceOrder, TX.TableName.SERVICE_ORDER),
                    Pair(Appointment, TX.TableName.APPOINTMENT)
                })
            {
            }
        }

        public const string ServiceOrder = ID.FSEntityType.ServiceOrder;
        public const string Appointment = ID.FSEntityType.Appointment;

        public class serviceOrder : PX.Data.BQL.BqlString.Constant<serviceOrder>
        {
            public serviceOrder() : base(ID.FSEntityType.ServiceOrder)
            {
            }
        }
        ...
        public class appointment : PX.Data.BQL.BqlString.Constant<appointment>
        {
            public appointment() : base(ID.FSEntityType.Appointment)
            {
            }
        }
    }
