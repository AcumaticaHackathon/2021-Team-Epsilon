...
namespace PX.Objects.IN
{
	...
	public partial class INCostStatus : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class Account : GL.Account.PK.ForeignKeyOf<INCostStatus>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<INCostStatus>.By<subID> { }
			public class Site : INSite.PK.ForeignKeyOf<INCostStatus>.By<siteID> { }
    ...
    [PXProjection(typeof(Select4<INCostStatus, Where<INCostStatus.costSiteID, Equal<SiteAttribute.transitSiteID>>, Aggregate<
