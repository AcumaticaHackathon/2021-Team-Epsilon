...
namespace PX.Objects.AP
{
	...
	public partial class APTran : IBqlTable, DR.Descriptor.IDocumentLine, ISortOrder, ITaxableDetail, IAccountable
	{
		...
		{
			public class Document : AP.APRegister.PK.ForeignKeyOf<APTran>.By<tranType, refNbr> { }
			public class Invoice : AP.APInvoice.PK.ForeignKeyOf<APTran>.By<tranType, refNbr> { }
			public class Payment : AP.APPayment.PK.ForeignKeyOf<APTran>.By<tranType, refNbr> { }
			...
			public class POOrder : PO.POOrder.PK.ForeignKeyOf<APTran>.By<pOOrderType, pONbr> { }
			public class POLine : PO.POLine.PK.ForeignKeyOf<APTran>.By<pOOrderType, pONbr, pOLineNbr> { }
			public class SuppliedByVendor : AP.Vendor.PK.ForeignKeyOf<APTran>.By<suppliedByVendorID> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<APTran>.By<inventoryID> { }
			public class LandedCostDocument : PO.POLandedCostDoc.PK.ForeignKeyOf<APTran>.By<lCDocType, lCRefNbr> { }
			public class LandedCostLine : PO.POLandedCostDetail.PK.ForeignKeyOf<APTran>.By<lCDocType, lCRefNbr, lCLineNbr> { }
			public class POReceipt : PO.POReceipt.PK.ForeignKeyOf<APTran>.By<receiptNbr> { }
			public class POReceiptLine : PO.POReceiptLine.PK.ForeignKeyOf<APTran>.By<receiptNbr, receiptLineNbr> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<APTran>.By<curyInfoID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<APTran>.By<taxID> { }
			public class TaxCategory : TX.TaxCategory.PK.ForeignKeyOf<APTran>.By<taxCategoryID> { }
			...
			public class DeferralCode : DR.DRDeferredCode.PK.ForeignKeyOf<APTran>.By<deferredCode> { }
			public class Site : INSite.PK.ForeignKeyOf<APTran>.By<siteID> { }
		}
		#endregion
		...
		[ActiveProjectTask(
			typeof(APTran.projectID), BatchModule.AP,
	...
	[PXHidden]
	public partial class APTranSigned : APTran
	{
		public new abstract class tranType : PX.Data.BQL.BqlString.Field<tranType> { }
		public new abstract class refNbr : PX.Data.BQL.BqlString.Field<refNbr> { }
		public new abstract class lineNbr : PX.Data.BQL.BqlInt.Field<lineNbr> { }
		public new abstract class origLineNbr : PX.Data.BQL.BqlInt.Field<origLineNbr> { }
		public new abstract class tranBal : PX.Data.BQL.BqlInt.Field<tranBal> { }
		public new abstract class origTranAmt : PX.Data.BQL.BqlInt.Field<origTranAmt> { }
		#region TranBalSigned
