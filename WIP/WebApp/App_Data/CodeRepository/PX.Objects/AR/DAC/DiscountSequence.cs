namespace PX.Objects.AR
{
	...
	public partial class DiscountSequence : PX.Data.IBqlTable
	{
		...
		{
			public class FreeItem : IN.InventoryItem.PK.ForeignKeyOf<DiscountSequence>.By<freeItemID> { }
			public class PendingFreeItem : IN.InventoryItem.PK.ForeignKeyOf<DiscountSequence>.By<pendingFreeItemID> { }
			public class LastFreeItem : IN.InventoryItem.PK.ForeignKeyOf<DiscountSequence>.By<lastFreeItemID> { }
		}
		#endregion
		#region DiscountID
