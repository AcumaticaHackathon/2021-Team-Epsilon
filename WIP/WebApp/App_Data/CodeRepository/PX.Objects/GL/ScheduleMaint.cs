				...
				if (document != null)
				{
					...
					if (updatedBatch == null)
					{
						...
						PXDBTimestampAttribute batchTimestampAttribute = _dummyBatch.Cache
							...
							.First();
						bool recordComesFirst = batchTimestampAttribute.RecordComesFirst;
						batchTimestampAttribute.RecordComesFirst = true;
						try
						{
						...
						{
							batchTimestampAttribute.RecordComesFirst = recordComesFirst;
						}
					}
				}
			}
