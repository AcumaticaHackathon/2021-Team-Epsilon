namespace PX.Objects.AP
 {
	...
	public partial class APDiscount : PX.Data.IBqlTable
	 {
		#region Keys
		public class PK : PrimaryKeyOf<APDiscount>.By<discountID, bAccountID>
		{
			public static APDiscount Find(PXGraph graph, Int32? discountID, Int32? bAccountID) => FindBy(graph, discountID, bAccountID);
		}
		public static class FK
		{
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APDiscount>.By<bAccountID> { }
		}
		#endregion
