...
namespace PX.Objects.PR
{
	...
	public class PRPaymentEarning : IBqlTable
	{
		...
		{
			public static PRPaymentEarning Find(PXGraph graph, string docType, string refNbr, string typeCD, int? locationID) =>
				FindBy(graph, docType, refNbr, typeCD, locationID);
		}
