...
namespace PX.Objects.IN
{
	...
	public partial class INPostClass : PX.Data.IBqlTable
	{
		...
		{
			public class ReasonCodeSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<reasonCodeSubID> { }
			public class InventoryAccrualAccount : Account.PK.ForeignKeyOf<INPostClass>.By<invtAcctID> { }
			public class InventoryAccrualSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<invtSubID> { }
			public class COGSAccount : Account.PK.ForeignKeyOf<INPostClass>.By<cOGSAcctID> { }
			public class COGSSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<cOGSSubID> { }
			public class SalesAccount : Account.PK.ForeignKeyOf<INPostClass>.By<salesAcctID> { }
			public class SalesSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<salesSubID> { }
			public class StandardCostRevaluationAccount : Account.PK.ForeignKeyOf<INPostClass>.By<stdCstRevAcctID> { }
			public class StandardCostRevaluationSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<stdCstRevSubID> { }
			public class PPVAccount : Account.PK.ForeignKeyOf<INPostClass>.By<pPVAcctID> { }
			public class PPVSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<pPVSubID> { }
			public class StandardCostVarianceAccount : Account.PK.ForeignKeyOf<INPostClass>.By<stdCstVarAcctID> { }
			public class StandardCostVarianceSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<stdCstVarSubID> { }
			public class POAccrualAccount : Account.PK.ForeignKeyOf<INPostClass>.By<pOAccrualAcctID> { }
			public class POAccrualSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<pOAccrualSubID> { }
			public class LandedCostVarianceAccount : Account.PK.ForeignKeyOf<INPostClass>.By<lCVarianceAcctID> { }
			public class LandedCostVarianceSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<lCVarianceSubID> { }
			public class DeferralAccount : Account.PK.ForeignKeyOf<INPostClass>.By<deferralAcctID> { }
			public class DeferralSubaccount : Sub.PK.ForeignKeyOf<INPostClass>.By<deferralSubID> { }
			public class PIReasonCode : ReasonCode.PK.ForeignKeyOf<INPostClass>.By<pIReasonCode> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use InventoryAccrualSubaccount instead.")]
			public class InvtSub : InventoryAccrualSubaccount { }
		...
		[PXForeignReference(typeof(FK.InventoryAccrualAccount))]
		...
		[PXForeignReference(typeof(FK.InventoryAccrualSubaccount))]
