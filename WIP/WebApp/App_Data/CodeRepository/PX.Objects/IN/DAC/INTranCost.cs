...
namespace PX.Objects.IN
{
	...
	public partial class INTranCost : PX.Data.IBqlTable
	{
		...
		{
			public class Register : INRegister.PK.ForeignKeyOf<INTranCost>.By<docType, refNbr> { }
			public class Tran : INTran.PK.ForeignKeyOf<INTranCost>.By<docType, refNbr, lineNbr> { }
			public class CostRegister : INRegister.PK.ForeignKeyOf<INTranCost>.By<costDocType, costRefNbr> { }
			...
			public class COGSAccount : Account.PK.ForeignKeyOf<INTranCost>.By<cOGSAcctID> { }
			public class COGSSubaccount : Sub.PK.ForeignKeyOf<INTranCost>.By<cOGSSubID> { }
			public class InventoryAccount : Account.PK.ForeignKeyOf<INTranCost>.By<invtAcctID> { }
			public class InventorySubaccount : Sub.PK.ForeignKeyOf<INTranCost>.By<invtSubID> { }
			//todo public class FinancialPeriod : GL.FinPeriods.TableDefinition.FinPeriod.PK.ForeignKeyOf<INTranCost>.By<finPeriodID> { }
			//todo public class MasterFinancialPeriod : GL.FinPeriods.TableDefinition.FinPeriod.PK.ForeignKeyOf<INTranCost>.By<tranPeriodID> { }
