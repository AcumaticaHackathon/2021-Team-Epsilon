namespace PX.Objects.DR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<DRRevenueBalance>.By<branchID, acctID, subID, componentID, customerID, projectID, finPeriodID>
		{
			public static DRRevenueBalance Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? customerID, Int32? projectID, String finPeriodID) => FindBy(graph, branchID, acctID, subID, componentID, customerID, projectID, finPeriodID);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<DRRevenueBalance>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<DRRevenueBalance>.By<acctID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<DRRevenueBalance>.By<subID> { }
			public class Component : IN.InventoryItem.PK.ForeignKeyOf<DRRevenueBalance>.By<componentID> { }
			public class Customer : AR.Customer.PK.ForeignKeyOf<DRRevenueBalance>.By<customerID> { }
			public class Project : PM.PMProject.PK.ForeignKeyOf<DRRevenueBalance>.By<projectID> { }
		}
		#endregion
		#region BranchID
    ...
    {
		#region Keys
		public class PK : PrimaryKeyOf<DRRevenueBalanceByPeriod>.By<branchID, acctID, subID, componentID, customerID, projectID, finPeriodID>
		{
			public static DRRevenueBalanceByPeriod Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? customerID, Int32? projectID, String finPeriodID) => FindBy(graph, branchID, acctID, subID, componentID, customerID, projectID, finPeriodID);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<DRRevenueBalanceByPeriod>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<DRRevenueBalanceByPeriod>.By<acctID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<DRRevenueBalanceByPeriod>.By<subID> { }
			public class Component : IN.InventoryItem.PK.ForeignKeyOf<DRRevenueBalanceByPeriod>.By<componentID> { }
			public class Customer : AR.Customer.PK.ForeignKeyOf<DRRevenueBalanceByPeriod>.By<customerID> { }
			public class Project : PM.PMProject.PK.ForeignKeyOf<DRRevenueBalanceByPeriod>.By<projectID> { }
		}
		#endregion
		#region BranchID
		public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<DRRevenueBalance2>.By<branchID, acctID, subID, componentID, customerID, projectID, finPeriodID>
		{
			public static DRRevenueBalance2 Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? customerID, Int32? projectID, String finPeriodID) => FindBy(graph, branchID, acctID, subID, componentID, customerID, projectID, finPeriodID);
		}
		public new static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<DRRevenueBalance2>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<DRRevenueBalance2>.By<acctID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<DRRevenueBalance2>.By<subID> { }
			public class Component : IN.InventoryItem.PK.ForeignKeyOf<DRRevenueBalance2>.By<componentID> { }
			public class Customer : AR.Customer.PK.ForeignKeyOf<DRRevenueBalance2>.By<customerID> { }
			public class Project : PM.PMProject.PK.ForeignKeyOf<DRRevenueBalance2>.By<projectID> { }
		}
		#endregion
		#region BranchID
