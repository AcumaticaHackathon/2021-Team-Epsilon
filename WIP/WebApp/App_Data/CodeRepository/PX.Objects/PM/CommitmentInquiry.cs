...
namespace PX.Objects.PM
{
	...
	public class CommitmentInquiry : PXGraph<CommitmentInquiry>
	{
		...
		public PXSelectJoin<PMCommitment,
			LeftJoin<POLine, On<PMCommitment.commitmentID, Equal<POLine.commitmentID>>>,
			...
			And2<Where<PMCommitment.inventoryID, Equal<Current<ProjectBalanceFilter.inventoryID>>, Or<Current<ProjectBalanceFilter.inventoryID>, IsNull>>,
			And<Where<POLine.orderType, Equal<Current<ProjectBalanceFilter.relatedDocumentType>>, Or<Current<ProjectBalanceFilter.relatedDocumentType>, 
				Equal<RelatedDocumentType.all>>>>>>>>>> Items;

		public PXSelectJoinGroupBy<PMCommitment,
			LeftJoin<POLine, On<PMCommitment.commitmentID, Equal<POLine.commitmentID>>>,
			Where2<Where<PMCommitment.projectID, Equal<Current<ProjectBalanceFilter.projectID>>, Or<Current<ProjectBalanceFilter.projectID>, IsNull>>,
			And2<Where<PMCommitment.accountGroupID, Equal<Current<ProjectBalanceFilter.accountGroupID>>, Or<Current<ProjectBalanceFilter.accountGroupID>, IsNull>>,
			And2<Where<PMCommitment.projectTaskID, Equal<Current<ProjectBalanceFilter.projectTaskID>>, Or<Current<ProjectBalanceFilter.projectTaskID>, IsNull>>,
		...
		public partial class ProjectBalanceFilter : IBqlTable
		{
			...
			[PXDBString]
			[PXUIField(DisplayName = "Related Document Type")]
			[PXDefault(CommitmentInquiry.RelatedDocumentType.AllCommitmentsType)]
			[RelatedDocumentType.List]
