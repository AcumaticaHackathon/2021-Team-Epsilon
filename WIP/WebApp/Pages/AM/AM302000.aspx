<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="AM302000.aspx.cs" Inherits="Page_AM302000" Title="Untitled Page" %>
<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>

<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" BorderStyle="NotSet" PrimaryView="batch" TypeName="PX.Objects.AM.MoveEntry" HeaderDescriptionField="TranDesc">
		<CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" SyncPosition="True" >
            ...
            <px:PXGridLevel DataMember="transactions" DataKeyNames="DocType,BatNbr,LineNbr">
                <RowTemplate>
                    ...
                    <px:PXSelector Size="s" ID="edReceiptNbr" runat="server" DataField="ReceiptNbr" AutoRefresh="true">
                        <GridProperties FastFilterFields="ReceiptNbr,INRegisterExt__AMBatNbr">
						    <Columns>
                                ...
                                <px:PXGridColumn AllowUpdate="False" DataField="INRegisterExt__AMBatNbr" Width="100px">
							    </px:PXGridColumn>
						    </Columns>
						    <Layout ColumnsMenu="False" />
                ...
                <Columns>
                    <px:PXGridColumn DataField="LineNbr" TextAlign="Right" Width="81px" />
                    ...
                    <px:PXGridColumn DataField="Qty" TextAlign="Right" AutoCallBack="True" Width="130px" />
                    ...
                    <px:PXGridColumn DataField="LotSerialNbr" Width="180px" AutoCallBack="true" />
                    <px:PXGridColumn DataField="ExpireDate" Width="90px" />
                    <px:PXGridColumn DataField="ReceiptNbr" Width="81px" AutoCallBack="true" />
                    <px:PXGridColumn DataField="QtyScrapped" TextAlign="Right" Width="130px" AutoCallBack="true" />
		...
		<ActionBar ActionsText="False">
		    <CustomItems>
		        <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LSAMMove_binLotSerial" CommandSourceID="ds" DependOnGrid="grid" />
