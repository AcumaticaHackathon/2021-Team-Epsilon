...
namespace PX.Objects.GL
{
	...
	public partial class GLTrialBalanceImportMap : IBqlTable
	{
		...
		{
			public static GLTrialBalanceImportMap Find(PXGraph graph, String number) => FindBy(graph, number);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<GLTrialBalanceImportMap>.By<branchID> { }
