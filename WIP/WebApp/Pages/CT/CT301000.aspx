...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.CT.ContractMaint"
		PrimaryView="Contracts" BorderStyle="NotSet" HeaderDescriptionField="CustomerID">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ViewUsage"  CommitChanges="True" />
			...
			<px:PXDSCallbackCommand Name="Renew" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="ViewContract" Visible="False" DependOnGrid="RenewalHistoryGrid" />
			<px:PXDSCallbackCommand Name="Bill" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="Activate" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="Setup" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="SetupAndActivate" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="Terminate" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="Upgrade" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="ActivateUpgrade" CommitChanges="True" />
			<px:PXDSCallbackCommand Name="UndoBilling" CommitChanges="True" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	...
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Contracts" Caption="Contract Info"
		...
		BPEventsIndicator="true" EmailingGraph="PX.Objects.CR.CREmailActivityMaint,PX.Objects" DefaultControlID="edContractCD">
		<Template>
