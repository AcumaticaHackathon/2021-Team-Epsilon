namespace PX.Objects.TX
{
	...
	public partial class TaxBucketLine : PX.Data.IBqlTable
	{
		...
		{
			public static TaxBucketLine Find(PXGraph graph, int? vendorID, int? bucketID, int? taxReportRevisionID, int? lineNbr) => FindBy(graph, vendorID, bucketID, taxReportRevisionID, lineNbr);
		}
