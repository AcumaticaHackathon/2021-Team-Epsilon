...
namespace PX.Objects.FS
{
    ...
    public class FSServiceTemplateDet : PX.Data.IBqlTable
	{
        ...
        {
            public static FSServiceTemplateDet Find(PXGraph graph, int? serviceTemplateID, int? serviceTemplateDetID) => FindBy(graph, serviceTemplateID, serviceTemplateDetID);
        }
