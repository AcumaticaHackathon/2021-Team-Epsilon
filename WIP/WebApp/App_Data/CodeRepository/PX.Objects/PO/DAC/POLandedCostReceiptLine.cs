...
namespace PX.Objects.PO
{
	...
	public class POLandedCostReceiptLine : PX.Data.IBqlTable, ISortOrder
	{
		...
		public static class FK
		{
			...
			public class Receipt : POReceipt.UK.ForeignKeyOf<POLandedCostReceiptLine>.By<pOReceiptType, pOReceiptNbr> { }
			public class ReceiptLine : POReceiptLine.UK.ForeignKeyOf<POLandedCostReceiptLine>.By<pOReceiptType, pOReceiptNbr, pOReceiptLineNbr> { }
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use LandedCostDocument instead.")]
			public class LandedCostDoc : LandedCostDocument { }
		}
		#endregion
		...
		[PXDefault(typeof(Coalesce<
			Search<LocationBranchSettings.vSiteID,
				Where<LocationBranchSettings.bAccountID, Equal<Current<POLandedCostDoc.vendorID>>,
					And<LocationBranchSettings.locationID, Equal<Current<POLandedCostDoc.vendorLocationID>>,
					And<LocationBranchSettings.branchID, Equal<Current<POLandedCostDoc.branchID>>>>>>,
			...
			Search<InventoryItem.dfltSiteID, Where<InventoryItem.inventoryID, Equal<Current<inventoryID>>>>>),
			PersistingCheck = PXPersistingCheck.Nothing)]
