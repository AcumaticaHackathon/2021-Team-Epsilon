...
namespace PX.Objects.FS
{
    ...
    public class FSContractPeriodDet : PX.Data.IBqlTable
    {
        ...
        {
            public static FSContractPeriodDet Find(PXGraph graph, int? contractPeriodID, int? contractPeriodDetID) => FindBy(graph, contractPeriodID, contractPeriodDetID);
        }
        ...
        public static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSContractPeriodDet>.By<projectTaskID> { }
