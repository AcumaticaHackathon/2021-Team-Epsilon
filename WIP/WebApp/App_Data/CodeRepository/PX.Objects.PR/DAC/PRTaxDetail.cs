...
namespace PX.Objects.PR
{
	...
	public class PRTaxDetail : IBqlTable, IPaycheckDetail
	{
		...
		{
			public static PRTaxDetail Find(PXGraph graph, int? recordID) => FindBy(graph, recordID);
		}
		...
		public static class FK
		{
			...
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PRTaxDetail>.By<projectTaskID> { }
