...
namespace PX.Objects.AM
{
    ...
    public class AMDisassembleTranSplit : AMMTranSplit
    {
        ...
        {
	        public static AMDisassembleTranSplit Find(PXGraph graph, 
		        string docType, string batNbr, int? lineNbr, int? splitLineNbr) =>
		        FindBy(graph, docType, batNbr, lineNbr, splitLineNbr);
        }
