...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FADepreciationMethod>.By<methodID>
		{
			public static FADepreciationMethod Find(PXGraph graph, int? methodID) => FindBy(graph, methodID);
		}
		public class UK : PrimaryKeyOf<FADepreciationMethod>.By<methodCD>
		{
			public static FADepreciationMethod Find(PXGraph graph, string methodCD) => FindBy(graph, methodCD);
		}
		public static class FK
		{
			public class Book : FA.FABook.PK.ForeignKeyOf<FADepreciationMethod>.By<bookID> { }
			public class ClassMethod : FA.FADepreciationMethod.PK.ForeignKeyOf<FADepreciationMethod>.By<parentMethodID> { }
		}
		#endregion
