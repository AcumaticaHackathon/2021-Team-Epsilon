...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%"
		...
		BPEventsIndicator="True" Caption="Email Account Summary" DefaultControlID="edEmailAccountID">
		<Template>
		...
		<Items>
			<px:PXTabItem Text="Servers" RepaintOnDemand="false">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Authentication" />
					<px:PXDropDown ID="edAuthenticationMethod" runat="server" DataField="AuthenticationMethod" CommitChanges="true" />
					<px:PXTextEdit ID="edAzureTenantID" runat="server" DataField="AzureTenantID" />
					<px:PXSelector ID="edOAuthApplicationID" runat="server" DataField="OAuthApplicationID" AllowEdit="true" CommitChanges="true" />
			...
			<px:PXTabItem Text="Incoming Mail Processing">
				<Template>
					...
					<px:PXCheckBox ID="edSubmitToIncomingAPDocuments" runat="server" DataField="SubmitToIncomingAPDocuments" CommitChanges="true" />
			...
			<px:PXTabItem Text="Content">
				<Template>
					...
					<px:PXLabel ID="lblCommentAttach" runat="server" Text="Specify the extensions for allowed attachment types separating them by commas. Example: .csv, .jpg, .png, .xls"
						SuppressLabel="False"/>	 
