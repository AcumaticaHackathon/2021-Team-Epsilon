...
namespace PX.Objects.FA
{
	...
	public partial class FAServiceSchedule : PX.Data.IBqlTable
	{
		...
		{
			public static FAServiceSchedule Find(PXGraph graph, Int32? scheduleID) => FindBy(graph, scheduleID);
		}
		public class UK : PrimaryKeyOf<FAServiceSchedule>.By<scheduleCD>
		{
			public static FAServiceSchedule Find(PXGraph graph, string scheduleCD) => FindBy(graph, scheduleCD);
		}
		#endregion
		#region ScheduleID
