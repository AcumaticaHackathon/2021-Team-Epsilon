...
namespace PX.Objects.CA
{
    ...
    public partial class CASetup : IBqlTable
	{
		...
		{
			public class BatchNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CASetup>.By<batchNumberingID> { }
			public class TransactionNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CASetup>.By<registerNumberingID> { }
			public class TransferNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CASetup>.By<transferNumberingID> { }
			public class PaymentBatchNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CASetup>.By<cABatchNumberingID> { }
			public class BankStatementNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CASetup>.By<cAStatementNumberingID> { }
			public class PaymentImportNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CASetup>.By<cAImportPaymentsNumberingID> { }
			public class CorporateCardNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CASetup>.By<corpCardNumberingID> { }
			public class CashInTransitAccount : GL.Account.PK.ForeignKeyOf<CASetup>.By<transitAcctId> { }
			public class CashInTransitSubaccount : GL.Sub.PK.ForeignKeyOf<CASetup>.By<transitSubID> { }
			public class UnrecognizedReceiptsEntryType : CA.CAEntryType.PK.ForeignKeyOf<CASetup>.By<unknownPaymentEntryTypeID> { }
	}
		...
		/// </summary>
		[PXDBDecimal(MinValue = 0, MaxValue = 100.0)]
		[PXDefault(TypeCode.Decimal, "87.5", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIField(DisplayName = "Ref. Nbr. Weight")]
		...
		/// </summary>
		[PXDBDecimal(MinValue = 0, MaxValue = 100)]
		[PXDefault(TypeCode.Decimal, "12.5", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIField(DisplayName = "Doc. Payee Weight")]
		...
		/// </summary>
		[PXDBDecimal(MinValue = 0, MaxValue = 365)]
		[PXDefault(TypeCode.Decimal, "2.0", PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIField(DisplayName = "Estimated Deviation (Days)")]
