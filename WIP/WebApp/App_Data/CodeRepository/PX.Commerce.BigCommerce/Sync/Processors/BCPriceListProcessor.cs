...
namespace PX.Commerce.BigCommerce
{
	...
	public class BCPriceListProcessor : BCProcessorBulkBase<BCPriceListProcessor, BCPriceListEntityBucket, MappedPriceList>, IProcessor
	{
		...
		#region Import
		public override List<BCPriceListEntityBucket> FetchBucketsImport(List<BCSyncStatus> ids)
		{
		...
		#region Export
		public override List<BCPriceListEntityBucket> FetchBucketsExport(List<BCSyncStatus> ids)
		{
			...
			foreach (var priceCode in priceCodes)
			{
				...
				var priceClassNoteID = customerPrices.First().PriceClassNoteID.Value;
