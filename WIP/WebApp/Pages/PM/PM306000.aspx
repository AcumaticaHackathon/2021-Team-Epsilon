    ...
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="150px" SkinID="PrimaryInquire" SyncPosition="true" FastFilterFields="ExtRefNbr, RefNoteID">
        <Levels>
            <px:PXGridLevel DataMember="Items">
                <Columns>
                    <px:PXGridColumn DataField="POLine__OrderType" />
                    ...
                    <px:PXGridColumn DataField="CommittedVarianceQty" TextAlign="Right" />
                    <px:PXGridColumn DataField="CommittedVarianceAmount" TextAlign="Right" />
                </Columns>
                <RowTemplate>
