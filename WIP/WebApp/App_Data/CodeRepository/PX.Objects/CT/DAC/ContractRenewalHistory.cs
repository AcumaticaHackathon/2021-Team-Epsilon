...
namespace PX.Objects.CT
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<ContractRenewalHistory>.By<contractID, revID>
		{
			public static ContractRenewalHistory Find(PXGraph graph, int? contractID, Int32? revID) => FindBy(graph, contractID, revID);
		}
		public static class FK
		{
			public class Contract : CT.Contract.PK.ForeignKeyOf<ContractRenewalHistory>.By<contractID> { }
			public class Discount : AR.ARDiscount.PK.ForeignKeyOf<ContractRenewalHistory>.By<discountID> { }
		}
		#endregion
		#region ContractID
