namespace PX.Objects.PO
{
	...
	public partial class POSetup : PX.Data.IBqlTable
	{
		...
		{
			public class BlanketOrderNumbering : Numbering.PK.ForeignKeyOf<POSetup>.By<standardPONumberingID> { }
			public class RegularOrderNumbering : Numbering.PK.ForeignKeyOf<POSetup>.By<regularPONumberingID> { }
			public class ReceiptNumbering : Numbering.PK.ForeignKeyOf<POSetup>.By<receiptNumberingID> { }
			public class LandedCostNumbering : Numbering.PK.ForeignKeyOf<POSetup>.By<landedCostDocNumberingID> { }
			public class ReceiptAssignmentMap : EPAssignmentMap.PK.ForeignKeyOf<POSetup>.By<defaultReceiptAssignmentMapID> { }
			public class FreightExpenseAccount : Account.PK.ForeignKeyOf<POSetup>.By<freightExpenseAcctID> { }
			public class FreightExpenseSubaccount : Sub.PK.ForeignKeyOf<POSetup>.By<freightExpenseSubID> { }
			public class POReturnReasonCode : ReasonCode.PK.ForeignKeyOf<POSetup>.By<rCReturnReasonCodeID> { }
			public class TaxReasonCode : ReasonCode.PK.ForeignKeyOf<POSetup>.By<taxReasonCodeID> { }
			public class PPVReasonCode : ReasonCode.PK.ForeignKeyOf<POSetup>.By<pPVReasonCodeID> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use POReturnReasonCode instead.")]
			public class RCReturnReasonCode : POReturnReasonCode { }
		}
		#endregion
		...
		[PXForeignReference(typeof(FK.FreightExpenseAccount))]
		...
		[PXDefault()]
		[PXForeignReference(typeof(FK.POReturnReasonCode))]
		...
		#endregion
		#region APInvoiceValidation
		public abstract class aPInvoiceValidation : PX.Data.BQL.BqlString.Field<aPInvoiceValidation> { }

		[PXDefault(APInvoiceValidationMode.None)]
		[APInvoiceValidationMode.List]
		[PXUIField(DisplayName = "Bill Against Commitments")]
		[PXDBString(1, IsFixed = true)]
		public virtual String APInvoiceValidation
		{
			get;
			set;
		}
	...
	public class APInvoiceValidationMode
	{
		public class List : PXStringListAttribute
		{
			public List() : base(
				new[]
				{
					Pair(None, Messages.APInvoiceNoValidation),
					Pair(Warning, Messages.APInvoiceValidateWithWarning)
				}) {}
		}
