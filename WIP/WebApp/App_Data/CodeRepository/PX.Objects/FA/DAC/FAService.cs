...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FAService>.By<assetID, serviceNumber>
		{
			public static FAService Find(PXGraph graph, Int32? assetID, String serviceNumber) => FindBy(graph, assetID, serviceNumber);
		}
		public static class FK
		{
			public class FixedAsset : FA.FixedAsset.PK.ForeignKeyOf<FAService>.By<assetID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<FAService>.By<vendorID> { }
		}
		#endregion
		#region AssetID
