...
namespace PX.Objects.PM
{
	...
	public static partial class Messages
	{
		...
		public const string CommitmentTotalIsNegative = "The change order cannot be released because the line total of the {0} {1} will go negative.";
		...
		public const string CannotCorrectContainsRetainage = "You cannot make corrections to the pro forma invoice because the corresponding AR document has at least one related retainage document. Reverse or delete the following related retainage documents first:{0}.";
		public const string CannotCorrectContainsApplications = "You cannot make corrections to the pro forma invoice because the corresponding AR document has at least one applied document. Unapply or void the following applications related to the {0} AR document first:{1}.";
		...
		public const string DraftInvoiceAmount = "Draft Invoices Amount";
