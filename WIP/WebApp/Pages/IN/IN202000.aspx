...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" AutoCallBack="True" Visible="True" Width="100%" TypeName="PX.Objects.IN.NonStockItemMaint" PrimaryView="Item">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Visible="false" Name="ViewVendorEmployee" DependOnGrid="PXGridVendorItems" CommitChanges="true" />
            <px:PXDSCallbackCommand Visible="false" Name="ViewBAccount" DependOnGrid="crossgrid" CommitChanges="true" />
        </CallbackCommands>
        <DataTrees>
        ...
        <Items>
            ...
            <px:PXTabItem Text="Price/Cost">
                <Template>
                    ...
                    <px:PXFormView ID="curySettingsForm" runat="server" SkinID="Transparent" RenderStyle="simple" DataSourceID="ds" DataMember="CurySettings_InventoryItem" CaptionVisible="false">
                        <Template>
                            <px:PXLayoutRule ID="PXLayoutRule3" runat="server" StartColumn="true" ControlSize="XM" GroupCaption="Price Management" />
                    ...
                    <px:PXFormView ID="curySettingsForm2" runat="server" SkinID="Transparent" RenderStyle="simple" DataSourceID="ds" DataMember="CurySettings_InventoryItem" CaptionVisible="false">
                        <Template>
            ...
            <px:PXTabItem Text="GL Accounts">
                <Template>
                    ...
                    <px:PXSegmentMask CommitChanges="True" ID="edInvtSubID" runat="server" DataField="InvtSubID" AutoRefresh="True" />
                    <px:PXSegmentMask CommitChanges="True" ID="edReasonCodeSubID" runat="server" DataField="ReasonCodeSubID" AutoRefresh="True" />
                    <px:PXSegmentMask CommitChanges="True" ID="edExpenseAccountID" runat="server" DataField="COGSAcctID" />
                    <px:PXSegmentMask CommitChanges="True" ID="edExpenseSubID" runat="server" DataField="COGSSubID" AutoRefresh="True" />
                    ...
                    <px:PXSegmentMask CommitChanges="True" ID="edSalesSubID" runat="server" DataField="SalesSubID" AutoRefresh="True" />
                    <px:PXSegmentMask ID="edPPVAcctID" runat="server" DataField="PPVAcctID" CommitChanges="true" />
                    <px:PXSegmentMask CommitChanges="True" ID="edPPVSubID" runat="server" DataField="PPVSubID" AutoRefresh="True" />
					<px:PXSegmentMask ID="edDeferralAcctID" runat="server" DataField="DeferralAcctID" CommitChanges="true" />		   
                    <px:PXSegmentMask CommitChanges="True" ID="edDeferralSubID" runat="server" DataField="DeferralSubID" AutoRefresh="True" />
                    ...
                    <px:PXSegmentMask CommitChanges="True" ID="edEarningsSubID" runat="server" DataField="EarningsSubID" AutoRefresh="true" />
					<px:PXSegmentMask ID="edBenefitExpenseAcctID" runat="server" DataField="BenefitExpenseAcctID" CommitChanges="true" />
                    <px:PXSegmentMask CommitChanges="True" ID="edBenefitExpenseSubID" runat="server" DataField="BenefitExpenseSubID" AutoRefresh="true" />
					<px:PXSegmentMask ID="edTaxExpenseAcctID" runat="server" DataField="TaxExpenseAcctID" CommitChanges="true" />
                    <px:PXSegmentMask CommitChanges="True" ID="edTaxExpenseSubID" runat="server" DataField="TaxExpenseSubID" AutoRefresh="true" />
                </Template>
            </px:PXTabItem>
			...
			<px:PXTabItem Text="eCommerce">
				<Template>
					<px:PXLayoutRule runat="server" ID="BCPXLayoutRule11" StartColumn="True" LabelsWidth="SM" ControlSize="XL" />
					...
					<px:PXGrid runat="server" ID="gridInventoryFileUrls" CaptionVisible="True" Caption="Media URLs" SkinID="ShortList" AutoAdjustColumns="True" ExportNotes="False" FilesIndicator="False" NoteIndicator="False" Height="245px" Width="500px">
						<Levels>
