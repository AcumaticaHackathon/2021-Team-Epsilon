...
<asp:Content ID="Content3" ContentPlaceHolderID="phUser" Runat="Server">
	...
	<script type="text/javascript">
		...
		function OidcLoginOnClick(e) {
            $("[id$=<%=this.txtDummyOidcProviderName.ID%>]").val(e.id);
            ...
            $("[id$=<%=this.btnLoginOpenId.ID%>]").click();
            return false;
        }
	</script>
</asp:Content>
...
<asp:Content ID="extLogins" ContentPlaceHolderID="phExt" Runat="Server">
	<asp:LinkButton runat="server" ID="btnLoginFederation" class="extlogin_wide_button" OnClick="btnLoginFederation_Click" Visible="false" 
		Text="<img src='../Icons/loginFederation_new.png' alt='logo' /><span>Active Directory</span>" />
	<asp:LinkButton runat="server" ID="btnLoginGoogle" class="extlogin_wide_button" OnClick="btnLoginOAuth_Click" CommandName="Google" Visible="false"
		Text="<img src='../Icons/loginGoogle_new.png' alt='logo' /><span>Google</span>"/>	
	<asp:LinkButton runat="server" ID="btnLoginMicrosoft" class="extlogin_wide_button" OnClick="btnLoginOAuth_Click" CommandName="MicrosoftAccount" Visible="false" 
		Text="<img src='../Icons/loginLiveID_new.png' alt='logo' /><span>Microsoft</span>" />
	
	<asp:Button runat="server" ID="btnLoginOpenId" OnClick="btnLoginOpenId_Click" Visible="true" style="display:none;" />
	<input runat="server" id="txtDummyOidcProviderName" type="hidden" />
