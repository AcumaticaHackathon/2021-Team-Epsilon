...
namespace PX.Objects.FS
{
	...
	public class FSServiceTemplate : PX.Data.IBqlTable
	{
        ...
        {
            public static FSServiceTemplate Find(PXGraph graph, int? serviceTemplateID) => FindBy(graph, serviceTemplateID);
        }

        public class UK : PrimaryKeyOf<FSServiceTemplate>.By<serviceTemplateCD>
        {
            public static FSServiceTemplate Find(PXGraph graph, string serviceTemplateCD) => FindBy(graph, serviceTemplateCD);
        }
