...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLBudgetLine>.By<branchID, ledgerID, groupID, parentGroupID, finYear>
		{
			public static GLBudgetLine Find(PXGraph graph, int? branchID, int? ledgerID, Guid? groupID, Guid? parentGroupID, string finYear) => FindBy(graph, branchID, ledgerID, groupID, parentGroupID, finYear);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<GLBudgetLine>.By<branchID> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<GLBudgetLine>.By<ledgerID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<GLBudgetLine>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<GLBudgetLine>.By<subID> { }
		}
		#endregion
