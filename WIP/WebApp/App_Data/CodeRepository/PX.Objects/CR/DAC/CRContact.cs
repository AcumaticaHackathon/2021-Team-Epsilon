...
namespace PX.Objects.CR
{
    ...
    {
        #region Keys
        public class PK : PrimaryKeyOf<CRShippingContact>.By<contactID>
        {
            public static CRShippingContact Find(PXGraph graph, int? contactID) => FindBy(graph, contactID);
        }
        public new static class FK
        {
            public class BusinessAccount : CR.BAccount.PK.ForeignKeyOf<CRShippingContact>.By<bAccountID> { }
            public class Contact : CR.Contact.PK.ForeignKeyOf<CRShippingContact>.By<bAccountContactID> { }
            public class Location : CR.Location.PK.ForeignKeyOf<CRShippingContact>.By<bAccountID, bAccountLocationID> { }
        }
        #endregion
        ...
        public new abstract class bAccountLocationID : PX.Data.BQL.BqlInt.Field<bAccountLocationID> { }
        #endregion
        #region RevisionID
    ...
    {
        #region Keys
        public class PK : PrimaryKeyOf<CRContact>.By<contactID>
        {
            public static CRContact Find(PXGraph graph, int? contactID) => FindBy(graph, contactID);
        }
        public static class FK
        {
            public class BusinessAccount : CR.BAccount.PK.ForeignKeyOf<CRContact>.By<bAccountID> { }
            public class Contact : CR.Contact.PK.ForeignKeyOf<CRContact>.By<bAccountContactID> { }
            public class Location : CR.Location.PK.ForeignKeyOf<CRContact>.By<bAccountID, bAccountLocationID> { }
        }
        #endregion
