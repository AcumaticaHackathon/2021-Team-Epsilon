		...
		<Items>
			<px:PXTabItem Text="General Settings">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Three-Way Match Validation" />
					<px:PXDropDown ID="edAPInvoiceValidation" runat="server" AllowNull="False" DataField="APInvoiceValidation" CommitChanges="true" />
				...
				<Template>
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="ReceivePutAwaySetup" DefaultControlID="edShowReceivingTab" RenderStyle="Simple">
						<Template>
							...
							<px:PXCheckBox ID="edShowReturnTab" runat="server" DataField="ShowReturningTab" CommitChanges="true" />
							...
							<px:PXCheckBox ID="edRequestLocationForEachItemInReturn" runat="server" DataField="RequestLocationForEachItemInReturn" />
