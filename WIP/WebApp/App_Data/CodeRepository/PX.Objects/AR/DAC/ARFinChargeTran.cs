namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<ARFinChargeTran>.By<tranType, refNbr, lineNbr>
		{
			public static ARFinChargeTran Find(PXGraph graph, String tranType, String refNbr, Int32? lineNbr) => FindBy(graph, tranType, refNbr, lineNbr);
		}
		#endregion
