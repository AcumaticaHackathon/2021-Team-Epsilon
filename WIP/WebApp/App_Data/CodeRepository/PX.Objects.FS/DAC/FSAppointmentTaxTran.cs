...
{
    [Serializable]
    [PXCacheName(TX.TableName.FSAppointmentTaxTran)]
    public class FSAppointmentTaxTran : TaxDetail, PX.Data.IBqlTable
    {
        #region Keys
        public class PK : PrimaryKeyOf<FSAppointmentTaxTran>.By<srvOrdType, refNbr, recordID, taxID>
        {
            public static FSAppointmentTaxTran Find(PXGraph graph, string srvOrdType, string refNbr, int? recordID, string taxID)
        ...
        {
            public class ServiceOrderType : FSSrvOrdType.PK.ForeignKeyOf<FSAppointmentTaxTran>.By<srvOrdType> { }
            public class Appointment : FSAppointment.PK.ForeignKeyOf<FSAppointmentTaxTran>.By<srvOrdType, refNbr> { }
            public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<FSAppointmentTaxTran>.By<curyInfoID> { }
            public class Tax : Objects.TX.Tax.PK.ForeignKeyOf<FSAppointmentTaxTran>.By<taxID> { }
        }
        #endregion
