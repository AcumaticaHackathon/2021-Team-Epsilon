...
namespace PX.Objects.IN
{
	...
	public class INScanReceive : WMSBase
	{
		...
		{
			Base.receipt.Current = e.NewValue == null ? null : Base.receipt.Search<INRegister.refNbr>(e.NewValue);
		}
		...
		protected virtual void ProcessConfirm()
		{
			...
			else
			{
				...
				if (!EnsureNoUIErrors(existTransaction, () => Base.transactions.Delete(existTransaction)))
					return;
			}
