    ...
    public class EstimateMaint : PXRevisionableGraph<EstimateMaint, AMEstimateItem, AMEstimateItem.estimateID, AMEstimateItem.revisionID>
    {
        ...
        protected virtual void CopyOperations(AMBomItem bomItem)
        {
                ...
                .Select(this, bomItem.BOMID, bomItem.RevisionID))
            {
                ...
                newEstOper.FinishTime = bomOper.FinishTime;
        ...
        protected virtual void CreateBomDetails(AMEstimateItem estimateItem, BOMMaint bomMaintGraph)
        {
            ...
            >.Select(this, estimateItem.EstimateID, estimateItem.RevisionID))
            {
                ...
                oper.FinishTime = estimateOper.FinishTime;
        ...
        protected virtual void _(Events.CacheAttached<AMEstimateOper.operationID> e) { }

        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Fixed Labor Override", Visible = false)]
        protected virtual void _(Events.CacheAttached<AMEstimateOper.fixedLaborOverride> e) { }

        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Variable Labor Override", Visible = false)]
        protected virtual void _(Events.CacheAttached<AMEstimateOper.variableLaborOverride> e) { }

        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Machine Override", Visible = false)]
        protected virtual void _(Events.CacheAttached<AMEstimateOper.machineOverride> e) { }

        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Material Override", Visible = false)]
        protected virtual void _(Events.CacheAttached<AMEstimateOper.materialOverride> e) { }

        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Tool Override", Visible = false)]
        protected virtual void _(Events.CacheAttached<AMEstimateOper.toolOverride> e) { }

        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Fixed Ovhd Override", Visible = false)]
        protected virtual void _(Events.CacheAttached<AMEstimateOper.fixedOverheadOverride> e) { }

        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Variable Ovhd Override", Visible = false)]
        protected virtual void _(Events.CacheAttached<AMEstimateOper.variableOverheadOverride> e) { }

        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Subcontract Override", Visible = false)]
        protected virtual void _(Events.CacheAttached<AMEstimateOper.subcontractOverride> e) { }
