...
namespace PX.Objects.FA
{
	...
	{
		public class Events : PXEntityEvent<FARegister>.Container<Events>
		{
			public PXEntityEvent<FARegister> UpdateStatus;
			public PXEntityEvent<FARegister> ReleaseDocument;
		}
		
		#region Keys
		public class PK : PrimaryKeyOf<FARegister>.By<refNbr>
		{
			public static FARegister Find(PXGraph graph, String refNbr) => FindBy(graph, refNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<FARegister>.By<branchID> { }
		}
		#endregion
		#region Selected
