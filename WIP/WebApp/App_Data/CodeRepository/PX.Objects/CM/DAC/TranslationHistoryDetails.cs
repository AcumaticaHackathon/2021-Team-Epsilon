namespace PX.Objects.CM
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<TranslationHistoryDetails>.By<referenceNbr, branchID, accountID, subID, lineType>
		{
			public static TranslationHistoryDetails Find(PXGraph graph, String referenceNbr, int? branchID, int? accountID, int? subID, String lineType) => FindBy(graph, referenceNbr, branchID, accountID, subID, lineType);
		}
		public static class FK
		{
			public class TranslationNumber : CM.TranslationHistory.PK.ForeignKeyOf<TranslationHistoryDetails>.By<referenceNbr> { }
			public class Translation : CM.TranslDef.PK.ForeignKeyOf<TranslationHistoryDetails>.By<translDefId> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<TranslationHistoryDetails>.By<ledgerID> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<TranslationHistoryDetails>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<TranslationHistoryDetails>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<TranslationHistoryDetails>.By<accountID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<TranslationHistoryDetails>.By<curyID> { }
			public class RateType : CM.CurrencyRateType.PK.ForeignKeyOf<TranslationHistoryDetails>.By<rateTypeID> { }
		}
		#endregion
		#region ReferenceNbr
