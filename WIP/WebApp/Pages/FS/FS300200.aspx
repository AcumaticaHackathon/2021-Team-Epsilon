...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    <CallbackCommands>
      ...
      <px:PXDSCallbackCommand Name="OpenBillDocument" Visible="False" />
      ...
      <px:PXDSCallbackCommand Name="PauseStaff" Visible="False" />
      <px:PXDSCallbackCommand Name="ResumeStaff" Visible="False" />
      <px:PXDSCallbackCommand Name="PauseStaffMobile" Visible="False" />
      <px:PXDSCallbackCommand Name="ResumeStaffMobile" Visible="False" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="mainForm" runat="server" DataSourceID="ds" Style="z-index: 100" BPEventsIndicator="True" FilesIndicator="True" ActivityIndicator="True" NoteIndicator="True" Width="100%" DataMember="AppointmentRecords" TabIndex="100" MarkRequired="Dynamic">
        <Template>
            ...
            <px:PXCheckBox ID="edShowInvoicesTab" runat="server" DataField="ShowInvoicesTab"></px:PXCheckBox>
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM">
            </px:PXLayoutRule>
                            ...
                            <px:PXGridLevel
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="EmployeeID"
                                        AllowShowHide="False" CommitChanges="True" DisplayMode="Hint" LinkCommand="ViewEmployee">
                                    </px:PXGridColumn>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ProfitabilityRecords" DataKeyNames="ItemID">
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="edProfUnitPrice" runat="server" DataField="CuryUnitPrice">
                                    </px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edProfEstimatedQty" runat="server" DataField="EstimatedQty">
                                    </px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edProfEstimatedAmount" runat="server" DataField="CuryEstimatedAmount">
                                    </px:PXNumberEdit>
                                    ...
                                    <px:PXMaskEdit ID="edProfActualAmount" runat="server" DataField="CuryActualAmount">
                                    </px:PXMaskEdit>
                                    <px:PXNumberEdit ID="edProfBillableQty" runat="server" DataField="BillableQty">
                                    </px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edProfBillableAmount" runat="server" DataField="CuryBillableAmount">
                                    </px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edProfUnitCost" runat="server" DataField="CuryUnitCost">
                                    </px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edProfCostTotal" runat="server" DataField="CuryCostTotal">
                                    </px:PXNumberEdit>
                                    <px:PXNumberEdit ID="edProfProfit" runat="server" DataField="CuryProfit">
                                    </px:PXNumberEdit>
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CuryUnitCost" />
                                    <px:PXGridColumn DataField="EstimatedQty" />
                                    <px:PXGridColumn DataField="CuryEstimatedAmount" />
                                    <px:PXGridColumn DataField="CuryEstimatedCost" />
                                    ...
                                    <px:PXGridColumn DataField="CuryBillableAmount" />
                                    <px:PXGridColumn DataField="CuryProfit" />
