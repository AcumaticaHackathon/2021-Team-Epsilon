				...
				case VendorMaint vendorGraph:
					{
						...
						Location location = locationDetails.DefLocation.SelectSingle();
							...
							if (intran != null)
							{
								POReceiptLine line = PXSelect<POReceiptLine,
											Where<POReceiptLine.receiptNbr, Equal<Required<POReceipt.receiptNbr>>,
												...
												.Select(receiptEntry, receiptEntry.Document.Current.ReceiptNbr, intran.DocType, intran.RefNbr, intran.LineNbr); ;
