namespace PX.Objects.TX
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<TaxBucket>.By<vendorID, bucketID>
		{
			public static TaxBucket Find(PXGraph graph, Int32? vendorID, Int32? bucketID) => FindBy(graph, vendorID, bucketID);
		}
		public static class FK
		{
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<TaxBucket>.By<vendorID> { }
		}
		#endregion
		#region VendorID
