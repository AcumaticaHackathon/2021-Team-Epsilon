<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="TX503000.aspx.cs" Inherits="Page_TX503000" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" Width="100%" Visible="true" runat="server" TypeName="PX.Objects.TX.ProcessOutputSVAT" PrimaryView="Filter" />
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" DefaultControlID="edTaxAgencyID">
		<Template>
			...
			<px:PXSegmentMask ID="edTaxAgencyID" runat="server" DataField="TaxAgencyID" CommitChanges="True" AutoRefresh="True"/>
