...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.FA.TransactionEntry" PrimaryView="Document" HeaderDescriptionField="Origin">
        <CallbackCommands>
            <px:PXDSCallbackCommand CommitChanges="True" Name="Save" />
            <px:PXDSCallbackCommand Name="First" PostData="Self" StartNewGroup="True" />
            <px:PXDSCallbackCommand CommitChanges="True" Name="Release" StartNewGroup="True" PopupCheckSave="false" />
             <px:PXDSCallbackCommand CommitChanges="True" Name="Action" StartNewGroup="True" PopupCheckSave="false" />
