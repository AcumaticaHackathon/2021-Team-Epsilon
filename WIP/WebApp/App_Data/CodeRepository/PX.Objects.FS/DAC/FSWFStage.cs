...
namespace PX.Objects.FS
{
	...
	public class FSWFStage : PX.Data.IBqlTable
    {
		...
		{
			public static FSWFStage Find(PXGraph graph, int? wFStageID) => FindBy(graph, wFStageID);
		}
		public class UK : PrimaryKeyOf<FSWFStage>.By<wFID, parentWFStageID, wFStageCD>
		{
			public static FSWFStage Find(PXGraph graph, int? wFID, int? parentWFStageID, string wFStageCD) => FindBy(graph, wFID, parentWFStageID, wFStageCD);
		}
