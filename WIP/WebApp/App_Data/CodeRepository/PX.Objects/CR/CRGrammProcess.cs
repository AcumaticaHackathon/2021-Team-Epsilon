...
namespace PX.Objects.CR
{
	...
	public class CRGrammProcess : PXGraph<CRGrammProcess>
	{
		...
		public class Processor
		{
			...
			public bool IsAnyBlockingRulesConfigured
			{
				get { return Definition.IsAnyBlockingRulesConfigured; }
			}
				...
				public bool IsAnyBlockingRulesConfigured
				{
					get
					{
						return Contacts.Count > 0
								&& Contacts.Any(_ => _.CreateOnEntry != CreateOnEntryAttribute.Allow)
							|| Accounts.Count > 0
								&& Accounts.Any(_ => _.CreateOnEntry != CreateOnEntryAttribute.Allow);
					}
				}
			}
