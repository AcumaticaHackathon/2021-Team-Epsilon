...
namespace PX.Objects.FS
{
	...
	public class FSProblem : PX.Data.IBqlTable
	{
		...
		{
			public static FSProblem Find(PXGraph graph, int? problemID) => FindBy(graph, problemID);
		}

		public class UK : PrimaryKeyOf<FSProblem>.By<problemCD>
        {
            public static FSProblem Find(PXGraph graph, string problemCD) => FindBy(graph, problemCD);
        }
        #endregion
