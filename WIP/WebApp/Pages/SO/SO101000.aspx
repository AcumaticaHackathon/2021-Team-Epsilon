        ...
        <Items>
            <px:PXTabItem Text="General Settings">
                <Template>
                    ...
                    <px:PXPanel ID="pnlIntercompany" runat="server" Caption="Intercompany Order Settings" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="XM" />
                        <px:PXSelector ID="edDfltIntercompanyOrderType" runat="server" AllowNull="False" DataField="DfltIntercompanyOrderType" />
                        <px:PXSelector ID="edDfltIntercompanyRMAType" runat="server" AllowNull="False" DataField="DfltIntercompanyRMAType" />
                        <px:PXCheckBox ID="chkDisableAddingItemsForIntercompany" runat="server" DataField="DisableAddingItemsForIntercompany" />
                        <px:PXCheckBox ID="chkDisableEditingPricesDiscountsForIntercompany" runat="server" DataField="DisableEditingPricesDiscountsForIntercompany" CommitChanges="true" /> 
                    </px:PXPanel>
                </Template>
            </px:PXTabItem>
                ...
                <Template>
					<px:PXFormView ID="formScanSetup" runat="server" DataSourceID="ds" Width="100%" DataMember="PickPackShipSetup" DefaultControlID="edShowPickTab" RenderStyle="Simple">
						<Template>
							...
							<px:PXCheckBox SuppressLabel="True" ID="edShowReturnTab" runat="server" DataField="ShowReturningTab" CommitChanges="true" />
