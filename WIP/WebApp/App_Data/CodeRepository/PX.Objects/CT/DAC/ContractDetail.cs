...
namespace PX.Objects.CT
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<ContractDetail>.By<contractID, contractDetailID, revID>
		{
			public static ContractDetail Find(PXGraph graph, int? contractID, Int32? contractDetailID, Int32? revID) => FindBy(graph, contractID, contractDetailID, revID);
		}
		public static class FK
		{
			public class Contract : CT.Contract.PK.ForeignKeyOf<ContractDetail>.By<contractID> { }
			public class NonStockItem : IN.InventoryItem.PK.ForeignKeyOf<ContractDetail>.By<inventoryID> { }
			public class ContractItem : CT.ContractItem.PK.ForeignKeyOf<ContractDetail>.By<contractItemID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<ContractDetail>.By<curyID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ContractDetail>.By<curyInfoID> { }
		}
		#endregion
		#region Selected
