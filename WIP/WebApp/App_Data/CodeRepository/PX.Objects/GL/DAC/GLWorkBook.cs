...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLWorkBook>.By<workBookID>
		{
			public static GLWorkBook Find(PXGraph graph, String workBookID) => FindBy(graph, workBookID);
		}
		public static class FK
		{
			public class VoucherBatchNumberingSequence : CS.Numbering.PK.ForeignKeyOf<GLWorkBook>.By<voucherBatchNumberingID> { }
			public class VoucherNumberingSequence : CS.Numbering.PK.ForeignKeyOf<GLWorkBook>.By<voucherNumberingID> { }
			public class DefaultCashAccount : CA.CashAccount.PK.ForeignKeyOf<GLWorkBook>.By<defaultCashAccountID> { }
			public class DefaultEntryType : CA.CAEntryType.PK.ForeignKeyOf<GLWorkBook>.By<defaultEntryTypeID> { }
			public class DefaultBAccount : CR.BAccount.PK.ForeignKeyOf<GLWorkBook>.By<defaultBAccountID> { }
			public class DefaultVendor : AP.Vendor.PK.ForeignKeyOf<GLWorkBook>.By<defaultVendorID> { }
			public class DefaultCustomer : AR.Customer.PK.ForeignKeyOf<GLWorkBook>.By<defaultCustomerID> { }
			public class DefaultLocation : CR.Location.PK.ForeignKeyOf<GLWorkBook>.By<defaultBAccountID, defaultLocationID> { }
		}
		...
		[PXDefault(typeof(Search2<CAEntryType.entryTypeId, InnerJoin<CashAccountETDetail, On<CashAccountETDetail.entryTypeID, Equal<CAEntryType.entryTypeId>>>,
									Where<CashAccountETDetail.accountID, Equal<Current<GLWorkBook.defaultCashAccountID>>, And<CAEntryType.module, Equal<BatchModule.moduleCA>, And<CashAccountETDetail.isDefault, Equal<True>>>>>), 
