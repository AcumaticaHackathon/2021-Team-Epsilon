...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="true" Width="100%" TypeName="PX.Objects.EP.TimeCardMaint" PrimaryView="Document" HeaderDescriptionField="FormCaptionDescription">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True"
        ActivityField="NoteActivity" LinkIndicator="True" BPEventsIndicator="True" Caption="Document Summary" DefaultControlID="edTimeCardCD" TabIndex="14900">
        <Template>
