...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.CS.OrganizationMaint" PrimaryView="BAccount" HeaderDescriptionField="AcctName">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ChangeID" CommitChanges="True" />

			<px:PXDSCallbackCommand Name="ValidateAddresses" StartNewGroup="True" Visible="True" CommitChanges="True" />
		...
		<Template>
		    ...
		    <px:PXFormView ID="StateForm" runat="server" DataMember="StateView" DataSourceID="ds" Caption="Hidden Form needed for VisibleExp of TabItems" Visible="False">
		        <Template>
                    ...
                    <px:PXCheckBox SuppressLabel="True" ID="chkIsGroup" runat="server" DataField="IsGroup" />
					<px:PXCheckBox SuppressLabel="True" ID="chkIsCompanyGroupsVisible" runat="server" DataField="IsCompanyGroupsVisible" />
		        </Template>
		    </px:PXFormView>
		</Template>
	</px:PXFormView>
		...
		<Items>
			<px:PXTabItem Text="Company Details" RepaintOnDemand="false">
				<Template>
				    ...
				    <px:PXFormView ID="Company" runat="server" Caption="Base Currency Settings (Shared)" DataMember="OrganizationView" RenderStyle="Fieldset" DataSourceID="ds">
				        <Template>
				            <px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" StartColumn="True" />
					...
					<px:PXFormView ID="PXFormViewLocation" runat="server" DataMember="DefLocation" RenderStyle="Simple" DataSourceID="ds">
						<Template>
		        ...
		        <Template>
		            <px:PXFormView ID="frmDefLocation" runat="server" DataMember="DefLocation" Width="100%" CaptionVisible="False" TemplateContainer="" DataSourceID="ds" RenderStyle="Normal" SyncPosition="true">
		                <Template>
		                    ...
		                    <px:PXFormView ID="DefLocationAddress" runat="server" DataMember="DefLocationAddress" RenderStyle="Simple" DataSourceID="ds">
		                        <Template>
		                            <px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" StartColumn="True" />
		    ...
		    <px:PXTabItem Text="Employees" BindingContext="StateForm" VisibleExp="DataControls[&quot;chkIsGroup&quot;].Value == false">
		        <Template>
		                ...
		                <Levels>
		                    <px:PXGridLevel DataMember="Employees" DataKeyNames="AcctCD">
		                        ...
		                        <Columns>
		                            ...
		                            <px:PXGridColumn DataField="VStatus" />
		                        </Columns>
		    ...
		    <px:PXTabItem Text="Ledgers" BindingContext="StateForm" VisibleExp="DataControls[&quot;chkIsGroup&quot;].Value == false">
		        <Template>
		            <px:PXGrid ID="grdLedgerLinks" runat="server" Height="300px" Width="100%" AllowSearch="True" SkinID="DetailsInTab" DataSourceID="ds" SyncPosition="True" AdjustPageSize="Auto">
		                ...
		                <Levels>
		                    <px:PXGridLevel DataMember="OrganizationLedgerLinkWithLedgerSelect">
		                        <RowTemplate>
		                            <px:PXSelector ID="edLedgerID" runat="server" DataField="LedgerID" CommitChanges="True" AutoRefresh="true"/>
		                        </RowTemplate>
		                        <Columns>
			...
			<px:PXTabItem Text="Visual Appearance" RepaintOnDemand="False" BindingContext="StateForm" VisibleExp="DataControls[&quot;chkIsGroup&quot;].Value == false">
				<Template>
			...
			<px:PXTabItem Text="Company Groups" RepaintOnDemand="false" BindingContext="StateForm" VisibleExp="DataControls[&quot;chkIsCompanyGroupsVisible&quot;].Value == true">
				<Template>
					<px:PXGrid ID="grid" runat="server" Height="150px" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" SyncPosition="True">
						<ActionBar DefaultAction="cmdViewContact">
		                    <Actions>
		                    </Actions>
		                    <CustomItems>
		                        <px:PXToolBarButton Text="Set As Primary">
		                            <AutoCallBack Command="SetAsPrimary" Target="ds" />
		                        </px:PXToolBarButton>
		                    </CustomItems>
		                </ActionBar>
						<Levels>
							<px:PXGridLevel DataMember="Groups">
								<Columns>
									<px:PXGridColumn DataField="GroupID" LinkCommand="ViewGroup"/>
									<px:PXGridColumn DataField="Organization__OrganizationName" />
									<px:PXGridColumn DataField="PrimaryGroup" Type="CheckBox"  CommitChanges="true"/>					
								</Columns>
