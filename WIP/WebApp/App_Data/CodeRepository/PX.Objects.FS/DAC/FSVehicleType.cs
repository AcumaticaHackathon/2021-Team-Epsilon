...
namespace PX.Objects.FS
{
	...
	public class FSVehicleType : PX.Data.IBqlTable
	{
        ...
        {
            public static FSVehicleType Find(PXGraph graph, int? vehicleTypeID) => FindBy(graph, vehicleTypeID);
        }
        public class UK : PrimaryKeyOf<FSVehicleType>.By<vehicleTypeCD>
        {
            public static FSVehicleType Find(PXGraph graph, string vehicleTypeCD) => FindBy(graph, vehicleTypeCD);
        }
        #endregion
