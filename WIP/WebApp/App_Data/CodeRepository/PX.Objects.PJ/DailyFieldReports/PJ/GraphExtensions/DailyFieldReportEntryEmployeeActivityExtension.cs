...
namespace PX.Objects.PJ.DailyFieldReports.PJ.GraphExtensions
{
    public class DailyFieldReportEntryEmployeeActivityExtension : PXGraphExtension<DailyFieldReportEntry>
    {
        ...
        public virtual void _(Events.FieldUpdated<EPActivityApprove, PMTimeActivity.ownerID> args)
        {
			...
			args.Cache.SetDefaultExt<EPActivityApprove.labourItemID>(args.Row);
		}

		public virtual void _(Events.FieldUpdated<EPActivityApprove, PMTimeActivity.projectID> args)
		{
			args.Cache.SetDefaultExt<EPActivityApprove.labourItemID>(args.Row);
		}

		public virtual void _(Events.FieldUpdated<EPActivityApprove, PMTimeActivity.earningTypeID> args)
		{
			args.Cache.SetDefaultExt<EPActivityApprove.labourItemID>(args.Row);
        }
