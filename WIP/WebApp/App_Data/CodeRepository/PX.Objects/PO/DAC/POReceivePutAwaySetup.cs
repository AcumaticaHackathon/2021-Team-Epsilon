...
namespace PX.Objects.PO
{
	...
	public class POReceivePutAwaySetup : IBqlTable
	{
		...
		#endregion
		#region RequestLocationForEachItemInReturn
		[PXDBBool]
		[PXDefault(false)]
		...
		public abstract class requestLocationForEachItemInReturn : PX.Data.BQL.BqlBool.Field<requestLocationForEachItemInReturn> { }
		#endregion
	...
	public sealed class DefaultReceivePutAwayModeByUser : PXCacheExtension<UserPreferences>
	{
		...
		public abstract class rPAMode : PX.Data.BQL.BqlString.Field<rPAMode>
		{
			...
			public static class DisplayNames
			{
				...
				public const string Receive = WMS.ReceivePutAway.ReceiveMode.Msg.Description;
				public const string Return =  WMS.ReceivePutAway.ReturnMode.Msg.Description;
				public const string PutAway = WMS.ReceivePutAway.PutAwayMode.Msg.Description;
			}

			public const string None = "NONE";
			public const string Receive = WMS.ReceivePutAway.ReceiveMode.Value;
			public const string Return =  WMS.ReceivePutAway.ReturnMode.Value;
			public const string PutAway = WMS.ReceivePutAway.PutAwayMode.Value;
