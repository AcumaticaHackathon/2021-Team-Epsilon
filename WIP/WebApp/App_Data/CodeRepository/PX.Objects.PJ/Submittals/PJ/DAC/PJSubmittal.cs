...
namespace PX.Objects.PJ.Submittals.PJ.DAC
{
		...
		IAssign
	{
		...
		{
			public static PJSubmittal Find(PXGraph graph, string submittalID, string revisionID) => FindBy(graph, submittalID, revisionID);
		}
		...
		public static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PJSubmittal>.By<projectTaskId> { }
