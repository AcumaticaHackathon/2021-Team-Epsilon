...
namespace PX.Objects.PO
{
	...
	public partial class POReceiptLine : PX.Data.IBqlTable, ILSPrimary, ISortOrder, IPOReturnLineSource
	{
		...
		public class UK : PrimaryKeyOf<POReceiptLine>.By<receiptType, receiptNbr, lineNbr>
		{
			public static POReceiptLine Find(PXGraph graph, string receiptType, string receiptNbr, int? lineNbr) => FindBy(graph, receiptType, receiptNbr, lineNbr);
		}
		public static class FK
		{
			...
			public class OriginalReceipt : POReceipt.PK.ForeignKeyOf<POReceiptLine>.By<origReceiptNbr> { }
			public class OriginalReceiptLine : POReceiptLine.PK.ForeignKeyOf<POReceiptLine>.By<origReceiptNbr, origReceiptLineNbr> { }
			...
			public class Task : PMTask.PK.ForeignKeyOf<POReceiptLine>.By<taskID> { }
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OriginalReceipt instead.")]
			public class OrigReceipt : OriginalReceipt { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OriginalReceiptLine instead.")]
			public class OrigReceiptLine : OriginalReceiptLine { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OriginalPlanType instead.")]
			public class OrigPlanType : OriginalPlanType { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use SiteStatus instead.")]
			public class INSiteStatus : SiteStatus { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use LocationStatus instead.")]
			public class INLocationStatus : LocationStatus { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use LotSerialStatus instead.")]
			public class INLotSerialStatus : LotSerialStatus { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OriginalINTran instead.")]
			public class OrigTran : OriginalINTran { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use SOLine instead.")]
			public class SOOrderLine : SOLine { }
		}
		#endregion
		#region Selected
		...
		[PXDBCurrency(6, typeof(POReceiptLine.curyInfoID), typeof(POReceiptLine.tranUnitCost))]
