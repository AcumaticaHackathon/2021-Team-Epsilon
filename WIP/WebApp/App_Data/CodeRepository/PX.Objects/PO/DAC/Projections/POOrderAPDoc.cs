...
namespace PX.Objects.PO
{
	...
	public partial class POOrderAPDoc : IBqlTable
	{
		...
		{
			public static POOrderAPDoc Find(PXGraph graph, string docType, string refNbr, string pOOrderType, string pONbr) => FindBy(graph, docType, refNbr, pOOrderType, pONbr);
		}
