...
namespace PX.Objects.SO
{
	...
	public class SOPickPackShipSetup : IBqlTable
	{
		...
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<SOPickPackShipSetup>.By<branchID> { }
		...
		#endregion
		#region ShowReturningTab
		[PXDBBool]
		[PXDefault(true)]
		[PXUIField(DisplayName = "Display the Return Tab", Enabled = true)]
		public virtual bool? ShowReturningTab { get; set; }
		public abstract class showReturningTab : PX.Data.BQL.BqlBool.Field<showReturningTab> { }
		#endregion
	...
	public sealed class DefaultPickPackShipModeByUser : PXCacheExtension<PX.SM.UserPreferences>
	{
		...
		public abstract class pPSMode : PX.Data.BQL.BqlString.Field<pPSMode>
		{
			...
			public static class DisplayNames
			{
				...
				public const string Pick = WMS.PickPackShip.PickMode.Msg.Description;
				public const string Pack = WMS.PickPackShip.PackMode.Msg.Description;
				public const string Ship = WMS.PickPackShip.ShipMode.Msg.Description;
				public const string Return = WMS.PickPackShip.ReturnMode.Msg.Description;
			}

			public const string None = "NONE";
			public const string Pick = WMS.PickPackShip.PickMode.Value;
			public const string Pack = WMS.PickPackShip.PackMode.Value;
			public const string Ship = WMS.PickPackShip.ShipMode.Value;
			public const string Return = WMS.PickPackShip.ReturnMode.Value;
			...
			public class ListAttribute : PXStringListAttribute
			{
				public ListAttribute() : base(
					...
					Pair(Return, DisplayNames.Return)
				) { }
			}
		}
	}
