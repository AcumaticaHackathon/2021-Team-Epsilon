...
namespace PX.Objects.EP
{
	...
	public partial class EPExpenseClaimDetails : IBqlTable, PX.Data.EP.IAssign
	{
		...
		{
			public static EPExpenseClaimDetails Find(PXGraph graph, string claimDetailCD) => FindBy(graph, claimDetailCD);
		}
		...
		public static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<EPExpenseClaimDetails>.By<taskID> { }
