namespace PX.Objects.TX
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<TaxReportLine>.By<vendorID, taxReportRevisionID, lineNbr>
		{
			public static TaxReportLine Find(PXGraph graph, int? vendorID, int? taxReportRevisionID, int? lineNbr) => FindBy(graph, vendorID, taxReportRevisionID, lineNbr);
		}
		public static class FK
		{
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<TaxReportLine>.By<vendorID> { }
			public class TaxReport : TX.TaxReport.PK.ForeignKeyOf<TaxReportLine>.By<vendorID, taxReportRevisionID> { }
		}
		#endregion
		#region VendorID
