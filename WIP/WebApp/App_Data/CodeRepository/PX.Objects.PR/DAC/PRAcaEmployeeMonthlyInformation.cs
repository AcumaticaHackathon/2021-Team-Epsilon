...
namespace PX.Objects.PR
{
	...
	public class PRAcaEmployeeMonthlyInformation : IBqlTable
	{
		...
		{
			public static PRAcaEmployeeMonthlyInformation Find(PXGraph graph, int? orgBAccountID, string year, int? month, int? employeeID) =>
				FindBy(graph, orgBAccountID, year, month, employeeID);
		}
