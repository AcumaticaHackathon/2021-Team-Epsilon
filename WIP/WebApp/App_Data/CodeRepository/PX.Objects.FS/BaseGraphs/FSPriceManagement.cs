...
namespace PX.Objects.FS
{
    ...
    public class FSPriceManagement : PXGraph<FSPriceManagement>
    {
        ...
        public static SalesPriceSet CalculateSalesPriceWithCustomerContract(PXCache cache,
            ...
            => CalculateSalesPriceWithCustomerContract(cache,
                                                       serviceContractID,
                                                       billServiceContractID,
                                                       billContractPeriodID,
                                                       customerID,
                                                       customerLocationID,
                                                       lineRelatedToContract,
                                                       inventoryID,
                                                       siteID,
                                                       quantity,
                                                       uom, date,
                                                       currentUnitPrice,
                                                       alwaysFromBaseCurrency,
                                                       currencyInfo,
                                                       catchSalesPriceException,
                                                       Objects.TX.TaxCalculationMode.TaxSetting);
                                                         ...
                                                         int? inventoryID)
        {
            ...
            {
                fsServiceContractRow = FSServiceContract.PK.Find(cache.Graph, billServiceContractID);
            }
                                                         ...
                                                         string taxCalcMode)
        {
            ...
            try
            {
                ...
                {
                    price = ARSalesPriceMaint.CalculateSalesPrice(cache, custPriceClass, customerID, inventoryID, currencyinfo, quantity, uom, date, alwaysFromBaseCurrency: true, taxCalcMode: taxCalcMode);
                }
                else
                {
                    price = ARSalesPriceMaint.CalculateSalesPrice(cache, custPriceClass, customerID, inventoryID, siteID, currencyinfo, uom, quantity, date, currentUnitPrice, taxCalcMode);
                }
            }
