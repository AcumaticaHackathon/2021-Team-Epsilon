namespace PX.Objects.SO
{
	...
	public partial class SOSalesPerTran : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class SalesPerson : AR.SalesPerson.PK.ForeignKeyOf<SOSalesPerTran>.By<salespersonID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<SOSalesPerTran>.By<curyInfoID> { }
		}
		#endregion
