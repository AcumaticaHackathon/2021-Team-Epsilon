...
namespace PX.Objects.FS
{
    ...
    public class ContractPostBatchDetail : IBqlTable
    {
        ...
        {
            public static ContractPostBatchDetail Find(PXGraph graph, int? contractPostDocID, int? contractPostBatchID) => FindBy(graph, contractPostDocID, contractPostBatchID);
        }
