namespace PX.Objects.SO
{
	...
	public partial class SOTax : TaxDetail, PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class OrderLine : SOLine.PK.ForeignKeyOf<SOTax>.By<orderType, orderNbr, lineNbr> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<SOTax>.By<taxID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<SOTax>.By<taxZoneID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<SOTax>.By<curyInfoID> { }
		...
		[PXParent(typeof(FK.OrderLine), LeaveChildren = true)]
