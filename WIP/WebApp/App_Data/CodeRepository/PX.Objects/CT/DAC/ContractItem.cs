...
namespace PX.Objects.CT
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<ContractItem>.By<contractItemID>
		{
			public static ContractItem Find(PXGraph graph, int? contractItemID) => FindBy(graph, contractItemID);
		}
		public class UK : PrimaryKeyOf<ContractItem>.By<contractItemCD>
		{
			public static ContractItem Find(PXGraph graph, string contractItemCD) => FindBy(graph, contractItemCD);
		}
		public static class FK
		{
			public class Currency : CM.Currency.PK.ForeignKeyOf<ContractItem>.By<curyID> { }
			public class SetupItem : IN.InventoryItem.PK.ForeignKeyOf<ContractItem>.By<baseItemID> { }
			public class RenewalItem : IN.InventoryItem.PK.ForeignKeyOf<ContractItem>.By<renewalItemID> { }
		}
