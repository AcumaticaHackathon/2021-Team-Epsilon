...
namespace PX.Objects.CS
{
	...
	public static class Messages
	{
		...
		public const string DeleteGroup = "The current group will be deleted.";
		public const string CustomerVendorLink = "The visibility of some customers or vendors is limited to the {0} group. This restriction will be deleted. To proceed, click OK.";
		public const string CustomerVendorWillBeInvisible = "The usage of some customers or vendors is limited to the {0} group. The deletion of all companies from the group will make these customers or vendors inaccessible for users. To proceed, click OK.";
		public const string CustomerVendorWillBeInvisibleWhenOrganizationDeleted = "The usage of some customers or vendors is limited to a group or groups where the {0} company is the only member. The deletion of the company will make these customers or vendors inaccessible for users. To proceed, click OK.";
		...
		public const string ItemExistsReenter = "The {0} identifier is already used for another business account record (vendor, customer, employee, branch, company, or company group).";
		...
		public const string AddressLookupPluginIsNotActive = "The address lookup plug-in that you have specified is not active. Click the magnifier icon and select a plug-in from the list.";
		...
		public const string FeaturesDependencyDisabled = "To enable this feature, disable {0} first.";
		public const string FeaturesDependencies = "To enable this feature, enable one of the following features first: {0}.";
		public const string FeaturesDependenciesDisabled = "To enable this feature, disable one of the following features first: {0}.";
		public const string FeaturesDependenciesAllRequired = "To enable this feature, enable the following features first: {0}";
		public const string FeaturesDependenciesAllRequiredDisabled = "To enable this feature, disable the following features first: {0}";
		...
		public const string FeatureImageRecognitionIsNotConfigured = "The feature cannot be enabled because the current license does not include the support of cloud services.";
		public const string FeatureImageRecognitionIsNotConfiguredTrialMode = "To enable this feature, activate the license that includes this feature on the Activate License (SM201510) form.";
		...
		public const string ExtendedBranchCannotBeDeleted = "The {0} entity cannot be deleted because it has been extended to customer or vendor.";
		...
		public const string PrepaymentPercentMustBeDefined = "The prepayment percent must be defined if a prepayment is required.";
		...
		public const string RequiredConfigurationDataIsNotEnteredOnCurrencyManagementPreferencesForm = "The required configuration data is not entered on the Currency Management Preferences (CM101000) form.";		
		...
		public const string CurrentBranch = "Current Branch";
		...
		public const string FailedToCreateAddressAutoCompletePlugin = "The system cannot create an address lookup plug-in with the specified settings. Contact your system administrator.";
		public const string FailedToAddressLookupAutoCompletePlugin = "The address lookup plug-in has not been found. Contact your system administrator.";
		public const string ConnectionAddressValidatorAskSuccessHeader = "Settings";
		public const string ConnectionAddressValidatorAskSuccess = "The connection to the address provider was successful.";
		...
		public const string AddressLookupSitePrefFK = "The address lookup plug-in cannot be deleted because it is selected on the Site Preferences (SM200505) form.";
		public const string AddressLookupPortalPrefFK = "The address lookup plug-in cannot be deleted because it is selected on the Portal Preferences (SP800000) form.";
		public const string CountryCodeIsNotValid = "The {0} code is not a valid country code. Make sure that the country code complies with ISO 3166-1 alpha-2.";
		...
		public const string RecipientsOverride = "Override Recipients";
		public const string RecipientsAdd = "Add Recipients";
