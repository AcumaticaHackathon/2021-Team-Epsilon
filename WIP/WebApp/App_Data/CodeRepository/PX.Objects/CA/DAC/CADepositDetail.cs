...
namespace PX.Objects.CA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CADepositDetail>.By<tranType, refNbr, lineNbr>
		{
			public static CADepositDetail Find(PXGraph graph, string tranType, string refNbr, int? lineNbr) => FindBy(graph, tranType, refNbr, lineNbr);
		}

		public static class FK
		{
			public class CashAccountDeposit : CA.CADeposit.PK.ForeignKeyOf<CADepositDetail>.By<tranType, refNbr> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<CADepositDetail>.By<paymentMethodID> { }
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CADepositDetail>.By<accountID> { }
			public class DepositCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<CADepositDetail>.By<curyInfoID> { }
			public class CashAccountCurrency : CM.Currency.PK.ForeignKeyOf<CADepositDetail>.By<origCuryID> { }
			public class CashAccountCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<CADepositDetail>.By<origCuryInfoID> { }
			public class CashAccountTransaction : CA.CATran.PK.ForeignKeyOf<CADepositDetail>.By<accountID, tranID> { }
			public class ChargeEntryType : CA.CAEntryType.PK.ForeignKeyOf<CADepositDetail>.By<entryTypeID> { }
			public class ARPayment : AR.ARPayment.PK.ForeignKeyOf<CADepositDetail>.By<origDocType, origRefNbr> { }
			public class APPayment : AP.APPayment.PK.ForeignKeyOf<CADepositDetail>.By<origDocType, origRefNbr> { }
			public class CashTransaction : CA.CAAdj.PK.ForeignKeyOf<CADepositDetail>.By<origDocType, origRefNbr> { }
		}
		...
		/// <summary>
		/// The balance type of the original document
		/// </summary>
		/// <value>
		/// The field can have one of the following values:
		/// <c>"D"</c>: Receipt;
		...
		[PXDBString(1, IsFixed = true)]
		[CADrCr.List]
		public virtual string OrigDrCr
		{
			get;
			set;
		}
        ...
        public decimal OrigDocSign 
		{
			...
			get
			{
				return (this.OrigDrCr == CADrCr.CACredit) ? decimal.MinusOne : decimal.One;
			}
		}
