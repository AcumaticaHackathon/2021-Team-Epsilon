...
namespace PX.Objects.PJ.ProjectsIssue.PJ.DAC
{
    ...
    public class ProjectIssue : ProjectManagementImpact, IBqlTable, IAssign, IPXSelectable, IProjectManagementDocumentBase
    {
        ...
        {
            public static ProjectIssue Find(PXGraph graph, string projectIssueCd) => FindBy(graph, projectIssueCd);
        }
        ...
        public static class FK
        {
            ...
            /// Project Task
            /// </summary>
            public class ProjectTask : PMTask.PK.ForeignKeyOf<ProjectIssue>.By<projectTaskId> { }
