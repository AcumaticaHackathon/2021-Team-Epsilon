...
namespace PX.Objects.TX
{
	public class TXInvoiceEntry : APInvoiceEntry
	{
		...
		public TXInvoiceEntry()
		{
			...
			AP.InvoiceRecognition.APInvoiceEntryExt invoiceEntryExt = this.GetExtension<AP.InvoiceRecognition.APInvoiceEntryExt>();
			invoiceEntryExt.viewSourceDocument.SetVisible(false);
			invoiceEntryExt.viewSourceDocument.SetEnabled(false);
		}
