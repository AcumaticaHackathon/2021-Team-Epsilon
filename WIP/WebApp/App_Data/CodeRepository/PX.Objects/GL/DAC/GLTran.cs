...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLTran>.By<module, batchNbr, lineNbr>
		{
			public static GLTran Find(PXGraph graph, String module, String batchNbr, Int32? lineNbr) => FindBy(graph, module, batchNbr, lineNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<GLTran>.By<branchID> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<GLTran>.By<ledgerID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<GLTran>.By<curyInfoID> { }
			public class Batch : GL.Batch.PK.ForeignKeyOf<GLTran>.By<module, batchNbr> { }
			public class Account : GL.Account.PK.ForeignKeyOf<GLTran>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<GLTran>.By<subID> { }
			public class OriginalTransaction : GL.GLTran.PK.ForeignKeyOf<GLTran>.By<origModule, origBatchNbr, origLineNbr> { }
			public class OriginalAccount : GL.Account.PK.ForeignKeyOf<GLTran>.By<origAccountID> { }
			public class OriginalSubaccount : GL.Sub.PK.ForeignKeyOf<GLTran>.By<origSubID> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<GLTran>.By<inventoryID> { }
			public class CashAccountTransaction : CA.CATran.UK.ForeignKeyOf<GLTran>.By<cATranID> { }
			// public class ProjectTransaction : PM.PMTran.PK.ForeignKeyOf<GLTran>.By<pMTranID> { }
		}
		#endregion
