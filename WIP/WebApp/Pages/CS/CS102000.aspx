...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.CS.BranchMaint" PrimaryView="BAccount" HeaderDescriptionField="AcctName">
		<CallbackCommands>
		...
		<Items>
			<px:PXTabItem Text="Branch Details" RepaintOnDemand="false">
				<Template>
					...
					<px:PXFormView ID="PXFormViewLocation" runat="server" DataMember="DefLocation" RenderStyle="Simple" DataSourceID="ds" TabIndex="70">
						<Template>
			...
			<px:PXTabItem Text="Employees">
				<Template>
					<px:PXGrid ID="grdEmployees" runat="server" Height="150px" Width="100%" ActionsPosition="Top" AllowSearch="True" SkinID="Details" DataSourceID="ds" SyncPosition="true" AdjustPageSize="Auto">
