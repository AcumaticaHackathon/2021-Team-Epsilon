...
namespace PX.Objects.CA
{
    ...
    {
        #region Keys
        public class PK : PrimaryKeyOf<CABankTranRule>.By<ruleID>
        {
            public static CABankTranRule Find(PXGraph graph, int? ruleID) => FindBy(graph, ruleID);
        }

		public static class FK
		{
            public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CABankTranRule>.By<bankTranCashAccountID> { }
            public class Currency : CM.Currency.PK.ForeignKeyOf<CABankTranRule>.By<tranCuryID> { }
            public class ResultingEntryType : CA.CAEntryType.PK.ForeignKeyOf<CABankTranRule>.By<documentEntryTypeID> { }
		}
        ...
        [PXSelector(typeof(CABankTranRule.ruleID),
