...
namespace PX.Objects.PM
{
	...
	public class PMCostCode : PX.Data.IBqlTable
	{
		...
		{
			public static PMCostCode Find(PXGraph graph, int? costCodeID) => FindBy(graph, costCodeID);
		}
		...
		{
			public static PMCostCode Find(PXGraph graph, string costCodeCD) => FindBy(graph, costCodeCD);
		}
		#endregion
