...
namespace PX.Objects.PO
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<POOrderPOReceipt>.By<receiptNbr, pOType, pONbr>
		{
			public static POOrderPOReceipt Find(PXGraph graph, string receiptNbr, string pOType, string pONbr) => FindBy(graph, receiptNbr, pOType, pONbr);
		}
		public static class FK
		{
			public class Receipt : POReceipt.UK.ForeignKeyOf<POOrderPOReceipt>.By<receiptType, receiptNbr> { }
