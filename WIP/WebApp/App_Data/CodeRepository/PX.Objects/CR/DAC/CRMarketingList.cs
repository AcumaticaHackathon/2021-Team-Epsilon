...
namespace PX.Objects.CR
{
	...
	public partial class CRMarketingList : IBqlTable
	{
		...
		{
			public static CRMarketingList Find(PXGraph graph, int? marketingListID) => FindBy(graph, marketingListID);
		}
		public new static class FK
		{
			public class Owner : EP.EPEmployee.PK.ForeignKeyOf<CRMarketingList>.By<ownerID> { }
