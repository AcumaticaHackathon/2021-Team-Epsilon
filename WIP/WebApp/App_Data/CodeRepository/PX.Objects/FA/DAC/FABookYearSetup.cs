...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FABookYearSetup>.By<bookID>
		{
			public static FABookYearSetup Find(PXGraph graph, int? bookID) => FindBy(graph, bookID);
		}
		public static class FK
		{
			public class Book : FA.FABook.PK.ForeignKeyOf<FABookYearSetup>.By<bookID> { }
		}
		#endregion
		#region BookID
