...
namespace PX.Objects.GL
{
    ...
    public partial class Branch : IBqlTable, IIncludable, I1099Settings
	{
		...
		{
			public static Branch Find(PXGraph graph, string branchCD) => FindBy(graph, branchCD);
		}
    ...
    public class BranchAlias : Branch
    {
		...
		{
			public static BranchAlias Find(PXGraph graph, int? branchID) => FindBy(graph, branchID);
		}
		public new class UK : PrimaryKeyOf<BranchAlias>.By<branchCD>
		{
			public static BranchAlias Find(PXGraph graph, string branchCD) => FindBy(graph, branchCD);
		}
