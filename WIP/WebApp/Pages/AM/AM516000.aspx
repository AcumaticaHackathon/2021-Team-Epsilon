...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	<px:PXGrid ID="grid" runat="server" Height="400px" Width="100%" Style="z-index: 100" AllowPaging="True" OnRowDataBound="Grid_RowDataBound" 
		...
		<Levels>
			<px:PXGridLevel  DataMember="UnapprovedTrans" DataKeyNames="EmployeeID, LineNbr">
			    <RowTemplate>
                    ...
                    <px:PXSelector CommitChanges="True" ID="edEmployee" runat="server" DataField="EmployeeID" AllowEdit="True" />
                    ...
                    <px:PXDateTimeEdit ID="edStartTime" runat="server" DataField="StartTime_Time" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True" />
                    <px:PXDateTimeEdit ID="edEndTime" runat="server" DataField="EndTime_Time" DisplayFormat="t" EditFormat="t" TimeMode="True" SuppressLabel="True"/>
                    <px:PXMaskEdit ID="edLaborTime" runat="server" DataField="LaborTime" />
                </RowTemplate>
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="TranDate" Width="100px" AutoCallBack="True"/>
                    <px:PXGridColumn DataField="StartTime_Date" Width="90px" Visible="False" AutoCallBack="True"/>
                    <px:PXGridColumn DataField="StartTime_Time" Width="90px" TimeMode="True" AutoCallBack="True"/>
                    <px:PXGridColumn DataField="EndTime_Date" Width="90px" Visible="False" AutoCallBack="True"/>
                    <px:PXGridColumn DataField="EndTime_Time" Width="90px" TimeMode="True" AutoCallBack="True"/>                    
                    <px:PXGridColumn DataField="LaborTime" Width="90px" AutoCallBack="True" />  
                </Columns>
			</px:PXGridLevel>
		</Levels>
