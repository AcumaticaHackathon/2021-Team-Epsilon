        ...
        <Items>
            ...
            <px:PXTabItem Text="GL Accounts">
                <Template>
					...
					<px:PXSegmentMask ID="edDiscountSubID" runat="server" CommitChanges="True" DataField="DiscountSubID">
					</px:PXSegmentMask>
					...
					<px:PXSegmentMask ID="edRetainageSubID" runat="server" CommitChanges="True" DataField="RetainageSubID" />
                </Template>
            </px:PXTabItem>
