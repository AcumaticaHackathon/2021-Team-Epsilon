...
{
    public class LeadMaint : PXGraph<LeadMaint, CRLead, CRLead.displayName>, ICaptionable<object>
	{
        #region Selects
		...
		{
			CRLead currentItem = item as CRLead;
		...
		public class CRDuplicateEntitiesForLeadGraphExt : CRDuplicateContactEntities<LeadMaint, CRLead>
		{
			...
			public override void MergeEntities(PXGraph targetGraph, CRLead targetLead, CRLead duplicateLead)
			{
