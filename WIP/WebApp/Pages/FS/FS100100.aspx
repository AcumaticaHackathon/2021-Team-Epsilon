    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="348px" DataSourceID="ds" DataMember="SetupRecord"
        ...
        <px:PXTabItem Text="General Settings">
		    <Template>
                ...
                <px:PXCheckBox ID="edShowWorkflowStageField" runat="server" DataField="ShowWorkflowStageField" AlignLeft="True" />
                ...
                <px:PXTextEdit ID="edROWWLicensekey" runat="server" DataField="ROWWLicensekey" TextMode="Password"/>
        ...
        <px:PXTabItem Text="Calendars and Maps">
            <Template>
                ...
                <px:PXTextEdit ID="edMapApiKey" runat="server" DataField="MapApiKey" TextMode="Password">
                </px:PXTextEdit>
                <px:PXLayoutRule runat="server" Merge="True" ControlSize="XXS" LabelsWidth="XM" ></px:PXLayoutRule>
