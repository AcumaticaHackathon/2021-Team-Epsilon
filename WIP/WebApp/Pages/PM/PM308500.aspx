...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.PM.ChangeRequest.ChangeRequestEntry" PrimaryView="Document" BorderStyle="NotSet" EnableAttributes = True HeaderDescriptionField="FormCaptionDescription">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Change Request Summary" FilesIndicator="True"
        ...
        <Template>
            ...
            <px:PXSelector ID="edProjectIssueID" runat="server" DataField="ProjectIssueID" CommitChanges="True" AllowEdit="True" AutoRefresh="True" />
            <px:PXSelector ID="edRFIID" runat="server" DataField="RFIID" CommitChanges="True" AllowEdit="True" AutoRefresh="True" />
