		...
		<Levels>
			<px:PXGridLevel DataKeyNames="TaskID" DataMember="Activity">
			    ...
			    <Columns>
                    ...
                    <px:PXGridColumn DataField="ContractID" AutoCallBack="True"  LinkCommand="ViewContract"/>
                    ...
                    <px:PXGridColumn DataField="ApprovedDate" />
					<px:PXGridColumn DataField="CRCase__CaseCD" LinkCommand="ViewCase" />
                    <px:PXGridColumn DataField="CRCase__Status" />
