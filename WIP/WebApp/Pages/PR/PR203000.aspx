...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="PayrollEmployee" TypeName="PX.Objects.PR.PREmployeePayrollSettingsMaint">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="ImportTaxes" Visible="false" />
			...
			<px:PXDSCallbackCommand Name="AddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,fAddressInfo" CommitChanges="true" Visible="false" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
		...
		<Items>
			<px:PXTabItem Text="General Info">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Work Locations" LabelsWidth="0" />
					<px:PXCheckBox ID="chkLocationUseDflt" runat="server" DataField="LocationUseDflt" CommitChanges="True" />
					<px:PXGrid runat="server" DataSourceID="ds" ID="grdWorkLocations" SkinID="Details" Height="160px" Width="500px" AllowPaging="false">
						<Levels>
							<px:PXGridLevel DataMember="WorkLocations">
								<Columns>
									<px:PXGridColumn DataField="LocationID" Width="145px" CommitChanges="true" />
									<px:PXGridColumn DataField="PRLocation__Description" Width="240px"/>
									<px:PXGridColumn DataField="IsDefault" Type="CheckBox" TextAlign="Center" CommitChanges="true" />
 								</Columns>
							</px:PXGridLevel>
						</Levels>
					</px:PXGrid>
                    ...
                    <px:PXLayoutRule runat="server" Merge="True" />
                    <px:PXCheckBox ID="chkExemptFromCertifiedReporting" runat="server" DataField="ExemptFromCertifiedReporting" TabIndex="115" Width="202" CommitChanges="True" />
                    <px:PXCheckBox ID="chkExemptFromCertifiedReportingUseDflt" runat="server" DataField="ExemptFromCertifiedReportingUseDflt" TabIndex="120" CommitChanges="True" style="margin-left: 15px; margin-bottom: 30px" />
                    <px:PXLayoutRule runat="server" />
				</Template>
			</px:PXTabItem>
			<px:PXTabItem Text="Tax Settings">
				<Template>
					<px:PXGrid ID="EmpAttr" runat="server" DataSourceID="ds" SkinID="Inquire" MatrixMode="True" Width="100%" FilesIndicator="False" CssClass="SettingTable">
						<Levels>
							<px:PXGridLevel DataMember="EmployeeAttributes">
								<Columns>
									<px:PXGridColumn DataField="Description" Width="400px" />
									<px:PXGridColumn DataField="AdditionalInformation" />
									<px:PXGridColumn DataField="CompanyNotes" Width="200px" />
									...
									<px:PXGridColumn DataField="UsedForSymmetry" TextAlign="Center" Type="CheckBox" />
									<px:PXGridColumn DataField="UsedForAatrix" TextAlign="Center" Type="CheckBox" />
									<px:PXGridColumn DataField="FormBox" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
			...
			<px:PXTabItem Text="Taxes">
				<Template>
					<px:PXSplitContainer runat="server" ID="sp2" PositionInPercent="true" SplitterPosition="40" Orientation="Vertical">
						<AutoSize Enabled="true" />
						<Template1>
							<px:PXGrid ID="EmployeeTax" runat="server" DataSourceID="ds" SkinID="Inquire" KeepPosition="True" SyncPosition="True" Width="100%" Height="430px">
								<Levels>
								...
								<ActionBar>
									<CustomItems>
										<px:PXToolBarButton CommandSourceID="ds" CommandName="ImportTaxes" />
									</CustomItems>
								</ActionBar>
								<AutoSize Enabled="true" />
						...
						<Template2>
							<px:PXGrid ID="EmployeeTaxAttributes" runat="server" DataSourceID="ds" Caption="Tax Settings" CaptionVisible="true" MatrixMode="True"
								SkinID="Inquire" Width="100%" FilesIndicator="False" CssClass="SettingTable">
								<Levels>
			...
			<px:PXTabItem Text="Deductions and Benefits" LoadOnDemand="true" RepaintOnDemand="true">
				<Template>
					...
					<px:PXGrid ID="gridDeductions" runat="server" DataSourceID="ds" SkinID="DetailsInTab" Height="200px" Width="100%" SyncPosition="True" KeepPosition="True">
						<Levels>
			...
			<px:PXTabItem Text="Paid Time Off">
				<Template>
					<px:PXFormView ID="fEmployeePTOBanks" runat="server" DataMember="CurrentPayrollEmployee">
						<Template>
							<px:PXLayoutRule runat="server" StartRow="true" ControlSize="XXS" LabelsWidth="0px" />
							<px:PXCheckBox ID="edUsePTOBanksFromClass" runat="server" DataField="UsePTOBanksFromClass" CommitChanges="True" AlignLeft="true"/>
						</Template>
					</px:PXFormView>
						...
						<Levels>
							<px:PXGridLevel DataMember="EmployeeDirectDeposit">
								...
								<Columns>
									...
									<px:PXGridColumn DataField="BankName" Width="200px" CommitChanges="True" />
	...
	<px:PXSmartPanel ID="pnlCreateEditPREmployee" runat="server" Key="CreateEditPREmployeeFilter" Height="100px" CaptionVisible="True" Caption="Create Employee Payroll Settings" AllowResize="false">
		<px:PXFormView ID="formCreateEmployee" runat="server" DataMember="CreateEditPREmployeeFilter" DataSourceID="ds" SkinID="Transparent">
			<Template>
                ...
                <px:PXSelector ID="edCashAccountID" runat="server" DataField="CashAccountID" />
			</Template>
			<AutoSize Enabled="true" />
		</px:PXFormView>
