...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="DocType" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.TX.TXInvoiceEntry" PrimaryView="Document">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Visible="false" Name="ReleaseRetainage"/>
            <px:PXDSCallbackCommand Visible="false" Name="ViewSourceDocument"/>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="Document" Caption="Document Summary" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="true" ActivityField="NoteActivity"
        LinkIndicator="true" BPEventsIndicator="true" EmailingGraph="PX.Objects.CR.CREmailActivityMaint,PX.Objects" DefaultControlID="edDocType">
        <CallbackCommands>
            <Save PostData="Self" />
        </CallbackCommands>
