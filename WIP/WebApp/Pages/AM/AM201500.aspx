...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
		...
		<Items>
			...
			<px:PXTabItem Text="References">
                <Template>
                    ...
                    <px:PXTextEdit ID="edOrdTypeRef" runat="server" DataField="OrdTypeRef" AllowEdit="True" />
                    ...
                    <px:PXLayoutRule ID="PXLayoutRule65" runat="server" StartColumn="False" LabelsWidth="M" ControlSize="XM" Merge="true" />
                    <px:PXButton ID="linkSalesOrder" runat="server" Text="Link Sales Order" CommandName="linkSalesOrder" CommandSourceID="ds" />
            ...
            <px:PXTabItem Text="Line Details">
            <Template>
    ...
    <px:PXSmartPanel runat="server" Height="360px" TabIndex="5537" Width="960px" ID="edPanelLinkSales" LoadOnDemand="True" CaptionVisible="True" 
            Caption="SO Line Details" Key="LinkSOLineRecords" AutoCallBack-Command="Refresh" AutoCallBack-Target="LinkSalesGrid" CallBackMode-CommitChanges="True" > 
        <px:PXFormView ID="formSalesLinkFilter" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="linkSalesLinesFilter"
            Caption="None" CaptionVisible="false" SkinID="Transparent" >
            <Template>
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="S" />
                <px:PXSegmentMask ID="LinkFilterCustomerID" runat="server" DataField="CustomerID" AllowEdit="False" CommitChanges="true" />
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="S" />
                <px:PXSelector runat="server" ID="LinkFilterOrderType" DataField="OrderType" AllowEdit="False" CommitChanges="true" />
                <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="S"  />
				<px:PXSelector runat="server" ID="LinkFilterorderNbr" DataField="OrderNbr" AllowEdit="False"  CommitChanges="true" />
            </Template>
        </px:PXFormView>
        <px:PXGrid ID="LinkSalesGrid" runat="server" Height="360px" Width="100%" DataSourceID="ds" AutoAdjustColumns="true" SyncPosition="True" SkinID="Details" > 
            <Levels>
                <px:PXGridLevel DataMember="LinkSOLineRecords" > 
                    <RowTemplate>
						<px:PXCheckBox runat="server" DataField="AMSelected" ID="LinkGridCheckSelect"  CommitChanges="true"  />
						<px:PXSelector runat="server" ID="LinkGridOrderType" DataField="OrderType" AllowEdit="true" />
						<px:PXSelector runat="server" ID="LinkLineOrderNbr" DataField="OrderNbr" AllowEdit="true" />
						<px:PXNumberEdit runat="server" DataField="OrderQty" ID="LinkGridOrderQty" />
						<px:PXNumberEdit runat="server" DataField="OpenQty" ID="LinkGridOpenQty" /> 
                        <px:PXTextEdit runat="server" ID="LinkGridUOM" DataField="UOM" />
                        <px:PXTextEdit runat="server" ID="LinkGridLineNbr" DataField="LineNbr" />
                    </RowTemplate>
					<Columns>
						<px:PXGridColumn DataField="AMSelected" Type="CheckBox" TextAlign="Center" AutoCallBack="True" AllowCheckAll="false" />
						<px:PXGridColumn DataField="OrderType" Width="55px"/>
						<px:PXGridColumn DataField="OrderNbr" Width="120px"/>
                        <px:PXGridColumn DataField="OrderQty" TextAlign="Right" Width="75px" />
						<px:PXGridColumn DataField="OpenQty" TextAlign="Right" Width="75px" />
        ...
        <px:PXPanel ID="PanelLinkSalesOrdersButtons" runat="server" SkinID="Buttons">
            <px:PXButton ID="LinkSalesLine" runat="server" DialogResult="OK" Text="Save" />
            <px:PXButton ID="CancelLink" runat="server" DialogResult="Cancel" Text="Cancel" />
        </px:PXPanel>
    </px:PXSmartPanel>
</asp:Content>
