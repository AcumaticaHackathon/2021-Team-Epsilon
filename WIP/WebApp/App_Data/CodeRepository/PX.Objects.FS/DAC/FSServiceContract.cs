...
namespace PX.Objects.FS
 {
     ...
     public class FSServiceContract : PX.Data.IBqlTable
     {
        ...
        {
            public static FSServiceContract Find(PXGraph graph, int? serviceContractID) => FindBy(graph, serviceContractID);
        }

        public class UK : PrimaryKeyOf<FSServiceContract>.By<refNbr>
        {
            public static FSServiceContract Find(PXGraph graph, string refNbr) => FindBy(graph, refNbr);
        }
        ...
        public static class FK
        {
            ...
            public class DefaultTask : PMTask.PK.ForeignKeyOf<FSServiceContract>.By<dfltProjectTaskID> { }
        }
        #endregion
