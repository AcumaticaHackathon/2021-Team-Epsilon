...
namespace PX.Objects.CR
{
	...
	public partial class CROpportunityClass : CRBaseClass, IBqlTable, ITargetToAccount
	{
		...
		{
			public static CROpportunityClass Find(PXGraph graph, string cROpportunityClassID) => FindBy(graph, cROpportunityClassID);
		}
		public static class FK
		{
			...
			public class DiscountAccount : GL.Account.PK.ForeignKeyOf<CROpportunityClass>.By<discountAcctID> { }
			public class DiscountSubaccount : GL.Sub.PK.ForeignKeyOf<CROpportunityClass>.By<discountSubID> { }
		}
		#endregion
		...
		[PXDBInt]
		[PXForeignReference(typeof(Field<defaultEMailAccountID>.IsRelatedTo<EMailAccount.emailAccountID>))]
