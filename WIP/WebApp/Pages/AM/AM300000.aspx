...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
        <px:pxdatasource ID="ds" runat="server" Visible="True" BorderStyle="NotSet" PrimaryView="batch" TypeName="PX.Objects.AM.MaterialEntry" HeaderDescriptionField="TranDesc">
		<CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
		...
		<ActionBar ActionsText="False">
            <CustomItems>
		        <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LSAMMaterial_binLotSerial" CommandSourceID="ds" DependOnGrid="grid" />
            </CustomItems>
		</ActionBar>
	</px:pxgrid>
