...
namespace PX.Objects.CA
{
	...
	public partial class CABatchDetail : IBqlTable
	{
		...
		{
			public static CABatchDetail Find(PXGraph graph, string batchNbr, string origModule, string origDocType, string origRefNbr, string origLineNbr)
				=> FindBy(graph, batchNbr, origModule, origDocType, origRefNbr, origLineNbr);
		}
