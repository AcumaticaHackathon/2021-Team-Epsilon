namespace PX.Objects.CM
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<TranslDefDet>.By<translDefId, lineNbr, accountIdFrom>
		{
			public static TranslDefDet Find(PXGraph graph, String translDefId, Int32? lineNbr, Int32? accountIdFrom) => FindBy(graph, translDefId, lineNbr, accountIdFrom);
		}
		public static class FK
		{
			public class Translation : GL.Branch.PK.ForeignKeyOf<TranslDefDet>.By<translDefId> { }
			public class AccountFrom : GL.Account.PK.ForeignKeyOf<TranslDefDet>.By<accountIdFrom> { }
			public class SubaccountFrom : GL.Sub.PK.ForeignKeyOf<TranslDefDet>.By<subIdFrom> { }
			public class AccountTo : GL.Account.PK.ForeignKeyOf<TranslDefDet>.By<accountIdTo> { }
			public class SubaccountTo : GL.Sub.PK.ForeignKeyOf<TranslDefDet>.By<subIdTo> { }
			public class RateType : CM.CurrencyRateType.PK.ForeignKeyOf<TranslDefDet>.By<rateTypeId> { }
		}
		#endregion
		#region TranslDefId
