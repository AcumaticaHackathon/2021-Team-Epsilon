	...
	<px:PXFormView ID="BAccount" runat="server" Width="100%" Caption="Vendor Summary" DataMember="BAccount" NoteIndicator="True" FilesIndicator="True" BPEventsIndicator="True" ActivityIndicator="False" LinkIndicator="True"
		...
		<Template>
			...
			<px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" />
				...
				<px:PXSegmentMask ID="edAcctCD" runat="server" DataField="AcctCD" DataSourceID="ds" FilterByAllFields="True" />
				<px:PXDropDown ID="edVStatus" runat="server" DataField="VStatus" CommitChanges="True"/>
				...
				<px:PXFormView ID="VendorBalance" runat="server" DataMember="VendorBalance" DataSourceID="ds" RenderStyle="Simple">
					<Template>
						...
						<px:PXLayoutRule ID="edMerge11" runat="server" Merge="true" />
                            <px:PXTextEdit ID="edDepositsBalanceLabel" runat="server" 
                                           Style="background-color: transparent; border-width:0px; padding-left:0px; color:#5c5c5c"
                                           DataField="DepositsBalance_Label" 
                                           SuppressLabel="true" 
                                           Width="154px"  
                                           Enabled="false"
                                           IsClientControl="false" />
                            <px:PXNumberEdit ID="edBDepositsBalance" runat="server" DataField="DepositsBalance" SuppressLabel="true" />
						...
						<px:PXLayoutRule ID="edMerge21" runat="server" Merge="true" />
                            <px:PXTextEdit ID="edRetainageBalanceLabel" runat="server" 
                                           ...
                                           Enabled="false"
                                           IsClientControl="false" />
                            <px:PXNumberEdit ID="edBRetainageBalance" runat="server" DataField="RetainageBalance" SuppressLabel="true" />
			...
			<px:PXTabItem Text="General" RepaintOnDemand="false">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Additional Account Info" StartGroup="True" />
						...
						<px:PXFormView ID="CurrentVendor2" runat="server" DataMember="CurrentVendor" DataSourceID="ds" RenderStyle="Simple" TabIndex="400">
							<Template>
								<px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" />
						...
						<px:PXFormView ID="DefContact2" runat="server" DataMember="DefContact" DataSourceID="ds" RenderStyle="Simple" TabIndex="500">
							<Template>
                    ...
                    <px:PXFormView runat="server" ID="VendorDefaults" Caption="Project Defaults" DataMember="CurrentVendor" TabIndex="1161" RenderStyle="Fieldset">
                        <Template>
			...
			<px:PXTabItem Text="Financial">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Financial Settings" />
						...
						<px:PXBranchSelector CommitChanges="True" ID="edVOrgBAccountID" runat="server" DataField="VOrgBAccountID" InitialExpandLevel="0" />
						<px:PXLayoutRule runat="server" Merge="True" />
					...
					<px:PXFormView ID="DefLocation" runat="server" CaptionVisible="False" DataMember="DefLocation" Width="100%" SkinID="Transparent">
						<Template>
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Other Settings" />
								<px:PXSelector ID="edVBranchID" runat="server" DataField="VBranchID" AllowEdit="True" AutoRefresh="true"/>
								<px:PXLayoutRule runat="server" Merge="True" />
							...
							<px:PXFormView ID="PXFormView1" runat="server" DataMember="CurrentVendor" RenderStyle="Simple">
								<Template>
									<px:PXLayoutRule ID="PXLayoutRule10" runat="server" ControlSize="XM" LabelsWidth="SM" />
									<px:PXDropDown ID="edTinType" runat="server" DataField="TinType" CommitChanges="true" />
								</Template>
							</px:PXFormView>
							...
							<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Shipping Instructions" />
								...
								<px:PXSegmentMask ID="edVSiteIDIntercompany" runat="server" DataField="DefLocationBranchSettings.VSiteID" AllowEdit="True" CommitChanges="True" AutoRefresh="True" />
				...
				<Template>
					...
					<px:PXFormView ID="DefLocationGLAccounts" runat="server" DataMember="DefLocation" RenderStyle="Simple" TabIndex="2100" MarkRequired="Dynamic">
						<Template>
							...
							<px:PXSegmentMask ID="edVAPSubID" runat="server" CommitChanges="True" DataField="VAPSubID" />
							<px:PXSegmentMask ID="edVExpenseAcctID" runat="server" CommitChanges="True" DataField="VExpenseAcctID" />
							<px:PXSegmentMask ID="edVExpenseSubID" runat="server" CommitChanges="True" DataField="VExpenseSubID" />
							<px:PXSegmentMask ID="edVDiscountAcctID" runat="server" CommitChanges="True" DataField="VDiscountAcctID" />
							<px:PXSegmentMask ID="edVDiscountSubID" runat="server" CommitChanges="True" DataField="VDiscountSubID" />
						</Template>
					</px:PXFormView>
					...
					<px:PXSegmentMask ID="edPrepaymentSubID" runat="server" CommitChanges="True" DataField="PrepaymentSubID" />
					<px:PXSegmentMask CommitChanges="True" ID="edPOAccrualAcctID" runat="server" DataField="POAccrualAcctID" />
					<px:PXSegmentMask ID="edPOAccrualSubID" runat="server" CommitChanges="True" DataField="POAccrualSubID" />
					<px:PXSegmentMask CommitChanges="True" ID="edPrebookAcctID" runat="server" DataField="PrebookAcctID" />
					<px:PXSegmentMask ID="edPrebookSubID" runat="server" CommitChanges="True" DataField="PrebookSubID" />
					<px:PXFormView ID="formRetainage" runat="server" DataMember="DefLocation" RenderStyle="Simple" >
						<Template>
							...
							<px:PXSegmentMask ID="edVRetainageSubID" CommitChanges="True" runat="server" DataField="VRetainageSubID" />
						</Template>
					</px:PXFormView>
				</Template>
			</px:PXTabItem>
