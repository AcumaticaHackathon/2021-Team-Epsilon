...
namespace PX.Objects.AR
{
	...
	[PXProjection(
		typeof(Select2<PMInstance, LeftJoin<PaymentMethod, On<PMInstance.pMInstanceID, Equal<PaymentMethod.pMInstanceID>>,
			...
			Where2<Where<PaymentMethod.aRIsOnePerCustomer, Equal<True>, Or<PaymentMethod.aRIsOnePerCustomer, IsNull, 
					Or<Where<PaymentMethod.aRIsOnePerCustomer, Equal<False>, And<PaymentMethod.paymentType,Equal<PaymentMethodType.creditCard>>>>>>,
	...
	public partial class CustomerPaymentMethodInfo : PX.Data.IBqlTable
	{
		...
		{
			public class Customer : AR.Customer.PK.ForeignKeyOf<CustomerPaymentMethodInfo>.By<bAccountID> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<CustomerPaymentMethodInfo>.By<paymentMethodID> { }
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CustomerPaymentMethodInfo>.By<cashAccountID> { }
		}
		#endregion
		...
		[DeprecatedProcessing(ErrorMappedFieldName = nameof(CustomerPaymentMethodInfo.Descr))]
