...
{	
	...
	{
        #region Keys
        public class PK : PrimaryKeyOf<FSWeekCodeDate>.By<weekCodeDate>
        {
            public static FSWeekCodeDate Find(PXGraph graph, DateTime? weekCodeDate) => FindBy(graph, weekCodeDate);
        }
        #endregion
