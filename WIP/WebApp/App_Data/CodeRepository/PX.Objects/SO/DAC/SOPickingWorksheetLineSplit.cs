...
namespace PX.Objects.SO
{
	...
	public class SOPickingWorksheetLineSplit : IBqlTable
	{
		...
		public static class FK
		{
			...
			public class SiteStatus : IN.INSiteStatus.PK.ForeignKeyOf<SOPickingWorksheetLineSplit>.By<inventoryID, subItemID, siteID> { }
			public class Location : INLocation.PK.ForeignKeyOf<SOPickingWorksheetLineSplit>.By<locationID> { }
			public class LocationStatus : IN.INLocationStatus.PK.ForeignKeyOf<SOPickingWorksheetLineSplit>.By<inventoryID, subItemID, siteID, locationID> { }
			public class SortingLocation : INLocation.PK.ForeignKeyOf<SOPickingWorksheetLineSplit>.By<sortingLocationID> { }
			public class SortingLocationStatus : IN.INLocationStatus.PK.ForeignKeyOf<SOPickingWorksheetLineSplit>.By<inventoryID, subItemID, siteID, locationID> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<SOPickingWorksheetLineSplit>.By<inventoryID> { }
			public class SubItem : INSubItem.PK.ForeignKeyOf<SOPickingWorksheetLineSplit>.By<subItemID> { }
			//todo public class UnitOfMeasure : INUnit.PK.ForeignKeyOf<SOPickingWorksheetLineSplit>.By<inventoryID, uOM> { }
		}
		#endregion
