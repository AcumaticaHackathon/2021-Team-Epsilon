...
namespace PX.Objects.CS
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<Dimension>.By<dimensionID>
		{
			public static Dimension Find(PXGraph graph, String dimensionID) => FindBy(graph, dimensionID);
		}
		public static class FK
		{
			public class ParentDimension : CS.Dimension.PK.ForeignKeyOf<Dimension>.By<parentDimensionID> { }
		}
		#endregion
		#region DimensionID
