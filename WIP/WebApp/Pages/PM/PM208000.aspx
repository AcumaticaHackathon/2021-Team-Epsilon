            ...
            <px:PXTabItem Text="Summary">
                <Template>
                   ...
                   <px:PXSelector ID="edTermsID" runat="server" DataField="TermsID" />
                    ...
                    <px:PXLayoutRule ID="PXLayoutRule1" runat="server" StartGroup="True" StartColumn="true" GroupCaption="Visibility Settings" LabelsWidth="SM" ControlSize="XM"/>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Tasks" DataKeyNames="ProjectID,TaskCD">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask Size="s" ID="edDefaultSalesSubID2" runat="server" DataField="DefaultSalesSubID" />
                                    <px:PXSegmentMask Size="s" ID="edDefaultExpenseSubID2" runat="server" DataField="DefaultExpenseSubID" />
