...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLVoucher>.By<workBookID, voucherBatchNbr, lineNbr>
		{
			public static GLVoucher Find(PXGraph graph, String workBookID, String voucherBatchNbr, int? lineNbr) => FindBy(graph, workBookID, voucherBatchNbr, lineNbr);
		}
		public static class FK
		{
			public class GLVoucherBatch : GL.GLVoucherBatch.PK.ForeignKeyOf<GLVoucher>.By<workBookID, voucherBatchNbr> { }
			public class Batch : GL.Batch.PK.ForeignKeyOf<GLVoucher>.By<module, refNbr> { }
		}
		#endregion
