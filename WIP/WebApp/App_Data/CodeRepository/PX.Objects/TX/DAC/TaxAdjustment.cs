...
namespace PX.Objects.TX
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<TaxAdjustment>.By<docType, refNbr>
		{
			public static TaxAdjustment Find(PXGraph graph, string docType, string refNbr) => FindBy(graph, docType, refNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<TaxAdjustment>.By<branchID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<TaxAdjustment>.By<vendorID> { }
			public class Location : CR.Location.PK.ForeignKeyOf<TaxAdjustment>.By<vendorID, vendorLocationID> { }

			public class AdjustmentAccount : GL.Account.PK.ForeignKeyOf<TaxAdjustment>.By<adjAccountID> { }
			public class AdjustmentSubaccount : GL.Sub.PK.ForeignKeyOf<TaxAdjustment>.By<adjSubID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<TaxAdjustment>.By<curyInfoID> { }
			public class Currency : PX.Objects.CM.Currency.PK.ForeignKeyOf<TaxAdjustment>.By<curyID> { }
		}
		#endregion
