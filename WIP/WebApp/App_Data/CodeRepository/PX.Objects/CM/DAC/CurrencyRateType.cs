namespace PX.Objects.CM
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CurrencyRateType>.By<curyRateTypeID>
		{
			public static CurrencyRateType Find(PXGraph graph, String curyRateTypeID) => FindBy(graph, curyRateTypeID);
		}
		#endregion
