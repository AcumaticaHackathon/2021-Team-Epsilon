namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLTranCode>.By<module, tranType>
		{
			public static GLTranCode Find(PXGraph graph, String module, String tranType) => FindBy(graph, module, tranType);
		}
		#endregion
