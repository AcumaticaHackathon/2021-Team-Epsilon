...
namespace PX.Objects.AM.GraphExtensions
{
    public class InventoryItemMaintAMExtension : PXGraphExtension<InventoryItemMaint>
    {
        ...
        {
            configuration
                .GetScreenConfigurationContext<InventoryItemMaint, InventoryItem>()
                .UpdateScreenConfigurationFor(screen =>
                    screen.WithActions(actions =>
                        actions.Add<InventoryItemMaintAMExtension>(e => e.WhereUsedInq, a => a.InFolder(FolderType.InquiriesFolder))));
        }
