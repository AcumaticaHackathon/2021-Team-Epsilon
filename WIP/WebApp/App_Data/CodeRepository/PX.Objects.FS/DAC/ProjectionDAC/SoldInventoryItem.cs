...
namespace PX.Objects.FS
{
    ...
    [PXGroupMask(typeof(InnerJoinSingleTable<Customer, On<Customer.bAccountID, Equal<SoldInventoryItem.customerID>, And<Match<Customer, Current<AccessInfo.userName>>>>>))]
    #endregion
