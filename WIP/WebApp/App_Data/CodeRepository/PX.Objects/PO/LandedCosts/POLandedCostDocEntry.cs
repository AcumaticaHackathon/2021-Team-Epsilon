...
namespace PX.Objects.PO
{
	...
	public class POLandedCostDocEntry : PXGraph<POLandedCostDocEntry, POLandedCostDoc>
	{
		...
		public PXSelectJoinGroupBy<POReceipt,
				...
				LeftJoin<Vendor, On<POReceipt.vendorID, Equal<Vendor.bAccountID>>>>,
		...
		public virtual IEnumerable PoReceiptSelection()
		{
			...
			var resultSet = poReceiptSelectionView.View.Select(PXView.Currents, PXView.Parameters, new object[PXView.SortColumns.Length],
				PXView.SortColumns,
		...
		public PXAutoAction<POLandedCostDoc> initializeState;
