...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
  <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="ProcessFilter" Width="100%" Height="" AllowAutoHide="false">
    <Template>
      ...
      <px:PXLayoutRule runat="server" ID="CstPXLayoutRule4" StartColumn="True" LabelsWidth="S" ControlSize="SM" />
      <px:PXDropDown runat="server" ID="CstPXDropDown2" CommitChanges="True" DataField="PrepareMode" />
      <px:PXLayoutRule runat="server" ID="CstPXLayoutRule5" StartColumn="True" LabelsWidth="S" ControlSize="SM" ></px:PXLayoutRule>
      <px:PXDateTimeEdit runat="server" ID="CstPXDateTimeEdit6" DataField="StartDate" ControlSize="SM" Width="170" />
      <px:PXDateTimeEdit runat="server" ID="CstPXDateTimeEdit5" DataField="EndDate" ControlSize="SM" Width="170" />
    </Template>  
