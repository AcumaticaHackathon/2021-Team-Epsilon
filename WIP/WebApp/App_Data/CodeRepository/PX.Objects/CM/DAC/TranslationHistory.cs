...
namespace PX.Objects.CM
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<TranslationHistory>.By<referenceNbr>
		{
			public static TranslationHistory Find(PXGraph graph, String referenceNbr) => FindBy(graph, referenceNbr);
		}
		public static class FK
		{
			public class Translation : CM.TranslDef.PK.ForeignKeyOf<TranslationHistory>.By<translDefId> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<TranslationHistory>.By<branchID> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<TranslationHistory>.By<ledgerID> { }
			public class DestinationCurrency : CM.Currency.PK.ForeignKeyOf<TranslationHistory>.By<destCuryID> { }
		}
		#endregion
		#region ReferenceNbr
