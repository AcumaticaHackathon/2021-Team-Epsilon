...
namespace PX.Objects.PM
{
	...
	public class PMBudget : IBqlTable, IProjectFilter, IQuantify
	{
		...
		{
			public static PMBudget Find(PXGraph graph, int? projectID, int? projectTaskID, int? accountGroupID, int? costCodeID, int? inventoryID) => FindBy(graph, projectID, projectTaskID, accountGroupID, costCodeID, inventoryID);
		}
		...
		public static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PMBudget>.By<projectTaskID> { }
	...
	public class PMRevenueBudget : PMBudget
	{
		...
		{
			public static PMRevenueBudget Find(PXGraph graph, int? projectID, int? projectTaskID, int? accountGroupID, int? costCodeID, int? inventoryID) => FindBy(graph, projectID, projectTaskID, accountGroupID, costCodeID, inventoryID);
		}
		...
		public new static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PMRevenueBudget>.By<projectTaskID> { }
		...
		[PXDBCurrency(typeof(Search<CommonSetup.decPlPrcCst>), typeof(curyInfoID), typeof(rate))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXUIField(DisplayName = "Unit Rate")]
	...
	public class PMCostBudget : PMBudget
	{
		...
		{
			public static PMCostBudget Find(PXGraph graph, int? projectID, int? projectTaskID, int? accountGroupID, int? costCodeID, int? inventoryID) => FindBy(graph, projectID, projectTaskID, accountGroupID, costCodeID, inventoryID);
		}
		...
		public new static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PMCostBudget>.By<projectTaskID> { }
