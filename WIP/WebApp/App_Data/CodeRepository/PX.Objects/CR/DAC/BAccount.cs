...
namespace PX.Objects.CR
{
	...
	public partial class BAccount : IBqlTable, IAssign, IPXSelectable, INotable
	{
		...
		public static class FK
		{
			...
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<BAccount>.By<taxZoneID> { }
		...
		public abstract class status : PX.Data.BQL.BqlString.Field<status>
		{
			...
			public class ListAttribute : CustomerStatus.ListAttribute { }
	...
	public sealed class BAccount2 : BAccount
	{
		...
		{
			public static BAccount2 Find(PXGraph graph, int bAccountID) => FindBy(graph, bAccountID);
		}
		public new class UK : PrimaryKeyOf<BAccount2>.By<acctCD>
		{
			public static BAccount2 Find(PXGraph graph, string acctCD) => FindBy(graph, acctCD);
		}
	...
	public sealed class BAccountParent : BAccount
	{
		...
		{
			public static BAccountParent Find(PXGraph graph, int bAccountID) => FindBy(graph, bAccountID);
		}
		public new class UK : PrimaryKeyOf<BAccountParent>.By<acctCD>
		{
			public static BAccountParent Find(PXGraph graph, string acctCD) => FindBy(graph, acctCD);
		}
		public new static class FK
		{
