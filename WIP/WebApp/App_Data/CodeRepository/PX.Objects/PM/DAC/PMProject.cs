...
namespace PX.Objects.PM
{
	...
	public partial class PMProject : Contract, IAssign, PX.SM.IIncludable
	{
		...
		/// <summary>
		/// Default Sales Sub Account Associated with the project. This Subaccount can be later used in allocation and billing rules.
		/// </summary>
		...
		/// <summary>
		/// Default Cost Sub Account Associated with the project. This Subaccount can be later used in allocation and/or Cost transactions.
		/// </summary>
