    ...
    public class StaffSelectionHelper
    {
                                ...
                                And<
                                    Where2<
                                        Where<
                                            ...
                                            And<
                                                Where2<
                                                    Where2<Not<FeatureInstalled<FeaturesSet.visibilityRestriction>>,
                                                        Or<Vendor.vOrgBAccountID, RestrictByUserBranches<Current<AccessInfo.userName>>>>,
                                                And<
       ...
       public class LicenseTypeRecords_View : PXSelectOrderBy<LicenseTypeGridFilter,
        ...
        private static List<int?> GetStaffByLineRefTab(object staffView, string lineRef)
        {
            ...
            {
                AppointmentEntry.AppointmentServiceEmployees_View appEmployeeView = (AppointmentEntry.AppointmentServiceEmployees_View)staffView;
            ...
            {
                ServiceOrderEntry.ServiceOrderEmployees_View soEmployeeView = (ServiceOrderEntry.ServiceOrderEmployees_View)staffView;
