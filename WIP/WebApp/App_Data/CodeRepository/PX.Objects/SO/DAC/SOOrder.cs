...
namespace PX.Objects.SO
{
    ...
    public partial class SOOrder : PX.Data.IBqlTable, PX.Data.EP.IAssign, IFreightBase, ICCAuthorizePayment, ICCCapturePayment, IInvoice, ICreatePaymentDocument
	{
		#region Keys
		...
		public static class FK
		{
			...
			public class Owner : CR.Standalone.EPEmployee.PK.ForeignKeyOf<SOOrder>.By<ownerID> { }
			...
			public class IntercompanyPOReturn : PO.POReceipt.PK.ForeignKeyOf<SOOrder>.By<intercompanyPOReturnNbr> { }
			//todo public class FinancialPeriod : FinPeriod.PK.ForeignKeyOf<SOOrder>.By<finPeriodID> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use BillingAddress instead.")]
			public class BillAddress : BillingAddress { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use ShippingAddress instead.")]
			public class ShipAddress : ShippingAddress { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use BillingContact instead.")]
			public class BillContact : BillingContact { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use ShippingContact instead.")]
			public class ShipContact : ShippingContact { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OriginalOrderType instead.")]
			public class OrigOrderType : OriginalOrderType { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OriginalOrder instead.")]
			public class OrigOrder : OriginalOrder { }
		}
		#endregion
		#region Events
		...
		[PXFormula(typeof(Selector<defaultOperation, SOOrderTypeOperation.iNDocType>))]
		...
		[PXFormula(typeof(
			Maximum<
				Sub<
					Switch<Case<Where<Add<releasedCntr, billedCntr>, Equal<int0>>, curyOrderTotal>, curyUnbilledOrderTotal>,
					curyPaymentTotal>,
				decimal0>))]
		[PXDefault(TypeCode.Decimal, "0.0")]
		...
		#endregion
		#region HasLegacyCCTran
		[Obsolete(Common.Messages.ItemIsObsoleteAndWillBeRemoved2022R2)]
		public abstract class hasLegacyCCTran : PX.Data.BQL.BqlBool.Field<hasLegacyCCTran> { }
		[PXDBBool]
		[PXDefault(false)]
		[Obsolete(Common.Messages.ItemIsObsoleteAndWillBeRemoved2022R2)]
		public virtual bool? HasLegacyCCTran
		{
			get;
			set;
		}
		...
		[PXUIField(DisplayName = "Orig. Transaction", Visibility = PXUIVisibility.SelectorVisible, Enabled = false)]
		...
		[PXDefault(TypeCode.Decimal, "0.0", typeof(Search<Terms.prepaymentPct, Where<Terms.termsID, Equal<Current<SOOrder.termsID>>>>))]
		...
		[PXFormula(typeof(
			IIf<Where<defaultTranType, NotEqual<INTranType.transfer>,
				And<aRDocType, NotIn3<ARDocType.cashSale, ARDocType.cashReturn>>>,
				True, False>))]
	...
	public static class SOOrder_ExtensionMethods
	{
		...
		{
			if (order != null && order.ARDocType != ARDocType.NoUpdate && order.Completed == false)
			{
