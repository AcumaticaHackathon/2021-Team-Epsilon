            ...
            else
            {
                ...
                else if (item != null)
                {
                    ...
                    if (e.Row.BaseQtyRemaining > oldRowBaseQty)
                    {
                        ...
                        UpdateSplits(sender, e.Row, (decimal)e.Row.BaseQtyRemaining - oldRowBaseQty);
...
#pragma warning restore PX1048
        ...
        protected virtual bool HasDetail(AMProdMatl masterRow)
        {
            return masterRow != null && (SelectDetail(DetailCache, masterRow)?.Length ?? 0) != 0;
        }
