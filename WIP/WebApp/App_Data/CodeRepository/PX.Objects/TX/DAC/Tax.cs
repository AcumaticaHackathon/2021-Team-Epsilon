...
namespace PX.Objects.TX
{
	...
	public partial class Tax : PX.Data.IBqlTable
	{
		...
		{
			public class TaxAgency : AP.Vendor.PK.ForeignKeyOf<Tax>.By<taxVendorID> { }
			public class TaxPayableAccount : GL.Account.PK.ForeignKeyOf<Tax>.By<salesTaxAcctID> { }
			public class TaxPayableSubaccount : GL.Sub.PK.ForeignKeyOf<Tax>.By<salesTaxSubID> { }
			public class TaxClaimableAccount : GL.Account.PK.ForeignKeyOf<Tax>.By<purchTaxAcctID> { }
			public class TaxClaimableSubaccount : GL.Sub.PK.ForeignKeyOf<Tax>.By<purchTaxSubID> { }
			public class PendingTaxPayableAccount : GL.Account.PK.ForeignKeyOf<Tax>.By<pendingSalesTaxAcctID> { }
			public class PendingTaxPayableSubaccount : GL.Sub.PK.ForeignKeyOf<Tax>.By<pendingSalesTaxSubID> { }
			public class PendingTaxClaimableAccount : GL.Account.PK.ForeignKeyOf<Tax>.By<pendingPurchTaxAcctID> { }
			public class PendingTaxClaimableSubaccount : GL.Sub.PK.ForeignKeyOf<Tax>.By<pendingPurchTaxSubID> { }
			public class TaxExpenseAccount : GL.Account.PK.ForeignKeyOf<Tax>.By<expenseAccountID> { }
			public class TaxExpenseSubaccount : GL.Sub.PK.ForeignKeyOf<Tax>.By<expenseSubID> { }
		}
		#endregion
		#region TaxID
		...
		#endregion
		#region ZeroTaxable
		public abstract class zeroTaxable : PX.Data.BQL.BqlBool.Field<zeroTaxable> { }
		protected Boolean? _ZeroTaxable;
		...
		[PXDBBool()]
		[PXDefault(false)]
		public virtual Boolean? ZeroTaxable
		{
			get
			{
				return this._ZeroTaxable;
			}
			set
			{
				this._ZeroTaxable = value;
			}
		}
		#endregion
