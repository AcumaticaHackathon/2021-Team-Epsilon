namespace PX.Objects.GL
{
	...
	public partial class GLAllocationDestination : PX.Data.IBqlTable
    {
		...
		public static class FK
		{
			...
			public class Account : GL.Account.PK.ForeignKeyOf<GLAllocationDestination>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<GLAllocationDestination>.By<subID> { }
