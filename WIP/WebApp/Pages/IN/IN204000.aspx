...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INSiteMaint" PrimaryView="site">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="AddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,addrForm" CommitChanges="true" Visible="false" />
    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="621px" DataSourceID="ds" DataMember="siteaccounts">
        ...
        <Items>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="location" DataKeyNames="SiteID,LocationCD">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ProductionValid" TextAlign="Center" Type="CheckBox"/>
									...
									<px:PXGridColumn DataField="AMMRPFlag" Width="60" Type="CheckBox" TextAlign="Center" />
                                </Columns>
                ...
                <Template>
                    ...
                    <px:PXFormView ID="addrForm" runat="server" Caption="Address" DataMember="Address" DataSourceID="ds" RenderStyle="Simple" SkinID="Transparent">
                        <Template>
                            ...
                            <px:PXButton Size="xs" ID="btnViewMainOnMap" runat="server" CommandName="ViewOnMap" CommandSourceID="ds" Text="View on Map" TabIndex="-1" />
			...
			<px:PXTabItem Text="Manufacturing">
				<Template>
					<px:PXLayoutRule runat="server" ID="edGeneralLayoutRule1" StartColumn="True" StartGroup="True" GroupCaption="General" />
					<px:PXLayoutRule runat="server" ID="edGeneralLayoutRule2" Merge="True" LabelsWidth="M" ColumnWidth="M" />
					<px:PXCheckBox runat="server" ID="edAMMRPFcst" DataField="AMMRPFcst" AlignLeft="True" />
					<px:PXCheckBox runat="server" ID="edAMMRPPO" DataField="AMMRPPO" AlignLeft="True" />
					<px:PXLayoutRule runat="server" ID="edGeneralLayoutRule3" Merge="True" LabelsWidth="M" ColumnWidth="M" />
					<px:PXCheckBox runat="server" ID="edAMMRPFlag" DataField="AMMRPFlag" AlignLeft="True" />
					<px:PXCheckBox runat="server" ID="edAMMRPProd" DataField="AMMRPProd" AlignLeft="True" />
					<px:PXLayoutRule runat="server" ID="edGeneralLayoutRule4" Merge="True" LabelsWidth="M" ColumnWidth="M" />
					<px:PXCheckBox runat="server" ID="edAMMRPMPS" DataField="AMMRPMPS" AlignLeft="True" />
					<px:PXCheckBox runat="server" ID="edAMMRPSO" DataField="AMMRPSO" AlignLeft="True" />
					<px:PXLayoutRule runat="server" ID="edGeneralLayoutRule5" Merge="True" LabelsWidth="M" ColumnWidth="M" />
					<px:PXCheckBox runat="server" ID="edAMMRPShip" DataField="AMMRPShip" AlignLeft="True" />
					<px:PXLayoutRule runat="server" ID="edGeneralLayoutRule6" StartGroup="True" GroupCaption="Scrap" />
					<px:PXLayoutRule runat="server" ID="edGeneralLayoutRule7" LabelsWidth="M" ColumnWidth="M" />
