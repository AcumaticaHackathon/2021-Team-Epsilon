...
namespace PX.Objects.GL
{
	...
	public partial class GLHistoryByPeriod : PX.Data.IBqlTable
	{
		...
		{
			public static GLHistoryByPeriod Find(PXGraph graph, Int32? ledgerID, Int32? branchID, Int32? accountID, Int32? subID, String finPeriodID) => FindBy(graph, ledgerID, branchID, accountID, subID, finPeriodID);
		}
	...
	public partial class GLHistoryLastRevaluation : PX.Data.IBqlTable
	{
		...
		{
			public static GLHistoryLastRevaluation Find(PXGraph graph, Int32? ledgerID, Int32? branchID, Int32? accountID, Int32? subID) => FindBy(graph, ledgerID, branchID, accountID, subID);
		}
		public static class FK
		{
