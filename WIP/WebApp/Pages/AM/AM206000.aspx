...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" BorderStyle="NotSet" PrimaryView="EstimateClassRecords" 
        TypeName="PX.Objects.AM.EstimateClassMaint" HeaderDescriptionField="Description">
		<CallbackCommands>
