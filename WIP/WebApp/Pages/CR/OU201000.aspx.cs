...
public partial class Page_OU201000 : PX.Web.UI.PXPage
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (this.IsCallback)
		{
			...
			if (graph.Filter.Current.NewContactFirstName == null)
				graph.Filter.Current.NewContactFirstName = this.Request.Form[_outlookFirstName];
			if (graph.Filter.Current.NewContactLastName == null)
		...
		else
		{
			...
			RegisterControlClientIdVariable(form, "edRecognitionIsNotStarted", "isRecognitionNotStartedId");
			...
			RegisterControlClientIdVariable(form, "edDuplicateFileMsg", "duplicateFileMsgId");
		}
	}
