...
namespace PX.Objects.PJ.RequestsForInformation.PJ.DAC
{
    ...
    public class RequestForInformation : ProjectManagementImpact, IAssign, IPXSelectable, IBqlTable, IProjectManagementDocumentBase
    {
        ...
        {
            public static RequestForInformation Find(PXGraph graph, string requestForInformationCd) => FindBy(graph, requestForInformationCd);
        }
        ...
        public static class FK
        {
            ...
            /// Project Task
            /// </summary>
            public class ProjectTask : PMTask.PK.ForeignKeyOf<RequestForInformation>.By<projectTaskId> { }
