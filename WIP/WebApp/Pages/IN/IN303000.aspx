...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INAdjustmentEntry" PrimaryView="adjustment" HeaderDescriptionField="TranDesc">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="LSINAdjustmentTran_generateLotSerial" />
            <px:PXDSCallbackCommand CommitChanges="True" Visible="False" Name="LSINAdjustmentTran_binLotSerial" DependOnGrid="grid" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" Caption="Document Summary" DataMember="adjustment"
    ...
    <px:PXTab ID="tab" runat="server" Height="216px" Width="100%">
        <Items>
			...
			<px:PXTabItem Text="Manufacturing">
				<Template>
					<px:PXFormView runat="server" ID="formam1" DataMember="CurrentDocument" RenderStyle="Simple" DataSourceID="ds">
						<Template>
							<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="M" />
							<px:PXSelector runat="server" ID="edAMBatNbr" DataField="AMBatNbr" Enabled="False" AllowEdit="True" />
