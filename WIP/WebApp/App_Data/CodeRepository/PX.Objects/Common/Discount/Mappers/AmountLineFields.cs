...
namespace PX.Objects.Common.Discount.Mappers
{
	public abstract class AmountLineFields : DiscountedLineMapperBase
	{
		...
		internal static AmountLineFields GetMapFor<TLine>(TLine line, PXCache cache, bool applyQuantityDiscountByBaseUOM)
			where TLine : class, IBqlTable
		{
			return GetMapFor(line, cache, new DiscountEngine.ApplyQuantityDiscountByBaseUOMOption(
				applyQuantityDiscountByBaseUOM, applyQuantityDiscountByBaseUOM));
		}

		internal static AmountLineFields GetMapFor<TLine>(TLine line, PXCache cache,
			...
			DiscountEngine.ApplyQuantityDiscountByBaseUOMOption? applyQuantityDiscountByBaseUOM)
		{
			...
			{
				return applyQuantityDiscountByBaseUOM?.ForAR ?? DiscountEngine.ApplyQuantityDiscountByBaseUOMForAR(cache.Graph)
			...
			{
				return applyQuantityDiscountByBaseUOM?.ForAP ?? DiscountEngine.ApplyQuantityDiscountByBaseUOMForAP(cache.Graph)
