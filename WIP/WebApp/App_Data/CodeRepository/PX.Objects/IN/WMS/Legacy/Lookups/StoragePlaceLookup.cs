...
namespace PX.Objects.IN
{
	...
	public class StoragePlaceLookup : WMSBase
	{
		...
		protected virtual void _(Events.FieldDefaulting<WMSInfo, WMSInfo.message> e) => e.NewValue = Localize(Msg.CommandStorage);
		...
		protected override void ProcessLocationBarcode(string barcode)
		{
			...
			if (storage == null)
			{
				ReportError(Msg.StorageNotFound, barcode);
			}
		...
		public new abstract class Msg : WMSBase.Msg
		{
			...
			public const string StorageNotFound = "The {0} storage is not found.";
		}
		#endregion
	}
}