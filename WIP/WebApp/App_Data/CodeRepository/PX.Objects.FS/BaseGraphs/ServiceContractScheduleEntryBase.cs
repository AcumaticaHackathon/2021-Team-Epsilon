...
namespace PX.Objects.FS
{
        ...
        where TCustomerID : PX.Data.IBqlField
    {
        ...
        public virtual void SetCostCodeDefault(FSScheduleDet fsScheduleDetRow, int? projectID, FSSrvOrdType fsSrvOrdTypeRow, PXFieldDefaultingEventArgs e)
        {
        ...
        protected virtual void _(Events.FieldDefaulting<FSScheduleDet, FSScheduleDet.costCodeID> e)
        {
            ...
            SetCostCodeDefault(fsScheduleDetRow, CurrentServiceContract.Current?.ProjectID, SrvOrdTypeSelected.Current, e.Args);
        }
        ...
        protected virtual void _(Events.RowSelected<FSScheduleDet> e)
        {
            ...
            SharedFunctions.SetEquipmentFieldEnablePersistingCheck(cache, FSScheduleDetRow);
