...
namespace PX.Objects.FS
{
    ...
    public class PostingBatchDetail : IBqlTable
    {
        ...
        {
            public static PostingBatchDetail Find(PXGraph graph, int? batchID, int? postDetID) => FindBy(graph, batchID, postDetID);
        }
        ...
        [PXDBInt(IsKey = true, BqlField = typeof(FSPostDet.postDetID))]
