namespace PX.Objects.AP
{
	...
	public class APDiscountLocation : PX.Data.IBqlTable
	{
		...
		{
			public static APDiscountLocation Find(PXGraph graph, Int32? discountID, string discountSequenceID, Int32? vendorID, Int32? locationID) => FindBy(graph, discountID, discountSequenceID, vendorID, locationID);
		}
