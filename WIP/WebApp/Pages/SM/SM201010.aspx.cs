...
public partial class Page_SM201010 : PX.Web.UI.PXPage
{
	...
	{
		if (tab.Items["saleforceSyncStatus"] != null &&
			(!ds.DataGraph.Views.ContainsKey("SyncRecs") || ds.DataGraph.Views["SyncRecs"].GetItemType().FullName == "PX.SM.SFSyncRecord"))
		{
			tab.Items["saleforceSyncStatus"].Visible = false;
		}
