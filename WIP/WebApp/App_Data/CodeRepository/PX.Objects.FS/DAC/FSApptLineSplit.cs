...
namespace PX.Objects.FS
{
    ...
    public partial class FSApptLineSplit : PX.Data.IBqlTable, ILSDetail
    {
		...
		public static class FK
		{
			...
			public class SiteStatus : IN.INSiteStatus.PK.ForeignKeyOf<FSApptLineSplit>.By<inventoryID, subItemID, siteID> { }
			public class Location : INLocation.PK.ForeignKeyOf<FSApptLineSplit>.By<locationID> { }
			public class LocationStatus : IN.INLocationStatus.PK.ForeignKeyOf<FSApptLineSplit>.By<inventoryID, subItemID, siteID, locationID> { }
			public class LotSerialStatus : IN.INLotSerialStatus.PK.ForeignKeyOf<FSApptLineSplit>.By<inventoryID, subItemID, siteID, locationID, lotSerialNbr> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<FSApptLineSplit>.By<vendorID> { }
			public class POSite : INSite.PK.ForeignKeyOf<FSApptLineSplit>.By<pOSiteID> { }
			public class POOrder : Objects.PO.POOrder.PK.ForeignKeyOf<FSApptLineSplit>.By<pOType, pONbr> { }
			public class POLine : Objects.PO.POLine.PK.ForeignKeyOf<FSApptLineSplit>.By<pOType, pONbr, pOLineNbr> { }
			public class POReceipt : Objects.PO.POReceipt.UK.ForeignKeyOf<FSApptLineSplit>.By<pOReceiptType, pOReceiptNbr> { }
		}
        #endregion
