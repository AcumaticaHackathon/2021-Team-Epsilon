...
namespace PX.Objects.DR
{
	...
	public static class Messages
	{
		...
		public const string TermCantBeNegativeWithTermStartDateValue = "Term End Date must be later than Term Start Date ({0:d}).";
		...
		public const string DRTermStartDateShouldNotBeEmpty = "Term Start Date should be specified to generate deferral transactions.";
		public const string DRTermEndDateShouldNotBeEmpty = "Term End Date should be specified to generate deferral transactions.";
		public const string RecalculateBalanceTooltip = "Recalculate deferred balances based on recognition transactions";
