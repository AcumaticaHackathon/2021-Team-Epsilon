...
namespace PX.Objects.AR
{
	...
	public partial class DiscountItem : PX.Data.IBqlTable
	{
		...
		{
			public class DiscountSequence : AR.DiscountSequence.PK.ForeignKeyOf<DiscountItem>.By<discountID, discountSequenceID> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<DiscountItem>.By<inventoryID> { }
		}
		[Obsolete("Use DiscountItem.FK.DiscountSequence")]
		public class DiscountSequenceFK : DiscountSequence.PK.ForeignKeyOf<DiscountItem>.By<discountID, discountSequenceID> { }
		[Obsolete("Use DiscountItem.FK.Inventory")]
