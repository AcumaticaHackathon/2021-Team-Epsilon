...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXTab ID="form" runat="server" Style="z-index: 100" Width="100%" 
		...
		<px:PXTabItem Text="Properties" LoadOnDemand="true" RepaintOnDemand="false">
			<Template>
				...
				<px:PXGrid ID="visibility" OnRowDataBound="visibility_RowDataBound" OnSyncCellState="visibility_SyncCellState"
				runat="server"  SkinID="Details" Width="100%" SyncPosition="true" 
				FeedbackMode="ForceDataEntry" NoteIndicator="false" FilesIndicator="false">
					...
					<Levels>
						<px:PXGridLevel>
							<Columns >
								...
								<px:PXGridColumn DataField="DefaultValue" Width="250px" MatrixMode="True" AllowNull="True" RenderEditorText="False" CommitChanges="true" AllowFilter="false" AllowSort="false"><Header Text="Default" /></px:PXGridColumn>
							</Columns>
							</px:PXGridLevel>
					</Levels>
				</px:PXGrid>
