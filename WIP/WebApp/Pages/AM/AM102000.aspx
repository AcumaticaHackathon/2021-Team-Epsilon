		...
		<Items>
			<px:PXTabItem Text="General Settings">
                <Template>
                    ...
                    <px:PXCheckBox ID="edUseShiftCrewSize" runat="server" DataField="UseShiftCrewSize" />
                    ...
                    <px:PXSelector ID="edCTPOrderType" runat="server" DataField="CTPOrderType" AllowEdit="True" CommitChanges="true" />
