...
namespace PX.Objects.IN
{
	...
	public class INScanSetup : IBqlTable
	{
		...
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<INScanSetup>.By<branchID> { }
			public class InventoryLabelsReport : SiteMap.PK.ForeignKeyOf<INScanSetup>.By<inventoryLabelsReportID> { }
		}
		#endregion
