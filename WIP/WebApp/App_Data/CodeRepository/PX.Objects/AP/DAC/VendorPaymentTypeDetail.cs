namespace PX.Objects.AP
{
	...
	public partial class VendorPaymentMethodDetail : PX.Data.IBqlTable
	{
		...
		{
			public static VendorPaymentMethodDetail Find(PXGraph graph, Int32? bAccountID, Int32? locationID, string paymentMethodID, String detailID) => FindBy(graph, bAccountID, locationID, paymentMethodID, detailID);
		}
