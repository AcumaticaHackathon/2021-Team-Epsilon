namespace PX.Objects.AR
{
    ...
    {
      #region Keys
      public class PK : PrimaryKeyOf<ARInvoiceDiscountDetail>.By<docType, refNbr, recordID>
      {
         public static ARInvoiceDiscountDetail Find(PXGraph graph, string docType, string refNbr, Int32? recordID) => FindBy(graph, docType, refNbr, recordID);
      }
      public static class FK
		{
         public class Discount : AR.ARDiscount.PK.ForeignKeyOf<ARInvoiceDiscountDetail>.By<discountID> { }
         ...
         public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ARInvoiceDiscountDetail>.By<curyInfoID> { }
         public class FreeItem : IN.InventoryItem.PK.ForeignKeyOf<ARInvoiceDiscountDetail>.By<freeItemID> { }
      }
		#endregion
