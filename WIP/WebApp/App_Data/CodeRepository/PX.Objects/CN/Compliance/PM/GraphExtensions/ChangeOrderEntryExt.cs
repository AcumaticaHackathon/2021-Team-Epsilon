...
{
    public class ChangeOrderEntryExt : PXGraphExtension<ComplianceViewEntityExtension<ChangeOrderEntry, PMChangeOrder>, ChangeOrderEntry>
    {
        ...
        protected virtual void _(Events.CacheAttached<ComplianceDocument.costTaskID> e)
        {
        }
        ...
        [PXSelector(typeof(Search5<PMTask.taskID,
            ...
            SubstituteKey = typeof(PMTask.taskCD),
            DescriptionField = typeof(PMTask.description))]
        protected virtual void _(Events.CacheAttached<ComplianceDocument.revenueTaskID> e)
        {
        }
        ...
        protected virtual void _(Events.CacheAttached<ComplianceDocument.costCodeID> e)
        {
        }
