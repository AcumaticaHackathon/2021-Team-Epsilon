...
RecognizedValue.prototype._initOcrBoundingBoxes = function (boundingBoxes) {
    ...
    boundingBoxes.forEach(function (box) {
        ...
        if (coordinates !== null) {
            that._addRectangle(page.unit, page.width, page.height, coordinates, container.width, container.height);
...
RecognizedValue.prototype._initWordBoundingBox = function (word, wordIndex, pageIndex) {
    ...
    this._addRectangle(page.unit, page.width, page.height, coordinates, container.width, container.height);
...
RecognizedValue.prototype._addRectangle = function (unit, pageWidth, pageHeight, coordinates, containerWidth, containerHeight) {
    const rect = new RecognizedRectangle(unit, pageWidth, pageHeight, coordinates, containerWidth, containerHeight);
