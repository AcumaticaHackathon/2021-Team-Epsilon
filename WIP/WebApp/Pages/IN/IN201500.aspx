...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INAvailabilitySchemeMaint" PrimaryView="Schemes" HeaderDescriptionField="Description">
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Schemes" Style="z-index: 100" Width="100%">
		<Template>
			...
			<px:PXCheckBox runat="server" AlignLeft="True" DataField="InclQtyProductionDemandPrepared" ID="chkInclQtyProductionDemandPrepared" />
			<px:PXCheckBox runat="server" AlignLeft="True" DataField="InclQtyProductionDemand" ID="chkInclQtyProductionDemand" />
			<px:PXCheckBox runat="server" AlignLeft="True" DataField="InclQtyProductionAllocated" ID="chkInclQtyProductionAllocated" />
			...
			<px:PXCheckBox runat="server" AlignLeft="True" DataField="InclQtyProductionSupplyPrepared" ID="chkInclQtyProductionSupplyPrepared" />
			<px:PXCheckBox runat="server" AlignLeft="True" DataField="InclQtyProductionSupply" ID="chkInclQtyProductionSupply" />
		</Template>
