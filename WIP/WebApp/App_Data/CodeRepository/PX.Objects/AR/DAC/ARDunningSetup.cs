namespace PX.Objects.AR
{
    ...
    {
      #region Keys
      public class PK : PrimaryKeyOf<ARDunningSetup>.By<dunningLetterLevel>
      {
         public static ARDunningSetup Find(PXGraph graph, Int32? dunningLetterLevel) => FindBy(graph, dunningLetterLevel);
      }
      #endregion
