...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.SO.SOOrderTypeMaint" PrimaryView="soordertype" HeaderDescriptionField="Descr">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="soordertype" Caption="Order Type Settings"
        ...
        <Template>
            ...
            <px:PXSelector CommitChanges="True" ID="edTemplate" runat="server" DataField="Template" />
        </Template>
    </px:PXFormView>
        ...
        <Items>
            <px:PXTabItem Text="General Settings">
                <Template>
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Intercompany Posting Settings" />
                    <px:PXDropDown ID="edIntercompanySalesAcctDefault" runat="server" AllowNull="False" DataField="IntercompanySalesAcctDefault" />
                    <px:PXDropDown ID="edIntercomapnyCOGSAcctDefault" runat="server" AllowNull="False" DataField="IntercompanyCOGSAcctDefault" />
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Manufacturing Settings" />
                    <px:PXCheckBox runat="server" ID="edAMProductionOrderEntry" DataField="AMProductionOrderEntry" />
					<px:PXCheckBox runat="server" ID="edAMProductionOrderEntryOnHold" DataField="AMProductionOrderEntryOnHold" />
					<px:PXCheckBox runat="server" ID="edAMEstimateEntry" DataField="AMEstimateEntry" />
					<px:PXCheckBox runat="server" ID="chkAMConfigurationEntry" DataField="AMConfigurationEntry" />
					<px:PXCheckBox runat="server" ID="edAMEnableWarehouseLinkedProduction" DataField="AMEnableWarehouseLinkedProduction" />
					<px:PXCheckBox runat="server" ID="edAMMTOOrder" DataField="AMMTOOrder" />
                </Template>
            </px:PXTabItem>
