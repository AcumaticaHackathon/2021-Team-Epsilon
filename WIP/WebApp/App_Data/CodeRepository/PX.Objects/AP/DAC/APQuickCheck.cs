...
namespace PX.Objects.AP.Standalone
{
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<APQuickCheck>.By<docType, refNbr>
		{
			public static APQuickCheck Find(PXGraph graph, string docType, string refNbr) => FindBy(graph, docType, refNbr);
		}
		public new static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<APQuickCheck>.By<branchID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APQuickCheck>.By<vendorID> { }

			public class VendorLocation : CR.Location.PK.ForeignKeyOf<APQuickCheck>.By<vendorID, vendorLocationID> { }

			public class SuppliedByVendor : AP.Vendor.PK.ForeignKeyOf<APQuickCheck>.By<suppliedByVendorID> { }
			public class SuppliedByVendorLocation : CR.Location.PK.ForeignKeyOf<APQuickCheck>.By<suppliedByVendorID, suppliedByVendorLocationID> { }

			public class RemittanceAddress : CR.Address.PK.ForeignKeyOf<APQuickCheck>.By<remitAddressID> { }
			public class RemittanceContact : CR.Contact.PK.ForeignKeyOf<APQuickCheck>.By<remitContactID> { }

			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<APQuickCheck>.By<curyInfoID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<APQuickCheck>.By<curyID> { }
			public class APAccount : GL.Account.PK.ForeignKeyOf<APQuickCheck>.By<aPAccountID> { }
			public class APSubaccount : GL.Sub.PK.ForeignKeyOf<APQuickCheck>.By<aPSubID> { }
			public class Schedule : GL.Schedule.PK.ForeignKeyOf<APQuickCheck>.By<scheduleID> { }
			...
			public class Terms : CS.Terms.PK.ForeignKeyOf<APQuickCheck>.By<termsID> { }
		}
		#endregion

		public new class Events : PXEntityEvent<APQuickCheck>.Container<Events>
		{
			public PXEntityEvent<APQuickCheck> UpdateStatus;
		}
