...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<Batch>.By<module, batchNbr>
		{
			public static Batch Find(PXGraph graph, String module, String batchNbr) => FindBy(graph, module, batchNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<Batch>.By<branchID> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<Batch>.By<ledgerID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<Batch>.By<curyInfoID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<Batch>.By<curyID> { }
			public class OriginalBatch : Batch.PK.ForeignKeyOf<Batch>.By<origModule, origBatchNbr> { }
			public class Schedule : GL.Schedule.PK.ForeignKeyOf<Batch>.By<scheduleID> { }
		}
		#endregion
		...
		#endregion
		#region Events
		public class Events : PXEntityEvent<Batch>.Container<Events>
		{
			public PXEntityEvent<Batch, GL.Schedule> ConfirmSchedule;
			public PXEntityEvent<Batch, GL.Schedule> VoidSchedule;
			public PXEntityEvent<Batch> ReleaseBatch;
			public PXEntityEvent<Batch> PostBatch;
			public PXEntityEvent<Batch> UpdateStatus;
		}
		#endregion
		#region BranchID
