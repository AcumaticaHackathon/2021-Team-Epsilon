...
namespace PX.Objects.CT
{
	...
	public partial class ContractTemplate : Contract
	{
		...
		{
			public static ContractTemplate Find(PXGraph graph, int? contractID) => FindBy(graph, contractID);
		}
		public new class UK : PrimaryKeyOf<ContractTemplate>.By<baseType, contractCD>
		{
			public static ContractTemplate Find(PXGraph graph, string baseType, string contractCD) => FindBy(graph, baseType, contractCD);
		}
