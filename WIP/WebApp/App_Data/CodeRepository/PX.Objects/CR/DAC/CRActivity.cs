...
namespace PX.Objects.CR
{
	...
	public partial class CRParentActivity : CRActivity
	{
		...
		{
			public static CRParentActivity Find(PXGraph graph, Guid noteID) => FindBy(graph, noteID);
		}
		#endregion
	}
	...
	public partial class CRActivity : IBqlTable, IAssign, INotable
	{
		...
		{
			public static CRActivity Find(PXGraph graph, Guid? noteID) => FindBy(graph, noteID);
		}
		...
		public static class FK
		{
			...
			/// Owner
			/// </summary>
			public class Owner : EP.EPEmployee.PK.ForeignKeyOf<CRActivity>.By<ownerID> { }
