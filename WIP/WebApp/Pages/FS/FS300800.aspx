...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="ServiceContractRecords" 
		...
		<CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ActivatePeriod" Visible="False" CommitChanges="True"></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="OpenRouteScheduleScreenByScheduleDetService" Visible="False" CommitChanges="True"></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="OpenRouteScheduleScreenByScheduleDetPart" Visible="False" CommitChanges="True"></px:PXDSCallbackCommand>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
        Width="100%" Caption="Service Contract" BPEventsIndicator="True" FilesIndicator="True"
        ActivityIndicator="True" NoteIndicator="True" DataMember="ServiceContractRecords" DefaultControlID="edCustomerID" AllowColapse="True" AllowCollapse="True">
        <Template>
            ...
            <px:PXSegmentMask ID="edCustomerID" runat="server" DataField="CustomerID" AllowEdit="True" AllowAddNew="True" CommitChanges="True" AutoRefresh="true">
            </px:PXSegmentMask>
            ...
            <px:PXSegmentMask ID="edProjectID" runat="server" AutoRefresh="True" CommitChanges="True" DataField="ProjectID" AllowEdit="True" AllowAddNew="True">
            </px:PXSegmentMask>
            ...
            <px:PXDropDown ID="edUpcomming" runat="server" DataField="UpcomingStatus">
            </px:PXDropDown>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="100%" DataSourceID="ds" 
		...
		<Items>
			    ...
			    <Template>
					...
					<px:PXFormView runat="server" Caption="Location"
                        ...
                        <Template>
                            ...
                            <px:PXSelector ID="edCustomerContactID" runat="server" DataField="CustomerContactID" AllowEdit="True" AutoRefresh="True" CommitChanges="True"/>
                            ...
                            <px:PXSegmentMask ID="edBillCustomerID" runat="server" DataField="BillCustomerID" AllowEdit="True" AllowAddNew="True" CommitChanges="True" AutoRefresh="True">
                            </px:PXSegmentMask>
            ...
            <px:PXTabItem Text="Services per Period" LoadOnDemand="True" RepaintOnDemand="True" BindingContext="form" VisibleExp="DataControls[&quot;edShowPriceTab&quot;].Value == false">
                <Template>
					...
					FilesIndicator="False" NoteIndicator="False" Height="200px" TabIndex="11300" DataSourceID="ds" SyncPosition="True" MatrixMode="True">
                        <Levels>
                            <px:PXGridLevel DataMember="ContractPeriodDetRecords" DataKeyNames="ContractPeriodDetID,InventoryID,SMEquipmentID">
                                <Columns>
                                ...
                                <RowTemplate>
                                    <px:PXDropDown runat="server" ID="edSBP_LineType" DataField="LineType" />
            ...
            <px:PXTabItem Text="Billing Documents" BindingContext="form" LoadOnDemand="True" RepaintOnDemand="False" VisibleExp="DataControls[&quot;edShowPriceTab&quot;].Value == false">
                <Template>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="InvoiceRecords" DataKeyNames="RecordID">
                                <RowTemplate>
                                    ...
                                    <px:PXDropDown ID="edBillPeriodStatus" runat="server" DataField="ContractPeriodStatus" />
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ContractPeriodStatus" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="SalesPriceID,InventoryItem__InventoryCD" DataMember="SalesPriceLines">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Mem_UnitPrice" TextAlign="Right" CommitChanges="True">
                                    </px:PXGridColumn>
