...
namespace PX.Objects.FS
{
	...
	public class FSGeoZone : PX.Data.IBqlTable
	{
        ...
        {
            public static FSGeoZone Find(PXGraph graph, int? geoZoneID) => FindBy(graph, geoZoneID);
        }

        public class UK : PrimaryKeyOf<FSGeoZone>.By<geoZoneCD>
        {
            public static FSGeoZone Find(PXGraph graph, string geoZoneCD) => FindBy(graph, geoZoneCD);
        }
