		...
		<Items>
			<px:PXTabItem Text="Screen Aspx">
				<Template>
					...
					<px:PXHtmlView NoFrame="true" runat="server" ID="AspxCode" DataField="AspxCode" Width="100%" Height="300px"
			...
			<px:PXTabItem Text="Business Logic">
				<Template>
					...
					<px:PXSplitContainer AllowAutoHide="False" ID="SplitSource" runat="server" Orientation="Vertical" Width="100%" Style="bottom: 0px;">
						...
						<Template1>
							<px:PXHtmlView runat="server" NoFrame="true" ID="TableOfContent" DataField="TableOfContent" Width="100%" Height="300px" Style="white-space: nowrap; overflow: auto;">
								<AutoSize Enabled="True" Container="Parent"></AutoSize>
							</px:PXHtmlView>
						...
						<Template2>
							<px:PXHtmlView runat="server" NoFrame="true" ID="ReadonlyEventSource" DataField="ReadonlyEventSource" Width="100%" Height="300px"
								Style="white-space: pre; font-family: 'Courier New', monospace; font-size: 10pt; line-height: 16px;">
								<AutoSize Enabled="True" Container="Parent"></AutoSize>
							</px:PXHtmlView>
			...
			<px:PXTabItem Text="Data Access">
				<Template>
					...
					<px:PXHtmlView runat="server" NoFrame="true" ID="GeneratedDacSource" DataField="GeneratedDacSource" Width="100%" Height="300px"
						Style="white-space: pre; font-family: 'Courier New', monospace; font-size: 10pt; line-height: 16px;">
						<AutoSize Enabled="True" Container="Parent"></AutoSize>
					</px:PXHtmlView>
						...
						<Template2>
							...
							<px:PXFormView ID="PXFormView1" runat="server" DataMember="filter" SkinID="Transparent" Width="100%" Height="300px">
								...
								<Template>
									...
									<px:PXHtmlView runat="server" NoFrame="true" ID="SourceFile" DataField="SourceFile" Width="100%" Height="300px" Style="white-space: pre; font-family: 'Courier New', monospace; font-size: 10pt; line-height: 16px;">
										<AutoSize Enabled="True" Container="Parent"></AutoSize>
									</px:PXHtmlView>
								</Template>
