...
namespace PX.Objects.PO
{
	...
	public partial class POOrder : PX.Data.IBqlTable, PX.Data.EP.IAssign
	{
		...
		public static class FK
		{
			...
			public class Owner : EPEmployee.PK.ForeignKeyOf<POOrder>.By<employeeID> { }
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use RemittanceAddress instead.")]
			public class RemitAddress : RemittanceAddress { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use RemittanceContact instead.")]
			public class RemitContact : RemittanceContact { }
		...
		[PXDefault((object)null, typeof(Coalesce<
			Search<LocationBranchSettings.vSiteID, Where<Current<POOrder.shipDestType>, Equal<POShippingDestination.site>,
			...
			Search<Location.vSiteID, Where<Current<POOrder.shipDestType>, Equal<POShippingDestination.site>,
	...
	public class POOrderStatus
	{
		...
		public const string Balanced = PendingApproval;
		[Obsolete(Common.Messages.ItemIsObsoleteAndWillBeRemoved2022R1)]
