...
namespace PX.Objects.AM
{
    ...
    public class AMMTran : IBqlTable, ILSPrimary, IProdOper, IAMBatch, INotable
    {
        ...
        #endregion
        #region TranTypeChanged
        /// <summary>
        /// Returns true if the trantype has been changed. This is used when deleting splits to make sure tran isn't recalculated
        /// </summary>
        public abstract class tranTypeChanged : PX.Data.BQL.BqlBool.Field<tranTypeChanged> { }

        protected bool? _TranTypeChanged;
        /// <summary>
        /// Returns true if the splits associated with the line has mixed ProjectTask values.
        /// This field is used to validate the record on persist. 
        /// Project/Task is not implemented for Manufacturing. Including fields as a 5.30.0663 or greater requirement for the class that implements ILSPrimary/ILSMaster
        ...
        public virtual bool? TranTypeChanged
        {
            get
            {
                return _TranTypeChanged;
            }
            set
            {
                _TranTypeChanged = value;
            }
        }
        #endregion
    ...
    [PXHidden]
    [Serializable]
    [PXProjection(typeof(Select4<AMMTran, 
        Aggregate<GroupBy<AMMTran.docType, GroupBy<AMMTran.batNbr, GroupBy<AMMTran.orderType, GroupBy<AMMTran.prodOrdID>>>>>>), Persistent = false)]
    public class AMMTranProductionOrder : IBqlTable
    {
        #region DocType
