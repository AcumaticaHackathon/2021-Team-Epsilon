...
namespace PX.Commerce.Shopify
{
	...
	public class BCBindingShopify : IBqlTable
	{
		...
		public abstract class shopifyPOS : IBqlField { }
		#endregion
		...
		[PXSelector(
			typeof(Search<SOOrderType.orderType,
				Where<SOOrderType.active, Equal<True>,
					And<SOOrderType.behavior, Equal<SOOrderTypeConstants.invoiceOrder>, And<SOOrderType.aRDocType, Equal<ARDocType.invoice>>>>>),
			DescriptionField = typeof(SOOrderType.descr))]
		[PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
		public virtual string POSDirectOrderType { get; set; }
		public abstract class pOSDirectOrderType : IBqlField { }
		#endregion
		...
		[PXSelector(
			typeof(Search<SOOrderType.orderType,
				Where<SOOrderType.active, Equal<True>,
					And<SOOrderType.behavior, Equal<SOOrderTypeConstants.salesOrder>, And<SOOrderType.aRDocType, Equal<ARDocType.invoice>>>>>),
			DescriptionField = typeof(SOOrderType.descr))]
		[PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
		public virtual string POSShippingOrderType { get; set; }
		public abstract class pOSShippingOrderType : IBqlField { }
		#endregion
