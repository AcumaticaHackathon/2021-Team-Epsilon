...
namespace PX.Objects.PM
{
	public class AllocationMaint : PXGraph<AllocationMaint, PMAllocation>
	{
		...
		protected virtual bool ValidateErrors(PMAllocationDetail step)
		{
			...
			{
				valid = false;
				Step.Cache.RaiseExceptionHandling<PMAllocationDetail.sourceBranchID>(step, step.SourceBranchID, new PXSetPropertyException(ErrorMessages.FieldIsEmpty, $"[{nameof(PMAllocationDetail.sourceBranchID)}]"));
			}
