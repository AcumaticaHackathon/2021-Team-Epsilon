...
namespace PX.Objects.IN.S
{
	...
	public partial class INItemSite : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class InventoryAccount : Account.PK.ForeignKeyOf<INItemSite>.By<invtAcctID> { }
			...
			public class PreferredVendorLocation : CR.Location.PK.ForeignKeyOf<INItemSite>.By<preferredVendorID, preferredVendorLocationID> { }
			...
			public class ReplenishmentSourceSite : INSite.PK.ForeignKeyOf<INItemSite>.By<replenishmentSourceSiteID> { }
