...
namespace PX.Objects.AP
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<APVendorPrice>.By<recordID>
		{
			public static APVendorPrice Find(PXGraph graph, Int32? recordID) => FindBy(graph, recordID);
		}
		public static class FK
		{
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APVendorPrice>.By<vendorID> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<APVendorPrice>.By<inventoryID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<APVendorPrice>.By<curyID> { }
			public class Site : INSite.PK.ForeignKeyOf<APVendorPrice>.By<siteID> { }
		}
		#endregion
