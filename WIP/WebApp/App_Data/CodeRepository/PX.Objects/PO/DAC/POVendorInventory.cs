...
namespace PX.Objects.PO
{
	...
	public partial class POVendorInventory : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class SubItem : INSubItem.PK.ForeignKeyOf<POVendorInventory>.By<subItemID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<POVendorInventory>.By<vendorID> { }
			public class VendorLocation : Location.PK.ForeignKeyOf<POVendorInventory>.By<vendorID, vendorLocationID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<POVendorInventory>.By<curyID> { }
			//todo public class PurchaseUnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<POVendorInventory>.By<inventoryID, purchaseUnit> { }
		}
		#endregion
