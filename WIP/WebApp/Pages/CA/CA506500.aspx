...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" Caption="Selection" DataMember="filter">
        <Template>
            ...
            <px:PXSelector CommitChanges="True" ID="edBranch" runat="server" DataField="BranchID" InitialExpandLevel="0" />
            <px:PXSelector CommitChanges="True" runat="server" DataField="EntryTypeID" ID="edEntryTypeID" />
            <px:PXSegmentMask CommitChanges="True" runat="server" DataField="AccountID" ID="edAccountID" AutoRefresh="True"  />            
            ...
            <px:PXCheckBox CommitChanges="True" runat="server" SuppressLabel="true" DataField="CopyDescriptionfromDetails" ID="chkCopyDescriptionfromDetails" />
        </Template>
    </px:PXFormView>
</asp:Content>
