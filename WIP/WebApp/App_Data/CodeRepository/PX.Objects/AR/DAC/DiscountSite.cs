...
namespace PX.Objects.AR
{
	...
	public partial class DiscountSite : PX.Data.IBqlTable
    {
      ...
      {
         public class DiscountSequence : AR.DiscountSequence.PK.ForeignKeyOf<DiscountSite>.By<discountID, discountSequenceID> { }
         public class Site : INSite.PK.ForeignKeyOf<DiscountSite>.By<siteID> { }
      }
      [Obsolete("Use DiscountSite.FK.DiscountSequence")]
      public class DiscountSequenceFK : DiscountSequence.PK.ForeignKeyOf<DiscountSite>.By<discountID, discountSequenceID> { }
      [Obsolete("Use DiscountSite.FK.Site")]
