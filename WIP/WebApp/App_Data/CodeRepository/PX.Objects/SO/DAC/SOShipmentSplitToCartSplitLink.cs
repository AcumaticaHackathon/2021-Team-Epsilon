...
namespace PX.Objects.SO
{
	...
	public class SOShipmentSplitToCartSplitLink : IBqlTable
	{
		...
		{
			public static SOShipmentSplitToCartSplitLink Find(PXGraph graph, string shipmentNbr, int? shipmentLineNbr, int? shipmentSplitLineNbr, int? siteID, int? cartID, int? cartSplitLineNbr)
				=> FindBy(graph, shipmentNbr, shipmentLineNbr, shipmentSplitLineNbr, siteID, cartID, cartSplitLineNbr);
		}
