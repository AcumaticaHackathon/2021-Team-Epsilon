...
namespace PX.Objects.AP
{
	...
	public static class Messages
	{
		...
		public const string EntityCannotBeAssociated = "An entity with the base currency other than {0} cannot be associated with the {1} account.";
		...
		public const string NotLinked = "The line is not linked to a purchase order line. You can click the Link Line button to select a purchase order line.";
		public const string Linked = "Linked";
		public const string MultiplePOLinesFound = "Multiple purchase order lines have been found. You can click the Link Line button to select a purchase order line.";
		public const string MultiplePRLinesFound = "Multiple purchase receipt lines have been found. You can click the Link Line button to select a purchase receipt line.";
		...
		public static string ViewIntercompanyBill = "View AP Document";
		public static string GenerateIntercompanyBill = "Generate AP Document";
		public static string WaitingTimeExceeded = "Waiting time exceeded";
		public const string RecognitionServiceNoResult = "The recognition service did not return any result, contact your Acumatica support provider for assistance.";
