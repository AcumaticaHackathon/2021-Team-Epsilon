...
namespace PX.Objects.AP
{
    ...
    {
        #region Keys
        public new class PK : PrimaryKeyOf<VendorDiscountSequence>.By<vendorID, discountID, discountSequenceID>
		{
            public static VendorDiscountSequence Find(PXGraph graph, int? vendorID, string discountID, string discountSequenceID)
                => FindBy(graph, vendorID, discountID, discountSequenceID);
        }
        public class UK : PrimaryKeyOf<VendorDiscountSequence>.By<discountID, discountSequenceID>
        {
            public static VendorDiscountSequence Find(PXGraph graph, string discountID, string discountSequenceID)
