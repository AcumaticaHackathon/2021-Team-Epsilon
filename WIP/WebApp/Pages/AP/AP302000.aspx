...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" runat="server" UDFTypeField="DocType" Visible="True" Width="100%" TypeName="PX.Objects.AP.APPaymentEntry" PrimaryView="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Visible="False" CommitChanges="True" Name="ReloadJointPayees" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
                ...
                <Template>
                    <px:PXGrid runat="server" SyncPosition="True" KeepPosition="True" Height="300px" SkinID="DetailsInTab" Width="100%" ID="grdJointPayees" DataSourceID="ds" AllowPaging="True" PageSize="12" NoteIndicator="False" FilesIndicator="False">
                        ...
                        <ActionBar>
                            ...
                            <CustomItems>
                                <px:PXToolBarButton Text="Reload Joint Payees">
                                    <AutoCallBack Command="ReloadJointPayees" Target="ds">
                                        <Behavior CommitChanges="True" />
                                    </AutoCallBack>
                                </px:PXToolBarButton>
                            </CustomItems>
