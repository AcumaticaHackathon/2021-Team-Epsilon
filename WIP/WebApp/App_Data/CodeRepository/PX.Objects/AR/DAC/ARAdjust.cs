...
namespace PX.Objects.AR
{
		...
		: IBqlTable, IAdjustment, IDocumentAdjustment, IAdjustmentAmount
	{
		...
		{
			public class Payment : AR.ARRegister.PK.ForeignKeyOf<ARAdjust>.By<adjgDocType, adjgRefNbr> { }
			public class PaymentCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ARAdjust>.By<adjgCuryInfoID> { }
			public class PaymentBranch : GL.Branch.PK.ForeignKeyOf<ARAdjust>.By<adjgBranchID> { }
			public class PaymentCustomer : AR.Customer.PK.ForeignKeyOf<ARAdjust>.By<customerID> { }
			public class Invoice : AR.ARRegister.PK.ForeignKeyOf<ARAdjust>.By<adjdDocType, adjdRefNbr> { }
			public class InvoiceCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ARAdjust>.By<adjdCuryInfoID> { }
			public class InvoiceBranch : GL.Branch.PK.ForeignKeyOf<ARAdjust>.By<adjdBranchID> { }
			public class InvoiceCustomer : AR.Customer.PK.ForeignKeyOf<ARAdjust>.By<adjdCustomerID> { }
			public class SOOrder : SO.SOOrder.PK.ForeignKeyOf<ARAdjust>.By<adjdOrderType, adjdOrderNbr> { }
			public class OrderCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ARAdjust>.By<adjdOrigCuryInfoID> { }
		}
		#endregion
		...
		[PXParent(typeof(Select<ARPaymentTotals,
			Where<ARPaymentTotals.docType, Equal<Current<ARAdjust.adjgDocType>>,
				And<ARPaymentTotals.refNbr, Equal<Current<ARAdjust.adjgRefNbr>>>>>), ParentCreate = true, LeaveChildren = true)]
		...
		[PXRestrictor(typeof(Where<SOInvoice.hasLegacyCCTran, NotEqual<True>, Or<SOInvoice.hasLegacyCCTran, IsNull>>),
			SO.Messages.CantProcessSOInvoiceBecauseItHasLegacyCCTran, typeof(SOInvoice.refNbr))]
		[ARInvoiceType.AdjdRefNbr(typeof(Search2<ARInvoice.refNbr,
			...
			Where<ARInvoice.docType, Equal<Optional<ARAdjust.adjdDocType>>,
				And2<Where<ARInvoice.released, Equal<True>, Or<ARInvoice.origModule, Equal<BatchModule.moduleSO>>>,
				And2<Not<ARInvoice.released, Equal<False>,
								And<Current<ARRegister.docType>, Equal<ARDocType.creditMemo>,
								And<Current<ARRegister.released>, Equal<False>>>>,
		...
		[CopyChildLink(typeof(ARPaymentTotals.invoiceCntr), typeof(curyAdjdAmt),
			new Type[] { typeof(adjdDocType), typeof(adjdRefNbr) },
		...
		[PXRestrictor(typeof(Where<ARInvoice.paymentsByLinesAllowed, Equal<True>,
					And<ARTran.curyTranBal, NotEqual<decimal0>>>), ErrorMessages.ElementDoesntExist, typeof(ARTran.lineNbr))]
	...
	[PXDefault(typeof(ARPayment.adjCntr))]
		...
		[PXDBBool]
		[DenormalizedFrom(
			new[] { typeof(ARPayment.isCCPayment), typeof(ARPayment.pendingProcessing), typeof(ARPayment.released), typeof(ARPayment.isCCAuthorized), typeof(ARPayment.isCCCaptured), typeof(ARPayment.isCCCaptureFailed) },
			new[] { typeof(isCCPayment), typeof(paymentPendingProcessing), typeof(paymentReleased), typeof(isCCAuthorized), typeof(isCCCaptured), typeof(paymentCaptureFailed) },
			defaultValues: new object[] { false, false, false, false, false, false })]
		...
		#endregion
		#region PaymentPendingProcessing
		public abstract class paymentPendingProcessing : Data.BQL.BqlBool.Field<paymentPendingProcessing> { }
		[PXDBBool]
		public virtual bool? PaymentPendingProcessing
		{
			get;
			set;
		}
		...
		#endregion
		#region PaymentCaptureFailed
		public abstract class paymentCaptureFailed : Data.BQL.BqlBool.Field<paymentCaptureFailed> { }
		[PXDBBool]
		public virtual bool? PaymentCaptureFailed
		{
			get;
			set;
		}
	...
	public partial class ARAdjust2 : PX.Objects.AR.ARAdjust, ICreatePaymentAdjust
	{
		#region Keys
		public new class PK : PrimaryKeyOf<ARAdjust2>.By<adjgDocType, adjgRefNbr, adjNbr, adjdDocType, adjdRefNbr, adjdLineNbr>
		{
			public static ARAdjust2 Find(PXGraph graph, String adjgDocType, String adjgRefNbr, Int32? adjNbr, String adjdDocType, String adjdRefNbr, Int32? adjdLineNbr)
														=> FindBy(graph, adjgDocType, adjgRefNbr, adjNbr, adjdDocType, adjdRefNbr, adjdLineNbr);
		}
		public new static class FK
		{
			public class PaymentCustomer : AR.Customer.PK.ForeignKeyOf<ARAdjust2>.By<customerID> { }
			public class Payment : AR.ARRegister.PK.ForeignKeyOf<ARAdjust2>.By<adjgDocType, adjgRefNbr> { }
			public class PaymentCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ARAdjust2>.By<adjgCuryInfoID> { }
			public class PaymentBranch : GL.Branch.PK.ForeignKeyOf<ARAdjust2>.By<adjgBranchID> { }
			public class Invoice : AR.ARRegister.PK.ForeignKeyOf<ARAdjust2>.By<adjdDocType, adjdRefNbr> { }
			public class InvoiceCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ARAdjust2>.By<adjdCuryInfoID> { }
			public class InvoiceBranch : GL.Branch.PK.ForeignKeyOf<ARAdjust2>.By<adjdBranchID> { }
		}
		#endregion
		...
		[PXParent(typeof(Select<ARPayment,
			Where<ARPayment.docType, Equal<Current<adjgDocType>>,
				And<ARPayment.refNbr, Equal<Current<adjgRefNbr>>>>>), LeaveChildren = true)]
		[PXParent(typeof(Select<ARPaymentTotals,
			Where<ARPaymentTotals.docType, Equal<Current<ARAdjust2.adjgDocType>>,
				And<ARPaymentTotals.refNbr, Equal<Current<ARAdjust2.adjgRefNbr>>>>>), ParentCreate = true, LeaveChildren = true)]
		...
		[PXUnboundFormula(
			typeof(Switch<Case<Where<curyAdjdAmt, NotEqual<decimal0>,
				And<paymentPendingProcessing, Equal<True>,
				And<paymentCaptureFailed, NotEqual<True>>>>, int1>, int0>),
			typeof(SumCalc<AR.ARInvoice.pendingProcessingCntr>),
			ForceAggregateRecalculation = true)]
		[PXUnboundFormula(
			typeof(Switch<Case<Where<curyAdjdAmt, NotEqual<decimal0>,
				And<paymentCaptureFailed, Equal<True>>>, int1>, int0>),
			typeof(SumCalc<AR.ARInvoice.captureFailedCntr>),
			ForceAggregateRecalculation = true)]
		[CopyChildLink(typeof(ARPaymentTotals.invoiceCntr), typeof(curyAdjdAmt),
			new Type[] { typeof(adjdDocType), typeof(adjdRefNbr) },
			new Type[] { typeof(ARPaymentTotals.adjdDocType), typeof(ARPaymentTotals.adjdRefNbr) })]
		...
		[PXDBLong()]
		[CurrencyInfo(typeof(AR.ARInvoice.curyInfoID), ModuleCode = BatchModule.AR, CuryIDField = "AdjdOrigCuryID")]
		...
		[PXUnboundFormula(
			...
			typeof(SumCalc<AR.ARInvoice.curyBalanceWOTotal>))]
		...
		[PXDefault(TypeCode.Decimal, "0.0")]
		[PXUnboundFormula(
			typeof(Switch<Case<Where<voided, Equal<False>>, curyAdjdAmt>, decimal0>),
			typeof(SumCalc<AR.ARInvoice.curyPaymentTotal>))]
		[PXUnboundFormula(
			typeof(Switch<Case<Where<voided, Equal<False>, And<released, Equal<False>, And<paymentReleased, Equal<False>, And<isCCAuthorized, Equal<False>>>>>,
				curyAdjdAmt>, decimal0>),
			typeof(SumCalc<AR.ARInvoice.curyUnreleasedPaymentAmt>),
			ForceAggregateRecalculation = true)]
		[PXUnboundFormula(
			typeof(Switch<Case<Where<voided, Equal<False>, And<released, Equal<False>, And<paymentReleased, Equal<False>, And<isCCAuthorized, Equal<True>>>>>,
				curyAdjdAmt>, decimal0>),
			typeof(SumCalc<AR.ARInvoice.curyCCAuthorizedAmt>))]
		[PXUnboundFormula(
			typeof(Switch<Case<Where<voided, Equal<False>, And<released, Equal<False>, And<paymentReleased, Equal<True>>>>,
				curyAdjdAmt>, decimal0>),
			typeof(SumCalc<AR.ARInvoice.curyPaidAmt>))]
        [PXFormula(null, typeof(SumCalc<SOAdjust.curyAdjdBilledAmt>))]
		...
		#region IsCCPayment
		public new abstract class isCCPayment : Data.BQL.BqlBool.Field<isCCPayment> { }
		[PXDBBool]
		[DenormalizedFrom(
			new[] { typeof(ARPayment.isCCPayment), typeof(ARPayment.pendingProcessing), typeof(ARPayment.released), typeof(ARPayment.isCCAuthorized), typeof(ARPayment.isCCCaptured), typeof(ARPayment.isCCCaptureFailed) },
			new[] { typeof(isCCPayment), typeof(paymentPendingProcessing), typeof(paymentReleased), typeof(isCCAuthorized), typeof(isCCCaptured), typeof(paymentCaptureFailed) },
			childToParentLinkField: typeof(adjgRefNbr))]
		public override bool? IsCCPayment
		{
			get;
			set;
		}
		#endregion
		#region PaymentPendingProcessing
		public new abstract class paymentPendingProcessing : Data.BQL.BqlBool.Field<paymentPendingProcessing> { }
		[PXDBBool]
		public override bool? PaymentPendingProcessing
		{
			get;
			set;
		}
		#endregion
		#region PaymentReleased
		public new abstract class paymentReleased : Data.BQL.BqlBool.Field<paymentReleased> { }
		[PXDBBool]
		public override bool? PaymentReleased
		{
			get;
			set;
		}
		#endregion
		#region IsCCAuthorized
		public new abstract class isCCAuthorized : Data.BQL.BqlBool.Field<isCCAuthorized> { }
		[PXDBBool]
		public override bool? IsCCAuthorized
		{
			get;
			set;
		}
		#endregion
		#region IsCCCaptured
		public new abstract class isCCCaptured : Data.BQL.BqlBool.Field<isCCCaptured> { }
		[PXDBBool]
		public override bool? IsCCCaptured
		{
			get;
			set;
		}
		#endregion
		#region PaymentCaptureFailed
		public new abstract class paymentCaptureFailed : Data.BQL.BqlBool.Field<paymentCaptureFailed> { }
		[PXDBBool]
		public override bool? PaymentCaptureFailed
		{
			get;
			set;
		}
