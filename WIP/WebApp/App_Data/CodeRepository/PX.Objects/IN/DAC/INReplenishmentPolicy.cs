...
namespace PX.Objects.IN
{
	...
	public partial class INReplenishmentPolicy : PX.Data.IBqlTable
	{
		...
		{
			public class Calendar : CSCalendar.PK.ForeignKeyOf<INReplenishmentPolicy>.By<calendarID> { }
		}
		#endregion
	...
	public class INReplenishmentSource
	{
		...
		{
			public SOListWithBlankets() : base(
				new[]
				{
					Pair(DropShipToOrder, Messages.DropShipToOrder),
					Pair(BlanketDropShipToOrder, Messages.BlanketForDropShip),
					Pair(PurchaseToOrder, Messages.PurchaseToOrder),
					Pair(BlanketPurchaseToOrder, Messages.BlanketForPurchaseToOrder),
				})
			{ }
		}
		...
		public class blanketDropShipToOrder : PX.Data.BQL.BqlString.Constant<blanketDropShipToOrder>
		{
			public blanketDropShipToOrder() : base(BlanketDropShipToOrder) { }
		}
		public class purchaseToOrder : PX.Data.BQL.BqlString.Constant<purchaseToOrder>
		{
			public purchaseToOrder() : base(PurchaseToOrder) { }
		}
		public class blanketPurchaseToOrder : PX.Data.BQL.BqlString.Constant<blanketPurchaseToOrder>
		{
			public blanketPurchaseToOrder() : base(BlanketPurchaseToOrder) { }
		}
