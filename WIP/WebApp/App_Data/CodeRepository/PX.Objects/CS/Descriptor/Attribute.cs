...
namespace PX.Objects.CS
{
	...
	public class PXDimensionMaskAttribute : PXDimensionAttribute
	{
		...
		public override void FieldVerifying(PXCache sender, PXFieldVerifyingEventArgs e)
		{
			...
			if (errs.Count > 0)
			{
				if (errs.Count == 1)
				{
					throw new PXSetPropertyException(ErrorMessages.ElementOfFieldDoesntExist, errs[0], $"[{_FieldName}]");
				}
				errs.Add($"[{_FieldName}]");
	...
	public sealed class LocationRawAttribute : AcctSubAttribute, IPXRowPersistedSubscriber
	{
		...
		public LocationRawAttribute(Type WhereType, Type SubstituteKey = null) : base() 
		{
			Type SearchType =
				BqlCommand.Compose(	typeof(Search<,>),typeof(Location.locationCD),WhereType);
			_Attributes.Add(new PXDimensionSelectorAttribute(DimensionName, SearchType, SubstituteKey ?? typeof(Location.locationCD),
	...
	#region RecipientAddToAttribute
	...
	public class RecipientAddToAttribute : PXStringListAttribute
	{
		...
		public RecipientAddToAttribute()
			: base(
				new [] { To, Cc, Bcc },
				new [] { PXReportMessages.To, PXReportMessages.Cc, PXReportMessages.Bcc })
		{
		}
	}
	...
	public class RecipientsBehaviorAttribute : PXStringListAttribute
	{
		public const string Override = "O";
		public const string Add = "A";

		public RecipientsBehaviorAttribute()
			: base(
				new[] { Override, Add },
				new[] { Messages.RecipientsOverride, Messages.RecipientsAdd })
		{
		}

		public class overrideConst : PX.Data.BQL.BqlString.Constant<overrideConst>
		{
			public overrideConst() : base(Override) { }
		}

		public class addConst : PX.Data.BQL.BqlString.Constant<addConst>
		{
			public addConst() : base(Add) { }
		}
	}
