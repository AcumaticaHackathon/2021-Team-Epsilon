namespace PX.Objects.PM
{
	...
	public partial class PMTax : TaxDetail, PX.Data.IBqlTable
	{
		...
		[PXParent(typeof(Select<PMProforma, Where<PMProforma.refNbr, Equal<Current<PMTax.refNbr>>, 
			And<PMProforma.revisionID, Equal<Current<PMTax.revisionID>>>>>))]
		[PXParent(typeof(Select<PMProformaTransactLine, Where<PMProformaTransactLine.refNbr, Equal<Current<PMTax.refNbr>>, 
			And<PMProformaTransactLine.lineNbr, Equal<Current<PMTax.lineNbr>>,
			And<PMProformaTransactLine.revisionID, Equal<Current<PMTax.revisionID>>,
			And<PMProformaTransactLine.type, Equal<PMProformaLineType.transaction>>>>>>), LeaveChildren = true)]
		[PXParent(typeof(Select<PMProformaProgressLine, Where<PMProformaProgressLine.refNbr, Equal<Current<PMTax.refNbr>>,
			And<PMProformaProgressLine.lineNbr, Equal<Current<PMTax.lineNbr>>,
			And<PMProformaProgressLine.revisionID, Equal<Current<PMTax.revisionID>>,
			And<PMProformaProgressLine.type, Equal<PMProformaLineType.progressive>>>>>>), LeaveChildren = true)]
