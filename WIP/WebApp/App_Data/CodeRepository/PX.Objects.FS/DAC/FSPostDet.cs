...
namespace PX.Objects.FS
{
	...
	{
        #region Keys
        public class PK : PrimaryKeyOf<FSPostDet>.By<batchID, postDetID>
        {
            public static FSPostDet Find(PXGraph graph, int? batchID, int? postDetID) => FindBy(graph, batchID, postDetID);
        }

        public static class FK
        {
            public class PostBatch : FSPostBatch.PK.ForeignKeyOf<FSPostDet>.By<batchID> { }
            public class SOOrderType : SO.SOOrderType.PK.ForeignKeyOf<FSPostDet>.By<sOOrderType> { }
            public class SOOrder : SO.SOOrder.PK.ForeignKeyOf<FSPostDet>.By<sOOrderType, sOOrderNbr> { }
            public class SOOrderLine : SO.SOLine.PK.ForeignKeyOf<FSPostDet>.By<sOOrderType, sOOrderNbr, sOLineNbr> { }
            public class ARInvoice : AR.ARInvoice.PK.ForeignKeyOf<FSPostDet>.By<arDocType, arRefNbr> { }
            public class ARInvoiceLine : AR.ARTran.PK.ForeignKeyOf<FSPostDet>.By<arDocType, arRefNbr, aRLineNbr> { }
            public class APInvoice : AP.APInvoice.PK.ForeignKeyOf<FSPostDet>.By<apDocType, apRefNbr> { }
            public class APInvoiceLine : AP.APTran.PK.ForeignKeyOf<FSPostDet>.By<apDocType, apRefNbr, aPLineNbr> { }
            public class INIssue : IN.INRegister.PK.ForeignKeyOf<FSPostDet>.By<iNDocType, iNRefNbr> { }
            public class INIssueLine : IN.INTran.PK.ForeignKeyOf<FSPostDet>.By<iNDocType, iNRefNbr, iNLineNbr> { }
            public class SOInvoice : SO.SOInvoice.PK.ForeignKeyOf<FSPostDet>.By<sOInvDocType, sOInvRefNbr> { }
            public class SOInvoiceLine : AR.ARTran.PK.ForeignKeyOf<FSPostDet>.By<sOInvDocType, sOInvRefNbr, sOInvLineNbr> { }
            //public class PMRegister : PM.PMRegister.PK.ForeignKeyOf<FSPostInfo>.By<pMDocType, pMRefNbr> { }
            public class PMRegisterLine : PM.PMTran.PK.ForeignKeyOf<FSPostDet>.By<pMTranID> { }
        }
        #endregion
