...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLVoucher>.By<workBookID, voucherBatchNbr>
		{
			public static GLVoucher Find(PXGraph graph, String workBookID, String voucherBatchNbr) => FindBy(graph, workBookID, voucherBatchNbr);
		}
		public static class FK
		{
			public class WorkBook : GL.GLWorkBook.PK.ForeignKeyOf<GLVoucherBatch>.By<workBookID> { }
		}
		#endregion
