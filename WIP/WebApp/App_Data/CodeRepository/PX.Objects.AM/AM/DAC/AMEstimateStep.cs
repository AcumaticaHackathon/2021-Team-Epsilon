...
namespace PX.Objects.AM
{
    ...
    public class AMEstimateStep : IBqlTable, IEstimateOper, INotable
    {
        ...
        [PXParent(typeof(Select<AMEstimateOper,
            Where<AMEstimateOper.estimateID, Equal<Current<estimateID>>,
            And<AMEstimateOper.revisionID, Equal<Current<revisionID>>,
            And<AMEstimateOper.operationID, Equal<Current<operationID>>>>>>))]
        [PXParent(typeof(Select<AMEstimateItem,
            Where<AMEstimateItem.estimateID, Equal<Current<estimateID>>,
            And<AMEstimateItem.revisionID, Equal<Current<revisionID>>>>>))]
