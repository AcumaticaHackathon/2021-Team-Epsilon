...
namespace PX.Objects.PR
{
	...
	public class PRProjectFringeBenefitRate : IBqlTable
	{
		...
		{
			public static PRProjectFringeBenefitRate Find(PXGraph graph, int? recordID) => FindBy(graph, recordID);
		}
		...
		public static class FK
		{
			...
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PRProjectFringeBenefitRate>.By<projectTaskID> { }
		}
		#endregion
