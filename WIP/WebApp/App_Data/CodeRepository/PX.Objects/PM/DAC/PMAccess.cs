...
namespace PX.Objects.PM
{
	...
	{
		#region Select
		public PXSelect<PMProject, Where<Current<PX.SM.RelationGroup.groupName>, IsNotNull, 
			And<PMProject.baseType, Equal<PMProject.ProjectBaseType>,
			And<PMProject.nonProject, Equal<False>>>>> Project;
		...
		#region DAC overrides
		[GL.SubAccount(DisplayName = "Default Sales Subaccount", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(GL.Sub.description))]
		public void _(Events.CacheAttached<PMProject.defaultSalesSubID> e)
		{
		}

		[GL.SubAccount(DisplayName = "Default Cost Subaccount", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(GL.Sub.description))]
		public void _(Events.CacheAttached<PMProject.defaultExpenseSubID> e)
		{
		}
		#endregion
