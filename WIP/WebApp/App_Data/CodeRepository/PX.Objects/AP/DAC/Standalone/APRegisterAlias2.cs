...
namespace PX.Objects.AP.Standalone
{
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<APRegisterAlias2>.By<docType, refNbr>
		{
			public static APRegisterAlias2 Find(PXGraph graph, string docType, string refNbr) => FindBy(graph, docType, refNbr);
		}
		public new static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<APRegisterAlias2>.By<branchID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APRegisterAlias2>.By<vendorID> { }
			public class VendorLocation : CR.Location.PK.ForeignKeyOf<APRegisterAlias2>.By<vendorID, vendorLocationID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<APRegisterAlias2>.By<curyInfoID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<APRegisterAlias2>.By<curyID> { }
			public class APAccount : GL.Account.PK.ForeignKeyOf<APRegisterAlias2>.By<aPAccountID> { }
			public class APSubaccount : GL.Sub.PK.ForeignKeyOf<APRegisterAlias2>.By<aPSubID> { }
			public class Schedule : GL.Schedule.PK.ForeignKeyOf<APRegisterAlias2>.By<scheduleID> { }
			public class RetainageAccount : GL.Account.PK.ForeignKeyOf<APRegisterAlias2>.By<retainageAcctID> { }
			public class RetainageSubaccount : GL.Sub.PK.ForeignKeyOf<APRegisterAlias2>.By<retainageSubID> { }
		}
		#endregion
