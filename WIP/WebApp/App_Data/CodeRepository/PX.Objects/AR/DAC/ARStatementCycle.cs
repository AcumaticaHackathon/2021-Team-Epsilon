...
namespace PX.Objects.AR
{
	...
	public partial class ARStatementCycle : IBqlTable
	{
		#region Keys
		/// <exclude/>
		public class PK : PrimaryKeyOf<ARStatementCycle>.By<statementCycleId>
		{
			public static ARStatementCycle Find(PXGraph graph, Int32? statementCycleId) => FindBy(graph, statementCycleId);
		}
		#endregion
