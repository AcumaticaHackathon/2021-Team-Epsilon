...
namespace PX.Objects.DR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<DRScheduleTran>.By<scheduleID, componentID, detailLineNbr, lineNbr>
		{
			public static DRScheduleTran Find(PXGraph graph, int? scheduleID, int? componentID, int? detailLineNbr, int? lineNbr) => FindBy(graph, scheduleID, componentID, detailLineNbr, lineNbr);
		}
		public static class FK
		{
			public class Schedule : DR.DRSchedule.PK.ForeignKeyOf<DRScheduleTran>.By<scheduleID> { }
			public class Component : IN.InventoryItem.PK.ForeignKeyOf<DRScheduleTran>.By<componentID> { }
			public class ScheduleDetail : DR.DRScheduleDetail.PK.ForeignKeyOf<DRScheduleTran>.By<scheduleID, componentID, detailLineNbr> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<DRScheduleTran>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<DRScheduleTran>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<DRScheduleTran>.By<subID> { }
			// public class Batch : GL.Batch.PK.ForeignKeyOf<DRScheduleTran>.By<BatchModule.moduleDR, batchNbr> { }
		}
		#endregion
		#region ScheduleID
