...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" 
        ...
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="AddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,edBranchLocation_Address" CommitChanges="true" Visible="false" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    ...
    Width="100%" DataMember="BranchLocationRecords"
        TabIndex="1900" DefaultControlID="edBranchLocationCD" FilesIndicator="true" NoteIndicator="True">
        <Template>
                ...
                <Template>
                    ...
                    <px:PXFormView ID="edBranchLocation_Address" runat="server" Caption="Main Address" DataMember="BranchLocation_Address" DataSourceID="ds" RenderStyle="Fieldset">
                        <Template>
                            ...
                            <px:PXButton ID="btnViewMainOnMap" runat="server" CommandName="ViewMainOnMap" CommandSourceID="ds" Text="View On Map" TabIndex="-1" />
