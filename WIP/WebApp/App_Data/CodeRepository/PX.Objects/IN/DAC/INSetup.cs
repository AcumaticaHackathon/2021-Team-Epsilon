namespace PX.Objects.IN
{
    ...
    public partial class INSetup : PX.Data.IBqlTable
	{
		...
		{
			public class BatchNumbering : Numbering.PK.ForeignKeyOf<INSetup>.By<batchNumberingID> { }
			public class IssueNumbering : Numbering.PK.ForeignKeyOf<INSetup>.By<issueNumberingID> { }
			public class ReceiptNumbering : Numbering.PK.ForeignKeyOf<INSetup>.By<receiptNumberingID> { }
			public class AdjustmentNumbering : Numbering.PK.ForeignKeyOf<INSetup>.By<adjustmentNumberingID> { }
			public class ReplenishmentNumbering : Numbering.PK.ForeignKeyOf<INSetup>.By<replenishmentNumberingID> { }
			public class PINumbering : Numbering.PK.ForeignKeyOf<INSetup>.By<pINumberingID> { }
			public class KitAssemblyNumbering : Numbering.PK.ForeignKeyOf<INSetup>.By<kitAssemblyNumberingID> { }
			public class ServiceItemNumbering : Numbering.PK.ForeignKeyOf<INSetup>.By<serviceItemNumberingID> { }

			public class ARClearingAccount: Account.PK.ForeignKeyOf<INSetup>.By<aRClearingAcctID> { }
			public class ARClearingSubaccount: Sub.PK.ForeignKeyOf<INSetup>.By<aRClearingSubID> { }
			public class InTransitAccount : Account.PK.ForeignKeyOf<INSetup>.By<iNTransitAcctID> { }
			public class InTransitSubaccount : Sub.PK.ForeignKeyOf<INSetup>.By<iNTransitSubID> { }
			public class WorkInProgressAccount : Account.PK.ForeignKeyOf<INSetup>.By<iNProgressAcctID> { }
			public class WorkInProgressSubaccount : Sub.PK.ForeignKeyOf<INSetup>.By<iNProgressSubID> { }
			...
			public class DefaultStockItemClass : INItemClass.PK.ForeignKeyOf<INSetup>.By<dfltStkItemClassID> { }
			public class DefaultNonStockItemClass : INItemClass.PK.ForeignKeyOf<INSetup>.By<dfltNonStkItemClassID> { }
			public class DefaultPostClass : INPostClass.PK.ForeignKeyOf<INSetup>.By<dfltPostClassID> { }
			public class DefaultLotSerialClass : INLotSerClass.PK.ForeignKeyOf<INSetup>.By<dfltLotSerClassID> { }

			public class ModelAttribute: CSAttribute.PK.ForeignKeyOf<INSetup>.By<modelAttribute> { }
			public class ManufactureAttribute : CSAttribute.PK.ForeignKeyOf<INSetup>.By<manufactureAttribute> { }
			public class TransitSite : INSite.PK.ForeignKeyOf<INSetup>.By<transitSiteID> { }
			public class TransitBranch : Branch.PK.ForeignKeyOf<INSetup>.By<transitBranchID> { }
			public class DefaultSite : INSite.PK.ForeignKeyOf<INSetup>.By<defaultSiteID> { }
		}
		#endregion
		...
		[PXForeignReference(typeof(FK.ARClearingAccount))]
		...
		[PXForeignReference(typeof(FK.ARClearingSubaccount))]
		...
		[Account(DisplayName = "In-Transit Account",
			DescriptionField = typeof(Account.description),
			AvoidControlAccounts = true)]
		[PXForeignReference(typeof(FK.InTransitAccount))]
		...
		[SubAccount(typeof(INSetup.iNTransitAcctID), DisplayName = "In-Transit Sub.",
					 DescriptionField = typeof(Sub.description))]
		[PXDefault()]
		[PXForeignReference(typeof(FK.InTransitSubaccount))]
		...
		[Account(DisplayName = "Work In-Progress Account",
			DescriptionField = typeof(Account.description),
			AvoidControlAccounts = true)]
		[PXForeignReference(typeof(FK.WorkInProgressAccount))]
		...
		[PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
		[PXUIRequired(typeof(Where<FeatureInstalled<FeaturesSet.kitAssemblies>>))]
		[PXForeignReference(typeof(FK.WorkInProgressSubaccount))]
		...
		#endregion
		#region AllocateDocumentsOnHold
		[PXDBBool]
		[PXDefault(true)]
		[PXUIField(DisplayName = "Allocate Items in Documents on Hold")]
		public virtual bool? AllocateDocumentsOnHold { get; set; }
		public abstract class allocateDocumentsOnHold : PX.Data.BQL.BqlBool.Field<allocateDocumentsOnHold> { }
		#endregion
		#region UseLegacyWMS
		[PXDBBool]
		[PXDefault(false, typeof(Search<FeaturesSet.advancedFulfillment>))]
		[PXUIField(DisplayName = "Use Legacy Engine")]
		public virtual bool? UseLegacyWMS { get; set; }
		public abstract class useLegacyWMS : PX.Data.BQL.BqlBool.Field<useLegacyWMS> { }
		#endregion
	}
}
