...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INPostClassMaint" PrimaryView="postclass" HeaderDescriptionField="Descr">
        <CallbackCommands>
        ...
        <Items>
            <px:PXTabItem Text="Posting Settings">
                <Template>
					...
					<px:PXDropDown runat="server" ID="edAMWIPAccountDefault" CommitChanges="true" DataField="AMWIPAccountDefault" AllowNull="False" />
					<px:PXSegmentMask runat="server" DataField="AMWIPSubMask" ID="edAMWIPSubMask" />
					<px:PXDropDown runat="server" ID="edAMWIPVarianceAccountDefault" CommitChanges="true" DataField="AMWIPVarianceAccountDefault" AllowNull="False" />
					<px:PXSegmentMask runat="server" DataField="AMWIPVarianceSubMask" ID="edAMWIPVarianceSubMask" />
                </Template>
            </px:PXTabItem>
            <px:PXTabItem Text="GL Accounts">
                <Template>
                    ...
                    <px:PXSegmentMask ID="edAMWIPAcctID" runat="server" DataField="AMWIPAcctID" CommitChanges="true" />
                    <px:PXSegmentMask ID="edAMWIPSubID" runat="server" DataField="AMWIPSubID" AutoRefresh="true" />
                    <px:PXSegmentMask ID="edAMWIPVarianceAcctID" runat="server" DataField="AMWIPVarianceAcctID" CommitChanges="true" />
                    <px:PXSegmentMask ID="edAMWIPVarianceSubID" runat="server" DataField="AMWIPVarianceSubID" AutoRefresh="true" />
