...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FABookHistory>.By<assetID, bookID, finPeriodID>
		{
			public static FABookHistory Find(PXGraph graph, Int32? assetID, Int32? bookID, String finPeriodID) => FindBy(graph, assetID, bookID, finPeriodID);
		}
		public static class FK
		{
			public class FixedAsset : FA.FixedAsset.PK.ForeignKeyOf<FABookHistory>.By<assetID> { }
			public class Book : FA.FABook.PK.ForeignKeyOf<FABookHistory>.By<bookID> { }
		}
	#endregion
	#region AssetID
