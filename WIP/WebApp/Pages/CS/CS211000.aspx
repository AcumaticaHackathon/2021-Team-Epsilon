...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.CS.ReasonCodeMaint" PrimaryView="reasoncode" HeaderDescriptionField="Descr">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" DataMember="reasoncode" Caption="Reason Code" TemplateContainer="">
		...
		<Template>
			...
			<px:PXSegmentMask ID="edSubID" runat="server" DataField="SubID" AutoRefresh="True" CommitChanges="True" />
