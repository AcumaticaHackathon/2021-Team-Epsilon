namespace PX.Objects.AR
{
	...
	public partial class ARSalesPrice : PX.Data.IBqlTable
	{
		#region Keys
		/// <exclude/>
		public class PK : PrimaryKeyOf<ARSalesPrice>.By<recordID>
		{
			public static ARSalesPrice Find(PXGraph graph, Int32? recordID) => FindBy(graph, recordID);
		}
		public static class FK
		{
			public class Customer : AR.Customer.PK.ForeignKeyOf<ARSalesPrice>.By<customerID> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<ARSalesPrice>.By<inventoryID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<ARSalesPrice>.By<curyID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<ARSalesPrice>.By<taxID> { }
			public class Site : INSite.PK.ForeignKeyOf<ARSalesPrice>.By<siteID> { }
		}
		#endregion
		...
		[PXUIField(DisplayName = "Tax", Visibility = PXUIVisibility.SelectorVisible, Visible = false)]
