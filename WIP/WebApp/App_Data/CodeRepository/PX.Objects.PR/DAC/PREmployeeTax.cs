...
namespace PX.Objects.PR
{
	...
	public class PREmployeeTax : IBqlTable
	{
		...
		{
			public static PREmployeeTax Find(PXGraph graph, int? bAccountID, int? taxID) =>
				FindBy(graph, bAccountID, taxID);
		}
		...
		public static class FK
		{
			...
			//public class State : CS.State.PK.ForeignKeyOf<PREmployeeTax>.By<LocationConstants.CountryUS, state> { }
		}
		#endregion
