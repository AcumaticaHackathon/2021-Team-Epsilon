...
namespace PX.Objects.TX
{
	...
	public static class Messages
	{
		...
		public const string CannotPrepareReportExistPrepared = "A tax report cannot be prepared for the selected company and tax agency because there is an unreleased report for the {0} tax period. To proceed, release or void the tax report for {0} on the Release Tax Report (TX502000) form.";
		...
		public const string TaxPeriodsNotSync = "Tax periods do not match the financial periods in the general ledger for the {0} company. Use the {1} action to correct the period structure for the tax year.";
		public const string PrepareTaxRepPeriodNotSync = "The tax report cannot be prepared and released, because the {0} tax period does not match the financial period in the general ledger for the {1} company. Use the {2} action on the Tax Periods (TX207000) form to correct the period structure for the {3} tax year.";
		public const string ReleaseTaxRepPeriodNotSync = "The tax report cannot be prepared and released, because the {0} tax period does not match the financial period in the general ledger for the {1} company. Void the tax report, then use the {2} action on the Tax Periods (TX207000) form to correct the period structure for the {3} tax year.";
		public const string FinPeriodsNotGenerated = "Tax periods cannot be displayed for the {0} tax year because the corresponding financial periods have not yet been generated for the {1} company.";
		#endregion
		...
		public const string SubsequentTaxYearsWillBeDeleted = "The start date specified for the {0} tax year does not match the end date of the {1} tax year for the {2} company. The {0} tax year will be deleted.";
		...
		public const string SynchronizeWithGL = "Synchronize Periods with GL";
		#endregion
