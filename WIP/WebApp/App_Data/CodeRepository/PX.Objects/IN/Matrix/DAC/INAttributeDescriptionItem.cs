...
namespace PX.Objects.IN.Matrix.DAC
{
	...
	public class INAttributeDescriptionItem : IBqlTable
	{
		...
		{
			public static INAttributeDescriptionItem Find(PXGraph graph, int? templateID, int? groupID, string attributeID, string valueID)
		...
		public static class FK
		{
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use TemplateInventoryItem instead.")]
			public class TemplateItem : TemplateInventoryItem { }
		}
		#endregion
