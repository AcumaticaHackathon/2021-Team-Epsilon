...
namespace PX.Objects.IN.RelatedItems
{
	...
	public class INRelatedInventory: IBqlTable
	{
		...
		public static class FK
		{
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use InventoryItem instead.")]
			public class Inventory : InventoryItem { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use RelatedInventoryItem instead.")]
			public class RelatedInventory : RelatedInventoryItem { }
		}
		#endregion
