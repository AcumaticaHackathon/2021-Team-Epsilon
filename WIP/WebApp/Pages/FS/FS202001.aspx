...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" FilesIndicator="True" NoteIndicator="True"
		...
		<Items>
			<px:PXTabItem Text="Recurrence">
			    <Template>
                    ...
                    <px:PXTextEdit SuppressLabel="True" ID="edYearlyLabel" DataField="YearlyLabel" 
                    ...
                    <px:PXGroupBox ID="PXGroupBox1" runat="server" Caption="Yearly" 
                        CommitChanges="True" RenderStyle="Simple" DataField="YearlyLabel"
                    ...
                    <px:PXTextEdit ID="edMonths1" runat="server" DataField="MonthlyLabel" 
                    ...
                    <px:PXTextEdit ID="edWeeklyLabel" runat="server" DataField="WeeklyLabel" 
                    ...
                    <px:PXGroupBox ID="edWeekly" runat="server" Caption="Weekly" 
                        CommitChanges="True" RenderStyle="Simple" DataField="WeeklyLabel" Width="348px" 
                        RenderSimple="True">
                        <Template>
                    ...
                    <px:PXTextEdit SuppressLabel="True" ID="edDailyLabel" DataField="DailyLabel" runat="server" 
