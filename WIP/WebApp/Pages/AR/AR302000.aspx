...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="DocType" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AR.ARPaymentEntry" PrimaryView="Document">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="CaptureCCPayment" CommitChanges="true" PopupCommand="SyncPaymentTransaction" PopupCommandTarget="ds" />
            <px:PXDSCallbackCommand Name="AuthorizeCCPayment" Visible="false" CommitChanges="true" PopupCommand="SyncPaymentTransaction" PopupCommandTarget="ds" />
    ...
    <px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%"
        ...
        <Template>
            ...
            <px:PXSegmentMask CommitChanges="True" ID="edCustomerID" runat="server"
                DataField="CustomerID" AllowAddNew="True" AllowEdit="True" DataSourceID="ds" AutoRefresh="True"/>
            ...
            <px:PXSelector CommitChanges="True" ID="edPaymentMethodID" runat="server"
                ...
                DataSourceID="ds" />
            <px:PXCheckBox ID="chkTransactionRefund" runat="server" CommitChanges="true" DataField="cCTransactionRefund"></px:PXCheckBox>
			<px:PXSelector ID="PXSelector2" runat="server" DataField="RefTranExtNbr" ValueField="TranNumber" CommitChanges="true" AutoRefresh="true" DataSourceID="ds">
				<Parameters>
			...
			<px:PXCheckBox ID="chkSaveCard" runat="server" CommitChanges="true" DataField="SaveCard"></px:PXCheckBox>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ccProcTran">
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXDateTimeEdit ID="edFundHoldExpDate" runat="server" DataField="FundHoldExpDate" />
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn AllowNull="False" DataField="FundHoldExpDate"/>
