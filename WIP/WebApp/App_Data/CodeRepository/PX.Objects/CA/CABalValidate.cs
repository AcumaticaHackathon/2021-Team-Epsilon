...
namespace PX.Objects.CA
{
	...
	public class CABalValidate : PXGraph<CABalValidate>
	{
		...
		public CABalValidate()
		{
			...
			CABalValidateList.SetProcessCaption(GL.Messages.Process);
			CABalValidateList.SetProcessAllCaption(GL.Messages.ProcessAll);
			CABalValidateList.SetProcessTooltip(Messages.RecalculateBalanceTooltip);
			CABalValidateList.SetProcessAllTooltip(Messages.RecalculateBalanceTooltip);
