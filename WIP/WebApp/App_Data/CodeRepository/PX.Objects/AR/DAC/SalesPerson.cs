...
namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<SalesPerson>.By<salesPersonID>
		{
			public static SalesPerson Find(PXGraph graph, int? salesPersonID) => FindBy(graph, salesPersonID);
		}
		public class UK : PrimaryKeyOf<SalesPerson>.By<salesPersonCD>
		{
			public static SalesPerson Find(PXGraph graph, string salesPersonCD) => FindBy(graph, salesPersonCD);
		}
		public static class FK
		{
			public class SalesSubaccount : GL.Sub.PK.ForeignKeyOf<SalesPerson>.By<salesSubID> { }
		}
		#endregion
