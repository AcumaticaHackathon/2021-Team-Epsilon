...
namespace PX.Data
{
    ...
    public sealed class PXCommandPreparingEventArgs : CancelEventArgs
    {
        ...
        public sealed class FieldDescription : ICloneable, IEquatable<FieldDescription>
        {
            ...
            internal FieldDescription(Type bqlTable, SQLTree.SQLExpression expr, PXDbType dataType, int? dataLength, object dataValue, bool isRestriction, bool isExcludedFromUpdate = false, bool isForcedSubQuery = false)
            {
                BqlTable = bqlTable;
                DataType = dataType;
                ...
                IsForcedSubQuery = isForcedSubQuery;
            ...
            public object Clone()
            {
                return new FieldDescription(BqlTable, Expr, DataType, DataLength, DataValue, IsRestriction, IsExcludedFromUpdate, IsForcedSubQuery);
            }
            ...
            public bool Equals(FieldDescription other)
            {
                ...
                return BqlTable == other.BqlTable
                       ...
                       && IsForcedSubQuery == other.IsForcedSubQuery;
            }
        }
        ...
        {
            return new FieldDescription(_BqlTable, Expr, _DataType, _DataLength, _DataValue, _IsRestriction, _isExcludedFromUpdate, IsForcedSubQuery);
        }
        public void FillFromFieldDescription(FieldDescription fDescr)
        {
            ...
            IsForcedSubQuery = fDescr.IsForcedSubQuery;
            Expr = fDescr.Expr;
        }
        private readonly object _Row;
