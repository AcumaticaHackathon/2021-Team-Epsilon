...
namespace PX.Objects.AM.GraphExtensions
{
        ...
        where TPrimary : class, IBqlTable, new()
    {
        ...
        protected virtual void _(Events.CacheAttached<CROpportunityTax.lineNbr> e) { }
        ...
        protected virtual void CROpportunityProducts_RowUpdated(PXCache sender, PXRowUpdatedEventArgs e, PXRowUpdated del)
        {
            ...
            if (row == null || !AllowConfigurationsInt)
            {
                del?.Invoke(sender, e);
                return;
            }
        ...
        {
            if (AllowConfigurationsInt && CanUpdateConfigPrice((CROpportunityProducts)e.Row))
            {
                //Get config price
