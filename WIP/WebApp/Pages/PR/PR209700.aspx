...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" Width="100%" runat="server" TypeName="PX.Objects.PR.PRUnionMaint" PrimaryView="UnionLocal" Visible="True" HeaderDescriptionField="Description" />
</asp:Content>
