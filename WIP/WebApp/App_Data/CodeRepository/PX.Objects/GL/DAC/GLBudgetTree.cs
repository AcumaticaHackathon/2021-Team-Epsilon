...
namespace PX.Objects.GL
 {
	...
	public partial class GLBudgetTree : PX.Data.IBqlTable, PX.SM.IIncludable
	 {
		#region Keys
		public class PK : PrimaryKeyOf<GLBudgetTree>.By<groupID>
		{
			public static GLBudgetTree Find(PXGraph graph, Guid? groupID) => FindBy(graph, groupID);
		}
		public static class FK
		{
			public class ParentBudgetTree : GL.GLBudgetTree.PK.ForeignKeyOf<GLBudgetTree>.By<parentGroupID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<GLBudgetTree>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<GLBudgetTree>.By<subID> { }
		}
		#endregion
