...
namespace PX.Objects.IN
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<INReceiptStatus>.By<receiptNbr, inventoryID, costSubItemID, costSiteID, lotSerialNbr, accountID, subID>
		{
			public static INReceiptStatus Find(PXGraph graph, string receiptNbr, int? inventoryID, int? costSubItemID, int? costSiteID, string lotSerialNbr, int? accountID, int? subID)
				=> FindBy(graph, receiptNbr, inventoryID, costSubItemID, costSiteID, lotSerialNbr, accountID, subID);
		}
		...
		public static class FK
		{
			...
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<INReceiptStatus>.By<subID> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use Subaccount instead.")]
			public class Sub : Subaccount { }
		}
		#endregion
		#region ReceiptID
