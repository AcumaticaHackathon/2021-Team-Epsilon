...
namespace PX.Objects.PR
{
	...
	[DebuggerDisplay("{GetType().Name,nq}: DocType = {DocType,nq}, RefNbr = {RefNbr,nq}, BankID = {BankID,nq}")]
	public class PRPaymentPTOBank : IBqlTable, PTOHelper.IPTOHistory
	{
		#region Keys
		public class PK : PrimaryKeyOf<PRPaymentPTOBank>.By<docType, refNbr, bankID>
		{
			public static PRPaymentPTOBank Find(PXGraph graph, string docType, string refNbr, string bankID) =>
				FindBy(graph, docType, refNbr, bankID);
		}
