...
{	
	...
	public class RenewContracts : PXGraph<RenewContracts>
	{
		...
		public PXFilteredProcessing<
			...
			Items;
		public BqlCommand ItemsInitialCommand { get; set;} = PXSelect <
			ContractsList,
			...
			OrderBy<
				Asc<ContractsList.contractCD>>>.GetCommand();
		...
		protected virtual IEnumerable items()
		{
			...
			{
				ItemsInitialCommand = ItemsInitialCommand.WhereAnd<
			...
			return this.QuickSelect(ItemsInitialCommand);
		}
