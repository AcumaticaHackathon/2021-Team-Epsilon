...
<div runat="server" id="pnlDialogs">
    ...
    <px:PXSmartPanel ID="pnlProfiler" runat="server" CaptionVisible="True" DesignView="Hidden" ShowAfterLoad="true" 
        ...
        <px:PXDataSource ID="dsProfiler" runat="server" Visible="True" Width="100%" TypeName="PX.SM.PerformanceMonitorUserMaint" PrimaryView="ProfilerInfoView" IsDefaultDatasource="false">
		    <CallbackCommands>
        ...
        <px:PXFormView ID="formProfiler" runat="server" DataSourceID="dsProfiler" DataMember="ProfilerInfoView" Width="100%" Height="100%" AllowAutoHide="false" SkinID="Transparent">
		    <Template>
                ...
                <px:PXLabel runat="server" ID="PXLabel1" />
                <px:PXTextEdit runat="server" ID="lblExportText" DataField="ExportText" SuppressLabel="true" Enabled="false" Wrap="False" TextMode="MultiLine" Height="40px" Width="400px" SkinID="Label" DisableSpellcheck="true" Style="display: contents;" />
                <px:PXButton ID="btnLastRequest" CommandName="actionLastRequest" CommandSourceID="dsProfiler" runat="server" AlignLeft="true" Height="30px"></px:PXButton>
                <px:PXLabel runat="server" ID="lblPlace" />
                <asp:HyperLink ID="lnkMainProfiler" runat="server" Text="Request Profiler" Height="30px" />
		    </Template>
	    </px:PXFormView>
    </px:PXSmartPanel>
