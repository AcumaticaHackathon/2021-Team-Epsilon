		...
		public override void Configure(PXScreenConfiguration configuration)
		{
            ...
            var actionCloseAsDuplicate = context.ActionDefinitions.CreateExisting<DuplicateExt>(e => e.CloseAsDuplicate,
                a => a
                    ...
                    }).InFolder(FolderType.ActionsFolder).WithPersistOptions(ActionPersistOptions.ForcePersist));
			...
			context.AddScreenConfigurationFor(screen =>
			{
				return screen
					...
					.WithActions(actions =>
					{
						...
						actions.Add<CreateContactExt>(e => e.CreateContact, a => a.InFolder(FolderType.ActionsFolder).WithPersistOptions(ActionPersistOptions.ForcePersist));
						actions.Add<CreateAccountExt>(e => e.CreateBothContactAndAccount, a => a.InFolder(FolderType.ActionsFolder).WithPersistOptions(ActionPersistOptions.ForcePersist));
						actions.Add<DuplicateExt>(e => e.CheckForDuplicates, a => a.InFolder(FolderType.ActionsFolder).WithPersistOptions(ActionPersistOptions.ForcePersist));
						actions.Add<DuplicateExt>(e => e.MarkAsValidated, a => a.InFolder(FolderType.ActionsFolder).WithPersistOptions(ActionPersistOptions.ForcePersist));
						actions.Add<AddressActionsExt>(e => e.ValidateAddress, a => a.InFolder(FolderType.ActionsFolder).WithPersistOptions(ActionPersistOptions.ForcePersist));
					})
					.WithForms(forms =>
					{
						forms.Add(formOpen);
