...
namespace PX.Objects.CA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CashAccountETDetail>.By<accountID, entryTypeID>
		{
			public static CashAccountETDetail Find(PXGraph graph, int? accountID, string entryTypeID) => FindBy(graph, accountID, entryTypeID);
		}

		public static class FK
		{
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CashAccountETDetail>.By<accountID> { }
