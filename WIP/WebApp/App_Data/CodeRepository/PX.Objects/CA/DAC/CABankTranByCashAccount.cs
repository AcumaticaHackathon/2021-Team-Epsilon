...
namespace PX.Objects.CA
{
	...
	public class CABankTranByCashAccount : IBqlTable
	{
		...
		{
			public static CABankTranByCashAccount Find(PXGraph graph, int? cashAccountID) => FindBy(graph, cashAccountID);
		}
		#endregion
	...
	public class CABankTranSplitDebitCredit : IBqlTable
	{
		...
		{
			public static CABankTranSplitDebitCredit Find(PXGraph graph, int? cashAccountID) => FindBy(graph, cashAccountID);
		}
		#endregion
