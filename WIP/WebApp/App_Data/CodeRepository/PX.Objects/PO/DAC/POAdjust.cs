...
namespace PX.Objects.PO
{
	...
	public class POAdjust : IBqlTable, IAdjustmentStub
	{
		...
		{
			public class AdjustedOrder : POOrder.PK.ForeignKeyOf<POAdjust>.By<adjdOrderType, adjdOrderNbr> { }
			public class AdjustedInvoice : APInvoice.PK.ForeignKeyOf<POAdjust>.By<adjdDocType, adjdRefNbr> { }
			public class AdjustedCurrencyInfo : CurrencyInfo.PK.ForeignKeyOf<POAdjust>.By<adjdCuryInfoID> { }
			public class AdjustingPayment : APPayment.PK.ForeignKeyOf<POAdjust>.By<adjgDocType, adjgRefNbr> { }
			public class AdjustingCurrencyInfo : CurrencyInfo.PK.ForeignKeyOf<POAdjust>.By<adjgCuryInfoID> { }
			public class CacheAccount : CA.CashAccount.PK.ForeignKeyOf<POAdjust>.By<cashAccountID> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<POAdjust>.By<paymentMethodID> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use AdjustedOrder instead.")]
			public class Order : AdjustedOrder { }
		}
		#endregion
		...
		[PXParent(typeof(FK.AdjustedOrder))]
