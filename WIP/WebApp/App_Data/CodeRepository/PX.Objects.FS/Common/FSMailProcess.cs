...
namespace PX.Objects.FS
{
    public static class FSMailProcess
    {
        ...
        public static void VerifyRecipientsAndAddToList(RecipientList unverifiedRecipients, RecipientList verifiedRecipients, bool throwError, string errorMessage)
        {
