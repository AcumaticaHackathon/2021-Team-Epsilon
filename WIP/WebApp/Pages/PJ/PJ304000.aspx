...
<asp:Content ID="DataSourceContent" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" EnableAttributes="true" runat="server" Visible="True" Width="100%"
        ...
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ViewVendor" Visible="False" DependOnGrid="gridSubcontractors" />
            <px:PXDSCallbackCommand Name="ViewBAccount" Visible="False" DependOnGrid="gridVisitors" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="DailyFieldReportContent" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="DailyFieldReport"
        ...
        <Template>
            ...
            <px:PXCheckBox ID="chkHold" runat="server" DataField="Hold" CommitChanges="True" SuppressLabel="True" Visible="false" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataKeyNames="NoteID" DataMember="EmployeeActivities">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="OwnerID_description" AutoCallBack="True" Visible="false" SyncVisible="false" />
                    ...
                    <px:PXGrid ID="gridSubcontractors" runat="server" DataSourceID="ds" Width="100%" SkinID="Details" NoteIndicator="True" FilesIndicator="true">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Subcontractors">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="VendorId" CommitChanges="True" LinkCommand="ViewVendor" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Visitors">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="BusinessAccountId" LinkCommand="ViewBAccount" CommitChanges="True"/>
