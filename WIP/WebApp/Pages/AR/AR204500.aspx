...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" Width="100%" runat="server" TypeName="PX.Objects.AR.ARFinChargesMaint" Visible="True"
		PrimaryView="ARFinChargesList" HeaderDescriptionField="FinChargeDesc">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server" >
		...
		<Template>
					...
					<px:PXSegmentMask ID="edFinChargeSubID" runat="server" DataField="FinChargeSubID" CommitChanges="True"/>
