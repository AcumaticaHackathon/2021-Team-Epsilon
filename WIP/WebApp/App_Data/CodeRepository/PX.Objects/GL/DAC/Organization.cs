...
namespace PX.Objects.GL.DAC
{
	...
	public partial class Organization : IBqlTable, IIncludable, I1099Settings
	{
		...
		{
			public static Organization Find(PXGraph graph, int? organizationID) => FindBy(graph, organizationID);
		}
		public class UK : PrimaryKeyOf<Organization>.By<organizationCD>
		{
			public static Organization Find(PXGraph graph, string organizationCD) => FindBy(graph, organizationCD);
		}
		...
		#endregion
		#region OrganizationGroupID
		public abstract class organizationGroupID : PX.Data.BQL.BqlInt.Field<organizationGroupID> { }
		[PXUIField(DisplayName = "Organization Group", FieldClass = nameof(FeaturesSet.MultipleBaseCurrencies))]
		[Attributes.OrganizationGroup(PersistingCheck = PXPersistingCheck.Nothing)]
	...
	public partial class BranchItem : BAccount
	{
		...
		{
			public static BranchItem Find(PXGraph graph, int? bAccountID) => FindBy(graph, bAccountID);
		}
		public new class UK : PrimaryKeyOf<BranchItem>.By<acctCD>
		{
			public static BranchItem Find(PXGraph graph, string acctCD) => FindBy(graph, acctCD);
		}
	...
	[Serializable]
	[PXHidden]
	public partial class GroupOrganizationLink : IBqlTable
	{
		#region GroupID
