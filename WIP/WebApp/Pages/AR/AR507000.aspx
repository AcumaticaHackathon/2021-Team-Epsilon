...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" BorderStyle="None" Caption="Selection" DataMember="Filter" DefaultControlID="edStatementCycle" MarkRequired="Dynamic">
        <Template>
