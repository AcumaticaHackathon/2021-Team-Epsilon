...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="ReceiptType" runat="server" Visible="True" TypeName="PX.Objects.PO.POReceiptEntry" PrimaryView="Document" BorderStyle="NotSet" Width="100%">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="CreateAPDocument" CommitChanges="True" />            
            <px:PXDSCallbackCommand Name="CreateLCDocument" CommitChanges="True" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Document Summary"
        ...
        <Template>
            ...
            <px:PXDropDown ID="edReturnInventoryCostMode" runat="server" AllowNull="False" DataField="ReturnInventoryCostMode" CommitChanges="true" />
            ...
            <px:PXNumberEdit ID="edCuryOrderTotal" runat="server" DataField="CuryOrderTotal" />
            <px:PXCheckBox ID="chkShowPurchaseOrdersTab" runat="server" DataField="ShowPurchaseOrdersTab" />
            <px:PXCheckBox ID="chkShowPutAwayHistoryTab" runat="server" DataField="ShowPutAwayHistoryTab" />
            <px:PXCheckBox ID="chkShowLandedCostsTab" runat="server" DataField="ShowLandedCostsTab" />
        </Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Height="353px" Style="z-index: 100;" Width="100%" DataMember="CurrentDocument" DataSourceID="ds">
        ...
        <Items>
            <px:PXTabItem Text="Details">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100; left: 0px; top: 0px; height: 455px;" Width="100%"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="transactions">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="AllowEditUnitCost" TextAlign="Center" AllowNull="False" Type="CheckBox"/>
                                    <px:PXGridColumn AllowNull="False" DataField="CuryUnitCost" TextAlign="Right" Label="Unit Cost" CommitChanges="true" />
                                    <px:PXGridColumn AllowNull="False" DataField="CuryExtCost" TextAlign="Right" CommitChanges="true" />
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXNumberEdit ID="edCuryExtCost" runat="server" DataField="CuryExtCost" CommitChanges="true" />
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LSPOReceiptLine_binLotSerial" CommandSourceID="ds" DependOnGrid="grid" />
            ...
            <px:PXTabItem Text="Orders" VisibleExp="DataControls[&quot;chkShowPurchaseOrdersTab&quot;].Value == 1" BindingContext="form">
                <Template>
			...
			<px:PXTabItem Text="History" BindingContext="form" RepaintOnDemand="false">
                <Template>
			...
			<px:PXTabItem Text="Billing" BindingContext="form" RepaintOnDemand="false">
                <Template>
					<px:PXFormView ID="formBaseCurrencyMessage" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%">
						<Template>
							<px:PXLabel runat="server" ID="lblAmountsCurrency" Text="The values in the Billed Amt., Accrued Amt., and PPV Amt columns are always shown in the base currency."></px:PXLabel>
						</Template>
					</px:PXFormView>
			...
			<px:PXTabItem Text="Other">
				<Template>
					...
					<px:PXSelector ID="edSOOrderNbr" runat="server" DataField="SOOrderNbr" Enabled="False" AllowEdit="True" />
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Intercompany Sale" LabelsWidth="SM" ControlSize="SM" />
                    <px:PXSelector ID="edIntercompanyShipmentNbr" runat="server" DataField="IntercompanyShipmentNbr" AllowEdit="True" Enabled="False" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108;" Width="764px" Height="500px" Caption="Line Details" CaptionVisible="True"
