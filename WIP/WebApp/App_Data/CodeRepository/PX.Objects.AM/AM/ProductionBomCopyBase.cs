...
namespace PX.Objects.AM
{
    public abstract class ProductionBomCopyBase : PXGraph<ProductionBomCopyBase, AMProdItem>
    {
        ...
        {
            internal string DebuggerDisplay => $"ReferenceKey={ReferenceKey}; ParentIncludeOpReferenceKey={ParentIncludeOpReferenceKey}; Bom-Rev-Oper={BomID}-{BomRevisionID}-{BomOperationCD}; BomQtyReq={BomQtyReq}; IncludeOper={IncludeOper}";
