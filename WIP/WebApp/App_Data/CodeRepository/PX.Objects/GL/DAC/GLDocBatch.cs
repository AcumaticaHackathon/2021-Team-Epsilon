...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLDocBatch>.By<module, batchNbr>
		{
			public static GLDocBatch Find(PXGraph graph, String module, String batchNbr) => FindBy(graph, module, batchNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<GLDocBatch>.By<branchID> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<GLDocBatch>.By<ledgerID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<GLDocBatch>.By<curyInfoID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<GLDocBatch>.By<curyID> { }
			public class OriginalJournalVoucher : Batch.PK.ForeignKeyOf<GLDocBatch>.By<origModule, origBatchNbr> { }
		}
		#endregion

		#region Events
		public class Events : PXEntityEvent<GLDocBatch>.Container<Events>
		{
			public PXEntityEvent<GLDocBatch> UpdateStatus;
		}
		#endregion
