...
namespace PX.Objects.SO
{
	...
	public partial class SOBillingAddress : SOAddress
	{
		...
		{
			public static SOBillingAddress Find(PXGraph graph, int? addressID) => FindBy(graph, addressID);
		}
	...
	public partial class SOShippingAddress : SOAddress
	{
		...
		{
			public static SOShippingAddress Find(PXGraph graph, int? addressID) => FindBy(graph, addressID);
		}
		public new static class FK
		{
	...
	public partial class SOShipmentAddress : SOAddress
	{
		...
		{
			public static SOShipmentAddress Find(PXGraph graph, int? addressID) => FindBy(graph, addressID);
		}
		public new static class FK
		{
	...
	public partial class SOAddress : PX.Data.IBqlTable, IAddress, IAddressBase, IAddressLocation
	{
		#region Keys
		public class PK : PrimaryKeyOf<SOAddress>.By<addressID>
		{
			public static SOAddress Find(PXGraph graph, int? addressID) => FindBy(graph, addressID);
		}
