...
namespace PX.Objects.DR
{
	...
	public class DRScheduleDetail : IBqlTable
	{
		...
		#region Keys
		public class PK : PrimaryKeyOf<DRScheduleDetail>.By<scheduleID, componentID, detailLineNbr>
		{
			public static DRScheduleDetail Find(PXGraph graph, int? scheduleID, int? componentID, int? detailLineNbr) => FindBy(graph, scheduleID, componentID, detailLineNbr);
		}
		public static class FK
		{
			public class Schedule : DR.DRSchedule.PK.ForeignKeyOf<DRScheduleDetail>.By<scheduleID> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<DRScheduleDetail>.By<branchID> { }
			public class Component : IN.InventoryItem.PK.ForeignKeyOf<DRScheduleDetail>.By<componentID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<DRScheduleDetail>.By<curyInfoID> { }
			public class DeferralCode : DR.DRDeferredCode.PK.ForeignKeyOf<DRScheduleDetail>.By<defCode> { }
			public class DeferralAccount : GL.Account.PK.ForeignKeyOf<DRScheduleDetail>.By<defAcctID> { }
			public class DeferralSubaccount : GL.Sub.PK.ForeignKeyOf<DRScheduleDetail>.By<defSubID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<DRScheduleDetail>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<DRScheduleDetail>.By<subID> { }
			public class Contract : PM.PMProject.PK.ForeignKeyOf<DRScheduleDetail>.By<projectID> { }
			public class ProjectTask : CT.ContractTask.PK.ForeignKeyOf<DRScheduleDetail>.By<projectID, taskID> { }
		}
		#endregion
		...
		[PXDBDate]
		[PXDefault(typeof(Coalesce<Search<ARTran.dRTermStartDate, Where<ARTran.tranType, Equal<Current<docType>>,
									...
									Search<APTran.dRTermStartDate, Where<APTran.tranType, Equal<Current<docType>>,
											And<APTran.refNbr, Equal<Current<refNbr>>,
												And<APTran.lineNbr, Equal<Current<lineNbr>>,
												And<Current<DRSchedule.module>, Equal<BatchModule.moduleAP>>>>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
		...
		[PXDBDate]
		[PXDefault(typeof(Coalesce<Search<ARTran.dRTermEndDate, Where<ARTran.tranType, Equal<Current<docType>>,
											And<ARTran.refNbr, Equal<Current<refNbr>>,
												And<ARTran.lineNbr, Equal<Current<lineNbr>>,
												And<Current<DRSchedule.module>, Equal<BatchModule.moduleAR>>>>>>,
									Search<APTran.dRTermEndDate, Where<APTran.tranType, Equal<Current<docType>>,
											And<APTran.refNbr, Equal<Current<refNbr>>,
												And<APTran.lineNbr, Equal<Current<lineNbr>>,
												And<Current<DRSchedule.module>, Equal<BatchModule.moduleAP>>>>>>>), PersistingCheck = PXPersistingCheck.Nothing)]
