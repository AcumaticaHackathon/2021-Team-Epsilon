...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Width="100%" Height="250px" DataSourceID="ds" DataMember="CalendarDetails">
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="CSCalendarExceptions">
								...
								<RowTemplate>
									...
									<px:PXTimeSpan ID="edUnpaidTime" runat="server" DataField="UnpaidTime" InputMask="hh:mm" />
								...
								<Columns>
									...
									<px:PXGridColumn DataField="UnpaidTime" Width="90px" RenderEditorText="True" />
			...
			<px:PXTabItem Text="Break Times">
				<Template>
					<px:PXGrid runat="server" Height="100px" SkinID="DetailsInTab" Width="100%" ID="gridBreakTimes" DataSourceID="ds" AllowPaging="True" AdjustPageSize="Auto" AllowSearch="True">
						<AutoSize Enabled="True" MinWidth="100" MinHeight="100" />
						<Mode AllowDelete="True" />
						<Levels>
							<px:PXGridLevel DataMember="AMCalendarBreakTimes">
								<Mode AllowAddNew="True" AllowDelete="True" />
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
									<px:PXDropDown runat="server" ID="edDayOfWeekBT" TextField="Text" ValueField="Value" DataField="DayOfWeek" />
									<px:PXDateTimeEdit runat="server" ID="edStartTimeBT" EditFormat="t" DisplayFormat="t" TimeMode="true" DataField="StartTime" />
									<px:PXDateTimeEdit runat="server" ID="edEndTimeBT" EditFormat="t" DisplayFormat="t" TimeMode="true" DataField="EndTime" />
									<px:PXTextEdit runat="server" DataField="Description" ID="edDescriptionBT" />
                                </RowTemplate>
								<Columns>
									<px:PXGridColumn DataField="DayOfWeek" TextAlign="Right" Width="74px" />
									<px:PXGridColumn DataField="StartTime" TimeMode="true" Width="90px" />
									<px:PXGridColumn DataField="EndTime" TimeMode="true" Width="90px" />
									<px:PXGridColumn DataField="Description" Width="151px" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
