...
namespace PX.Objects.PR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<PRWorkCompensationBenefitRate>.By<workCodeID, deductCodeID, effectiveDate>
		{
			public static PRWorkCompensationBenefitRate Find(PXGraph graph, string workCodeID, int? deductCodeID, DateTime? effectiveDate) =>
