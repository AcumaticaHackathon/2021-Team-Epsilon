...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource  EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="TranslHistRecords" TypeName="PX.Objects.CM.TranslationHistoryMaint" 
        PageLoadBehavior="GoLastRecord" HeaderDescriptionField="Description">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%" DataMember="TranslHistRecords" Caption="Translation Summary" NoteIndicator="True" FilesIndicator="True" LinkIndicator="True" BPEventsIndicator="True"
