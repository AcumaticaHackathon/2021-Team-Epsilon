...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:pxdatasource id="ds" runat="server" visible="True" width="100%" typename="PX.Objects.CN.ProjectAccounting.CostProjectionEntry"
        primaryview="Document" borderstyle="NotSet" HeaderDescriptionField="FormCaptionDescription">
        <CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:pxtab id="tab" runat="server" width="100%" height="511px" datasourceid="ds" datamember="DocumentSettings">
        ...
        <ActionBar>
            <CustomItems>
                <px:PXToolBarButton Text="Add budget lines" Tooltip="Select lines from Project Budget">
...
<asp:Content ID="Dialogs" ContentPlaceHolderID="phDialogs" runat="Server">
    <px:pxsmartpanel id="AddCostBudgetPanel" runat="server" height="396px" width="850px" caption="Add Budget Lines" captionvisible="True" key="AvailableCostBudget" autocallback-command="Refresh"
