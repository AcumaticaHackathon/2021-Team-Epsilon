...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="ContractScheduleRecords" 
        TabIndex="5300" DefaultControlID="edSrvOrdType" NoteIndicator="True" BPEventsIndicator="True" FilesIndicator="True" AllowCollapse="True">
		<Template>
                <px:PXLayoutRule runat="server" StartRow="True" StartColumn="True" ControlSize = "M" LabelsWidth="SM">
                </px:PXLayoutRule>  
                <px:PXSelector ID="edEntityID" runat="server" DataField="EntityID" AutoRefresh="True" CommitChanges="True" AllowAddNew="True" FilterByAllFields="True">
                ...
                <px:PXDateTimeEdit ID="edScheduleStartTime" runat="server" DataField="ScheduleStartTime_Time" TimeMode="true" TextAlign="Right">
                </px:PXDateTimeEdit>
                <px:PXLayoutRule runat="server" Merge="True" LabelsWidth="SM" ControlSize="S"/>
                <px:PXMaskEdit ID="edScheduleDuration" runat="server" DataField="ScheduleDuration" CommitChanges="True" TextAlign="Right"/>
                <px:PXCheckBox ID="edOverrideDuration" runat="server" DataField="OverrideDuration" CommitChanges="True"/>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="550px" DataSourceID="ds" 
        DataMember="ContractScheduleSelected" MarkRequired="Dynamic">
        <Items>
                    ...
                    <px:PXGrid ID="PXGridDetails" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Height="100%" SkinID="DetailsInTab" TabIndex="2300" SyncPosition="True">
                        ...
                        <px:PXGridLevel 
                            ...
                            <RowTemplate>
                                ...
                                <px:PXDropDown ID="edLineType" runat="server" DataField="LineType" AutoRefresh="True">
                                </px:PXDropDown>                                                                      
                                ...
                                <px:PXSelector ID="edServiceTemplateID" runat="server" DataField="ServiceTemplateID" AllowEdit="True">
                                </px:PXSelector>
                                <px:PXMaskEdit ID="edUEstimatedDuration" runat="server" DataField="EstimatedDuration">
                                </px:PXMaskEdit>
                                ...
                                <px:PXSelector ID="edComponentID" runat="server" DataField="ComponentID" AutoRefresh="True">
                                </px:PXSelector>
								<px:PXSelector ID="edEquipmentLineRef" runat="server" DataField="EquipmentLineRef" AutoRefresh="True" >
								</px:PXSelector>
                                <px:PXTextEdit ID="edTranDesc" runat="server" DataField="TranDesc">
                                </px:PXTextEdit>
                                <px:PXSelector ID="edProjectTaskID" runat="server" DataField="ProjectTaskID" AutoRefresh="True">
                                </px:PXSelector>
                            ...
                            <Columns>
                                ...
                                <px:PXGridColumn DataField="Qty" TextAlign="Right" AllowDragDrop="true" CommitChanges="True">
                                </px:PXGridColumn>
