...
namespace PX.Objects.CA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CashAccountCheck>.By<accountID, paymentMethodID, checkNbr>
		{
			public static CashAccountCheck Find(PXGraph graph, int? accountID, string paymentMethodID, string checkNbr) 
				=> FindBy(graph, accountID, paymentMethodID, checkNbr);
		}

		public static class FK
		{
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CashAccountCheck>.By<accountID> { }
