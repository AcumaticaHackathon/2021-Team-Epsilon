...
namespace PX.Objects.AR
{
	...
	public partial class ARChildInvoice : ARInvoice
	{
		...
		{
			public static ARChildInvoice Find(PXGraph graph, string docType, string refNbr) => FindBy(graph, docType, refNbr);
		}
		#endregion
	...
	public partial class ARInvoice : ARRegister, IInvoice, ICreatePaymentDocument
	{
		...
		public class Events : PXEntityEvent<ARInvoice>.Container<Events>
		{
			...
			public PXEntityEvent<ARInvoice> UpdateStatus;
		}
		#endregion
		...
		[PXFormula(typeof(Switch<Case<Where<ARInvoice.customerLocationID, IsNotNull,
		...
		[PXDependsOnFields(
			...
			typeof(ARInvoice.pendingProcessing),
