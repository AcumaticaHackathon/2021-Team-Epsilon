...
namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CustomerPaymentMethod>.By<pMInstanceID>
		{
			public static CustomerPaymentMethod Find(PXGraph graph, int? pMInstanceID) => FindBy(graph, pMInstanceID);
		}
		public static class FK
		{
			public class Customer : AR.Customer.PK.ForeignKeyOf<CustomerPaymentMethod>.By<bAccountID> { }
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CustomerPaymentMethod>.By<cashAccountID> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<CustomerPaymentMethod>.By<paymentMethodID> { }
		}
		#endregion
		...
		[pMInstanceID.PMInstanceIDSelector (DescriptionField = typeof(CustomerPaymentMethod.paymentMethodID))]
		...
		[CashAccount(null, typeof(Search2<CashAccount.cashAccountID, InnerJoin<PaymentMethodAccount,
									...
									And<PaymentMethodAccount.useForAR,Equal<True>>>>>>), DisplayName = "Cash Account", DescriptionField = typeof(CashAccount.descr), Visibility = PXUIVisibility.Visible)]
		...
		[PXUIField(DisplayName = "Card/Account Nbr.", Enabled = false, Visibility = PXUIVisibility.SelectorVisible)]
