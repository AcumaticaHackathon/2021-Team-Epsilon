...
namespace PX.Objects.PR
{
	...
	public class PROvertimeRule : IBqlTable
	{
		...
		{
			public static PROvertimeRule Find(PXGraph graph, string overtimeRuleID) => FindBy(graph, overtimeRuleID);
		}

		public static class FK
		{
			public class DisbursingEarningType : EPEarningType.PK.ForeignKeyOf<PROvertimeRule>.By<disbursingTypeCD> { }
			//public class State : CS.State.PK.ForeignKeyOf<PROvertimeRule>.By<LocationConstants.CountryUS, state> { }
