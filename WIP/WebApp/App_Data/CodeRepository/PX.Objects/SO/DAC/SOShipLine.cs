...
namespace PX.Objects.SO
{
	...
	public partial class SOShipLine : PX.Data.IBqlTable, ILSPrimary, IHasMinGrossProfit, ISortOrder
	{
		...
		{
			public static SOShipLine Find(PXGraph graph, string shipmentType, string shipmentNbr, int? lineNbr)
				=> FindBy(graph, shipmentType, shipmentNbr, lineNbr);
		}
		...
		public static class FK
		{
			...
			public class Task : PMTask.PK.ForeignKeyOf<SOShipLine>.By<taskID> { }
			...
			//todo public class OrderUnitOfMeasure : INUnit.PK.ForeignKeyOf<SOShipLine>.By<inventoryID, orderUOM> { }
			//todo public class UnitOfMeasure : INUnit.PK.ForeignKeyOf<SOShipLine>.By<inventoryID, uOM> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OrderLineSplit instead.")]
			public class OrigLineSplit : OrderLineSplit { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use PlanType instead.")]
			public class OrigPlanType : PlanType { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OrderType instead.")]
			public class OrigOrderType : OrderType { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OrderLine instead.")]
			public class OrigLine : OrderLine { }
		}
		#endregion
