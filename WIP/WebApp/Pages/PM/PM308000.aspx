...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource  UDFTypeField="ClassID" EnableAttributes="True" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.PM.ChangeOrderEntry" PrimaryView="Document" BorderStyle="NotSet" HeaderDescriptionField="FormCaptionDescription">
        <CallbackCommands>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="RevenueBudget">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edInventoryIDRB" runat="server" DataField="InventoryID" AutoRefresh="true" />
                                    <px:PXSegmentMask ID="edRevenueBudgetedAccountGroupID" runat="server" DataField="AccountGroupID" AutoRefresh="true" />
                                    <px:PXSelector ID="edRevenueBudgetedUOM" runat="server" DataField="UOM" AutoRefresh="true" />
                                </RowTemplate>
                                <Columns>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="CostBudget">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edInventoryIDCB" runat="server" DataField="InventoryID" AutoRefresh="true" />
                                    <px:PXSegmentMask ID="edCostBudgetAccountGroupID" runat="server" DataField="AccountGroupID" AutoRefresh="true" />
                                    <px:PXSelector ID="edCostBudgetUOM" runat="server" DataField="UOM" AutoRefresh="true" />
                                </RowTemplate>
                                <Columns>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Details">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edInventoryIDDet" runat="server" DataField="InventoryID" AutoRefresh="true" />
                                    <px:PXSelector runat="server" ID="edPOOrderNbr2" DataField="POOrderNbr" AutoRefresh="True" />
                                    <px:PXSelector runat="server" ID="edCommitmentUOM" DataField="UOM" AutoRefresh="true" />
                                    <px:PXSelector runat="server" ID="edCommitmentCuryId" DataField="CuryID" AutoRefresh="true" />
                                    <px:PXSelector runat="server" ID="edPOLineNbr" DataField="POLineNbr" AutoRefresh="true" />
                                    <px:PXSegmentMask runat="server" ID="edVendorID" DataField="VendorID" AutoRefresh="true" />
                                </RowTemplate>
                                <Columns>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ComplianceDocuments">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CostTaskID" TextAlign="Left" CommitChanges="True" LinkCommand="ComplianceViewCostTask" />
                                    <px:PXGridColumn DataField="RevenueTaskID" TextAlign="Left" CommitChanges="True" LinkCommand="ComplianceViewRevenueTask" />
                                    <px:PXGridColumn DataField="CostCodeID" TextAlign="Left" CommitChanges="True" LinkCommand="ComplianceViewCostCode" />
