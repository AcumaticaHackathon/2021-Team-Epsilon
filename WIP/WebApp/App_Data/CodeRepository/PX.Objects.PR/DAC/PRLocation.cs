...
namespace PX.Objects.PR
{
	...
	public class PRLocation : IBqlTable
	{
		...
		{
			public static PRLocation Find(PXGraph graph, int? locationID) => FindBy(graph, locationID);
		}

		public class UK : PrimaryKeyOf<PRLocation>.By<locationCD>
		{
			public static PRLocation Find(PXGraph graph, string locationCD) => FindBy(graph, locationCD);
		}
