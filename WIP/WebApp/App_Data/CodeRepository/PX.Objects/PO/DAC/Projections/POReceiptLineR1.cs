...
namespace PX.Objects.PO
{
	...
	public partial class POReceiptLineR1 : IBqlTable, ISortOrder
	{
		...
		{
			public class Receipt : POReceipt.UK.ForeignKeyOf<POReceiptLineR1>.By<receiptType, receiptNbr> { }
			...
			public class SiteStatus : IN.INSiteStatus.PK.ForeignKeyOf<POReceiptLineR1>.By<inventoryID, subItemID, siteID> { }
