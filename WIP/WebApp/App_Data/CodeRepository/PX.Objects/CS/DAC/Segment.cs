...
namespace PX.Objects.CS
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<Segment>.By<dimensionID, segmentID>
		{
			public static Segment Find(PXGraph graph, String dimensionID, Int16? segmentID) => FindBy(graph, dimensionID, segmentID);
		}
		public static class FK
		{
			public class Dimension : CS.Dimension.PK.ForeignKeyOf<Segment>.By<dimensionID> { }
		}
		#endregion
