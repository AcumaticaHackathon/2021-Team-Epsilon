...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLTax>.By<module, batchNbr, lineNbr, detailType, taxID>
		{
			public static GLTax Find(PXGraph graph, String module, String batchNbr, Int32? lineNbr, Int16? detailType, String taxID) => FindBy(graph, module, batchNbr, lineNbr, detailType, taxID);
		}
		public static class FK
		{
			public class Batch : GL.GLDocBatch.PK.ForeignKeyOf<GLTax>.By<module, batchNbr> { }
			public class JournalVoucher : GL.GLTranDoc.PK.ForeignKeyOf<GLTax>.By<module, batchNbr, lineNbr> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<GLTax>.By<curyInfoID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<GLTax>.By<taxID> { }
		}
		#endregion
