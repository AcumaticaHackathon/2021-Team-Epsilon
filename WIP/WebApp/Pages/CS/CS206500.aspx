...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" TypeName="PX.Objects.CS.TermsMaint" runat="server" Visible="True" Width="100%" PrimaryView="TermsDef" HeaderDescriptionField="Descr">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="TermsDef" Caption="Credit Terms" DefaultControlID="edTermsID" DataSourceID="ds" TabIndex="2500">
		<Template>
			...
			<px:PXDropDown ID="edVisibleTo" runat="server" DataField="VisibleTo" CommitChanges="true" />
			...
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" GroupCaption="Sales Order Prepayment Settings" StartGroup="True" />
			<px:PXCheckBox ID="chkPrepayemntRequired" runat="server" DataField="PrepaymentRequired" CommitChanges="true" />
			<px:PXNumberEdit ID="edPrepaymentPct" runat="server" DataField="PrepaymentPct" CommitChanges="true" />
			<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Installments Settings" />
