...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="DocType" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AR.ARInvoiceEntry" PrimaryView="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="AddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,Billing_Address" CommitChanges="true" Visible="false" />
			<px:PXDSCallbackCommand Name="ShippingAddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,Shipping_Address" CommitChanges="true" Visible="false" />
			<px:PXDSCallbackCommand Name="GenerateOrViewIntercompanyBill" Visible="False" CommitChanges="true" />
			<px:PXDSCallbackCommand Name="ViewRelatedAPDocument" CommitChanges="true" Visible="false"/>
			<px:PXDSCallbackCommand Name="FSARTran$RelatedDocument$Link" Visible="false" CommitChanges="True" DependOnGrid="grid" />
		</CallbackCommands>
		<DataTrees>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="Document" Caption="Invoice Summary" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity" LinkIndicator="True"
		BPEventsIndicator="True" EmailingGraph="PX.Objects.CR.CREmailActivityMaint,PX.Objects" DefaultControlID="edDocType" TabIndex="100" MarkRequired="Dynamic">
		<CallbackCommands>
			<Save PostData="Self" />
		</CallbackCommands>
		<Template>
		...
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								<Columns>
									...
									<px:PXGridColumn DataField="FSARTran__RelatedDocument" Visible="false" RenderEditorText="True" LinkCommand="FSARTran$RelatedDocument$Link"/>
			...
			<px:PXTabItem Text="Financial Details">
				<Template>
					...
					<px:PXLayoutRule runat="server" GroupCaption="Default Payment Info" ControlSize="M" LabelsWidth="M" />
					...
					<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="M" GroupCaption="Tax Info" StartGroup="True" />
					...
					<px:PXLayoutRule runat="server" GroupCaption="Assigned To" StartGroup="True" ControlSize="M" LabelsWidth="M" />
					...
					<px:PXLayoutRule runat="server" StartColumn="False" LabelsWidth="SM" ControlSize="XM" GroupCaption="Intercompany Invoicing" StartGroup="True" />
					<px:PXTextEdit ID="edIntercompanyBill" runat="server" DataField="RelatedIntercompanyAPDocument.DocumentKey" Enabled="false" AllowEdit="True">
						<LinkCommand Target="ds" Command="ViewRelatedAPDocument"/>
					</px:PXTextEdit>
					<px:PXCheckBox ID="edIsHiddenInIntercompanySales" runat="server" DataField="IsHiddenInIntercompanySales" AlignLeft="true" />

					<px:PXLayoutRule runat="server" GroupCaption="Print and Email Options" StartGroup="True" ControlSize="M" LabelsWidth="M" />
					<px:PXLayoutRule runat="server" Merge="True" />
					...
					<px:PXLayoutRule runat="server" GroupCaption="Dunning Info" ControlSize="M" LabelsWidth="M" StartGroup="true" StartColumn="true"/>
					<px:PXFormView ID="DunningForm" runat="server" DataMember="dunningLetterDetail" RenderStyle="Simple">
						<Template>
							<px:PXLayoutRule runat="server" StartGroup="True" ControlSize="M" LabelsWidth="M" />
					...
					<px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="M" GroupCaption="Voucher Details" />
