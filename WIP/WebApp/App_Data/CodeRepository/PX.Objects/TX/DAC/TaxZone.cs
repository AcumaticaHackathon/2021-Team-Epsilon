...
namespace PX.Objects.TX
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<TaxZone>.By<taxZoneID>
		{
			public static TaxZone Find(PXGraph graph, String taxZoneID) => FindBy(graph, taxZoneID);
		}
		public static class FK
		{
			public class DefaultTaxCategory : TX.TaxCategory.PK.ForeignKeyOf<TaxZone>.By<dfltTaxCategoryID> { }
			public class Provider : TX.TaxCategory.PK.ForeignKeyOf<TaxZone>.By<taxPluginID> { }
			public class TaxAgency : AP.Vendor.PK.ForeignKeyOf<TaxZone>.By<taxVendorID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<TaxZone>.By<taxID> { }
		}
		#endregion
