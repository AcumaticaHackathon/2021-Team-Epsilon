...
namespace PX.Objects.CS
{
	public class FeaturesMaint : PXGraph<FeaturesMaint>
	{
		...
		{
			VerifyRecognitionFeature(e, InvoiceRecognitionService);
		}
		...
		private static void VerifyRecognitionFeature<F>(Events.FieldVerifying<F> e, IInvoiceRecognitionService service)
