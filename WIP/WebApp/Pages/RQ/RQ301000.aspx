...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" UDFTypeField="ReqClassID" Visible="True" TypeName="PX.Objects.RQ.RQRequestEntry" PrimaryView="Document" BorderStyle="NotSet" Width="100%">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="ValidateAddresses" StartNewGroup="True" CommitChanges="True" />
            ...
            <px:PXDSCallbackCommand Name="AddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,fShipping_Address" CommitChanges="true" Visible="false" />
        </CallbackCommands>
    </px:PXDataSource>
            ...
            <Levels>
                <px:PXGridLevel DataMember="Contents">
                    ...
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="RQRequisitionLineReceived__InventoryID" DisplayFormat="&gt;AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA" AllowUpdate="False" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <px:PXTab ID="tab" runat="server" Height="504px" Style="z-index: 100;" Width="100%" DataSourceID="ds" DataMember="CurrentDocument">
        ...
        <Items>
            ...
            <px:PXTabItem Text="Budget" VisibleExp="DataControls[&quot;chkBudgetValidation&quot;].Checked == true" RepaintOnDemand="false">
                <Template>
