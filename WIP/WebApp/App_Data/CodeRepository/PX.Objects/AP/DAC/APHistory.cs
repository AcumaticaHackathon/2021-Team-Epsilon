namespace PX.Objects.AP
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<APHistory>.By<branchID, accountID, subID, vendorID, finPeriodID>
		{
			public static APHistory Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, Int32? vendorID, String finPeriodID) => FindBy(graph, branchID, accountID, subID, vendorID, finPeriodID);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<APHistory>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<APHistory>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<APHistory>.By<subID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APHistory>.By<vendorID> { }
		}
		#endregion
