...
namespace PX.Objects.CA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CABankTranHeader>.By<cashAccountID, refNbr, tranType>
		{
			public static CABankTranHeader Find(PXGraph graph, int? cashAccountID, string refNbr, string tranType) => FindBy(graph, cashAccountID, refNbr, tranType);
		}

		public static class FK
		{
			public class CashAcccount : CA.CashAccount.PK.ForeignKeyOf<CABankTranHeader>.By<cashAccountID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<CABankTranHeader>.By<curyID> { }
		}
