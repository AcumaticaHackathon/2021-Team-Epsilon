namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<AccountClass>.By<accountClassID>
		{
			public static AccountClass Find(PXGraph graph, string accountClassID) => FindBy(graph, accountClassID);
		}
		#endregion
