...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource  EnableAttributes="true" UDFTypeField="ShipmentType" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.SO.SOShipmentEntry" PrimaryView="Document">
        <DataTrees>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Shipment Summary" NoteIndicator="True" FilesIndicator="True" LinkIndicator="true"
        BPEventsIndicator="true" EmailingGraph="PX.Objects.CR.CREmailActivityMaint,PX.Objects" ActivityIndicator="true" ActivityField="NoteActivity" DefaultControlID="edShipmentNbr" MarkRequired="Dynamic">
        <CallbackCommands>
            <Save PostData="Self" />
        </CallbackCommands>
        ...
        <Template>
            ...
            <px:PXNumberEdit ID="edControlQty" runat="server" DataField="ControlQty" CommitChanges="True" />
            ...
            <px:PXLayoutRule runat="server" ColumnSpan="2" StartRow="true" LabelsWidth="S" />
            <px:PXTextEdit ID="edShipmentDesc" runat="server" DataField="ShipmentDesc" />
        </Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
            ...
            <px:PXTabItem Text="Details">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="height: 250px;" Width="100%" SkinID="DetailsInTab" StatusField="Availability" SyncPosition="true" Height="372px" TabIndex="-7372">
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LSSOShipLine_binLotSerial" CommandSourceID="ds" DependOnGrid="grid" />
                ...
                <Template>
                    ...
                    <px:PXFormView ID="formI" runat="server" DataSourceID="ds" DataMember="CurrentDocument" Caption="Intercompany Purchase" RenderStyle="Fieldset">
                        <Template>
                            ...
                            <px:PXSelector ID="edIntercompanyPOReceiptNbr" runat="server" DataField="IntercompanyPOReceiptNbr" AllowEdit="True" Enabled="False" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 500px;" Width="764px" Caption="Line Details" CaptionVisible="True"
    ...
    <%-- Carrier Rates --%>
    <px:PXSmartPanel ID="PanelCarrierRates" Width="900" runat="server" Caption="Shop For Rates" CaptionVisible="True" LoadOnDemand="True" ShowAfterLoad="True" Key="CurrentDocument"
        ...
        <px:PXGrid ID="gridPackagesForRates" runat="server" Width="100%" DataSourceID="ds" Style="border-width: 1px 1px; left: 0px; top: 0px;"
            AutoAdjustColumns="true" Caption="Packages" SkinID="Details" Height="100px" CaptionVisible="True" AllowPaging="False">
            ...
            <Levels>
                <px:PXGridLevel DataMember="PackagesForRates">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="BoxDescription" Label="Description" />
