...
namespace PX.Commerce.Shopify.API.REST
{
	...
	[CommerceDescription(ShopifyCaptions.OrderData)]
	public class OrderData : BCAPIEntity
	{
		...
		[CommerceDescription(ShopifyCaptions.ShippingAddress)]
		...
		[CommerceDescription(ShopifyCaptions.SubtotalSet)]
		...
		[CommerceDescription(ShopifyCaptions.ItemsTotalSet)]
		...
		[CommerceDescription(ShopifyCaptions.OrderTotalSet)]
		...
		[CommerceDescription(ShopifyCaptions.TotalTaxSet)]
		...
		/// </summary>
		[ShouldNotSerialize]
		[CommerceDescription(ShopifyCaptions.OrderRisk)]
