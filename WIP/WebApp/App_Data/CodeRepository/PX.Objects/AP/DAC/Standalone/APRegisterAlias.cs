...
namespace PX.Objects.AP.Standalone
{
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<APRegisterAlias>.By<docType, refNbr>
		{
			public static APRegisterAlias Find(PXGraph graph, string docType, string refNbr) => FindBy(graph, docType, refNbr);
		}
		public new static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<APRegisterAlias>.By<branchID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APRegisterAlias>.By<vendorID> { }
			public class VendorLocation : CR.Location.PK.ForeignKeyOf<APRegisterAlias>.By<vendorID, vendorLocationID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<APRegisterAlias>.By<curyInfoID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<APRegisterAlias>.By<curyID> { }
			public class APAccount : GL.Account.PK.ForeignKeyOf<APRegisterAlias>.By<aPAccountID> { }
			public class APSubaccount : GL.Sub.PK.ForeignKeyOf<APRegisterAlias>.By<aPSubID> { }
			public class Schedule : GL.Schedule.PK.ForeignKeyOf<APRegisterAlias>.By<scheduleID> { }
			public class RetainageAccount : GL.Account.PK.ForeignKeyOf<APRegisterAlias>.By<retainageAcctID> { }
			public class RetainageSubaccount : GL.Sub.PK.ForeignKeyOf<APRegisterAlias>.By<retainageSubID> { }
		}
		#endregion
