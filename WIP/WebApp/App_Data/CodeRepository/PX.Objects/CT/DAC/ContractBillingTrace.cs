...
namespace PX.Objects.CT
{
    ...
    {
      #region Keys
      public class PK : PrimaryKeyOf<ContractBillingTrace>.By<contractID, recordID>
      {
         public static ContractBillingTrace Find(PXGraph graph, int? contractID, Int32? recordID) => FindBy(graph, contractID, recordID);
      }
      public static class FK
      {
         public class Contract : CT.Contract.PK.ForeignKeyOf<ContractBillingTrace>.By<contractID> { }
      }
      #endregion
      #region ContractID
