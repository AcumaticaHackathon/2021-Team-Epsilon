...
namespace PX.Objects.CM
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CurrencyInfo>.By<curyInfoID>
		{
			public static CurrencyInfo Find(PXGraph graph, Int64? curyInfoID) => FindBy(graph, curyInfoID);
		}
		public static class FK
		{
			public class Currency : CM.Currency.PK.ForeignKeyOf<CurrencyInfo>.By<curyID> { }
			public class BaseCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyInfo>.By<baseCuryID> { }
			public class CurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<CurrencyInfo>.By<curyRateTypeID> { }
		}
		#endregion
		...
		private sealed class CuryEffDateAttribute : PXEventSubscriberAttribute, IPXFieldUpdatedSubscriber
		{
			public void FieldUpdated(PXCache sender, PXFieldUpdatedEventArgs e)
			{
				...
				if (info != null)
				{
					if (info.CuryRateTypeID == null && info.CuryRate != null && info.RecipRate != null) return;
					try
					{
						info.defaultCuryRate(sender);
					}
