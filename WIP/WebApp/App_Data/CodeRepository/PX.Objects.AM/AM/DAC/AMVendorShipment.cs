...
namespace PX.Objects.AM
{
    ...
    public class AMVendorShipment : IBqlTable, INotable
    {
        ...
        [PXDefault((object)null, typeof(Coalesce<
            Search<LocationBranchSettings.vSiteID, Where<Current<AMVendorShipment.shipDestType>, Equal<POShippingDestination.site>,
                And<LocationBranchSettings.bAccountID, Equal<Current<AMVendorShipment.vendorID>>,
                And<LocationBranchSettings.locationID, Equal<Current<AMVendorShipment.vendorLocationID>>,
                And<LocationBranchSettings.branchID, Equal<Current<AMVendorShipment.branchID>>>>>>>,
            Search<Location.vSiteID, Where<Current<AMVendorShipment.shipDestType>, Equal<POShippingDestination.site>,
