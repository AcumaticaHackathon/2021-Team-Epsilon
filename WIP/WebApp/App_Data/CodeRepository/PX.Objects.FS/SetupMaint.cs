...
namespace PX.Objects.FS
{
    public class SetupMaint : PXGraph<SetupMaint>
    {
        ...
        {
            UpdateBillingInfoInDocsLOInt(callerGraph, currentCustomerID, currentBillingCycleID);
        }

        public virtual void PreUpdateBillingInfoDocs(PXGraph callerGraph, int? currentCustomerID, int? currentBillingCycleID)
        {
            PreUpdateBillingInfoDocsInt(callerGraph, currentCustomerID, currentBillingCycleID);
        }
        #endregion

        #region Static Methods
        public static void UpdateBillingInfoInDocsLOInt(PXGraph callerGraph, int? currentCustomerID, int? currentBillingCycleID)
        {
        ...
        public static void PreUpdateBillingInfoDocsInt(PXGraph callerGraph, int? currentCustomerID, int? currentBillingCycleID)
        {
            if (currentBillingCycleID != null)
            {
                PXUpdateJoin<
                    Set<FSServiceOrder.cBID, Null,
                    Set<FSServiceOrder.billingBy, Null>>,
                FSServiceOrder,
        ...
        protected virtual void _(Events.RowPersisted<FSSetup> e)
        {
            ...
            if (e.Operation == PXDBOperation.Update
                    && e.TranStatus == PXTranStatus.Open
                        && fsSetupRow.BillingOptionsChanged == true)
            {
                PreUpdateBillingInfoDocs(this, null, null);
            }
