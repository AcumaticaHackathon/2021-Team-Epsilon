...
namespace PX.Objects.AR
{
	...
	public partial class ARStatementDetailInfo : ARStatementDetail
	{
		#region Keys
		// <exclude/>
		public new class PK : PrimaryKeyOf<ARStatementDetailInfo>.By<branchID, customerID, curyID, statementDate, docType, refNbr>
		{
			public static ARStatementDetailInfo Find(PXGraph graph, Int32? branchID, Int32? customerID, String curyID, DateTime? statementDate, String docType, String refNbr)
													=> FindBy(graph, branchID, customerID, curyID, statementDate, docType, refNbr);
		}
