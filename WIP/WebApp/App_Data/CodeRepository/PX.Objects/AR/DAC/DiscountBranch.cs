...
namespace PX.Objects.AR
{
	...
	public partial class DiscountBranch : PX.Data.IBqlTable
	{
      ...
      {
         public class DiscountSequence : AR.DiscountSequence.PK.ForeignKeyOf<DiscountBranch>.By<discountID, discountSequenceID> { }
         public class Branch : GL.Branch.PK.ForeignKeyOf<DiscountBranch>.By<branchID> { }
      }
      
      [Obsolete("Use DiscountBranch.FK.DiscountSequence")]
      public class DiscountSequenceFK : DiscountSequence.PK.ForeignKeyOf<DiscountBranch>.By<discountID, discountSequenceID> { }
      [Obsolete("Use DiscountBranch.FK.Branch")]
