...
namespace PX.Objects.PR
{
	...
	public class PREmployeeDirectDeposit : IBqlTable, ISortOrder
	{
		...
		{
			public static PREmployeeDirectDeposit Find(PXGraph graph, int? bAccountID, int? lineNbr) =>
				FindBy(graph, bAccountID, lineNbr);
		}
		...
		[PXDBString(30, IsUnicode = true, InputMask = "000000000000000000")]
		[PXDefault]
