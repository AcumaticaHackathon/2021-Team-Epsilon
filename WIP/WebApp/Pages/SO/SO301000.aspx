            ...
            <Levels>
                <px:PXGridLevel DataMember="invoicesplits">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="DropShip" Type="CheckBox" />
                    </Columns>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Order Summary"
        ...
        <Template>
            ...
            <px:PXSelector runat="server" ID="edContactID" DataField="ContactID" AllowEdit="True" DataSourceID="ds" AllowAddNew="True" AutoRefresh="True" CommitChanges="True" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <px:PXTab ID="tab" runat="server" Height="540px" Style="z-index: 100;" Width="100%">
        <Items>
                    ...
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Width="100%"
                        ...
                        <ActionBar>
                            <CustomItems>
                                ...
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LSSOLine_binLotSerial" CommandSourceID="ds" DependOnGrid="grid">
                                    <AutoCallBack>
                                        <Behavior CommitChanges="True" PostData="Page" />
                                    </AutoCallBack>
                                </px:PXToolBarButton>
            ...
            <px:PXTabItem Text="Discounts" VisibleExp="DataControls[&quot;edOrderType&quot;].Value!=TR" BindingContext="form" RepaintOnDemand="false">
                <Template>
                ...
                <Template>
                    ...
                    <px:PXFormView ID="formOrderTotals" runat="server" Caption="Order Totals" DataMember="CurrentDocument" DataSourceID="ds" RenderStyle="Fieldset">
                        <Template>
                            ...
                            <px:PXNumberEdit ID="edCuryMiscTot" runat="server" Enabled="False" DataField="CuryMiscTot" Size="XM" />
                            <px:PXNumberEdit ID="edCuryTaxTotal" runat="server" DataField="CuryTaxTotal" Enabled="False" Size="XM" />
                        </Template>
                        <ContentStyle BackColor="Transparent" BorderStyle="None" />
                    </px:PXFormView>
                    <px:PXFormView ID="formCalculatedAmounts" runat="server" Caption="Calculated Amounts and Quantities" DataMember="CurrentDocument" DataSourceID="ds" RenderStyle="Fieldset">
                        <Template>
                            <px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="90%" Height="500px" Caption="Line Details" CaptionVisible="True" Key="lsselect"
