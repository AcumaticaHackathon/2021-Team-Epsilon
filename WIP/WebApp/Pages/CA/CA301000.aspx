...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource  EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Transfer" TypeName="PX.Objects.CA.CashTransferEntry">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Visible="False" Name="ViewExpenseTaxes" />
			<px:PXDSCallbackCommand Visible="false" Name="CAReversingTransfers" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Width="100%" DataMember="Transfer" Caption="Transfer summary" NoteIndicator="True" FilesIndicator="True" ActivityIndicator="True" 
		ActivityField="NoteActivity" LinkIndicator="True" BPEventsIndicator="True" DefaultControlID="edTransferNbr" AllowCollapse="true" MarkRequired="Dynamic" >
		<Template>
			...
			<px:PXSelector ID="edOrigTransferNbr" runat="server" DataField="OrigTransferNbr" Enabled="False" AllowEdit="True" DataSourceID="ds" />
            <px:PXNumberEdit ID="edReverseCount" runat="server" DataField="ReverseCount" Enabled="False">
                <LinkCommand Target="ds" Command="CAReversingTransfers"></LinkCommand>
            </px:PXNumberEdit>
			...
			<px:PXPanel ID="PXPanelCredit" runat="server" Caption="Destination Account" Width="100%" RenderStyle="Fieldset">
				...
				<px:PXSegmentMask CommitChanges="True" ID="edInAccountID" runat="server" DataField="InAccountID" TabIndex="8" AutoRefresh ="true"/>
		...
		<Levels>
			<px:PXGridLevel DataMember="Expenses">
                <RowTemplate>>
					...
					<px:PXSegmentMask ID="edCashAccountID" runat="server" DataField="CashAccountID" AutoRefresh="True"/>
                </RowTemplate>
				<Columns>
					...
					<px:PXGridColumn DataField="CuryTaxableAmt" CommitChanges="true"/>
					<px:PXGridColumn DataField="CuryTaxTotal" CommitChanges="true" LinkCommand="ViewExpenseTaxes"/>
					...
					<px:PXGridColumn DataField="TaxCalcMode" CommitChanges="true"/>
					...
					<px:PXGridColumn DataField="CuryTaxRoundDiff" />
				</Columns>
			</px:PXGridLevel>
		</Levels>
		<AutoSize Container="Window" Enabled="True" MinHeight="150" />
	</px:PXGrid>
	 <px:PXSmartPanel ID="PXTaxPanel" runat="server" CaptionVisible="True" Key="ExpenseTaxTrans" AcceptButtonID="Ok"  AutoRepaint="true" AutoReload="true"
         Width="764px" Height="360px" Caption="Expense Taxes" >
      <px:PXLayoutRule ID="PXLayoutRule232" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM"  />
        <px:PXGrid ID="PXGrid1" runat="server" Width="100%"
            ...
            <Levels>
                <px:PXGridLevel DataMember="ExpenseTaxTrans">
                   	<Columns>
        ...
        <px:PXPanel ID="PXPanel1" runat="server" SkinID="Buttons">
            <px:PXButton ID="PXButton1" runat="server" DialogResult="Yes" Text="Ok" CommandSourceID="ds" />
        </px:PXPanel>
    </px:PXSmartPanel>
</asp:Content>