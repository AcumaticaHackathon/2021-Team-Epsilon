				...
				<Template>
					...
					<px:PXGroupBox CommitChanges="True" RenderStyle="Simple" ID="gbMonthly" runat="server" DataField="MonthlyDaySel" Caption="Monthly" RenderSimple="True">
						<Template>
							...
							<px:PXLayoutRule runat="server" Merge="True"/>
							<px:PXRadioButton ID="rbOnDay" runat="server" Size="SM" GroupName="gbMonthly" Text="On Day" Value="D" />
							<px:PXDropDown ID="edMonthlyOnDay" runat="server" DataField="MonthlyOnDay" SelectedIndex="-1" CommitChanges="True" Size="xs" SuppressLabel="True" />
							<px:PXLayoutRule runat="server" ControlSize="M" LabelsWidth="S"/>
							<px:PXLayoutRule runat="server" Merge="True"/>
							<px:PXRadioButton ID="rbOnDayOfWeek" runat="server" Size="SM" GroupName="gbMonthly" Text="On the" Value="W" />
							<px:PXDropDown ID="edMonthlyOnWeek" runat="server" CommitChanges="True" DataField="MonthlyOnWeek" SelectedIndex="-1" Size="xs" SuppressLabel="True"/>
							<px:PXDropDown ID="edMonthlyOnDayOfWeek" runat="server" CommitChanges="True" DataField="MonthlyOnDayOfWeek" SelectedIndex="-1" Size="s" SuppressLabel="True" />
							<px:PXLayoutRule runat="server" />
						</Template>
					</px:PXGroupBox>
