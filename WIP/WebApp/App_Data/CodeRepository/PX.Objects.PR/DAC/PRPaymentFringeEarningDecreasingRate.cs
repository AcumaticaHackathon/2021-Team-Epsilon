...
namespace PX.Objects.PR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<PRPaymentFringeEarningDecreasingRate>.By<recordID>
		{
			public static PRPaymentFringeEarningDecreasingRate Find(PXGraph graph, int? recordID) => FindBy(graph, recordID);
		}

		public class UK : PrimaryKeyOf<PRPaymentFringeEarningDecreasingRate>.By<docType, refNbr, earningTypeCD, projectID, projectTaskID, laborItemID>
		{
			public static PRPaymentFringeEarningDecreasingRate Find(PXGraph graph, string docType, string refNbr, string earningTypeCD, int? projectID, int? projectTaskID, int? laborItemID) =>
				FindBy(graph, docType, refNbr, earningTypeCD, projectID, projectTaskID, laborItemID);
		}

		public static class FK
		{
			public class Payment : PRPayment.PK.ForeignKeyOf<PRPaymentFringeEarningDecreasingRate>.By<docType, refNbr> { }
			public class Project : PMProject.PK.ForeignKeyOf<PRPaymentFringeEarningDecreasingRate>.By<projectID> { }
			public class LaborItem : InventoryItem.PK.ForeignKeyOf<PRPaymentFringeEarningDecreasingRate>.By<laborItemID> { }
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PRPaymentFringeEarningDecreasingRate>.By<projectTaskID> { }
			public class EarningType : EPEarningType.PK.ForeignKeyOf<PRPaymentFringeEarningDecreasingRate>.By<earningTypeCD> { }
		}
		#endregion
