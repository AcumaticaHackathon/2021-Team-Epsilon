...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FATran>.By<refNbr, lineNbr>
		{
			public static FATran Find(PXGraph graph, String refNbr, Int32? lineNbr) => FindBy(graph, refNbr, lineNbr);
		}
		public static class FK
		{
			public class FixedAsset : FA.FixedAsset.PK.ForeignKeyOf<FATran>.By<assetID> { }
			public class Book : FA.FABook.PK.ForeignKeyOf<FATran>.By<bookID> { }
			public class DebitAccount : GL.Account.PK.ForeignKeyOf<FATran>.By<debitAccountID> { }
			public class DebitSubaccount : GL.Sub.PK.ForeignKeyOf<FATran>.By<debitSubID> { }
			public class CreditAccount : GL.Account.PK.ForeignKeyOf<FATran>.By<creditAccountID> { }
			public class CreditSubaccount : GL.Sub.PK.ForeignKeyOf<FATran>.By<creditSubID> { }
			public class AssetClass : FA.FAClass.PK.ForeignKeyOf<FATran>.By<classID> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<FATran>.By<branchID> { }
			public class Employee : EP.EPEmployee.PK.ForeignKeyOf<FATran>.By<employeeID> { }
			public class Department : EP.EPDepartment.PK.ForeignKeyOf<FATran>.By<department> { }
			public class FAAccrualTransaction : GL.Branch.PK.ForeignKeyOf<FAAccrualTran>.By<gLtranID> { }
		}
		#endregion
		...
		[PXDate]
		[PXDefault(typeof(Switch<Case<Where<Selector<classID, FixedAsset.underConstruction>, NotEqual<True>>, receiptDate>, Null>), PersistingCheck = PXPersistingCheck.Nothing)]
