...
namespace PX.Objects.FS
{
    ...
    public class FSServiceOrder : PX.Data.IBqlTable
	{
        ...
        {
            public static FSServiceOrder Find(PXGraph graph, int? sOID) => FindBy(graph, sOID);
        }
        ...
        public static class FK
        {
            ...
            public class ProjectTask : PMTask.PK.ForeignKeyOf<FSServiceOrder>.By<dfltProjectTaskID> { }
            ...
            public class CustomerBillingSetup : FSCustomerBillingSetup.PK.ForeignKeyOf<FSServiceOrder>.By<cBID> { }
        ...
        [PXUIVerify(typeof(
            Where<Current<FSSrvOrdType.active>, Equal<True>>), 
        ...
        [PXRestrictor(typeof(
            Where<Location.isActive, Equal<True>>), IN.Messages.InactiveLocation, typeof(Location.locationCD))]
        ...
        [PXDBString(2, IsFixed = true)]
        [PXUIField(DisplayName = "Billing By")]
        ...
        [PXDBScalar(typeof(Search<FSContractPeriod.invoiced, Where<FSContractPeriod.serviceContractID, Equal<FSServiceOrder.billServiceContractID>, 
        ...
        [PXFormula(typeof(Switch<Case<
                                ...
                                Selector<branchLocationID, FSBranchLocation.descr>>,
                                Selector<customerID, BAccountSelectorBase.acctName>>))]
