...
namespace PX.Objects.AP
{
	...
	public class APDocumentEnq : PXGraph<APDocumentEnq>
	{
		...
		protected virtual IEnumerable documents()
		{
			...
			if(header.IncludeUnreleased != true)
				selectAdjusted.WhereAnd<Where<APAdjust.released, Equal<True>>>();
			...
			if (header.IncludeUnreleased != true)
				selectAdjusting.WhereAnd<Where<APAdjust.released, Equal<True>>>();
			...
			if (header.IncludeUnreleased != true)
				selectRetainageBills.WhereAnd<Where<APInvoice.released, Equal<True>>>();
