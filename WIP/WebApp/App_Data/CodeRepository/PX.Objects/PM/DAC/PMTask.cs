...
namespace PX.Objects.PM
{
	...
	public class PMTask : PX.Data.IBqlTable
	{
		...
		/// Primary Key
		/// </summary>
		public class PK : PrimaryKeyOf<PMTask>.By<PMTask.taskID>.Dirty
		{
			public static PMTask Find(PXGraph graph, int? taskID) => FindBy(graph, taskID, (taskID ?? 0) <= 0);
		}
		...
		{
			public static PMTask Find(PXGraph graph, int? projectID, string taskCD) => FindBy(graph, projectID, taskCD);
		}
		#endregion
		...
		/// <summary>
		/// Default Sales Account. Can be used in allocation and/or billing to as a default for the new <see cref="PMTran"/> and <see cref="ARTran"/>.
		/// </summary>
		...
		/// <summary>
		/// Default Sales Subaccount. Can be used in allocation and/or billing to as a default for the new <see cref="PMTran"/> and <see cref="ARTran"/>.
		/// </summary>
		...
		/// <summary>
		/// Default Cost Account. Can be used in allocation and/or cost transaction as a default for the new <see cref="PMTran"/>.
		/// </summary>
		...
		/// <summary>
		/// Default Cost Subaccount. Can be used in allocation and/or cost transaction as a default for the new <see cref="PMTran"/>.
		/// </summary>
