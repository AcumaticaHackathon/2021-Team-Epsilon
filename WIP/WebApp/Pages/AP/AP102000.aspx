					...
					<px:PXGrid ID="gridUsers" BorderWidth="0px" runat="server" DataSourceID="ds" Height="150px"
						...
						<Levels>
							<px:PXGridLevel DataMember="Users">
								...
								<Columns>
									<px:PXGridColumn DataField="Included" TextAlign="Center" Type="CheckBox" AllowCheckAll="True" RenderEditorText="True" />
									<px:PXGridColumn DataField="Username" AllowUpdate="False" />
								    <px:PXGridColumn DataField="FullName" AllowUpdate="False" />
									<px:PXGridColumn DataField="Comment" AllowUpdate="False" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
					...
					<px:PXGrid SkinID="Details" ID="gridVendors" BorderWidth="0px" runat="server"
						...
						<Levels>
							<px:PXGridLevel DataMember="Vendor" >
								...
								<Columns>
									<px:PXGridColumn DataField="Included" TextAlign="Center" Type="CheckBox" AllowCheckAll="True" RenderEditorText="True" />
									<px:PXGridColumn DataField="AcctCD" RenderEditorText="true" />
									<px:PXGridColumn AllowUpdate="False" DataField="VStatus" RenderEditorText="true" />
									<px:PXGridColumn AllowUpdate="False" DataField="AcctName" />
								</Columns>
								<RowTemplate>
									<px:PXLayoutRule runat="server" StartColumn="True"  LabelsWidth="SM" ControlSize="M" />
