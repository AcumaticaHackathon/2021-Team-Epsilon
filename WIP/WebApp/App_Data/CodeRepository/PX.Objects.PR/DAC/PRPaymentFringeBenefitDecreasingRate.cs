...
namespace PX.Objects.PR
{
	...
	public class PRPaymentFringeBenefitDecreasingRate : IBqlTable
	{
		...
		{
			public static PRPaymentFringeBenefitDecreasingRate Find(PXGraph graph, int? recordID) => FindBy(graph, recordID);
		}
		...
		{
			public static PRPaymentFringeBenefitDecreasingRate Find(PXGraph graph, string docType, string refNbr, int? deductCodeID, int? projectID, int? projectTaskID, int? laborItemID) =>
				FindBy(graph, docType, refNbr, deductCodeID, projectID, projectTaskID, laborItemID);
		}
		...
		public static class FK
		{
			...
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PRPaymentFringeBenefitDecreasingRate>.By<projectTaskID> { }
