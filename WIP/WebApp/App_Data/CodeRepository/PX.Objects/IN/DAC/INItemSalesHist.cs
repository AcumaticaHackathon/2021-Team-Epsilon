...
namespace PX.Objects.IN
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<INItemSalesHist>.By<inventoryID, costSubItemID, costSiteID, finPeriodID>
		{
			public static INItemSalesHist Find(PXGraph graph, int? inventoryID, int? costSubItemID, int? costSiteID, string finPeriodID)
				=> FindBy(graph, inventoryID, costSubItemID, costSiteID, finPeriodID);
		}
		public static class FK
		{
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<INItemSalesHist>.By<inventoryID> { }
			public class CostSubItem : INSubItem.PK.ForeignKeyOf<INItemSalesHist>.By<costSubItemID> { }
			public class CostSite : INCostSite.PK.ForeignKeyOf<INItemSalesHist>.By<costSiteID> { }
			//todo public class FinPeriod : GL.FinPeriods.TableDefinition.FinPeriod.PK.ForeignKeyOf<INItemSalesHist>.By<finPeriodID> { }
		}
		#endregion
		#region InventoryID
