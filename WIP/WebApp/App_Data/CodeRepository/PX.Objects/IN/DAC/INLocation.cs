...
namespace PX.Objects.IN
{
	...
	public partial class INLocation : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class Project : PMProject.PK.ForeignKeyOf<INLocation>.By<projectID> { }
			public class Task : PMTask.PK.ForeignKeyOf<INLocation>.By<taskID> { }
		}
        #endregion
        #region LocationID
		...
		#endregion
		#region ProductionValid
		public abstract class productionValid : PX.Data.BQL.BqlBool.Field<productionValid> { }
		protected Boolean? _ProductionValid;
		[PXDBBool()]
		[PXDefault(true)]
		[PXUIField(DisplayName = "Production Allowed")]
		public virtual Boolean? ProductionValid
		{
			get
			{
				return this._ProductionValid;
			}
			set
			{
				this._ProductionValid = value;
			}
		}
		#endregion
