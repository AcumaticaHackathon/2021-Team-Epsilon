...
namespace PX.Objects.FS
{
    ...
    public class FSContractPostBatch : PX.Data.IBqlTable
    {
        ...
        {
            public static FSContractPostBatch Find(PXGraph graph, int? contractPostBatchID) => FindBy(graph, contractPostBatchID);
        }
        public class UK : PrimaryKeyOf<FSContractPostBatch>.By<contractPostBatchNbr>
        {
            public static FSContractPostBatch Find(PXGraph graph, string contractPostBatchNbr) => FindBy(graph, contractPostBatchNbr);
        }
        #endregion
