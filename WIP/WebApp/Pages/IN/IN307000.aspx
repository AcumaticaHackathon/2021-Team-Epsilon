...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.KitAssemblyEntry" PrimaryView="Document" UDFTypeField="DocType" EnableAttributes="true" HeaderDescriptionField="TranTranDesc">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Kit Summary" DataMember="Document"
        NoteIndicator="True" FilesIndicator="True" LinkIndicator="true" BPEventsIndicator="true" ActivityIndicator="true" ActivityField="NoteActivity"
        EmailingGraph="PX.Objects.CR.CREmailActivityMaint,PX.Objects" DefaultControlID="edRefNbr">
        <Template>
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="S" />
            <px:PXDropDown runat="server" ID="edDocType" DataField="DocType" SelectedIndex="-1" />
            <px:PXSelector runat="server" ID="edRefNbr" DataField="RefNbr" AutoRefresh="true" />
            <px:PXDropDown runat="server" ID="edStatus" DataField="Status" Enabled="False" />
            <px:PXDateTimeEdit runat="server" ID="edTranDate" DataField="TranDate" CommitChanges="true" />
            <px:PXSelector runat="server" ID="edFinPeriodID" DataField="FinPeriodID" />

            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="M" />
            <px:PXSegmentMask runat="server" ID="edKitInventoryID" DataField="KitInventoryID" CommitChanges="True" />
            <px:PXSelector runat="server" ID="edKitRevisionID" DataField="KitRevisionID" CommitChanges="True" AutoRefresh="True" />
            <px:PXSegmentMask runat="server" ID="edSubItemID" DataField="SubItemID" CommitChanges="True" AutoRefresh="True" />
            <px:PXSelector runat="server" ID="edReasonCode" DataField="ReasonCode">
                <Parameters>
            ...
            <px:PXTextEdit runat="server" ID="edTranDesc" DataField="TranTranDesc" />

            <px:PXLayoutRule ID="PXLayoutRule6" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="M" />
            <px:PXSegmentMask runat="server" ID="edSiteID" DataField="SiteID" CommitChanges="True" AutoRefresh="true" />
            <px:PXSegmentMask runat="server" ID="edLocationID" DataField="LocationID" AutoRefresh="true" />
            <px:PXSelector runat="server" ID="edUOM" DataField="UOM" CommitChanges="True" AutoRefresh="true" />
            <px:PXNumberEdit runat="server" ID="edQty" DataField="Qty" CommitChanges="True" />
        </Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="DocumentProperties">
        ...
        <Items>
            <px:PXTabItem Text="Stock Components">
                <Template>
                    <px:PXGrid runat="server" ID="componentsGrid" DataSourceID="ds" SkinID="DetailsInTab" Width="100%" 
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LSINComponentTran_binLotSerial" CommandSourceID="ds" DependOnGrid="componentsGrid">
                                </px:PXToolBarButton>
                            </CustomItems>
                        </ActionBar>
                        <Levels>
            ...
            <px:PXTabItem Text="Non-Stock Components">
                <Template>
                    <px:PXGrid runat="server" ID="overheadGrid" DataSourceID="ds" BorderStyle="None" Width="100%" SkinID="Details" SyncPosition="true">
                        <AutoSize Enabled="True" MinHeight="150" />
                        <Levels>
            ...
            <px:PXTabItem Text="Kit Line Details">
                <Template>
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 500px;"
        Width="764px" Caption="Line Details" DesignView="Content" CaptionVisible="True" Key="lsselect" AutoCallBack-Command="Refresh"
