...
namespace PX.Objects.PR
{
	...
	public class PRBenefitDetail : IBqlTable, IPaycheckDetail
	{
		...
		{
			public static PRBenefitDetail Find(PXGraph graph, int? recordID) => FindBy(graph, recordID);
		}
		...
		{
			public static PRBenefitDetail Find(PXGraph graph, int? branchID, string paymentDocType, string paymentRefNbr, int? codeID, int? projectID, int? projectTaskID, int? laborItemID, string earningTypeCD, int? costCodeID) =>
				FindBy(graph, branchID, paymentDocType, paymentRefNbr, codeID, projectID, projectTaskID, laborItemID, earningTypeCD, costCodeID);
		}
		...
		public static class FK
		{
			...
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PRBenefitDetail>.By<projectTaskID> { }
		...
		[PXSelector(
			typeof(SearchFor<PRDeductCode.codeID>
				.Where<paymentDocType.FromCurrent.IsEqual<PayrollType.voidCheck>
					.Or<PRDeductCode.contribType.IsNotEqual<ContributionType.employeeDeduction>
