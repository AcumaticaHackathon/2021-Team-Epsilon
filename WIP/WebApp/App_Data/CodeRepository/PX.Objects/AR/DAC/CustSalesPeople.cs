namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CustSalesPeople>.By<bAccountID, salesPersonID, locationID>
		{
			public static CustSalesPeople Find(PXGraph graph, Int32? bAccountID, Int32? salesPersonID, Int32? locationID) => FindBy(graph, bAccountID, salesPersonID, locationID);
		}
		public static class FK
		{
			public class Customer : AR.Customer.PK.ForeignKeyOf<CustSalesPeople>.By<bAccountID> { }
			public class Location : CR.Location.PK.ForeignKeyOf<CustSalesPeople>.By<bAccountID, locationID> { }
		}
		#endregion
