...
namespace PX.Objects.CA
{
	...
	{
		#region Events
		public class Events : PXEntityEvent<CATransfer>.Container<Events>
		{
			public PXEntityEvent<CATransfer> ReleaseDocument;
			public PXEntityEvent<CATransfer> UpdateStatus;
		}
		#endregion
		
		#region Keys
		public class PK : PrimaryKeyOf<CATransfer>.By<transferNbr>
		{
			public static CATransfer Find(PXGraph graph, string transferNbr) => FindBy(graph, transferNbr);
		}

		public static class FK
		{
			public class SourceCashAccount : CA.CashAccount.PK.ForeignKeyOf<CATransfer>.By<outAccountID> { }
			public class DestinationCashAccount : CA.CashAccount.PK.ForeignKeyOf<CATransfer>.By<inAccountID> { }
			public class SourceCurrencyInfo: CM.CurrencyInfo.PK.ForeignKeyOf<CATransfer>.By<outCuryInfoID> { }
			public class DestinationCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<CATransfer>.By<inCuryInfoID> { }
			public class SourceCurrency : CM.Currency.PK.ForeignKeyOf<CATransfer>.By<inCuryID> { }
			public class DestinationCurrency : CM.Currency.PK.ForeignKeyOf<CATransfer>.By<outCuryID> { }
			public class SourceBranch : GL.Branch.PK.ForeignKeyOf<CATransfer>.By<outBranchID> { }
			public class DestinationBranch : GL.Branch.PK.ForeignKeyOf<CATransfer>.By<inBranchID> { }
			public class SourceCashAccountTransaction : CM.Currency.PK.ForeignKeyOf<CATransfer>.By<tranIDOut> { }
			public class DestinationCashAccountTransaction : CM.Currency.PK.ForeignKeyOf<CATransfer>.By<tranIDIn> { }
		}
        ...
        /// </value>
        [PXDefault]
		[CashAccount( null, DisplayName = "Destination Account", DescriptionField = typeof(CashAccount.descr))]
		...
		[PXSelector(typeof(CATransfer.transferNbr))]
		public virtual string OrigTransferNbr
		{
			get;
			set;
		}
