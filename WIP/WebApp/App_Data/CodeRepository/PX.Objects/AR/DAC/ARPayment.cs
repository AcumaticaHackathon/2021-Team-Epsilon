...
namespace PX.Objects.AR
{
	...
	public class ARPayment : ARRegister, IInvoice, ICCPayment, IApprovable, IApprovalDescription
	{
		...
		public class Events : PXEntityEvent<ARPayment>.Container<Events>
		{
			...
			public PXEntityEvent<ARPayment> UpdateStatus;
		}
		...
		[PXFormula(typeof(Switch<Case<Where<ARPayment.customerLocationID, IsNotNull,
		...
		[PXDefault(typeof(IIf<Where<Current<docType>, Equal<ARDocType.refund>, 
			And<Selector<paymentMethodID, PaymentMethod.paymentType>, Equal<PaymentMethodType.creditCard>,
			And<Selector<paymentMethodID, PaymentMethod.isAccountNumberRequired>, Equal<True>>>>, True, False>))]
