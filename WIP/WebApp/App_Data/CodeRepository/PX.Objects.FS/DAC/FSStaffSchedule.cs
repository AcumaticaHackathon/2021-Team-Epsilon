...
namespace PX.Objects.FS
{
    ...
    public class FSStaffSchedule : FSSchedule
	{
        ...
        {
            public static FSStaffSchedule Find(PXGraph graph, string refNbr) => FindBy(graph, refNbr);
        }
        ...
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSStaffSchedule>.By<dfltProjectTaskID> { }
        }
        #endregion
