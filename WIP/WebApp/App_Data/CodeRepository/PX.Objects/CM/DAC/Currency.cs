...
namespace PX.Objects.CM
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<Currency>.By<curyID>
		{
			public static Currency Find(PXGraph graph, String curyID) => FindBy(graph, curyID);
		}
		public static class FK
		{
			public class RealGainAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<realGainAcctID> { }
			public class RealGainSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<realGainSubID> { }

			public class RealLossAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<realLossAcctID> { }
			public class RealLossSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<realLossSubID> { }

			public class RevalGainAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<revalGainAcctID> { }
			public class RevalGainSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<revalGainSubID> { }

			public class RevalLossAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<revalLossAcctID> { }
			public class RevalLossSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<revalLossSubID> { }

			public class APProvisioningAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<aPProvAcctID> { }
			public class APProvisioningSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<aPProvSubID> { }

			public class TranslationGainAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<translationGainAcctID> { }
			public class TranslationGainSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<translationGainSubID> { }

			public class TranslationLossAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<translationLossAcctID> { }
			public class TranslationLossSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<translationLossSubID> { }

			public class UnrealizedGainAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<unrealizedGainAcctID> { }
			public class UnrealizedGainSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<unrealizedGainSubID> { }

			public class RoundingGainAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<roundingGainAcctID> { }
			public class RoundingGainSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<roundingGainSubID> { }

			public class RoundingLossAccount : GL.Account.PK.ForeignKeyOf<Currency>.By<roundingLossAcctID> { }
			public class RoundingLossSubaccount : GL.Sub.PK.ForeignKeyOf<Currency>.By<roundingLossSubID> { }
		}
		#endregion
		...
		/// <summary>
		/// The identifier of the <see cref="CurrencyInfo">CurrencyInfo</see> object associated with the currency.
		/// </summary>
		/// <value>
		...
		public abstract class curyInfoBaseID : PX.Data.BQL.BqlLong.Field<curyInfoID> { }
		protected Int64? _CuryInfoBaseID;
		...
		/// </value>
		[PXDBLong()]
		public virtual Int64? CuryInfoBaseID
		{
			get
			{
				return this._CuryInfoBaseID;
			}
			set
			{
				this._CuryInfoBaseID = value;
			}
		}
		#endregion
