...
namespace PX.Objects.AP
{
	...
	public class MISC1099EFileFilter : IBqlTable
	{
		...
		[PXDBBool()]
		[PXDefault(false)]
		[PXUIEnabled(typeof(Where<fileFormat.IsEqual<fileFormat.mISC>>))]
		[PXFormula(typeof(Switch<Case<Where<fileFormat.IsEqual<fileFormat.nEC>>, False>, reportingDirectSalesOnly>))]
