...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<pxa:DynamicDataSource ID="ds" runat="server" Visible="True" PrimaryView="UserList" 
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="SendLoginLink" CommitChanges="True" Visible="false" />
			...
			<px:PXDSCallbackCommand DependOnGrid="gridIdentities" Name="removeIdentity" Visible="False" CommitChanges="True" StateColumn="Oidc" />
		</CallbackCommands>
