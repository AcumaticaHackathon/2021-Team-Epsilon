...
namespace PX.Objects.CA
{
	...
	public partial class CABankTranAdjustment : IBqlTable, ICADocAdjust, IAdjustment
	{
		...
		{
			public class BankTransaction : CA.CABankTran.PK.ForeignKeyOf<CABankTranAdjustment>.By<tranID> { }
			public class BranchOfAdjustedDocument : GL.Branch.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdBranchID> { }
			public class CurrencyInfoOfAdjustedDocument : CM.CurrencyInfo.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdCuryInfoID> { }
			public class OriginalCurrencyInfoOfAdjustedDocument : CM.CurrencyInfo.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdOrigCuryInfoID> { }
			public class AdjustmentBatch : GL.Batch.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdModule, adjBatchNbr> { }
			public class CurrencyInfoOfAdjustingPayment : CM.CurrencyInfo.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjgCuryInfoID> { }
			public class AccountOfAdjustedBill : GL.Account.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdAPAcct> { }
			public class SubaccountOfAdjustedBill : GL.Sub.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdAPSub> { }
			public class AccountOfAdjustedInvoice : GL.Account.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdARAcct> { }
			public class SubaccountOfAdjustedInvoice : GL.Sub.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdARSub> { }
			public class WithholdingTaxAccount : GL.Account.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdWhTaxAcctID> { }
			public class WithholdingTaxSubaccount : GL.Sub.PK.ForeignKeyOf<CABankTranAdjustment>.By<adjdWhTaxSubID> { }
			public class WriteOffReasonCode : CS.ReasonCode.PK.ForeignKeyOf<CABankTranAdjustment>.By<writeOffReasonCode> { }
		}
