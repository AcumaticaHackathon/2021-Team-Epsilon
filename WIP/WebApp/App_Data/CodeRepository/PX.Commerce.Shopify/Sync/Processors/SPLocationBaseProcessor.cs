...
namespace PX.Commerce.Shopify
{
		...
		where TPrimaryMapped : class, IMappedEntity, new()
	{
		...
		Where<PX.Objects.CR.BAccount.noteID, Equal<Required<PX.Objects.CR.BAccount.noteID>>>>.Select(this, customerObj.LocalID);
			...
			addressData.Province = GetSubstituteExternByLocal(BCSubstitute.GetValue(Operation.ConnectorType, BCSubstitute.State), addressImpl.State?.Value, addressImpl.State?.Value);
