		...
		<Items>
			<px:PXTabItem Text="General Info">
				<Template>
					...
					<px:PXDropDown ID="edTimePostingOption" runat="server" AllowNull="False" DataField="TimePostingOption" CommitChanges="true" />
					<px:PXSelector ID="edOffBalanceAccountGroupID" runat="server" DataField="OffBalanceAccountGroupID" />
					...
					<px:PXCheckBox SuppressLabel="True" ID="chkAutoReleaseOnPay" runat="server" DataField="AutoReleaseOnPay" />
