...
namespace PX.Objects.CA
{
	...
	public partial class CADeposit : IBqlTable, ICADocument 
	{
		...
		{
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CADeposit>.By<cashAccountID> { }
			public class CashDropAccount : CA.CashAccount.PK.ForeignKeyOf<CADeposit>.By<extraCashAccountID> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<CADeposit>.By<branchID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<CADeposit>.By<curyID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<CADeposit>.By<curyInfoID> { }
			public class DepositRelatedCashTransaction : CA.CATran.PK.ForeignKeyOf<CADeposit>.By<cashAccountID, tranID> { }
			public class CashDropTransaction : CA.CATran.PK.ForeignKeyOf<CADeposit>.By<cashAccountID, cashTranID> { }
			public class DepositChargeCashTransaction : CA.CATran.PK.ForeignKeyOf<CADeposit>.By<cashAccountID, chargeTranID> { }
			public class Workgroup : TM.EPCompanyTree.PK.ForeignKeyOf<CADeposit>.By<workgroupID> { }
			public class Owner : EP.EPEmployee.PK.ForeignKeyOf<CADeposit>.By<ownerID> { }
		}

		#endregion

		#region Events
		public class Events : PXEntityEvent<CADeposit>.Container<Events>
		{
			public PXEntityEvent<CADeposit> ReleaseDocument;
			public PXEntityEvent<CADeposit> VoidDocument;
			public PXEntityEvent<CADeposit> UpdateStatus;
		}
		#endregion
        ...
        /// </summary>
		[PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
		[Owner(typeof(CADeposit.workgroupID), Visibility = PXUIVisibility.SelectorVisible)]
