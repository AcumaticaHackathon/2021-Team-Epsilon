...
namespace PX.Objects.CR
{
    ...
    [CRQuotePrimaryGraph(VerifyRightsBy = new [] { typeof(QuoteMaint) })]
    ...
    public partial class CRQuote : IBqlTable, IAssign, IPXSelectable
    {
        ...
        {
            public static CRQuote Find(PXGraph graph, string opportunityID, string quoteNbr) => FindBy(graph, opportunityID, quoteNbr);
        }
        public static class FK
        {
            ...
            public class Owner : EP.EPEmployee.PK.ForeignKeyOf<CRQuote>.By<ownerID> { }
        ...
        [PXRestrictor(typeof(Where2<Where2<
                ...
                And<WhereEqualNotNull<Contact.bAccountID, CRQuote.bAccountID>>>),
