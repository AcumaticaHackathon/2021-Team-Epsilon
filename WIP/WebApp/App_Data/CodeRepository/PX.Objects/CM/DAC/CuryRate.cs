namespace PX.Objects.CM
{
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<CurrencyRateByDate2>.By<curyRateID>
		{
			public static CurrencyRateByDate2 Find(PXGraph graph, Int64? curyRateID) => FindBy(graph, curyRateID);
		}
		public new static class FK
		{
			public class FromCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRateByDate2>.By<fromCuryID> { }
			public class ToCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRateByDate2>.By<toCuryID> { }
			public class CurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<CurrencyRateByDate2>.By<curyRateType> { }
		}
		#endregion
		#region CuryRateID
		public new abstract class curyRateID : PX.Data.BQL.BqlInt.Field<curyRateID> { }
		#endregion
		#region FromCuryID
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<CurrencyRate2>.By<curyRateID>
		{
			public static CurrencyRate2 Find(PXGraph graph, Int64? curyRateID) => FindBy(graph, curyRateID);
		}
		public new static class FK
		{
			public class FromCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRate2>.By<fromCuryID> { }
			public class ToCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRate2>.By<toCuryID> { }
			public class CurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<CurrencyRate2>.By<curyRateType> { }
		}
		#endregion
		public new abstract class curyRateID : PX.Data.BQL.BqlInt.Field<curyRateID> { }
		public new abstract class curyEffDate : PX.Data.BQL.BqlDateTime.Field<curyEffDate> { }
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<CurrencyRateByDateForVendor>.By<curyRateID>
		{
			public static CurrencyRateByDateForVendor Find(PXGraph graph, Int64? curyRateID) => FindBy(graph, curyRateID);
		}
		public new static class FK
		{
			public class FromCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRateByDateForVendor>.By<fromCuryID> { }
			public class ToCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRateByDateForVendor>.By<toCuryID> { }
			public class CurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<CurrencyRateByDateForVendor>.By<curyRateType> { }
		}
		#endregion
		#region CuryRateID
		public new abstract class curyRateID : PX.Data.BQL.BqlInt.Field<curyRateID> { }
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<CurrencyRateByDate>.By<curyRateID>
		{
			public static CurrencyRateByDate Find(PXGraph graph, Int64? curyRateID) => FindBy(graph, curyRateID);
		}
		public new static class FK
		{
			public class FromCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRateByDate>.By<fromCuryID> { }
			public class ToCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRateByDate>.By<toCuryID> { }
			public class CurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<CurrencyRateByDate>.By<curyRateType> { }
		}
		#endregion
		#region CuryRateID
		public new abstract class curyRateID : PX.Data.BQL.BqlInt.Field<curyRateID> { }
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CurrencyRate>.By<curyRateID>
		{
			public static CurrencyRate Find(PXGraph graph, Int64? curyRateID) => FindBy(graph, curyRateID);
		}
		public static class FK
		{
			public class FromCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRate>.By<fromCuryID> { }
			public class ToCurrency : CM.Currency.PK.ForeignKeyOf<CurrencyRate>.By<toCuryID> { }
			public class CurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<CurrencyRate>.By<curyRateType> { }
		}
		#endregion
