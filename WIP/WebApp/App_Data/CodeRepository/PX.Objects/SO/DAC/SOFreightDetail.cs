namespace PX.Objects.SO
{
	...
	public partial class SOFreightDetail : PX.Data.IBqlTable, IFreightBase
	{
		...
		{
			public class Shipment : SOShipment.UK.ForeignKeyOf<SOFreightDetail>.By<shipmentType, shipmentNbr> { }
			public class OrderShipment : SOOrderShipment.UK.ForeignKeyOf<SOFreightDetail>.By<shipmentType, shipmentNbr, orderType, orderNbr> { }
			public class OrderType : SOOrderType.PK.ForeignKeyOf<SOFreightDetail>.By<orderType> { }
			public class Order : SOOrder.PK.ForeignKeyOf<SOFreightDetail>.By<orderType, orderNbr> { }
			...
			public class Carrier : CS.Carrier.PK.ForeignKeyOf<SOFreightDetail>.By<shipVia> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<SOFreightDetail>.By<curyInfoID> { }
			public class TaxCategory : TX.TaxCategory.PK.ForeignKeyOf<SOFreightDetail>.By<taxCategoryID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<SOFreightDetail>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<SOFreightDetail>.By<subID> { }
			public class Project : PMProject.PK.ForeignKeyOf<SOFreightDetail>.By<projectID> { }
			public class Task : PMTask.PK.ForeignKeyOf<SOFreightDetail>.By<taskID> { }
		}
		#endregion
