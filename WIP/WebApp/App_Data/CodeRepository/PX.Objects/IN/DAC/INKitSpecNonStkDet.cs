...
namespace PX.Objects.IN
{
	...
	public partial class INKitSpecNonStkDet : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class ComponentInventoryItem : InventoryItem.PK.ForeignKeyOf<INKitSpecNonStkDet>.By<compInventoryID> { }
			public class KitSpecification : INKitSpecHdr.PK.ForeignKeyOf<INKitSpecNonStkDet>.By<kitInventoryID, revisionID> { }
			//todo public class UnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<INKitSpecNonStkDet>.By<compInventoryID, uOM> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use ComponentInventoryItem instead.")]
			public class CompInventoryItem : ComponentInventoryItem { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use KitSpecification instead.")]
			public class KitSpecHdr : KitSpecification { }
		}
		#endregion
