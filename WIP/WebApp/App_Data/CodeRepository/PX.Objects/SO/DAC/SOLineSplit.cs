...
namespace PX.Objects.SO
{
	...
	public partial class SOLineSplit : PX.Data.IBqlTable, ILSDetail
	{
		...
		public static class FK
		{
			...
			public class POReceipt : Objects.PO.POReceipt.UK.ForeignKeyOf<SOLineSplit>.By<pOReceiptType, pOReceiptNbr> { }
                ...
                sender.Graph.Actions[ActionName] = (PXAction) Activator.CreateInstance(
                    ...
                    new object[]
                    {
                        ...
                        new PXEventSubscriberAttribute[]
                            {new PXUIFieldAttribute {MapEnableRights = PXCacheRights.Select}, new PXButtonAttribute() { VisibleOnDataSource = false} }
                    });
            }
