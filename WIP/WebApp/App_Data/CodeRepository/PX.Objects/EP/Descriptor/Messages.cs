...
namespace PX.Objects.EP
{
	...
	public static class Messages
	{
		...
		public const string CantDeleteWithActivities = "Members with activities cannot be removed.";
		public const string InactiveMemberTimeEntry = "This employee is inactive.";
		public const string WithoutActivities = "This employee has no activities.";
