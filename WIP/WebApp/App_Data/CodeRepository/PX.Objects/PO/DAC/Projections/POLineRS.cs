...
namespace PX.Objects.PO
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<POLineRS>.By<orderType, orderNbr, lineNbr>
		{
			public static POLineRS Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr) => FindBy(graph, orderType, orderNbr, lineNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<POLineRS>.By<branchID> { }
			public class Order : POOrder.PK.ForeignKeyOf<POLineRS>.By<orderType, orderNbr> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<POLineRS>.By<inventoryID> { }
			public class SubItem : INSubItem.PK.ForeignKeyOf<POLineRS>.By<subItemID> { }
			public class Site : INSite.PK.ForeignKeyOf<POLineRS>.By<siteID> { }
			public class SiteStatus : IN.INSiteStatus.PK.ForeignKeyOf<POLineRS>.By<inventoryID, subItemID, siteID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<POLineRS>.By<vendorID> { }
			public class PayToVendor : AP.Vendor.PK.ForeignKeyOf<POLineRS>.By<payToVendorID> { }
			public class VendorLocation : Location.PK.ForeignKeyOf<POLineRS>.By<vendorID, vendorLocationID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<POLineRS>.By<taxZoneID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<POLineRS>.By<curyID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<POLineRS>.By<curyInfoID> { }
			public class TaxCategory : TX.TaxCategory.PK.ForeignKeyOf<POLineRS>.By<taxCategoryID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<POLineRS>.By<taxID> { }
			public class ExpenseAccount : GL.Account.PK.ForeignKeyOf<POLineRS>.By<expenseAcctID> { }
			public class ExpenseSubaccount : Sub.PK.ForeignKeyOf<POLineRS>.By<expenseSubID> { }
			public class Project : PMProject.PK.ForeignKeyOf<POLineRS>.By<projectID> { }
			public class Task : PMTask.PK.ForeignKeyOf<POLineRS>.By<taskID> { }
			public class AccrualAccount : GL.Account.PK.ForeignKeyOf<POLineRS>.By<pOAccrualAcctID> { }
			public class AccrualSubaccount : Sub.PK.ForeignKeyOf<POLineRS>.By<pOAccrualSubID> { }
			public class CostCode : PMCostCode.PK.ForeignKeyOf<POLineRS>.By<costCodeID> { }
			public class Discount : APDiscount.PK.ForeignKeyOf<POLineRS>.By<discountID, vendorID> { }
			public class DiscountSequence : VendorDiscountSequence.PK.ForeignKeyOf<POLineRS>.By<vendorID, discountID, discountSequenceID> { }

			//todo public class AccrualStatus : POAccrualStatus.PK.ForeignKeyOf<POLineS>.By<refNoteID, lineNbr, POAccrualType.order> { }
			//todo public class UnitOfMeasure : INUnit.PK.ForeignKeyOf<POLineRS>.By<inventoryID, uOM> { }
		}
		#endregion
		#region Selected
		...
		//always false for all entities except POReceiptLine
