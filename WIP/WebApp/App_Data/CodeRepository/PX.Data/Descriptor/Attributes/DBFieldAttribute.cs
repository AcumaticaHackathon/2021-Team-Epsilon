...
namespace PX.Data
{
	...
	public class PXDBFieldAttribute : PXEventSubscriberAttribute, IPXRowSelectingSubscriber, IPXCommandPreparingSubscriber
	{
		...
		protected virtual void PrepareFieldName(string dbFieldName, PXCommandPreparingEventArgs e)
		{
			...
			e.BqlTable = this.prepCacheExtensionType ?? _BqlTable;
			var table = this.prepCacheExtensionType ?? e.Table ?? _BqlTable;
	...
	/// </example>
	[AttributeUsage(AttributeTargets.Property | AttributeTargets.Parameter | AttributeTargets.Class | AttributeTargets.Method)]
	public class PXDBLocalizableStringAttribute : PXDBStringAttribute, IPXRowPersistedSubscriber, IPXRowPersistingSubscriber
	{
				...
				if (e.TranStatus == PXTranStatus.Open)
				{
					...
					else
					{
						...
						if (translation != null)
						{
                            ...
                            PXTransactionScope.RemoveTranslationField(sender.BqlTable.Name, _FieldName);
        ...
        public virtual void RowPersisting(PXCache sender, PXRowPersistingEventArgs e)
        {
            ...
            {
                var translation = GetTranslations(sender, e.Row) as IStructuralEquatable;
                var originals = sender.GetSlot<string[]>(e.Row, _PositionInTranslations, true) as IStructuralEquatable;
                if (translation != null && !translation.Equals(originals, StringComparer.Ordinal))
                    PXTransactionScope.AddTranslationField(sender.BqlTable.Name, _FieldName);
            }
        }
	...
	public abstract class PXDBBaseIDAttribute : PXAggregateAttribute, IPXFieldVerifyingSubscriber
	{
		internal class AuditUserSelectorAttribute : PXDisplaySelectorAttribute
		{
			...
			public override void DescriptionFieldCommandPreparing(PXCache sender, PXCommandPreparingEventArgs e)
			{
				...
				if (q!= null && q.GetSelection().Count>0 && (q.GetSelection()[0] as Column)?.Name.Equals(nameof(PXDBCreatedByIDAttribute.Creator.displayName), StringComparison.OrdinalIgnoreCase)==true) {
		...
		internal PXDBBaseIDAttribute(Type search, Type substituteKey, Type descriptionField, params Type[] fields)
		{
		...
		public void AddUIFieldAttributeIfNeeded(string displayName)
		{
			...
			uiattr.DisplayName = displayName;
		}
	...
	public class PXDBCreatedByIDAttribute : PXDBBaseIDAttribute, IPXRowInsertingSubscriber
	{
		/// <exclude/>
		[PXBreakInheritance]
		[Serializable]
		...
		public PXDBCreatedByIDAttribute()
			: base(typeof(Creator.pKID), typeof(Creator.username), typeof(Creator.displayName),
	...
	public class PXDBLastModifiedByIDAttribute : PXDBCreatedByIDAttribute, IPXRowUpdatingSubscriber, IPXRowPersistingSubscriber
	{
		...
		{
			AddUIFieldAttributeIfNeeded(DisplayFieldNames.LastModifiedByID);
		}
	...
	#region PXDBStateChangedByIDAttribute
	/// <summary>Maps a DAC field to the database column and automatically
	...
	/// </example>
	[Serializable]
	public class PXDBStateChangedByIDAttribute : PXDBBaseIDAttribute, IPXRowInsertingSubscriber, IPXRowPersistingSubscriber
	{
		...
		public sealed class StateChanger : Users
		{
			...
			[PXDBString(64, IsKey = true, IsUnicode = true, InputMask = "")]
			[PXUIField(DisplayName = PXDBLastModifiedByIDAttribute.DisplayFieldNames.StateChangedByID, Enabled = false, Visibility = PXUIVisibility.SelectorVisible)]
			public override string Username { get; set; }
		...
		public PXDBStateChangedByIDAttribute()
			: base(typeof(StateChanger.pKID), typeof(StateChanger.username), typeof(StateChanger.displayName),
				typeof(StateChanger.pKID), typeof(StateChanger.username))
		{
			AddUIFieldAttributeIfNeeded(PXDBLastModifiedByIDAttribute.DisplayFieldNames.StateChangedByID);
		}

		private string _workflowProperty;

		[InjectDependencyOnTypeLevel]
		protected Automation.IWorkflowService WorkflowService { get; set; }

		[InjectDependencyOnTypeLevel]
		protected Automation.IScreenToGraphWorkflowMappingService ScreenToGraphWorkflowMappingService { get; set; }

		protected void WorkflowFieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
		{
			var newValue = cache.GetValue(e.Row, _workflowProperty);
			if (!object.Equals(e.OldValue, newValue))
			{
				cache.SetValue(e.Row, _FieldOrdinal, GetUserID(cache));
			}
		}
		...
		public override void CacheAttached(PXCache cache)
		{
			...
			var screenId = GetWorkflowScreenID(cache);
			if (screenId == null)
				return;

			_workflowProperty = WorkflowService.GetWorkflowStatePropertyName(screenId);
			if (_workflowProperty == null)
				return;

			cache.FieldUpdatedEvents[_workflowProperty] += WorkflowFieldUpdated;
		}

		protected string GetWorkflowScreenID(PXCache sender)
		{
			return ScreenToGraphWorkflowMappingService.GetScreenIDFromGraphType(sender.Graph?.GetType());
		}
		...
		void IPXRowPersistingSubscriber.RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
		{
			...
			if ((e.Operation & PXDBOperation.Insert) != 0)
				needUpdate = true;
			else if ((e.Operation & PXDBOperation.Update) != 0 && _workflowProperty != null)
			{
				var oldValue = cache.GetValueOriginal(e.Row, _workflowProperty);
				var newValue = cache.GetValue(e.Row, _workflowProperty);
	...
	#region PXDBBaseScreenIDAttribute
	...
	/// </code>
	/// </example>
	public class PXDBCreatedByScreenIDAttribute : PXDBBaseScreenIDAttribute, IPXRowInsertingSubscriber
	{
		void IPXRowInsertingSubscriber.RowInserting(PXCache sender, PXRowInsertingEventArgs e)
		{
	...
	#region PXDBStateChangedByScreenIDAttribute
	/// <summary>Maps a DAC field to the database column and automatically
	/// sets the field value to the string ID of the application screen on
	...
	/// </code>
	/// </example>
	public class PXDBStateChangedByScreenIDAttribute : PXDBBaseScreenIDAttribute, IPXRowInsertingSubscriber, IPXRowPersistingSubscriber
	{
		private string _workflowProperty;
		...
		protected void WorkflowFieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
		{
			...
			if (!object.Equals(e.OldValue, newValue))
			{
				cache.SetValue(e.Row, _FieldOrdinal, PXContext.GetScreenID()?.Replace(".", ""));
			}
		}
		...
		void IPXRowPersistingSubscriber.RowPersisting(PXCache cache, PXRowPersistingEventArgs e)
		{
			...
			if (needUpdate)
			{
				cache.SetValue(e.Row, _FieldOrdinal, GetScreenID(cache));
			}
		}
	}
	#endregion

	#region PXDBBaseDateTimeAttribute
	/// <summary>
	...
	/// </example>
	public class PXDBCreatedDateTimeAttribute : PXDBBaseDateTimeAttribute, IPXCommandPreparingSubscriber, IPXRowInsertingSubscriber
	{
		void IPXRowInsertingSubscriber.RowInserting(PXCache sender, PXRowInsertingEventArgs e)
		{
	...
	#region PXDBStateChangedDateTimeAttribute
	...
	/// </example>
	public class PXDBStateChangedDateTimeAttribute : PXDBBaseDateTimeAttribute, IPXRowInsertingSubscriber, IPXCommandPreparingSubscriber
	{
		private string _workflowProperty;
		...
		protected void WorkflowFieldUpdated(PXCache cache, PXFieldUpdatedEventArgs e)
		{
			...
			if (!object.Equals(e.OldValue, newValue))
			{
				cache.SetValue(e.Row, _FieldOrdinal, GetDate());
			}
		}
	...
	public class PXDBEmailAttribute : PXDBStringAttribute, IPXFieldVerifyingSubscriber
	{
		...
		public static string Distinct(string addresses)
		{
			...
			return PXDBEmailAttribute.ToString(result);
		}
	...
	/// <remarks>This attribute is obsolete and will be removed in future versions. Use <see cref="PXDBDefaultAttribute"/> instead.</remarks>
							...
							foreach (string field in cache.Fields) {
								...
								if (description != null && description.Expr != null)
								{
										...
										description.DataType != PXDbType.Timestamp)
									{
										...
										if (_BqlTable.IsDefined(typeof(PXTableAttribute), true))
										{
											if (
