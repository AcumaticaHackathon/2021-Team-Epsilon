...
namespace PX.Objects.PM
{
	...
	public class PMCostProjectionLine : PX.Data.IBqlTable
	{
		...
		{
			public static PMCostProjectionLine Find(PXGraph graph, int? projectID, string revisionID, int? lineNbr) => FindBy(graph, projectID, revisionID, lineNbr);
		}
		...
		public static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PMCostProjection>.By<taskID> { }
