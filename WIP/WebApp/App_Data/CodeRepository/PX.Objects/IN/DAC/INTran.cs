...
namespace PX.Objects.IN
{
	...
	public partial class INTran : PX.Data.IBqlTable, ILSPrimary
	{
		...
		public static class FK
		{
			...
			public class POReceipt : PO.POReceipt.UK.ForeignKeyOf<INTran>.By<pOReceiptType, pOReceiptNbr> { }
			...
			public class Task : PMTask.PK.ForeignKeyOf<INTran>.By<taskID> { }
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use INRegister instead.")]
			public class Register : INRegister { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OriginalTran instead.")]
			public class OrigTran : OriginalTran { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use SOShipmentLine instead.")]
			public class SOShipLine : SOShipmentLine { }
		}
		#endregion
		#region Selected
