namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CustomerPaymentMethodDetail>.By<pMInstanceID, paymentMethodID, detailID>
		{
			public static CustomerPaymentMethodDetail Find(PXGraph graph, Int32? pMInstanceID, String paymentMethodID, String detailID) => FindBy(graph, pMInstanceID, paymentMethodID, detailID);
		}
		public static class FK
		{
			public class CustomerPaymentMethod : AR.CustomerPaymentMethod.PK.ForeignKeyOf<CustomerPaymentMethodDetail>.By<pMInstanceID> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<CustomerPaymentMethodDetail>.By<paymentMethodID> { }
		}
		#endregion
