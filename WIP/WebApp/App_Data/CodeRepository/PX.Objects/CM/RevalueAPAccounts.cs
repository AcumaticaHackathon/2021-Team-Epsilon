...
namespace PX.Objects.CM
{
	...
	public partial class RevalueFilter : PX.Data.IBqlTable
	{
		...
		public abstract class organizationBaseCuryID : PX.Data.BQL.BqlInt.Field<orgBAccountID> { }
		[PXDBString(5, IsUnicode = true, InputMask = ">LLLLL")]
		[PXFormula(typeof(Selector<orgBAccountID, BAccount.baseCuryID>))]
		...
		[ClosedPeriod(null,
			typeof(RevalueFilter.businessDate),
		...
		[PXSelector(typeof(Search<Currency.curyID, Where<Currency.curyID, NotEqual<Current<organizationBaseCuryID>>, Or<Current<organizationBaseCuryID>, IsNull>>>))]
		...
		[CurySymbol(curyID: typeof(organizationBaseCuryID))]
