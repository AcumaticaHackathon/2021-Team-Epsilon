...
namespace PX.Objects.PR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<PRPayGroupYearSetup>.By<payGroupID>
		{
			public static PRPayGroupYearSetup Find(PXGraph graph, string payGroupID) => FindBy(graph, payGroupID);
		}

		public static class FK
		{
			public class PayGroup : PRPayGroup.PK.ForeignKeyOf<PRPayGroupYearSetup>.By<payGroupID> { }
		}
		#endregion
