...
namespace PX.Objects.AP
{
			...
			public ClassListAttribute()
				: base(
					...
					new string[]
					{
						...
						Messages.MaskNonStockItem, Messages.MaskEmployee, Messages.MaskCompany, Messages.MaskProject, Messages.MaskTask
					})
			{
			}
	...
	public class RestrictVendorByUserBranches : PXRestrictorAttribute
	{
		...
		public RestrictVendorByUserBranches()
			: base(BqlCommand.Compose(typeof(Where<,>),
				typeof(Vendor.vOrgBAccountID),
				typeof(RestrictByUserBranches<>),
				typeof(Current<>),
				typeof(AccessInfo.userName)),
				ErrorMessages.ElementDoesntExistOrNoRights)
		{
			AcctCD = typeof(Vendor.vOrgBAccountID);
		}

		public RestrictVendorByUserBranches(Type source)
			: base(BqlCommand.Compose(typeof(Where<,>),
					source,
					typeof(RestrictByUserBranches<>),
					typeof(Current<>),
		...
		public override object[] GetMessageParameters(PXCache sender, object itemres, object row)
		{
			...
			var cacheVendor = sender.Graph.Caches[BqlCommand.GetItemType(AcctCD)];
			var msgVendor = cacheVendor.GetStateExt(PXResult.Unwrap(itemres, BqlCommand.GetItemType(AcctCD)), "acctCD");
			result.Add(msgVendor);
	...
	{
		public RestrictVendorByOrganization(Type orgBAccountID = null)
			: base(BqlCommand.Compose(typeof(Where<,>),
				typeof(Vendor.vOrgBAccountID),
				typeof(RestrictByOrganization<>),
				typeof(Current<>),
				orgBAccountID), orgBAccountID, typeof(Vendor.acctCD), message: Messages.BranchRestrictedByVendor)
		{
			ResetBAccount = true;
		}
	}
	...
	{
		public RestrictVendorByCompany(Type organizationID = null)
			: base(BqlCommand.Compose(typeof(Where<,>),
				typeof(Vendor.vOrgBAccountID),
				typeof(RestrictByCompany<>),
				typeof(Current<>),
				organizationID), organizationID, typeof(Vendor.acctCD), message: Messages.BranchRestrictedByVendor)
		{
			ResetBAccount = true;
		}
	}
	...
	public class RestrictVendorByBranch : RestrictBAccountBySource
	{
		...
		public RestrictVendorByBranch(Type branchID = null)
			: base(BqlCommand.Compose(typeof(Where<,>),
				typeof(Vendor.vOrgBAccountID),
				typeof(RestrictByBranch<>),
				typeof(Current<>),
				branchID), source: branchID, acctCD: typeof(Vendor.acctCD), message: Messages.BranchRestrictedByVendor)
		{
		}

		public RestrictVendorByBranch(Type source, Type branchID = null)
			: base(BqlCommand.Compose(typeof(Where<,>),
				source,
				typeof(RestrictByBranch<>),
				typeof(Current<>),
				branchID), source: branchID, acctCD: source, message: Messages.BranchRestrictedByVendor)
		{
		}

		public RestrictVendorByBranch(Type source, Type WhereType, Type branchID = null)
			: base(BqlCommand.Compose(typeof(Where2<,>),
				...
				typeof(Current<>),
				branchID,
				WhereType), source: branchID, acctCD: source, message: Messages.BranchRestrictedByVendor)
		{
		}
	}

	public class RestrictBranchByVendor : RestrictBranchBySource
	{
		public override void CacheAttached(PXCache sender)
		{
		...
		public RestrictBranchByVendor(Type source, Type vOrgBAccountID = null)
			: base(BqlCommand.Compose(
				...
				typeof(Or<,>),
					...
					typeof(Equal<>),
					typeof(Zero)
				), source: source, branchCD: typeof(Branch.branchCD), message: Messages.BranchRestrictedByVendor)
		{
		}
	}
	...
	public class RestrictVendorClassByUserBranches : PXRestrictorAttribute
	{
		public RestrictVendorClassByUserBranches()
			: base(BqlCommand.Compose(typeof(Where<,>),
				typeof(VendorClass.orgBAccountID),
				typeof(RestrictByUserBranches<>),
				typeof(Current<>),
				typeof(AccessInfo.userName)),
				Messages.VendorClassRestrictedByOrganization, typeof(VendorClass.vendorClassID))
		{
		}
	}
	...
	///	Vendor.vendorClassID, Vendor.vStatus, Contact.phone1, Address.city, Address.countryID<br/>
	...
	///		Or<Where<Vendor.type, NotEqual<BAccountType.employeeType>, And<Where<Vendor.vStatus, Equal<VendorStatus.active>,
	///	    Or<Vendor.vStatus, Equal<VendorStatus.oneTime>>>>>>>>,
	...
	public sealed class VendorRawAttribute : AcctSubAttribute
	{
		...
		{			
			...
			_Attributes.Add(attr = new PXDimensionSelectorAttribute(DimensionName, SearchType, typeof(Vendor.acctCD),
					typeof(Vendor.acctCD), typeof(Vendor.acctName), typeof(Vendor.vendorClassID), typeof(Vendor.vStatus), typeof(Contact.phone1), typeof(Address.city), typeof(Address.countryID)
				));
			attr.DescriptionField = typeof(Vendor.acctName);
			_SelAttrIndex = _Attributes.Count - 1;
			this.Filterable = true;
	...
	public class APActiveProjectAttibute : APActiveProjectAttribute
	{
	...
	public class APActiveProjectAttribute : PM.ProjectBaseAttribute
	{

		public Type AccountFieldType { get; set; }

		public APActiveProjectAttribute() : base(null)
		{
				...
				project.BaseType == CT.CTPRType.Project && 
						...
						invoice?.IsRetainageDocument != true)
					{
						...
						if (account != null && account.AccountGroupID == null)
						{
							...
							// Next line is legacy code just moved in the file
