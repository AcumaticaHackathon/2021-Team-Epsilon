...
namespace PX.Objects.CA
{
	...
	public partial class PaymentMethod : IBqlTable
	{
		...
		{
			public static PaymentMethod Find(PXGraph graph, string paymentMethodID) => FindBy(graph, paymentMethodID);
		}
	...
	public partial class PMInstance : IBqlTable
	{
		...
		{
			public static PMInstance Find(PXGraph graph, int? pMInstanceID) => FindBy(graph, pMInstanceID);
		}
		#endregion
