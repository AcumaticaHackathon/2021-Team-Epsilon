...
namespace PX.Objects.PM
{
	public class TimeEntry : PXGraph<TimeEntry, PMTimeActivity>
	{
		...
		protected virtual void _(Events.CacheAttached<PMTimeActivity.noteID> e) { }

		[PXDBBool]
		[PXDefault(true)]
		[PXUIField(DisplayName = "Track Time")]
		protected virtual void _(Events.CacheAttached<PMTimeActivity.trackTime> e) { }
		
		[PXDefault(typeof(AccessInfo.contactID))]
		[TM.SubordinateAndWingmenOwnerEmployee(DisplayName = "Employee")]
		[PXMergeAttributes(Method = MergeMethod.Replace)]
		protected virtual void _(Events.CacheAttached<PMTimeActivity.ownerID> e) { }
		...
		[PXMergeAttributes(Method = MergeMethod.Merge)]
		protected virtual void _(Events.CacheAttached<PMTimeActivity.parentTaskNoteID> e) { }

		[PXUIField(DisplayName = "Time Card Ref.", Visibility = PXUIVisibility.SelectorVisible, Enabled = false)]
		[PXMergeAttributes(Method = MergeMethod.Merge)]
		public virtual void _(Events.CacheAttached<PMTimeActivity.timeCardCD> e) { }

		[PXMergeAttributes(Method = MergeMethod.Replace)]
		[PXDefault(ActivityStatusListAttribute.Open)]
		[PXDBString(2, IsFixed = true)]
		[PXUIField(DisplayName = "Approval Status")]
		public virtual void _(Events.CacheAttached<PMTimeActivity.approvalStatus> e) { }
		...
		{
			EPEmployee rowEmploye = PXSelect<EPEmployee>.Search<EPEmployee.defContactID>(this, e.Row.OwnerID);
		...
		public virtual void RecalculateEmployeeCost(PMTimeActivity row)
		{
			if (row != null && row.Date != null)
			{
				...
				if (row.OwnerID != null)
				{
					EPEmployee employee = PXSelect<EPEmployee, Where<EPEmployee.defContactID, Equal<Required<PMTimeActivity.ownerID>>>>.Select(this, row.OwnerID);
