...
namespace PX.Objects.GL.FinPeriods
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<MasterFinPeriod>.By<finPeriodID>
		{
			public static MasterFinPeriod Find(PXGraph graph, string finPeriodID) => FindBy(graph, finPeriodID);
		}
		public static class FK
		{
			public class FinYear : GL.FinPeriods.MasterFinYear.PK.ForeignKeyOf<MasterFinPeriod>.By<finYear> { }
		}
		#endregion
