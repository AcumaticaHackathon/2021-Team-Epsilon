...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentDet : IBqlTable, IFSSODetBase, IDocLine, ISortOrder, ILSPrimary
    {
        ...
        {
            public class Branch : GL.Branch.PK.ForeignKeyOf<FSAppointmentDet>.By<branchID> { }
            public class ServiceOrderType : FSSrvOrdType.PK.ForeignKeyOf<FSAppointmentDet>.By<srvOrdType> { }
            ...
            public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<FSAppointmentDet>.By<inventoryID> { }
            public class SubItem : INSubItem.PK.ForeignKeyOf<FSAppointmentDet>.By<subItemID> { }
            public class Site : INSite.PK.ForeignKeyOf<FSAppointmentDet>.By<siteID> { }
            public class SiteStatus : IN.INSiteStatus.PK.ForeignKeyOf<FSAppointmentDet>.By<inventoryID, subItemID, siteID> { }
            public class Location : INLocation.PK.ForeignKeyOf<FSAppointmentDet>.By<locationID> { }
            public class LocationStatus : IN.INLocationStatus.PK.ForeignKeyOf<FSAppointmentDet>.By<inventoryID, subItemID, siteID, locationID> { }
            public class LotSerialStatus : IN.INLotSerialStatus.PK.ForeignKeyOf<FSAppointmentDet>.By<inventoryID, subItemID, siteID, locationID, lotSerialNbr> { }
            public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<FSAppointmentDet>.By<curyInfoID> { }
            public class TaxCategory : Objects.TX.TaxCategory.PK.ForeignKeyOf<FSAppointmentDet>.By<taxCategoryID> { }
            public class Project : PMProject.PK.ForeignKeyOf<FSAppointmentDet>.By<projectID> { }
            public class Task : PMTask.PK.ForeignKeyOf<FSAppointmentDet>.By<projectTaskID> { }
            public class Account : GL.Account.PK.ForeignKeyOf<FSAppointmentDet>.By<acctID> { }
            public class Subaccount : GL.Sub.PK.ForeignKeyOf<FSAppointmentDet>.By<subID> { }
            public class CostCode : PMCostCode.PK.ForeignKeyOf<FSAppointmentDet>.By<costCodeID> { }
            public class Discount : ARDiscount.PK.ForeignKeyOf<FSAppointmentDet>.By<discountID> { }
            public class Vendor : AP.Vendor.PK.ForeignKeyOf<FSAppointmentDet>.By<poVendorID> { }
            public class Equipment : FSEquipment.PK.ForeignKeyOf<FSAppointmentDet>.By<SMequipmentID> { }
            public class Component : FSModelTemplateComponent.PK.ForeignKeyOf<FSAppointmentDet>.By<componentID> { }
            public class EquipmentComponent : FSEquipmentComponent.PK.ForeignKeyOf<FSAppointmentDet>.By<SMequipmentID, equipmentLineRef> { }
            public class PostInfo : FSPostInfo.PK.ForeignKeyOf<FSAppointmentDet>.By<postID> { }
            public class PurchaseOrderType : SO.SOOrderType.PK.ForeignKeyOf<FSAppointmentDet>.By<poType> { }
            public class PurchaseOrder : POOrder.PK.ForeignKeyOf<FSAppointmentDet>.By<poType, poNbr> { }            
            public class Schedule : FSSchedule.PK.ForeignKeyOf<FSAppointmentDet>.By<scheduleID> { }
            public class ScheduleDetail : FSScheduleDet.UK.ForeignKeyOf<FSAppointmentDet>.By<scheduleID, scheduleDetID> { }
            public class Staff : BAccount.PK.ForeignKeyOf<FSAppointmentDet>.By<staffID> { }
        ...
        [PXDefault(typeof(Switch<
                            Case<Where<Current<FSAppointment.completed>, Equal<True>,
                                ...
                                status.Completed,
                            Case<Where<linkedEntityType, Equal<linkedEntityType.Values.apBill>,
                                    Or<linkedEntityType, Equal<linkedEntityType.Values.expenseReceipt>>>,
                                status.Completed>>,
                        status.NotStarted>),
            PersistingCheck = PXPersistingCheck.NullOrBlank)]
        [PXFormula(typeof(Default<isTravelItem, linkedEntityType>))]
        ...
        [PXUnboundDefault(typeof(Switch<
                            ...
                            Case<Where<
                                ...
                                True,
                            Case<Where<
                                    Current<FSAppointment.areActualFieldsActive>, Equal<True>>,
                                True>>>,
                            False>))]
        [PXFormula(typeof(Default<isCanceledNotPerformed, isTravelItem, logActualDuration>))]
        ...
        [PXUIVerify(typeof(Where<actualDuration, GreaterEqual<Zero>>),
                    PXErrorLevel.Error,
                    TX.Error.FieldCannotBeNegativeReviewLogs, 
                    typeof(actualDuration),
        ...
        [PXUnboundFormula(typeof(Switch<
                                    ...
                                    int0>),
                            typeof(SumCalc<FSAppointment.apBillLineCntr>))]
        ...
        public virtual bool needToBePosted()
        {
            return (LineType == ID.LineType_ALL.SERVICE
                    ...
                    && Status != ID.Status_AppointmentDet.RequestForPO;
        }
