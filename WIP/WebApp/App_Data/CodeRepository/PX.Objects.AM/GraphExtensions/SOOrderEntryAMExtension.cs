...
namespace PX.Objects.AM.GraphExtensions
{
                        ...
                        Equal<Current<SOLine.lineNbr>>>>>>
    {
        ...
        protected virtual void _(Events.CacheAttached<SOLineSplit.planID> e) { }
        ...
        protected virtual void _(Events.CacheAttached<AMEstimateReference.bAccountID> e) { }
        ...
        {
            base.Initialize();
            Base.action.AddMenuAction(this.CTPButton);
...
#pragma warning restore PX1043
        ...
        public virtual void SOLine_InventoryID_FieldUpdated(PXCache sender, PXFieldUpdatedEventArgs e, PXFieldUpdated del)
        {
            ...
            if (item != null)
            {
                rowExt.AMProdCreate = PXCache<InventoryItem>.GetExtension<InventoryItemExt>(item)?.AMMakeToOrderItem == true 
                    && PXCache<SOOrderType>.GetExtension<SOOrderTypeExt>(Base.soordertype.Current)?.AMMTOOrder == true;
            }
        }
        ...
        [PXButton]
        [PXUIField(DisplayName = Messages.CreateProductionOrdersInq, MapViewRights = PXCacheRights.Select, MapEnableRights = PXCacheRights.Update, Visible = false)]
        ...
        internal static void _LinkProductionOrders(PXGraph graph, SOLine soLine, AMProdItem prodItem)
        {
            ...
            prodItemPlan.PlanType = prodItem.Hold == true
                || prodItem.StatusID == ProductionOrderStatus.Planned ? INPlanConstants.PlanMD : INPlanConstants.PlanME;
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [PXUIField(DisplayName = "Process CTP", MapEnableRights = PXCacheRights.Update, MapViewRights = PXCacheRights.Update, Visible = false)]
        ...
        [PXButton(OnClosingPopup = PXSpecialButtonType.Cancel, Tooltip = "Launch configuration entry", VisibleOnDataSource = false)]
        ...
        public virtual IEnumerable aMSOLineLinkRecords()
        {
            ...
            foreach(AMProdItem prodItem in PXSelect<AMProdItem,
                    Where<AMProdItem.statusID, NotIn3<
                    ProductionOrderStatus.cancel,
        ...
        protected virtual void _(Events.FieldUpdating<AMProdItem.selected> e)
        {
            var lineExt = Base.Transactions.Current.GetExtension<SOLineExt>();
