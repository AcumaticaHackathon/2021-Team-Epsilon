...
namespace PX.Objects.AP
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<VendorClass>.By<vendorClassID>
		{
			public static VendorClass Find(PXGraph graph, String vendorClassID) => FindBy(graph, vendorClassID);
		}
		public static class FK
		{
			public class Terms : CS.Terms.PK.ForeignKeyOf<VendorClass>.By<termsID> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<VendorClass>.By<paymentMethodID> { }
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<VendorClass>.By<cashAcctID> { }

			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<VendorClass>.By<taxZoneID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<VendorClass>.By<curyID> { }
			public class CurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<VendorClass>.By<curyRateTypeID> { }

			public class APAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<aPAcctID> { }
			public class APSubaccount: GL.Sub.PK.ForeignKeyOf<VendorClass>.By<aPSubID> { }

			public class DiscountAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<discountAcctID> { }
			public class DiscountSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<discountSubID> { }

			public class CashDiscountAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<discTakenAcctID> { }
			public class CashDiscountSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<discTakenSubID> { }

			public class ExpenseAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<expenseAcctID> { }
			public class ExpenseSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<expenseSubID> { }

			public class FreightAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<freightAcctID> { }
			public class FreightSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<freightSubID> { }

			public class PrepaymentAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<prepaymentAcctID> { }
			public class PrepaymentSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<prepaymentSubID> { }

			public class POAccrualAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<pOAccrualAcctID> { }
			public class POAccrualSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<pOAccrualSubID> { }

			public class ReclassificationAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<prebookAcctID> { }
			public class ReclassificationSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<prebookSubID> { }

			public class UnrealizedGainAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<unrealizedGainAcctID> { }
			public class UnrealizedGainSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<unrealizedGainSubID> { }

			public class UnrealizedLossAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<unrealizedLossAcctID> { }
			public class UnrealizedLossSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<unrealizedLossSubID> { }

			public class RetainageAccount : GL.Account.PK.ForeignKeyOf<VendorClass>.By<retainageAcctID> { }
			public class RetainageSubaccount : GL.Sub.PK.ForeignKeyOf<VendorClass>.By<retainageSubID> { }

			public class Country : CS.Country.PK.ForeignKeyOf<VendorClass>.By<countryID> { }
		}
		#endregion
        ...
        [SubAccount(typeof(VendorClass.pOAccrualAcctID), DisplayName = "PO Accrual Subaccount", Visibility = PXUIVisibility.Visible, DescriptionField = typeof(Sub.description))]
