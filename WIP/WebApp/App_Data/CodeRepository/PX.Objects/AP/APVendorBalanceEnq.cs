	...
	public class APVendorBalanceEnq : PXGraph<APVendorBalanceEnq>
	{
		...
		public virtual void APHistoryFilter_RowSelected(PXCache cache, PXRowSelectedEventArgs e)
		{
			...
			if (row != null)
			{
				...
				PXUIFieldAttribute.SetRequired<APHistoryFilter.orgBAccountID>(cache, multipleBaseCurrenciesInstalled);
				bool enableReports = multipleBaseCurrenciesInstalled ? row.FinPeriodID != null && row.OrgBAccountID != null : row.FinPeriodID != null;
