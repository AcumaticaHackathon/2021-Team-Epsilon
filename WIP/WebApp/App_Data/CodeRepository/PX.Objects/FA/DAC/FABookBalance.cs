...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FABookBalance>.By<assetID, bookID>
		{
			public static FABookBalance Find(PXGraph graph, int? assetID, int? bookID) => FindBy(graph, assetID, bookID);
		}
		public static class FK
		{
			public class FixedAsset : FA.FixedAsset.PK.ForeignKeyOf<FABookBalance>.By<assetID> { }
			public class AssetClass : FA.FAClass.PK.ForeignKeyOf<FABookBalance>.By<classID> { }
			public class Book : FA.FABook.PK.ForeignKeyOf<FABookBalance>.By<bookID> { }
			public class Bonus : FA.FABonus.PK.ForeignKeyOf<FABookBalance>.By<bonusID> { }
		}
		#endregion
		#region Selected
		...
		[PXUIField(DisplayName = "Depreciable", Visible = false, Visibility = PXUIVisibility.Invisible)]
