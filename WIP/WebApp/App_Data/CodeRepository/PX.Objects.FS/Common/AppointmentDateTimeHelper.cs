...
namespace PX.Objects.FS
{
    public partial class AppointmentEntry
    {
        ...
        public virtual void StartStaffAction(IEnumerable<FSAppointmentStaffExtItemLine> createLogItems = null)
        {
            StartStaffAction(createLogItems, null);
        }

        public virtual void StartStaffAction(IEnumerable<FSAppointmentStaffExtItemLine> createLogItems, DateTime? startTime)
        {
            IEnumerable<FSAppointmentStaffExtItemLine> createLogItemsLocal = null;

            startTime = startTime ?? LogActionFilter.Current.LogDateTime;
