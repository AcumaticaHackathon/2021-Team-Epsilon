...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Substitution" Caption="Substitution Lists">
        <Template>
            ...
            <px:PXSelector ID="selector2" DataField="TableName" runat="server" AllowNull="True" AutoRefresh="True" CommitChanges="True" />
            <px:PXDropDown ID="dropdown1" DataField="FieldName" runat="server" AllowNull="True" AutoRefresh="True" CommitChanges="True" />
        </Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" SkinID="Details" Height="150px" Style="z-index: 100" Width="100%"
        ActionsPosition="Top" AllowSearch="True" AutoAdjustColumns="True" MatrixMode="False">
        ...
        <Levels>
            <px:PXGridLevel DataMember="SubstitutionValues">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="SubstitutedValue" Required="True" AllowStrings="True" MatrixMode="True" />
                </Columns>
            </px:PXGridLevel>
        </Levels>
