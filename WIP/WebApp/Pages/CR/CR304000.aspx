...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Opportunity Summary" DataMember="Opportunity" FilesIndicator="True"
        ...
        <Template>
            ...
            <px:PXNumberEdit ID="edQuotedAmount" runat="server" DataField="QuotedAmount" CommitChanges="True" />
            <px:PXNumberEdit ID="edCost" runat="server" DataField="Cost" CommitChanges="True" />
            <px:PXNumberEdit ID="edGrossMarginAbsolute" runat="server" DataField="GrossMarginAbsolute" />
            <px:PXNumberEdit ID="edGrossMarginPercentage" runat="server" DataField="GrossMarginPercentage" />
            ...
            <px:PXNumberEdit ID="edTotalAmount" runat="server" DataField="TotalAmount" CommitChanges="True" />        
            ...
            <px:PXCheckBox ID="chkMultipleAccounts" runat="server" DataField="MultipleAccounts" CommitChanges="True" />
        </Template>
    </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="280px" DataSourceID="ds" DataMember="OpportunityCurrent" OnDataBound="tab_DataBound">
        <Items>
			...
			<px:PXTabItem Text="Multiple Customers" BindingContext="form" VisibleExp="DataControls[&quot;chkMultipleAccounts&quot;].Value == true">
				<Template>
					<px:PXGrid runat="server" ID="grdMultipleQuotes" SkinID="DetailsInTab" Width="100%" AllowPaging="True" KeepPosition="False" SyncPosition="True" DataSourceID="ds" FilesIndicator="True" NoteIndicator="True">
						<Levels>
							<px:PXGridLevel DataMember="MultipleQuotes">
								<Columns>
									<px:PXGridColumn DataField="BusinessAccountID" Width="120" CommitChanges="True" LinkCommand="MultipleQuotes_BAccount_ViewDetails" />
									<px:PXGridColumn DataField="ContactID" Width="70" CommitChanges="True" LinkCommand="MultipleQuotes_Contact_ViewDetails" DisplayMode="Text" TextAlign="Left" />
									<px:PXGridColumn DataField="QuotedAmount" Width="70" TextAlign="Right" CommitChanges="True" />
									<px:PXGridColumn DataField="CostEstimate" Width="70" TextAlign="Right" CommitChanges="True" />
									<px:PXGridColumn DataField="GrossMarginAbsolute" Width="100" TextAlign="Right" />
									<px:PXGridColumn DataField="GrossMarginPercentage" Width="70" TextAlign="Right" />
									<px:PXGridColumn DataField="QuotedOn" Width="90" CommitChanges="True" />
									<px:PXGridColumn DataField="IsSelected" Width="60" Type="CheckBox" CommitChanges="True" TextAlign="Center" />
									<px:PXGridColumn DataField="FinalAmount" Width="70" TextAlign="Right" CommitChanges="True" />
									<px:PXGridColumn DataField="FinalGrossMarginAbsolute" Width="100" TextAlign="Right" />
									<px:PXGridColumn DataField="FinalGrossMarginPercentage" Width="70" TextAlign="Right" />
									<px:PXGridColumn DataField="CreatedByID" Width="200" CommitChanges="True" />
									<px:PXGridColumn DataField="LastModifiedByID" Width="200" CommitChanges="True" />
								</Columns>
								<RowTemplate>
									<px:PXSelector runat="server" DataField="ContactID" AutoRefresh="True" ID="edContactID" />
								</RowTemplate>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="True" MinHeight="150" />
    ...
    <px:PXSmartPanel ID="panelCreateSalesOrder" runat="server" Style="z-index: 108; left: 27px; position: absolute; top: 99px;" Caption="Create Sales Order"
        ...
        <px:PXFormView ID="formCopyTo" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" CaptionVisible="False" DataMember="CreateOrderParams">
            ...
            <Template>
	            ...
	            <px:PXCheckBox runat="server" DataField="AMIncludeEstimate" ID="cstChkAMIncludeEstimate" />
	            <px:PXCheckBox runat="server" DataField="AMCopyConfigurations" ID="cstChkAMCopyConfigurations" />
			</Template>
        </px:PXFormView>
