...
namespace PX.Objects.IN
{
	...
	public class INBarCodeItem : IBqlTable
	{
		...
		public static class FK
		{
			...
			public class ReasonCode : CS.ReasonCode.PK.ForeignKeyOf<INBarCodeItem>.By<reasonCode> { }
			//todo public class UnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<INBarCodeItem>.By<inventoryID, uOM> { }
		}
		#endregion
		#region BarCode
