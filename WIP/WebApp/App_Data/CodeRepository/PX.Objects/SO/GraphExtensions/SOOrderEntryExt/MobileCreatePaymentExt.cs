...
namespace PX.Objects.SO.GraphExtensions.SOOrderEntryExt
{
    public class MobileCreatePaymentExt : PXGraphExtension<CreatePaymentExt, SOOrderEntry>
    {
		...
		[PXButton(ImageKey = PX.Web.UI.Sprite.Main.AddNew, Tooltip = "Create Payment", VisibleOnDataSource = false, OnClosingPopup = PXSpecialButtonType.Cancel)]
		...
		[PXButton(ImageKey = PX.Web.UI.Sprite.Main.AddNew, Tooltip = "Create Prepayment", VisibleOnDataSource = false, OnClosingPopup = PXSpecialButtonType.Cancel)]
