...
namespace PX.Objects.PR
{
	...
	public class PRDeductCodeBenefitIncreasingWage : IBqlTable
	{
		...
		{
			public static PRDeductCodeBenefitIncreasingWage Find(PXGraph graph, int? deductCodeID, int? applicableBenefitCodeID) =>
				FindBy(graph, deductCodeID, applicableBenefitCodeID);
		}
