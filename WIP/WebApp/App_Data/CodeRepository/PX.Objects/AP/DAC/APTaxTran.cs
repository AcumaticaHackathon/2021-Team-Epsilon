...
namespace PX.Objects.AP
{
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<APTaxTran>.By<tranDate, recordID>
		{
			public static APTaxTran Find(PXGraph graph, DateTime? tranDate, Int32? recordID) => FindBy(graph, tranDate, recordID);
		}
		public new static class FK
		{
			public class Document : AP.APRegister.PK.ForeignKeyOf<APTaxTran>.By<tranType, refNbr> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<APTaxTran>.By<branchID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APTaxTran>.By<vendorID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<APTaxTran>.By<taxZoneID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<APTaxTran>.By<taxID> { }
			public class BAccount : CR.BAccount.PK.ForeignKeyOf<APTaxTran>.By<bAccountID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<APTaxTran>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<APTaxTran>.By<subID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<APTaxTran>.By<curyInfoID> { }
		}
		#endregion
