...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXLabel runat="server" Text="Site Map" CssClass="projectLink transparent border-box" id="lblSiteMapSectionHeader" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
    ...
    <px:PXSmartPanel runat="server" ID="FilterSelectSiteMap" Width="600px" Height="400px" CaptionVisible="True"
		Caption="" ShowMaximizeButton="True" Key="ViewSelectSiteMap" ShowAfterLoad="true" AutoRepaint="True">
