...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FADetails>.By<assetID>
		{
			public static FADetails Find(PXGraph graph, Int32? assetID) => FindBy(graph, assetID);
		}
		public static class FK
		{
			public class FixedAsset : FA.FixedAsset.PK.ForeignKeyOf<FADetails>.By<assetID> { }
			public class Receipt : PO.POReceipt.PK.ForeignKeyOf<FADetails>.By<receiptNbr> { }
		}
		#endregion
		#region AssetID
		...
		[PXDefault(typeof(Search2<POOrder.orderNbr,
							...
							Where<POReceiptLine.receiptType, Equal<Current<FADetails.receiptType>>,
							  And<POReceiptLine.receiptNbr, Equal<Current<FADetails.receiptNbr>>>>>),
		...
		public virtual Boolean? Hold
		{
			get
			{
				return Status == FixedAssetStatus.Hold;
			}
		}
		#endregion
