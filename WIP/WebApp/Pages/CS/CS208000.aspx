...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="ShipTermsCurrent" TypeName="PX.Objects.CS.ShipTermsMaint" HeaderDescriptionField="Description">
		<CallbackCommands>
