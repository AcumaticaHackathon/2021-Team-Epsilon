...
namespace PX.Objects.FS
{
    ...
    public class FSBillingCycle : PX.Data.IBqlTable
    {
        ...
        {
            public static FSBillingCycle Find(PXGraph graph, int? billingCycleID) => FindBy(graph, billingCycleID);
        }
        public class UK : PrimaryKeyOf<FSBillingCycle>.By<billingCycleCD>
        {
            public static FSBillingCycle Find(PXGraph graph, string billingCycleCD) => FindBy(graph, billingCycleCD);
        }
        #endregion
