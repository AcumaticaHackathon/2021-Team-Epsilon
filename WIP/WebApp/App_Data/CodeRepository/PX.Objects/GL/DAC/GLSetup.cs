namespace PX.Objects.GL
{
    ...
    public partial class GLSetup : PX.Data.IBqlTable
	{
		...
		{
			public class YTDNetIncomeAccount : GL.Account.PK.ForeignKeyOf<GLSetup>.By<ytdNetIncAccountID> { }
			public class RetainedEarningsAccount : GL.Account.PK.ForeignKeyOf<GLSetup>.By<retEarnAccountID> { }
			public class DefaultSubaccount : GL.Sub.PK.ForeignKeyOf<GLSetup>.By<defaultSubID> { }
			public class BatchNumberingSequence : CS.Numbering.PK.ForeignKeyOf<GLSetup>.By<batchNumberingID> { }
			public class DocumentBatchNumberingSequence : CS.Numbering.PK.ForeignKeyOf<GLSetup>.By<docBatchNumberingID> { }
			public class ImportNumberingSequence : CS.Numbering.PK.ForeignKeyOf<GLSetup>.By<tBImportNumberingID> { }
			public class AllocationNumberingSequence : CS.Numbering.PK.ForeignKeyOf<GLSetup>.By<allocationNumberingID> { }
			public class ScheduleNumberingSequence : CS.Numbering.PK.ForeignKeyOf<GLSetup>.By<scheduleNumberingID> { }
		}
		#endregion
