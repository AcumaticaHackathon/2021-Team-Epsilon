...
namespace PX.Objects.GL
{
	...
	public partial class Account : PX.Data.IBqlTable, PX.SM.IIncludable
	{
		...
		public class UK : PrimaryKeyOf<Account>.By<accountCD>
		{
			public static Account Find(PXGraph graph, string accountCD) => FindBy(graph, accountCD);
		}

		public static class FK
		{
			public class AccountClass : GL.AccountClass.PK.ForeignKeyOf<Account>.By<accountClassID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<Account>.By<curyID> { }
			public class CurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<Account>.By<revalCuryRateTypeId> { }
			public class TaxCategory : TX.TaxCategory.PK.ForeignKeyOf<Account>.By<taxCategoryID> { }
			public class ConsolidationAccount : GL.Account.UK.ForeignKeyOf<Account>.By<gLConsolAccountCD> { }
		}
		#endregion
