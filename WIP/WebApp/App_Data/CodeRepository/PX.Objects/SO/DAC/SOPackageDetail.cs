...
namespace PX.Objects.SO
{
	...
	public partial class SOPackageDetail : PX.Data.IBqlTable
	{
		...
		{
			public class Box : CS.CSBox.PK.ForeignKeyOf<SOPackageDetail>.By<boxID> { }
			...
			//todo public class UnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<SOPackageDetail>.By<inventoryID, qtyUOM> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use Box instead.")]
			public class CSBox : Box { }
		}
		#endregion
		#region ShipmentNbr
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<SOPackageDetailEx>.By<shipmentNbr, lineNbr>
		{
			public static SOPackageDetailEx Find(PXGraph graph, string shipmentNbr, int? lineNbr) => FindBy(graph, shipmentNbr, lineNbr);
		}
