...
#pragma warning restore PX1088
        ...
        protected virtual IEnumerable prodMatlRecs()
        {
            ...
            if (current != null)
            {
                ...
                if (!itVar1)
                {
                    foreach (PXResult<AMProdMatl, AMProdOper, AMProdItem, InventoryItem, 
                            AMProdMatlSplit, INSiteStatus, INLocationTotals> result in PXSelectJoin<AMProdMatl,
                        ...
                        LeftJoin<INLocationTotals, On<INSiteStatus.inventoryID, Equal<INLocationTotals.inventoryID>,
                                And<INSiteStatus.siteID, Equal<INLocationTotals.siteID>,
                                And<INSiteStatus.subItemID, Equal<INLocationTotals.subItemID>>>>>>>>>>,
                    ...
                    {
                        var row = BuildSelectedProdMatl(prodMatlList, result, result, result, result, result, result, result);
                        if (row != null)
                        {
        ...
        protected virtual SelectedProdMatl BuildSelectedProdMatl(List<SelectedProdMatl> prodMatlList, AMProdMatl amProdMatl, AMProdOper amProdOper, AMProdItem amProdItem, 
            InventoryItem inventoryItem, AMProdMatlSplit amProdMatlSplit, INSiteStatus inSiteStatus, INLocationTotals locationTotals)
        {
        ...
        [Obsolete(InternalMessages.MethodIsObsoleteAndWillBeRemoved2020R2 + @"Use BuildSelectedProdMatl(List<SelectedProdMatl>, AMProdMatl  AMProdOper, AMProdItem, 
            InventoryItem, AMProdMatlSplit, INSiteStatus, INLocationTotals)")]
        protected virtual SelectedProdMatl BuildSelectedProdMatl(List<SelectedProdMatl> prodMatlList, AMProdMatl amProdMatl, AMProdOper amProdOper, AMProdItem amProdItem,
...
#pragma warning restore 618
    ...
    public class SelectedProdMatl : AMProdMatl
    {
	    ...
	    {
		    public static SelectedProdMatl Find(PXGraph graph, string orderType, string prodOrdID, int? operationID, int? lineID) 
   ...
   InnerJoin<INLocation, On<INLocation.locationID, Equal<INLocationStatus.locationID>,
       And<INLocation.siteID, Equal<INLocationStatus.siteID>>>>,
   Where<INLocation.productionValid, Equal<True>>,
   Aggregate<
       GroupBy<INLocationStatus.siteID,
       GroupBy<INLocationStatus.inventoryID,
       GroupBy<INLocationStatus.subItemID,
           ...
           Sum<INLocationStatus.qtyProductionDemand>>>>>>>>>>>>), Persistent = false)]
    [PXHidden]
    public partial class INLocationTotals : PX.Data.IBqlTable
    {
        #region InventoryID
        public abstract class inventoryID : PX.Data.BQL.BqlInt.Field<inventoryID> { }
        protected Int32? _InventoryID;
        [PXDBInt(IsKey = true, BqlField = typeof(INLocationStatus.inventoryID))]
        [PXDefault()]
        public virtual Int32? InventoryID
        {
            get
        ...
        public abstract class subItemID : PX.Data.BQL.BqlInt.Field<subItemID> { }
        protected Int32? _SubItemID;
        [PXDBInt(IsKey = true, BqlField = typeof(INLocationStatus.subItemID))]
        public virtual Int32? SubItemID
        {
            get
            {
        ...
        public abstract class qtyHardAvail : PX.Data.BQL.BqlDecimal.Field<qtyHardAvail> { }
        protected Decimal? _QtyHardAvail;
        [PXDBQuantity(BqlField = typeof(INLocationStatus.qtyHardAvail))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        /// </summary>
        [PXDBQuantity(BqlField = typeof(INLocationStatus.qtyProductionSupplyPrepared))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        /// </summary>
        [PXDBQuantity(BqlField = typeof(INLocationStatus.qtyProductionSupply))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        /// </summary>
        [PXDBQuantity(BqlField = typeof(INLocationStatus.qtyProductionDemandPrepared))]
        [PXDefault(TypeCode.Decimal, "0.0")]
        ...
        /// </summary>
        [PXDBQuantity(BqlField = typeof(INLocationStatus.qtyProductionDemand))]
        [PXDefault(TypeCode.Decimal, "0.0")]
