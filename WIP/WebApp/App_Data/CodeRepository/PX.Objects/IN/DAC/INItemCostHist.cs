...
namespace PX.Objects.IN
{
	...
	public partial class INItemCostHist : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class Account : GL.Account.PK.ForeignKeyOf<INItemCostHist>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<INItemCostHist>.By<subID> { }
			public class Site : INSite.PK.ForeignKeyOf<INItemCostHist>.By<siteID> { }
			//todo public class FinPeriod : GL.FinPeriods.TableDefinition.FinPeriod.PK.ForeignKeyOf<INItemCostHist>.By<finPeriodID> { }
