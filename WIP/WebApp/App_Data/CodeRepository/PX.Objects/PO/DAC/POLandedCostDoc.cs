...
namespace PX.Objects.PO
{
	...
	public partial class POLandedCostDoc : PX.Data.IBqlTable, IAssign
	{
		...
		{
			public static POLandedCostDoc Find(PXGraph graph, string docType, string refNbr) => FindBy(graph, docType, refNbr);
		}
		public static class FK
		{
			...
			public class Owner : EP.EPEmployee.PK.ForeignKeyOf<POLandedCostDoc>.By<ownerID> { }
