namespace PX.Objects.AR
{
    ...
    {
      #region Keys
      public class PK : PrimaryKeyOf<DiscountSequenceDetail>.By<discountDetailsID>
      {
         public static DiscountSequenceDetail Find(PXGraph graph, Int32? discountDetailsID) => FindBy(graph, discountDetailsID);
      }
      #endregion
