...
namespace PX.Objects.IN
{
    ...
    public partial class INReplenishmentLine : IBqlTable
    {
		...
		public static class FK
		{
			...
			public class VendorLocation : CR.Location.PK.ForeignKeyOf<INReplenishmentLine>.By<vendorID, vendorLocationID> { }
			...
			public class POOrder : PO.POOrder.PK.ForeignKeyOf<INReplenishmentLine>.By<pOType, pONbr> { }
			public class POLine : PO.POLine.PK.ForeignKeyOf<INReplenishmentLine>.By<pOType, pONbr, pOLineNbr> { }
			public class SOOrderType : SO.SOOrderType.PK.ForeignKeyOf<INReplenishmentLine>.By<sOType> { }
			public class SOOrder : SO.SOOrder.PK.ForeignKeyOf<INReplenishmentLine>.By<sOType, sONbr> { }
			public class SOLine : SO.SOLine.PK.ForeignKeyOf<INReplenishmentLine>.By<sOType, sONbr, sOLineNbr> { }
			public class SOLineSplit: SO.SOLineSplit.PK.ForeignKeyOf<INReplenishmentLine>.By<sOType, sONbr, sOLineNbr, sOSplitLineNbr> { }
			//todo public class UnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<INReplenishmentLine>.By<inventoryID, uOM> { }
		}
		#endregion
		#region RefNbr
