...
namespace PX.Objects.AR
{
	...
	public class ARStatementAdjust : IBqlTable, IDocumentAdjustment, IAdjustmentAmount
	{
		#region Keys
		/// <exclude/>
		public class PK : PrimaryKeyOf<ARStatementAdjust>.By<branchID, customerID, curyID, statementDate, adjdDocType, adjdRefNbr, adjdLineNbr, adjgDocType, adjgRefNbr, adjNbr>
		{
			public static ARStatementAdjust Find(PXGraph graph, Int32? branchID, Int32? customerID, String curyID, DateTime? statementDate, String adjdDocType, String adjdRefNbr, Int32? adjdLineNbr, String adjgDocType, String adjgRefNbr, Int32? adjNbr)
													=> FindBy(graph, branchID, customerID, curyID, statementDate, adjdDocType, adjdRefNbr, adjdLineNbr, adjgDocType, adjgRefNbr, adjNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<ARStatementAdjust>.By<branchID> { }
			public class Customer : AR.Customer.PK.ForeignKeyOf<ARStatementAdjust>.By<customerID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<ARStatementAdjust>.By<curyID> { }
			public class Statement : AR.ARStatement.PK.ForeignKeyOf<ARStatementAdjust>.By<branchID, customerID, curyID, statementDate> { }
		}
		#endregion
