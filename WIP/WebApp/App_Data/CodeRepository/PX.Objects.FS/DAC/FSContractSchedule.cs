...
namespace PX.Objects.FS
{
    ...
    public class FSContractSchedule : FSSchedule
	{
        ...
        {
            public static FSContractSchedule Find(PXGraph graph, int? entityID, string refNbr) => FindBy(graph, entityID, refNbr);
        }
        ...
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSContractSchedule>.By<dfltProjectTaskID> { }
        }
        #endregion
