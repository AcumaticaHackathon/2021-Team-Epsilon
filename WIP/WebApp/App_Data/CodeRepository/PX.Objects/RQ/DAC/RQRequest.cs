...
namespace PX.Objects.RQ
{
	...
	[PXEMailSource]
	[PXGroupMask(typeof(LeftJoinSingleTable<Vendor, On<Vendor.bAccountID, Equal<RQRequest.vendorID>, And<Match<Vendor, Current<AccessInfo.userName>>>>>),
		WhereRestriction = typeof(Where<Vendor.bAccountID, IsNotNull, Or<RQRequest.vendorID, IsNull>>))]
	public partial class RQRequest : PX.Data.IBqlTable, PX.Data.EP.IAssign
	{
		...
		#endregion
		#region Events
		public class Events : PXEntityEvent<RQRequest>.Container<Events>
		{
		...
		[PXDefault((object)null, typeof(Coalesce<
			Search<LocationBranchSettings.vSiteID, Where<Current<RQRequest.shipDestType>, Equal<POShippingDestination.site>,
				And<LocationBranchSettings.bAccountID, Equal<Current<RQRequest.vendorID>>,
				And<LocationBranchSettings.locationID, Equal<Current<RQRequest.vendorLocationID>>,
				And<LocationBranchSettings.branchID, Equal<Current<RQRequest.branchID>>>>>>>,
			Search<Location.vSiteID, Where<Current<RQRequest.shipDestType>, Equal<POShippingDestination.site>,
