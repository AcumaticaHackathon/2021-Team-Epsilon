...
namespace PX.Objects.FS
{
    ...
    {
        #region Keys
        public class PK : PrimaryKeyOf<BAccountLocation>.By<customerID, locationID>
        {
            public static BAccountLocation Find(PXGraph graph, int? customerID, int? locationID) => FindBy(graph, customerID, locationID);
        }

        public static class FK
        {
            public class Customer : AR.Customer.PK.ForeignKeyOf<BAccountLocation>.By<customerID> { }
            public class CustomerLocation : Location.PK.ForeignKeyOf<BAccountLocation>.By<customerID, locationID> { }
        }
        #endregion
        ...
        [PXDBString(60, IsUnicode = true, BqlField = typeof(Location.descr))]
    ...
    public class CustomerLocationInq : PXGraph<CustomerLocationInq>
    {
        ...
        public virtual void openRouteServiceContract()
        {
            if (RouteContractSchedules.Current != null)
            {
                ...
                graphRouteServiceContractEntry.ServiceContractRecords.Current = FSServiceContract.PK.Find(this, RouteContractSchedules.Current.EntityID);
