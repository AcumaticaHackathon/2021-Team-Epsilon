						...
						<Template>
							<px:PXFormView ID="formSettings" runat="server" DataSourceID="ds" DataMember="StepSettings" Width="100%" SkinID="Transparent">
								<Template>
									...
									<px:PXPanel ID="formSelection" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule15" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
										...
										<px:PXLayoutRule ID="PXLayoutRule88" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM"/>
									...
									<px:PXPanel ID="PXPanel4" runat="server" Width="100%" RenderStyle="Simple">
                                        <px:PXLayoutRule ID="PXLayoutRule23" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M"  />
                                        ...
                                        <px:PXLayoutRule ID="PXLayoutRule22" runat="server" StartColumn="True" ControlSize="XM" />
									...
									<px:PXPanel ID="PXPanel1" runat="server" Width="100%" RenderStyle="Simple">
										...
										<px:PXLayoutRule ID="PXLayoutRule12" runat="server" StartColumn="True" ControlSize="XM"/>
										...
										<px:PXSegmentMask ID="edTaskCD" runat="server" DataField="TaskCD" SuppressLabel="True" CommitChanges="True"/>
									...
									<px:PXPanel ID="PXPanel2" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule17" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
										...
										<px:PXLayoutRule ID="PXLayoutRule13" runat="server" StartColumn="True" ControlSize="XM" />
										...
										<px:PXSegmentMask ID="edOffsetTaskCD" runat="server" DataField="OffsetTaskCD" SuppressLabel="True" CommitChanges="True"/>
									...
									<px:PXPanel ID="PXPanel3" runat="server" Width="100%" RenderStyle="Simple">
										<px:PXLayoutRule ID="PXLayoutRule18" runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="M" />
