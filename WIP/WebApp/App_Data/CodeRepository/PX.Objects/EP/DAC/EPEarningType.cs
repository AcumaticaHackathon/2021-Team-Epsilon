...
namespace PX.Objects.EP
{
	...
	public partial class EPEarningType : IBqlTable
	{
		...
		{
			public static EPEarningType Find(PXGraph graph, string typeCD) => FindBy(graph, typeCD);
		}
		...
		public static class FK
		{
			...
			/// </summary>
			public class DefaultProjectTask : PMTask.PK.ForeignKeyOf<EPEarningType>.By<taskID> { }
		}
		#endregion
