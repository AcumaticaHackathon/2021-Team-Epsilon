...
namespace PX.Objects.IN
{
    ...
    public partial class INTransitLine : PX.Data.IBqlTable
    {
		...
		public static class FK
		{
            ...
            public class SOOrderType : SO.SOOrderType.PK.ForeignKeyOf<INTransitLine>.By<sOOrderType> { }
            public class SOOrder : SO.SOOrder.PK.ForeignKeyOf<INTransitLine>.By<sOOrderType, sOOrderNbr> { }
            public class SOLine : SO.SOLine.PK.ForeignKeyOf<INTransitLine>.By<sOOrderType, sOOrderNbr, sOOrderLineNbr> { }
            public class SOShipment : SO.SOShipment.UK.ForeignKeyOf<INTransitLine>.By<sOShipmentType, sOShipmentNbr> { }
            public class SOShipmentLine : SO.SOShipLine.UK.ForeignKeyOf<INTransitLine>.By<sOShipmentType, sOShipmentNbr, sOShipmentLineNbr> { }
            //todo public class Transfer : INRegister.PK.ForeignKeyOf<INTransitLine>.By<INDocType.transfer, transferNbr> { }
            //todo public class TransferLine : INTran.PK.ForeignKeyOf<INTransitLine>.By<INDocType.transfer, transferNbr, transferLineNbr> { }
		}
		#endregion
