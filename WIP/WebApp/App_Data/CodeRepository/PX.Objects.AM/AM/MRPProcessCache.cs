...
namespace PX.Objects.AM
{
    ...
    public class MRPProcessCache
    {
            ...
            Dictionary<int, Dictionary<int, ReplenishmentSourceCache>> itemReplenishmentSourceDictionary, bool subItemEnabled)
        {
            ...
            var isFirst = true;
#endif
            foreach (PXResult<INItemSite, InventoryItem, POVendorInventory, VendorLocation, BomItemActiveRevision, BomItemActiveRevision2, BomItemActiveRevision3, BomItemActiveRevision4> result in
            SelectFrom<INItemSite>.
                ...
                LeftJoin<BomItemActiveRevision>.On<INItemSiteExt.aMBOMID.IsEqual<BomItemActiveRevision.bOMID>>.
                LeftJoin<BomItemActiveRevision2>.On<INItemSiteExt.aMPlanningBOMID.IsEqual<BomItemActiveRevision2.bOMID>>.
                LeftJoin<BomItemActiveRevision3>.On<InventoryItemExt.aMBOMID.IsEqual<BomItemActiveRevision3.bOMID>>.
                LeftJoin<BomItemActiveRevision4>.On<InventoryItemExt.aMPlanningBOMID.IsEqual<BomItemActiveRevision4.bOMID>>.
                Where<InventoryItem.stkItem.IsEqual<True>.
                    And<Where<InventoryItemExt.aMMRPItem.IsEqual<True>.
                        Or<InventoryItemExt.aMMRPItem.IsNull>>>>.
                OrderBy<INItemSite.inventoryID.Asc, INItemSite.siteID.Asc>.
