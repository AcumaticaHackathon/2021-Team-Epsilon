...
namespace PX.Objects.AR
{
	...
	public partial class ARStatementDetail : IBqlTable
	{
		#region Keys
		// <exclude/>
		public class PK : PrimaryKeyOf<ARStatementDetail>.By<branchID, customerID, curyID, statementDate, docType, refNbr>
		{
			public static ARStatementDetail Find(PXGraph graph, Int32? branchID, Int32? customerID, String curyID, DateTime? statementDate, String docType, String refNbr)
