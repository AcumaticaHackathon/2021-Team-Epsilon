...
namespace PX.Objects.CA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CADepositCharge>.By<tranType, refNbr, entryTypeID, depositAcctID, paymentMethodID>
		{
			public static CADepositCharge Find(PXGraph graph, string tranType, string refNbr, string entryTypeID, int? depositAcctID, string paymentMethodID) 
				=> FindBy(graph, tranType, refNbr, entryTypeID, depositAcctID, paymentMethodID);
		}

		public static class FK
		{
			public class ChargeEntryType : CA.CAEntryType.PK.ForeignKeyOf<CADepositCharge>.By<entryTypeID> { }
			public class ClearingAccount : CA.CashAccount.PK.ForeignKeyOf<CADepositCharge>.By<depositAcctID> { }
			public class DepositPaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<CADepositCharge>.By<paymentMethodID> { }
			public class ExpenseAccount : GL.Account.PK.ForeignKeyOf<CADepositCharge>.By<accountID> { }
			public class ExpenseSubaccount : GL.Sub.PK.ForeignKeyOf<CADepositCharge>.By<subID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<CADepositCharge>.By<curyInfoID> { }
		}
		#endregion
