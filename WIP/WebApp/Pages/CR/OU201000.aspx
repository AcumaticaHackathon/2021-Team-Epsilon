...
<asp:Content ID="cont3" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXFormView ID="form" runat="server" Width="100%" Height="643px" DataSourceID="ds" DataMember="Filter" SkinID="Transparent" OnDataBound="form_OnDataBound">
        <Template>                         
            ...
            <px:PXCheckBox ID="edRecognitionIsNotStarted" runat="server" DataField="RecognitionIsNotStarted" />
            ...
            <px:PXLabel ID="edRefreshText" runat="server" Style="padding-top: 4px;">Document recognition is in progress...</px:PXLabel>
            ...
            <px:PXTextEdit runat="server" ID="edDuplicateFileMsg" DataField="DuplicateFilesMsg" SkinID="Label" Width="270px" TextAlign="Left" Height="35px" TextMode="MultiLine" />
    ...
    <script type="text/javascript">
        ...
        function startFormRefreshing() {
            ...
            formRefreshingInterval = setInterval(function () {
                try {
                    const isRecognitionNotStartedControl = px_all[isRecognitionNotStartedId];
                    if (isRecognitionNotStartedControl && isRecognitionNotStartedControl.getValue() == true) {
                        stopFormRefreshing();
                        return;
                    }
