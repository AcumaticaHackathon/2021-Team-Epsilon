...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" UDFTypeField="AssetTypeID"  ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.FA.AssetMaint" PrimaryView="Asset"
        BorderStyle="NotSet">
        <CallbackCommands>
			...
			<px:PXDSCallbackCommand DependOnGrid="gridTranHistory" Name="ViewDocument" Visible="False" CommitChanges="True" PopupCommand="Cancel" PopupCommandTarget="ds" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <px:PXSmartPanel ID="pnlSuspendParams" runat="server" Key="SuspendParams" AutoCallBack-Command="Refresh" AutoCallBack-Target="frmSuspendParams" AutoCallBack-Enabled="true"
        LoadOnDemand="True" AcceptButtonID="cbsOk" CancelButtonID="cbsCancel" Caption="Suspend Parameters" CaptionVisible="True">
		...
		<px:PXPanel ID="PXPanel2" runat="server" SkinID="Buttons">        
            <px:PXButton ID="cbsOk" runat="server" Text="OK" DialogResult="OK" />
            <px:PXButton ID="cbsCancel" runat="server" Text="Cancel" DialogResult="Cancel" />
        </px:PXPanel>
    </px:PXSmartPanel>
    <px:PXSmartPanel ID="spRevDispInfoDlg" runat="server" Key="RevDispInfo"
        ...
        LoadOnDemand="True" AcceptButtonID="cbrdOk" CancelButtonID="cbrdCancel" Caption="Reverse Disposal Info"
		CaptionVisible="True"  DesignView="Content">
		...
		<px:PXPanel ID="PXPanel3" runat="server" SkinID="Buttons">        
			<px:PXButton ID="cbrdOk" runat="server" Text="OK" DialogResult="OK" />
			<px:PXButton ID="cbrdCancel" runat="server" Text="Cancel" DialogResult="Cancel" />
		</px:PXPanel> 
    </px:PXSmartPanel>
</asp:Content>
