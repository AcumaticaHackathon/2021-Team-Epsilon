...
{	
    ...
    {
        #region Keys
        public class PK : PrimaryKeyOf<FSSchedule>.By<scheduleID>
        {
            public static FSSchedule Find(PXGraph graph, int? scheduleID) => FindBy(graph, scheduleID);
        }

        public class UK : PrimaryKeyOf<FSSchedule>.By<refNbr, customerID>
        {
            public static FSSchedule Find(PXGraph graph, string refNbr, int? customerID) => FindBy(graph, refNbr, customerID);
        }

        public static class FK
        {
            public class Branch : GL.Branch.PK.ForeignKeyOf<FSSchedule>.By<branchID> { }
            public class BranchLocation : FSBranchLocation.PK.ForeignKeyOf<FSSchedule>.By<branchLocationID> { }
            public class Customer : AR.Customer.PK.ForeignKeyOf<FSSchedule>.By<customerID> { }
            public class CustomerLocation : Location.PK.ForeignKeyOf<FSSchedule>.By<customerID, customerLocationID> { }
            public class Vendor : AP.Vendor.PK.ForeignKeyOf<FSSchedule>.By<vendorID> { }
            public class VehicleType : FSVehicleType.PK.ForeignKeyOf<FSSchedule>.By<vehicleTypeID> { }
            public class Employee : EP.EPEmployee.PK.ForeignKeyOf<FSSchedule>.By<employeeID> { }
            public class Project : PMProject.PK.ForeignKeyOf<FSSchedule>.By<projectID> { }
            public class DefaultTask : PMTask.PK.ForeignKeyOf<FSSchedule>.By<dfltProjectTaskID> { }
        }
        #endregion
        ...
        public virtual string YearlyLabel
        {
            get
            {
                return PXMessages.LocalizeNoPrefix(TX.RecurrenceDescription.YEARS);
            }
        }
        #endregion
        #region MonthlyLabel
        ...
        public virtual string MonthlyLabel
        {
            get
            {
                return PXMessages.LocalizeNoPrefix(TX.RecurrenceDescription.MONTHS);
            }
        }
        #endregion
        #region WeeklyLabel
        ...
        public virtual string WeeklyLabel
        {
            get
            {
                return PXMessages.LocalizeNoPrefix(TX.RecurrenceDescription.WEEKS);
            }
        }
        #endregion
        #region DailyLabel
        ...
        public virtual string DailyLabel
        {
            get
            {
                return PXMessages.LocalizeNoPrefix(TX.RecurrenceDescription.DAYS);
            }
        }
        #endregion
        ...
        #region OverrideDuration
        public abstract class overrideDuration : PX.Data.BQL.BqlBool.Field<overrideDuration> { }
        ...
        #endregion
        #region ScheduleDuration
        public abstract class scheduleDuration : PX.Data.BQL.BqlInt.Field<scheduleDuration> { }

        [PXDBTimeSpanLong(Format = TimeSpanFormatType.LongHoursMinutes)]
        [PXUIField(DisplayName = "Schedule Duration")]
        [PXDefault(0, PersistingCheck = PXPersistingCheck.Nothing)]
        [PXUIEnabled(typeof(overrideDuration))]
        [PXFormula(typeof(Switch<
            Case<Where<
                overrideDuration, Equal<False>>,
