...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Filter" Caption="Selection" DefaultControlID="edDate">
        <Template>
            ...
            <px:PXDateTimeEdit CommitChanges="True" ID="edDate" runat="server" DataField="Date" Size="S" />
			...
			<px:PXCheckBox CommitChanges="True" ID="chkCreateOnHold" runat="server" DataField="CreateOnHold" />
			<px:PXCheckBox CommitChanges="True" ID="chkCreateInSpecificPeriod" runat="server" DataField="CreateInSpecificPeriod" />
			<px:PXSelector CommitChanges="True" ID="edFinPeriodID" runat="server" DataField="FinPeriodID" Size="S" />
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
            <px:PXSegmentMask CommitChanges="True" ID="edProjectID" runat="server" DataField="ProjectID" DataSourceID="ds" />
			<px:PXCheckBox CommitChanges="True" ID="chkCopyProjectInformation" runat="server" DataField="CopyProjectInformation" />
        </Template>
    </px:PXFormView>
</asp:Content>
