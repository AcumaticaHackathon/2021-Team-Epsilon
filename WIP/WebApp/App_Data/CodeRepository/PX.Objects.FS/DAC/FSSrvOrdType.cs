...
namespace PX.Objects.FS
{
    ...
    public class FSSrvOrdType : PX.Data.IBqlTable
    {
        ...
        {
            public static FSSrvOrdType Find(PXGraph graph, string srvOrdType) => FindBy(graph, srvOrdType);
        }
        public class UK : PrimaryKeyOf<FSSrvOrdType>.By<srvOrdTypeID>
        {
            public static FSSrvOrdType Find(PXGraph graph, int? srvOrdTypeID) => FindBy(graph, srvOrdTypeID);
        }
