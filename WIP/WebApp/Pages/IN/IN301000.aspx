...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INReceiptEntry" PrimaryView="receipt" HeaderDescriptionField="TranDesc">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" Caption="Document Summary" DataMember="receipt"
        NoteIndicator="True" FilesIndicator="True" LinkIndicator="True" BPEventsIndicator="True" ActivityIndicator="True" DefaultControlID="edRefNbr">
        <Template>
