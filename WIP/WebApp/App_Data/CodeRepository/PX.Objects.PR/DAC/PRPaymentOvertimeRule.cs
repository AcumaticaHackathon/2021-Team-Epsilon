...
namespace PX.Objects.PR
{
	...
	public class PRPaymentOvertimeRule : IBqlTable
	{
		...
		{
			public static PRPaymentOvertimeRule Find(PXGraph graph, string paymentDocType, string paymentRefNbr, string overtimeRuleID) =>
				FindBy(graph, paymentDocType, paymentRefNbr, overtimeRuleID);
		}
