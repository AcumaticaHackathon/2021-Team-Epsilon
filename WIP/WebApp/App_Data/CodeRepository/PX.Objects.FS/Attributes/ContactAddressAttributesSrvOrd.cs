...
namespace PX.Objects.FS
{
    public class FSSrvOrdContactAttribute : FSDocumentContactAttribute
    {
        ...
        public virtual bool DefaultBLOCContact<TContact, TContactID>(PXCache sender, string fieldName, object documentRow, object contactRow, object sourceRow)
            ...
            where TContactID : IBqlField
        {
            ...
            if (sourceRow != null)
            {
                ...
                if (contact == null)
                {
                    contact = FSContact.PK.Find(sender.Graph, (int?)sender.GetValue(documentRow, fieldName));
                }
    ...
    public class FSSrvOrdAddressAttribute : FSDocumentAddressAttribute
    {
        ...
        public virtual bool DefaultBLOCAddress<TAddress, TAddressID>(PXCache sender, string fieldName, object documentRow, object addressRow, object sourceRow)
