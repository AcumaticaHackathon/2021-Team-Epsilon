...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<pxa:DynamicDataSource ID="ds" runat="server" AutoCallBack="True" Visible="True"
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="associateUser" CommitChanges="True" Visible="false" DependOnGrid="gridIdentities" StateColumn="NotOidc" />
			<px:PXDSCallbackCommand Name="removeIdentity" CommitChanges="True" Visible="false" DependOnGrid="gridIdentities" StateColumn="Oidc"  />
		</CallbackCommands>
				...
				<Template>
					...
					<px:PXFormView ID="form2" runat="server" Width="100%" DataMember="CalendarSettings" DataSourceID="ds" CaptionVisible="False" SkinID="Transparent">
						<Template>
							...
							<asp:HyperLink CssClass="ordinary_link"  Style="margin-left: 160px; margin-top:5px;" Height="15px" runat="server" ID="OutlookAddin" NavigateUrl="~/OutlookAddinManifest">Download Outlook Add-In Manifest</asp:HyperLink>
			...
			<px:PXTabItem Text="External Identities" Key="roles" LoadOnDemand="True">
				<Template>
					<px:PXGrid ID="gridIdentities" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100"
						...
						<Levels>
							<px:PXGridLevel DataMember="Identities">
								<Columns>
									...
									<px:PXGridColumn DataField="UserIdentityClaimType" Width="250px" />
									<px:PXGridColumn DataField="Oidc" Width="90px" TextAlign="Center" Type="CheckBox" />
									<px:PXGridColumn DataField="NotOidc" Type="CheckBox" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						...
						<ActionBar>
							<CustomItems>
								<px:PXToolBarButton Text="Associate" AutoPostBack="True" CommandName="associateUser" CommandSourceID="ds" StateColumn="NotOidc" />
								<px:PXToolBarButton ImageKey="RecordDel" CommandName="removeIdentity" CommandSourceID="ds" DisplayStyle="Image" StateColumn="Oidc" />
							</CustomItems>
							<Actions>
