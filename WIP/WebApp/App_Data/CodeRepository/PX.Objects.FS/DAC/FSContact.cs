...
namespace PX.Objects.FS
{
    ...
    public partial class FSShippingContact : FSContact
    {
        ...
        {
            public static FSShippingContact Find(PXGraph graph, int? contactID) => FindBy(graph, contactID);
        }
    ...
    public partial class FSContact : IBqlTable, IPersonalContact, IContactBase, CR.CRDefaultMailToAttribute.IEmailMessageTarget, IConsentable
    {
        #region Keys
        public class PK : PrimaryKeyOf<FSContact>.By<contactID>
        {
            public static FSContact Find(PXGraph graph, int? contactID) => FindBy(graph, contactID);
        }
