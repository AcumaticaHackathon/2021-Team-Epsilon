...
namespace PX.Objects.AM.GraphExtensions
{
            ...
            where TConfigWhere : IBqlWhere, new()
    {
        ...
        protected virtual void _(Events.CacheAttached<AMConfigResultsOption.inventoryID> e) { }

        [PXDBInt]
        [PXUIField(DisplayName = "Subitem")]
        protected virtual void _(Events.CacheAttached<AMConfigResultsOption.subItemID> e) { }

        [PXDBInt]
        [PXUIField(DisplayName = "Inventory ID")]
        protected virtual void _(Events.CacheAttached<AMConfigurationOption.inventoryID> e) { }

        [PXDBInt]
        [PXUIField(DisplayName = "Subitem")]
        protected virtual void _(Events.CacheAttached<AMConfigurationOption.subItemID> e) { }

        [PXDBInt]
        [PXUIField(DisplayName = "Warehouse")]
        protected virtual void _(Events.CacheAttached<AMConfigurationOption.siteID> e) { }
        ...
        {
            if (rowExtension == null || !AllowConfigurationsInt)
            {
                return;
            }
