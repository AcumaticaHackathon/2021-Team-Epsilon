...
namespace PX.Objects.PR
{
	...
	public class PRPaymentProjectPackageDeduct : IBqlTable
	{
		...
		{
			public static PRPaymentProjectPackageDeduct Find(PXGraph graph, int? recordID) => FindBy(graph, recordID);
		}
		...
		{
			public static PRPaymentProjectPackageDeduct Find(PXGraph graph, string docType, string refNbr, int? deductCodeID, int? projectID, int? laborItemID, string contribType) =>
				FindBy(graph, docType, refNbr, deductCodeID, projectID, laborItemID, contribType);
		}
