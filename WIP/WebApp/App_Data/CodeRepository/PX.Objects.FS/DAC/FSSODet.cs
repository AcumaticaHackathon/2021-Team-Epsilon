...
namespace PX.Objects.FS
{
    ...
    public class FSSODet : IBqlTable, IFSSODetBase, IDocLine, ILSPrimary, ISortOrder
    {
        ...
        {
            public static FSSODet Find(PXGraph graph, int? sODetID) => FindBy(graph, sODetID);
        }
        ...
        public static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSSODet>.By<projectTaskID> { }
        ...
        [LocationAvail(typeof(FSSODet.inventoryID), typeof(FSSODet.subItemID), typeof(FSSODet.siteID), typeof(FSSODet.tranType), typeof(FSSODet.invtMult))]
        ...
        [PXDefault(TypeCode.Decimal, "0.0")]
        [PXFormula(typeof(Default<FSSODet.isFree, FSSODet.lineType>))]
        [PXFormula(typeof(Switch<
        ...
        [PXFormula(typeof(Switch<
                                ...
                                SharedClasses.decimal_0>),
                                typeof(SumCalc<FSServiceOrder.curyCostTotal>))]
