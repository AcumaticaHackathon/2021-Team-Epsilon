...
namespace PX.Objects.PR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<PRPaymentWCPremium>.By<docType, refNbr, workCodeID, deductCodeID, contribType>
		{
			public static PRPaymentWCPremium Find(PXGraph graph, string docType, string refNbr, string workCodeID, int? deductCodeID, string contribType) => 
				FindBy(graph, docType, refNbr, workCodeID, deductCodeID, contribType);
		}
