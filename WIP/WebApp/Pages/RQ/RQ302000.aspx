...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" TypeName="PX.Objects.RQ.RQRequisitionEntry" PrimaryView="Document" BorderStyle="NotSet" Width="100%" HeaderDescriptionField="Description">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="viewBidding" PopupCommand="Cancel" PopupCommandTarget="ds" PopupVisible="true"/>
			...
			<px:PXDSCallbackCommand Name="ValidateAddresses" StartNewGroup="True" />
            ...
            <px:PXDSCallbackCommand Name="AddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,formSA" CommitChanges="true" Visible="false" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Document" Caption="Document Summary" NoteIndicator="True"
        FilesIndicator="True" LinkIndicator="true" BPEventsIndicator="true" ActivityIndicator="true" ActivityField="NoteActivity" EmailingGraph="PX.Objects.CR.CREmailActivityMaint,PX.Objects"
        ...
        <Items>
            ...
            <px:PXTabItem Text="Bidding">
                <Template>
					...
					<px:PXGrid ID="gridVendor" runat="server" DataSourceID="ds" Width="100%" Height="200px" SkinID="DetailsWithFilter" Caption="Bidding Vendors" SyncPosition="True">
						...
						<ActionBar>
							<CustomItems>
								...
								<px:PXToolBarButton Text="Send Request" Tooltip="Send request for proposal to the selected vendor">
									<AutoCallBack Command="sendRequestToCurrentVendor" Target="ds">
										<Behavior CommitChanges="True" />
									</AutoCallBack>
								</px:PXToolBarButton>
							</CustomItems>
            ...
            <px:PXTabItem Text="Approvals" RepaintOnDemand="false">
                <Template>
                    ...
                    <px:PXGrid ID="gridPOOrders" runat="server" DataSourceID="ds" Width="100%" BorderWidth="0px" SkinID="Details">
                        ...
                        <ActionBar DefaultAction="Content">
                            <CustomItems>
                                ...
                                <px:PXToolBarButton Text="Create Orders" Tooltip="Create purchase orders for requisition" Key="CreatePOOrder">
                                    <AutoCallBack Command="Action@CreatePOOrder" Target="ds">
                                        <Behavior CommitChanges="True" />
                                    </AutoCallBack>
                                </px:PXToolBarButton>
                            </CustomItems>
                    ...
                    <px:PXGrid ID="gridSOOrders" runat="server" DataSourceID="ds" Width="100%" BorderWidth="0px" SkinID="Details">
                        ...
                        <ActionBar DefaultAction="Content">
                            <CustomItems>
                                ...
                                <px:PXToolBarButton Text="Create Quote" Tooltip="Create quotation for requisition" Key="CreateQTOrder">
                                    <AutoCallBack Command="Action@CreateQTOrder" Target="ds">
                                        <Behavior CommitChanges="True" />
                                    </AutoCallBack>
                                </px:PXToolBarButton>
                            </CustomItems>
