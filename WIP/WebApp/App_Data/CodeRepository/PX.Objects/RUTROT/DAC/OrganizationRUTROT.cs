...
namespace PX.Objects.RUTROT.DAC
{
	...
	public class OrganizationRUTROT : PXCacheExtension<Organization>, IRUTROTConfigurationHolder
	{
		...
		/// <summary>
		/// The identifier of the <see cref="CM.Currency"/>, in which RUT and ROT are deducted.
		/// This field is relevant only for the branches that <see cref="AllowsRUTROT">allow RUT and ROT deduction</see>.
		/// </summary>
		/// <value>
