...
namespace PX.Objects.PM
{
	...
	public class PMChangeOrderLine : PX.Data.IBqlTable, IQuantify
	{
		...
		{
			public static PMChangeOrderLine Find(PXGraph graph, string refNbr, int? lineNbr) => FindBy(graph, refNbr, lineNbr);
		}
		...
		public static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PMChangeOrderLine>.By<taskID> { }
