...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" DataMember="Filter" Caption="Selection" TabIndex="2100" MarkRequired="Dynamic">
        <Template>
            ...
            <px:PXBranchSelector CommitChanges="True" ID="edOrgBAccountID" runat="server" DataField="OrgBAccountID" Size="m" InitialExpandLevel="0" />
            <px:PXSelector CommitChanges="True" ID="edAccountID" runat="server" DataField="CashAccountID" Size="m" DataSourceID="ds" AutoRefresh="true" />
            ...
            <px:PXSelector CommitChanges="True" ID="edDefaultAccountID" runat="server" DataField="DefaultAccountID" Size="m" DataSourceID="ds"  AutoRefresh="true"/>
