...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FABookPeriod>.By<bookID, organizationID, finPeriodID>
		{
			public static FABookPeriod Find(PXGraph graph, Int32? bookID, Int32? organizationID, String finPeriodID) => FindBy(graph, bookID, organizationID, finPeriodID);
		}
		public static class FK
		{
			public class Book : FA.FABook.PK.ForeignKeyOf<FABookPeriod>.By<bookID> { }
			public class Organization : GL.DAC.Organization.PK.ForeignKeyOf<FABookPeriod>.By<organizationID> { }
		}
		#endregion
