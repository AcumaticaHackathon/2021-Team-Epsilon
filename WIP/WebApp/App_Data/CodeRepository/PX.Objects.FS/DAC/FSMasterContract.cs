...
{	
    ...
    public class FSMasterContract : PX.Data.IBqlTable
	{
		...
		{
			public static FSMasterContract Find(PXGraph graph, int? masterContractID) => FindBy(graph, masterContractID);
		}
		public class UK : PrimaryKeyOf<FSMasterContract>.By<masterContractCD>
        {
            public static FSMasterContract Find(PXGraph graph, string masterContractCD) => FindBy(graph, masterContractCD);
        }
