...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" UDFTypeField="DocType" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AP.APInvoiceEntry" PrimaryView="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="VoidInvoice" Visible="false" CommitChanges="true" />
			...
			<px:PXDSCallbackCommand Name="PayInvoice" />
			<px:PXDSCallbackCommand Visible="False" Name="ViewSchedule" CommitChanges="true" DependOnGrid="grid" />
			<px:PXDSCallbackCommand Name="CreateSchedule" CommitChanges="true" />
			...
			<px:PXDSCallbackCommand Name="ViewSourceDocument" Visible="false" />
			<px:PXDSCallbackCommand Name="DeleteJointPayee" Visible="False" DependOnGrid="grdJointPayees"/>
			<px:PXDSCallbackCommand Name="OpenFSDocument" Visible="false" />
		</CallbackCommands>
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" Style="z-index: 100" Width="100%"
		...
		LinkIndicator="True" BPEventsIndicator="True" DefaultControlID="edDocType"
			...
			<px:PXTabItem Text="Document Details">
				<Template>
					<px:PXGrid ID="grid" runat="server" Style="z-index: 100;" Width="100%" Height="300px" SyncPosition="True" SkinID="DetailsInTab" DataSourceID="ds" TabIndex="18300" KeepPosition="True">
						<Levels>
							<px:PXGridLevel DataMember="Transactions">
								<Columns>
                                    ...
                                    <px:PXGridColumn DataField="RelatedEntityType" CommitChanges="True" />
									<px:PXGridColumn DataField="RelatedDocNoteID" CommitChanges="True" DisplayMode="Text" MatrixMode="True" LinkCommand="OpenFSDocument"/>
								...
								<RowTemplate>
                                    ...
                                    <px:PXDropDown ID="edRelatedEntityType" runat="server" DataField="RelatedEntityType" CommitChanges="true" />
									<pxa:PXDynamicSelector ID="edRelatedDocNoteID" runat="server" DataField="RelatedDocNoteID" CommitChanges="True" AllowEdit="True" DisplayMode="Text" FilterByAllFields="True"/>
						...
						<ActionBar>
							<CustomItems>
								<px:PXToolBarButton Text="View Deferrals" Key="cmdViewSchedule">
				...
				<Template>
					<px:PXFormView ID="form2" runat="server" Style="z-index: 100" Width="100%" DataMember="CurrentDocument" CaptionVisible="False" SkinID="Transparent" DataSourceID="ds" MarkRequired="Dynamic">
						<Template>
							...
							<px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" GroupCaption="Intercompany Invoicing" StartGroup="True" />
							<px:PXSelector ID="edIntercompanyInvoiceNoteID" runat="server" DataField="IntercompanyInvoiceNoteID" AutoRefresh="True" CommitChanges="true" AllowEdit="true" TextMode="ReadOnly"/>
...
<%--									<px:PXGridColumn DataField="OrderNbr" TextAlign="Right" />
						...
						<Levels>
							<px:PXGridLevel DataMember="JointPayees">
								<Columns>
									...
									<px:PXGridColumn DataField="JointBalance" CommitChanges="True" />
									<px:PXGridColumn DataField="CanDelete" AllowShowHide="False" Visible="false"/>
								</Columns>
								<RowTemplate>
						...
						<ActionBar>
							...
							<CustomItems>
								<px:PXToolBarButton ImageKey="RecordDel" DisplayStyle="Image" StateColumn="CanDelete">
									<AutoCallBack Command="DeleteJointPayee" Target="ds" />
								</px:PXToolBarButton>
							</CustomItems>
						</ActionBar>
						<AutoSize Enabled="True" MinHeight="150" />
						...
						<Levels>
							<px:PXGridLevel DataMember="ComplianceDocuments">
								<Columns>
									...
									<px:PXGridColumn DataField="JointVendorInternalId" LinkCommand="ComplianceViewJointVendor" TextAlign="Left" CommitChanges="True" />
	...
	<px:PXSmartPanel ID="PanelAddPOReceipt" runat="server" Style="z-index: 108;" Width="900px" Height="400px"
		...
		<px:PXGrid ID="grid4" runat="server" Width="100%" Height="200px" SkinID="Inquire"
			...
			<Levels>
				<px:PXGridLevel DataMember="poreceiptslist" DataKeyNames="ReceiptType,ReceiptNbr">
					<Columns>
						<px:PXGridColumn AllowCheckAll="True" CommitChanges="True" AllowMove="False" AllowSort="False" DataField="Selected" TextAlign="Center" Type="CheckBox"/>
						<px:PXGridColumn DataField="ReceiptNbr" />
	...
	<px:PXSmartPanel ID="PanelAddPOOrder" runat="server" Width="800px" Height="400px" Key="poorderslist" CommandSourceID="ds"
		...
		<px:PXGrid ID="PXGrid1" runat="server" Height="200px" Width="100%" SkinID="Inquire"
			DataSourceID="ds" FastFilterFields="OrderNbr" TabIndex="17500">
			<AutoSize Enabled="true" />
			<Levels>
				<px:PXGridLevel DataMember="poorderslist">
					<Columns>
						<px:PXGridColumn DataField="Selected" Type="CheckBox" CommitChanges="True" AllowCheckAll="True" AllowSort="False" AllowMove="False" TextAlign="Center" AllowResize="False" />
    ...
    <px:PXSmartPanel runat="server" ID="PanelAddSubcontract" Height="400px" Width="800px" LoadOnDemand="True" CaptionVisible="True" Caption="Add Subcontract" Key="subcontracts" CommandSourceID="ds" AutoCallBack-Command="Refresh" AutoCallBack-Target="PXGridSubcontract" DependsOnView="subcontracts">
        <px:PXGrid runat="server" ID="PXGridSubcontract" Height="200px" SkinID="Inquire" TabIndex="17500" Width="100%" BatchUpdate="True" DataSourceID="ds" FastFilterFields="SubcontractNbr">
            <AutoSize Enabled="true" />
            <Levels>
                <px:PXGridLevel DataMember="subcontracts">
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="SubcontractBilledQty" TextAlign="Right" />
                        <px:PXGridColumn DataField="CurySubcontractBilledTotal" TextAlign="Right" />
                    </Columns>
                </px:PXGridLevel>
            </Levels>
        </px:PXGrid>
	...
	<px:PXSmartPanel ID="PanelAddPOOrderLine" runat="server" Width="1000px" Height="400px" Key="poorderlineslist" CommandSourceID="ds"
		...
		<px:PXGrid ID="POOrderLinesGrid" runat="server" Height="200px" Width="100%" SkinID="Inquire"
				   DataSourceID="ds" FastFilterFields="OrderNbr" TabIndex="17500">
			<AutoSize Enabled="true" />
			<Levels>
				<px:PXGridLevel DataMember="poorderlineslist">
					<Columns>
						<px:PXGridColumn DataField="Selected" Type="CheckBox" AllowCheckAll="True" CommitChanges="True" AllowSort="False" AllowMove="False" TextAlign="Center" AllowResize="False" />
						<px:PXGridColumn DataField="OrderNbr" />
						<px:PXGridColumn DataField="OrderType" />
						<px:PXGridColumn DataField="VendorID" />
						<px:PXGridColumn DataField="VendorLocationID" />
    ...
    <px:PXSmartPanel runat="server" ID="PanelAddSubcontractLine" Height="400px" Width="1000px" LoadOnDemand="True" CaptionVisible="True" Caption="Add Subcontract Line" Key="SubcontractLines" CommandSourceID="ds" AutoCallBack-Command="Refresh" AutoCallBack-Target="SubcontractLinesGrid" DependsOnView="SubcontractLines">
		    <px:PXFormView runat="server" ID="PXAddSubcontractLineFormView" SkinID="Transparent" CaptionVisible="false" Width="100%" DataMember="orderfilter">
			    <Template>
				    ...
				    <px:PXCheckBox runat="server" CommitChanges="True" DataField="ShowUnbilledLines" ID="chkShowUnbilledLines" />
			    </Template>
		    </px:PXFormView>
		    <px:PXGrid runat="server" ID="SubcontractLinesGrid" Height="200px" SkinID="Inquire" TabIndex="17500" Width="100%" BatchUpdate="True" DataSourceID="ds" FastFilterFields="SubcontractNbr">
			    <AutoSize Enabled="true" />
			    <Levels>
				    <px:PXGridLevel DataMember="SubcontractLines">
					    <Columns>
						    ...
						    <px:PXGridColumn DataField="UnbilledQty" TextAlign="Right" />
						    <px:PXGridColumn DataField="CuryUnbilledAmt" TextAlign="Right" />
							<px:PXGridColumn DataField="BilledQty" TextAlign="Right" />
						    <px:PXGridColumn DataField="CuryBilledAmt" TextAlign="Right" />
					    </Columns>
				    </px:PXGridLevel>
			    </Levels>
			    <CallbackCommands>
				    <Refresh RepaintControlsIDs="PXAddSubcontractLineFormView" />
			    </CallbackCommands>
		    </px:PXGrid>
    ...
    <px:PXSmartPanel runat="server" ID="PanelPayBillJC" AutoCallBack-Target="PXGridJointCheck" AutoCallBack-Command="Refresh" CommandSourceID="ds" Key="JointPayees" LoadOnDemand="True" Caption="Indicate Amounts to Pay" CaptionVisible="True" Width="950px" Height="430px" AutoReload="True" DependsOnView="JointPayeePayments">
