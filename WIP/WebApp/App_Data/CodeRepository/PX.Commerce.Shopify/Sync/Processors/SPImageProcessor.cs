...
namespace PX.Commerce.Shopify
{
	...
	public class SPImageProcessor : BCProcessorBulkBase<SPImageProcessor, SPImageEntityBucket, MappedStockItem>, IProcessor
	{
		...
		public override List<SPImageEntityBucket> FetchBucketsImport(List<BCSyncStatus> ids)
		{
			throw new NotImplementedException();
		}
		#endregion
				...
				try
				{
					...
					{ //For Creation
						...
						newImageData = new ProductImageData()
						{
							...
							Filename = fileName,
							Metafields = new List<MetafieldData>() { new MetafieldData() { Key = ShopifyConstants.ProductImage, Value = localObj.FileNoteID.Value.ToString(), ValueType = ShopifyConstants.ValueType_String, Namespace = ShopifyConstants.Namespace_Global } },
						};
		...
		public override List<SPImageEntityBucket> FetchBucketsExport(List<BCSyncStatus> ids)
		{
