...
namespace PX.Objects.SO
{
	...
	public partial class SOShipment : PX.Data.IBqlTable, PX.Data.EP.IAssign, IFreightBase
	{
		...
		{
			public static SOShipment Find(PXGraph graph, string shipmentType, string shipmentNbr) => FindBy(graph, shipmentType, shipmentNbr);
		}
		public static class FK
		{
			...
			public class Owner : CR.Standalone.EPEmployee.PK.ForeignKeyOf<SOShipment>.By<ownerID> { }
