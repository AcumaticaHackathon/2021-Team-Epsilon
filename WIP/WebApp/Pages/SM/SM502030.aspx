...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.BusinessProcess.UI.BusinessProcessEventHistoryMaint" SuspendUnloading="False" PrimaryView="Filter">
         <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="historySettings" CommitChanges="True" Visible="True" DependOnGrid="grid"/>
        </CallbackCommands>
    </px:PXDataSource>
    ...
    <px:PXSmartPanel ID="PXSmartPanel2" runat="server" Width="450px" Caption="History Settings"
                     CaptionVisible="true" Key="EventSettings" AutoCallBack-Enabled="true"
                     AutoCallBack-Command="Refresh" AutoCallBack-Target="frmViewDetails" AllowResize="false">
        <px:PXFormView ID="PXFormView1" runat="server" DataSourceID="ds" Width="100%" CaptionVisible="False" DataMember="EventSettings">
            <ContentStyle BackColor="Transparent" BorderStyle="None"/>
            <Template>
                <px:PXLayoutRule runat="server"  Merge="true" />
                    <px:PXCheckBox SuppressLabel="True"  ID="edAutoHistory" runat="server" DataField="DeleteHistoryAutomatically" AlignLeft="true" />
                    <px:PXNumberEdit SuppressLabel="True" ID="edDetails" runat="server" DataField="HistoryRetainCount" /> 
                <px:PXLabel Text="days." runat="server"></px:PXLabel>
            </Template>
        </px:PXFormView>
        <px:PXPanel ID="PXPanel1" runat="server" SkinID="Buttons" >
            <px:PXButton ID="PXButton2" runat="server" DialogResult="OK" Text="Save" Width="63px" Height="20px"/>
            <px:PXButton ID="PXButton3" runat="server" DialogResult="Cancel" Text="Close" Width="63px" Height="20px"/>
        </px:PXPanel>
    </px:PXSmartPanel>
</asp:Content>
