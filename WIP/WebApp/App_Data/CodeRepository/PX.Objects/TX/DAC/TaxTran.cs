...
namespace PX.Objects.TX
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<TaxTran>.By<module, tranDate, recordID>
		{
			public static TaxTran Find(PXGraph graph, String module, DateTime? tranDate, Int32? recordID) => FindBy(graph, module, tranDate, recordID);
		}
		public static class FK
		{
			public class BAccount : CR.BAccount.PK.ForeignKeyOf<TaxTran>.By<bAccountID> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<TaxTran>.By<branchID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<TaxTran>.By<vendorID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<TaxTran>.By<taxID> { }
			public class TaxReport : TX.TaxReport.PK.ForeignKeyOf<TaxTran>.By<vendorID, revisionID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<TaxTran>.By<taxZoneID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<TaxTran>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<TaxTran>.By<subID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<TaxTran>.By<curyInfoID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<TaxTran>.By<curyID> { }
			public class ReportCurrency : CM.Currency.PK.ForeignKeyOf<TaxTran>.By<reportCuryID> { }
			public class ReportCurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<TaxTran>.By<reportCuryRateTypeID> { }
			public class TaxBucket : TX.TaxBucket.PK.ForeignKeyOf<TaxTran>.By<vendorID, taxBucketID> { }
		}
		#endregion
