...
namespace PX.Objects.IN
{
	...
	public partial class INItemSiteHistDay : PX.Data.IBqlTable
    {
		...
		{
			public static INItemSiteHistDay Find(PXGraph graph, int? inventoryID, int? subItemID, int? siteID, int? locationID, DateTime? sDate)
				=> FindBy(graph, inventoryID, subItemID, siteID, locationID, sDate);
		}
