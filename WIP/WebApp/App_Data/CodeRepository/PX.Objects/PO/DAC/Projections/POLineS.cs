...
namespace PX.Objects.PO
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<POLineS>.By<orderType, orderNbr, lineNbr>
		{
			public static POLineS Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr) => FindBy(graph, orderType, orderNbr, lineNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<POLineS>.By<branchID> { }
			public class Order : POOrder.PK.ForeignKeyOf<POLineS>.By<orderType, orderNbr> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<POLineS>.By<inventoryID> { }
			public class SubItem : INSubItem.PK.ForeignKeyOf<POLineS>.By<subItemID> { }
			public class Site : INSite.PK.ForeignKeyOf<POLineS>.By<siteID> { }
			public class SiteStatus : IN.INSiteStatus.PK.ForeignKeyOf<POLineS>.By<inventoryID, subItemID, siteID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<POLineS>.By<vendorID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<POLineS>.By<curyInfoID> { }
			public class TaxCategory : TX.TaxCategory.PK.ForeignKeyOf<POLineS>.By<taxCategoryID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<POLineS>.By<taxID> { }
			public class ExpenseAccount : GL.Account.PK.ForeignKeyOf<POLineS>.By<expenseAcctID> { }
			public class ExpenseSubaccount : Sub.PK.ForeignKeyOf<POLineS>.By<expenseSubID> { }
			public class Project : PMProject.PK.ForeignKeyOf<POLineS>.By<projectID> { }
			public class Task : PMTask.PK.ForeignKeyOf<POLineS>.By<taskID> { }
			public class AccrualAccount : GL.Account.PK.ForeignKeyOf<POLineS>.By<pOAccrualAcctID> { }
			public class AccrualSubaccount : Sub.PK.ForeignKeyOf<POLineS>.By<pOAccrualSubID> { }
			public class CostCode : PMCostCode.PK.ForeignKeyOf<POLineS>.By<costCodeID> { }
			public class Discount : APDiscount.PK.ForeignKeyOf<POLineS>.By<discountID, vendorID> { }
			public class DiscountSequence : VendorDiscountSequence.PK.ForeignKeyOf<POLineS>.By<vendorID, discountID, discountSequenceID> { }
