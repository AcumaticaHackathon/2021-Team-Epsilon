...
namespace PX.Objects.FS
{
	...
	public class FSEquipmentType : PX.Data.IBqlTable
	{
        ...
        {
            public static FSEquipmentType Find(PXGraph graph, string equipmentTypeCD) => FindBy(graph, equipmentTypeCD);
        }
		public class UK : PrimaryKeyOf<FSEquipmentType>.By<equipmentTypeID>
		{
			public static FSEquipmentType Find(PXGraph graph, int? equipmentTypeID) => FindBy(graph, equipmentTypeID);
		}
		#endregion
