...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FABookYear>.By<bookID, organizationID, year>
		{
			public static FABookYear Find(PXGraph graph, int? bookID, int? organizationID, String year) => FindBy(graph, bookID, organizationID, year);
		}
		public static class FK
		{
			public class Book : FA.FABook.PK.ForeignKeyOf<FABookYear>.By<bookID> { }
			public class Organization : GL.DAC.Organization.PK.ForeignKeyOf<FABookYear>.By<organizationID> { }
		}
		#endregion
		#region BookID
