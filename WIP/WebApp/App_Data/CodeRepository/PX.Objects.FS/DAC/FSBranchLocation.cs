...
namespace PX.Objects.FS
{
    ...
    public class FSBranchLocation : PX.Data.IBqlTable
    {
        ...
        {
            public static FSBranchLocation Find(PXGraph graph, int? branchLocationID) => FindBy(graph, branchLocationID);
        }
        public class UK : PrimaryKeyOf<FSBranchLocation>.By<branchLocationCD>
        {
            public static FSBranchLocation Find(PXGraph graph, string branchLocationCD) => FindBy(graph, branchLocationCD);
        }
