...
namespace PX.Objects.FS
{
    ...
    {        
        ...
        public class LineType_InvLookup : LineType_ALL
        {
            public new readonly string[] ID_LIST_ALL =
            {
                ID.LineType_ALL.ALL,
        ...
        public class Status_Log
        {
            ...
            public readonly string[] ID_LIST = { ID.Status_Log.IN_PROCESS, ID.Status_Log.PAUSED, ID.Status_Log.COMPLETED };
            public readonly string[] TX_LIST = { TX.Status_Log.IN_PROCESS, TX.Status_Log.PAUSED, TX.Status_Log.COMPLETED };
        }
        #endregion
        ...
        public class LogActions
        {
            ...
            public readonly string[] ID_LIST = { START, PAUSE, RESUME, COMPLETE };
            public readonly string[] TX_LIST = { TX.LogActions.START, TX.LogActions.PAUSE, TX.LogActions.RESUME, TX.LogActions.COMPLETE  };
        }
