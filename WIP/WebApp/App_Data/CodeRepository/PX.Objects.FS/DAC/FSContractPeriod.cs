...
namespace PX.Objects.FS
{
    ...
    public class FSContractPeriod : PX.Data.IBqlTable
    {
        ...
        {
            public static FSContractPeriod Find(PXGraph graph, int? serviceContractID, int? contractPeriodID) => FindBy(graph, serviceContractID, contractPeriodID);
        }
        public class UK : PrimaryKeyOf<FSContractPeriod>.By<contractPeriodID>
        {
            public static FSContractPeriod Find(PXGraph graph, int? contractPeriodID) => FindBy(graph, contractPeriodID);
        }
