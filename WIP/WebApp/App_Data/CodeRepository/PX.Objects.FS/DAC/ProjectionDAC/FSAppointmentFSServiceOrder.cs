...
namespace PX.Objects.FS
{
    ...
    {
        #region Keys
        public new class PK : PrimaryKeyOf<FSAppointmentFSServiceOrder>.By<refNbr, srvOrdType>
        {
            public static FSAppointmentFSServiceOrder Find(PXGraph graph, string refNbr, string srvOrdType) => FindBy(graph, refNbr, srvOrdType);
        }

        public new class UK : PrimaryKeyOf<FSAppointmentFSServiceOrder>.By<appointmentID>
        {
            public static FSAppointmentFSServiceOrder Find(PXGraph graph, int? appointmentID) => FindBy(graph, appointmentID);
        }

        public new static class FK
        {
            public class Customer : AR.Customer.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<customerID> { }
            public class Branch : GL.Branch.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<branchID> { }
            public class ServiceOrderType : FSSrvOrdType.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<srvOrdType> { }
            public class Project : PMProject.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<projectID> { }
            public class Task : PMTask.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<dfltProjectTaskID> { }
            public class WorkFlowStage : FSWFStage.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<wFStageID> { }
            public class ServiceContract : FSServiceContract.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<serviceContractID> { }
            public class Schedule : FSSchedule.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<scheduleID> { }
            public class BillServiceContract : FSServiceContract.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<billServiceContractID> { }
            public class TaxZone : Objects.TX.TaxZone.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<taxZoneID> { }
            public class Route : FSRoute.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<routeID> { }
            public class RouteDocument : FSRouteDocument.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<routeDocumentID> { }
            public class Vehicle : FSVehicle.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<vehicleID> { }
            public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<curyInfoID> { }
            public class Currency : CM.Currency.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<curyID> { }
            public class SalesPerson : AR.SalesPerson.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<salesPersonID> { }
            public class BillCustomer : AR.Customer.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<billCustomerID> { }
            public class BranchLocation : FSBranchLocation.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<branchLocationID> { }
            public class Contract : CT.Contract.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<contractID> { }
            public class CustomerBillingSetup : FSCustomerBillingSetup.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<cBID> { }
            public class Room : FSRoom.PK.ForeignKeyOf<FSAppointmentFSServiceOrder>.By<branchLocationID, roomID> { }
        }
        #endregion
        ...
        [PXUIField(DisplayName = "Scheduled End Date", Visibility = PXUIVisibility.SelectorVisible)]
        ...
        public new abstract class scheduledDuration : PX.Data.BQL.BqlInt.Field<scheduledDuration> { }
