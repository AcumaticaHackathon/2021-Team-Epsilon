...
namespace PX.Objects.AM
{
    ...
    {
        #region Keys
        public new class PK : PrimaryKeyOf<AMDisassembleTran>.By<docType, batNbr, lineNbr>
        {
	        public static AMDisassembleTran Find(PXGraph graph, string docType, string batNbr, int? lineNbr) =>
		        FindBy(graph, docType, batNbr, lineNbr);
        }
        #endregion
