...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Style="z-index: 100" AllowPaging="True" AllowSearch="true"
        Width="100%" Height="150px" Caption="Customers" SkinID="PrimaryInquire" FastFilterFields="AcctCD, AcctName">
        <Levels>
            <px:PXGridLevel DataKeyNames="AcctCD" DataMember="Details">
                <Columns>
                    ...
                    <px:PXGridColumn DataField="AcctCD" Label="Customer" LinkCommand ="ViewDocument" />
                    <px:PXGridColumn DataField="AcctName" Label="Customer Name" />
