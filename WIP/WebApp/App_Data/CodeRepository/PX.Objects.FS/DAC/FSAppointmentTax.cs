...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentTax : TaxDetail, PX.Data.IBqlTable
    {
        ...
        public static class FK
        {
            ...
            public class Appointment : FSAppointment.PK.ForeignKeyOf<FSAppointmentTax>.By<srvOrdType, refNbr> { }
            public class AppointmentLine : FSAppointmentDet.PK.ForeignKeyOf<FSAppointmentTax>.By<srvOrdType, refNbr, lineNbr> { }
