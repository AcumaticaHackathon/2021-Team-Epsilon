		...
		<Items>
						...
						<Levels>
							<px:PXGridLevel DataMember="Transactions" DataKeyNames="RefNbr,LineNbr">
								<Columns>
									...
									<px:PXGridColumn DataField="FSARTran__ReplaceSMEquipmentID" Visible="false" />
									<px:PXGridColumn DataField="FSARTran__EquipmentAction" CommitChanges="True" Visible="false" />
									<px:PXGridColumn DataField="FSARTran__Comment" CommitChanges="True" Visible="false" />
									<px:PXGridColumn DataField="FSARTran__SMEquipmentID" CommitChanges="True" Visible="false" />
                                    <px:PXGridColumn DataField="FSARTran__NewEquipmentLineNbr" CommitChanges="True" Visible="false" />
                                    <px:PXGridColumn DataField="FSARTran__ComponentID" CommitChanges="True" Visible="false" />
                                    <px:PXGridColumn DataField="FSARTran__EquipmentComponentLineNbr" CommitChanges="True" Visible="false" />
                                    <px:PXGridColumn DataField="FSARTran__RelatedDocument" RenderEditorText="True" LinkCommand="FSARTran$RelatedDocument$Link" Visible="false" />
								...
								<RowTemplate>
									...
									<px:PXSelector runat="server" ID="edReplaceSMEquipmentID" DataField="FSARTran__ReplaceSMEquipmentID" AllowEdit="True" />
									<px:PXDropDown runat="server" ID="edEquipmentAction" DataField="FSARTran__EquipmentAction" CommitChanges="True" />
									<px:PXSelector runat="server" ID="edSMEquipmentID" DataField="FSARTran__SMEquipmentID" CommitChanges="True" AutoRefresh="True" AllowEdit="True"/>
									<px:PXSelector runat="server" ID="edNewEquipmentLineNbr" DataField="FSARTran__NewEquipmentLineNbr" CommitChanges="True" AutoRefresh="True" />
									<px:PXSelector runat="server" ID="edSMComponentID" DataField="FSARTran__ComponentID" CommitChanges="True" AutoRefresh="True" />
									<px:PXSelector runat="server" ID="edEquipmentComponentLineNbr" DataField="FSARTran__EquipmentComponentLineNbr" CommitChanges="True" AutoRefresh="True" />
			...
			<px:PXTabItem Text="Financial">
				<Template>
					...
					<px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" StartGroup="True" GroupCaption="Ownership" />
					...
					<px:PXCheckBox ID="chkDontPrint" runat="server" Checked="True" DataField="DontPrint" Size="SM" AlignLeft="True" CommitChanges="true" />
					<px:PXCheckBox ID="chkPrinted" runat="server" DataField="Printed" Enabled="False" Size="SM" AlignLeft="True" />
					<px:PXLayoutRule runat="server" Merge="True" />
					<px:PXCheckBox ID="chkDontEmail" runat="server" Checked="True" DataField="DontEmail" Size="SM" AlignLeft="True" CommitChanges="true" />
			...
			<px:PXTabItem Text="Discounts" RepaintOnDemand="False">
				<Template>
