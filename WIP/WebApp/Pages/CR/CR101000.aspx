			...
			<px:PXTabItem Text="General Settings">
				<Template>
					...
					<px:PXPanel ID="PXPanel1" runat="server" RenderSimple="True" RenderStyle="Simple">
						...
						<px:PXCheckBox runat="server" DataField="AMEstimateEntry" ID="edAMEstimateEntry" />
						<px:PXCheckBox runat="server" DataField="AMConfigurationEntry" ID="chkAMConfigurationEntry" />
            ...
            <px:PXTabItem Text="Duplicate Validation Settings">
                <Template>
                    <px:PXPanel ID="validationForm" runat="server" Style="z-index: 100" Width="100%" CaptionVisible="False" RenderStyle="Simple" ContentLayout-OuterSpacing="Around">
                        ...
                        <px:PXNumberEdit ID="edLeadToAccountValidationThreshold" Size="xxs" runat="server" DataField="LeadToAccountValidationThreshold" Decimals="2" ValueType="Decimal" CommitChanges="true"/>
                        <px:PXNumberEdit ID="edAccountValidationThreshold" Size="xxs" runat="server" DataField="AccountValidationThreshold" Decimals="2" ValueType="Decimal" CommitChanges="true"/>
						                ...
						                <Levels>
							                <px:PXGridLevel DataMember="LeadContactValidationRules">
								                <Columns>
													...
													<px:PXGridColumn DataField="ScoreWeight" Width="110px" />
													<px:PXGridColumn DataField="TransformationRule" Width="150px" />
													<px:PXGridColumn DataField="CreateOnEntry" Width="110px"/>
								                </Columns>
							                </px:PXGridLevel>
						                </Levels>
