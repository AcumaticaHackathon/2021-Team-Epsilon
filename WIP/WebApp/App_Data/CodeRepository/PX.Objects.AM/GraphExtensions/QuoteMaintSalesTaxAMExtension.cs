...
namespace PX.Objects.AM.GraphExtensions
{
    public class QuoteMaintSalesTaxAMExtension : PXGraphExtension<QuoteMaint.SalesTax, QuoteMaint>
    {
            ...
            Action<object, decimal, decimal, decimal> del)
        {
            ...
            var docTotalWithEstimate = curyDocTotal + oppExt.AMCuryEstimateTotal.GetValueOrDefault();
        ...
        {
            var estimateTotal = PXCache<CRQuote>.GetExtension<CRQuoteExt>(row)?.AMCuryEstimateTotal ?? 0m;
