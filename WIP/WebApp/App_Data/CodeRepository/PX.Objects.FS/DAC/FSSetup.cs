...
namespace PX.Objects.FS
{
	...
	public class FSSetup : PX.Data.IBqlTable
	{
        ...
        {
            public class Calendar : CS.CSCalendar.PK.ForeignKeyOf<FSSetup>.By<calendarID> { }
            public class DfltServiceOrderType : FSSrvOrdType.PK.ForeignKeyOf<FSSetup>.By<dfltSrvOrdType> { }
            public class DfltSOServiceOrderType : FSSrvOrdType.PK.ForeignKeyOf<FSSetup>.By<dfltSOSrvOrdType> { }
            public class DfltCasesServiceOrderType : FSSrvOrdType.PK.ForeignKeyOf<FSSetup>.By<dfltCasesSrvOrdType> { }
            public class DfltOpportunityServiceOrderType : FSSrvOrdType.PK.ForeignKeyOf<FSSetup>.By<dfltOpportunitySrvOrdType> { }
            public class EmpSchdlNumbering : Numbering.PK.ForeignKeyOf<FSSetup>.By<empSchdlNumberingID> { }
            public class LicenseNumbering : Numbering.PK.ForeignKeyOf<FSSetup>.By<licenseNumberingID> { }
            public class EquipmentNumbering : Numbering.PK.ForeignKeyOf<FSSetup>.By<equipmentNumberingID> { }
            public class PostBatchNumbering : Numbering.PK.ForeignKeyOf<FSSetup>.By<postBatchNumberingID> { }
            public class ScheduleNumbering : Numbering.PK.ForeignKeyOf<FSSetup>.By<scheduleNumberingID> { }
            public class ServiceContractNumbering : Numbering.PK.ForeignKeyOf<FSSetup>.By<serviceContractNumberingID> { }
        }
        ...
        #endregion
        #region ShowWorkflowStageField
        public abstract class showWorkflowStageField : PX.Data.BQL.BqlBool.Field<showWorkflowStageField> { }

        [PXDBBool]
        [PXDefault(false)]
        [PXUIField(DisplayName = "Enable Workflow Stages", Visibility = PXUIVisibility.Invisible)]
