...
namespace PX.Objects.FS
{
    ...
    public partial class FSShippingAddress : FSAddress
    {
        ...
        {
            public static FSShippingAddress Find(PXGraph graph, int? addressID) => FindBy(graph, addressID);
        }
    ...
    public partial class FSAddress : PX.Data.IBqlTable, IAddress, IAddressBase, IAddressLocation
    {
        ...
        {
            public static FSAddress Find(PXGraph graph, Int32? addressID) => FindBy(graph, addressID);
        }
