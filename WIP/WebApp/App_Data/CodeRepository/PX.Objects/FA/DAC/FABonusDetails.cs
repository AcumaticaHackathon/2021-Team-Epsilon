...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FABonusDetails>.By<bonusID, lineNbr>
		{
			public static FABonusDetails Find(PXGraph graph, Int32? bonusID, Int32? lineNbr) => FindBy(graph, bonusID, lineNbr);
		}
		public static class FK
		{
			public class Bonus : FA.FABonus.PK.ForeignKeyOf<FABonusDetails>.By<bonusID> { }
		}
		#endregion
		#region BonusID
