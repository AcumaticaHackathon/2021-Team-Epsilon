...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Task" TypeName="PX.Objects.PM.ProjectTaskEntry" BorderStyle="NotSet" HeaderDescriptionField="FormCaptionDescription">
        <CallbackCommands>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ComplianceDocuments">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn TextAlign="Left" DataField="CostCodeID" LinkCommand="ComplianceViewCostCode" CommitChanges="True" />
