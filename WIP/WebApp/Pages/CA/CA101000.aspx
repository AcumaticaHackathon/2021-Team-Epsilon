...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="669px" Width="100%" DataMember="CASetupRecord"
		...
		<Items>
			...
			<px:PXSegmentMask ID="edTransitSubID" runat="server" DataField="TransitSubID" DataSourceID="ds" CommitChanges="True"/>
						...
						<Levels>
							<px:PXGridLevel DataMember="Approval" >
   								<RowTemplate>
									...
									<px:PXSelector ID="edAssignmentMapID" runat="server" DataField="AssignmentMapID" AllowEdit="True" AutoRefresh="True"/>
								...
								<Columns>
									...
									<px:PXGridColumn DataField="AssignmentMapID" TextField="AssignmentMapID_EPAssignmentMap_Name" AutoCallBack="True" />
		...
		<px:PXTabItem Text="Bank Statement Settings">
			<Template>
				...
				<px:PXLayoutRule runat="server" LabelsWidth="L" ControlSize="XM" StartGroup="True" GroupCaption="Invoice Matching"/>
				<px:PXCheckBox ID="chkInvoiceFilterByCashAccount" SuppressLabel="True" LabelsWidth="XXS" ControlSize="M" runat="server" DataField="InvoiceFilterByCashAccount" />
				<px:PXCheckBox ID="chkInvoiceFilterByDate" SuppressLabel="True" LabelsWidth="XXS" ControlSize="M" runat="server" DataField="InvoiceFilterByDate" CommitChanges="true"/>
				<px:PXNumberEdit ID="edDaysBeforeInvoiceDiscountDate" DataField="DaysBeforeInvoiceDiscountDate"  runat="server" />
				<px:PXNumberEdit ID="edDaysBeforeInvoiceDueDate" DataField="DaysBeforeInvoiceDueDate"  runat="server" />
				<px:PXNumberEdit ID="edDaysAfterInvoiceDueDate" DataField="DaysAfterInvoiceDueDate" runat="server" />
				<px:PXLayoutRule runat="server" LabelsWidth="XXS" ControlSize="M" StartGroup="True" GroupCaption="Other Matching Settings" SuppressLabel="true"/>
				...
				<px:PXLayoutRule runat="server" LabelsWidth="L" ControlSize="XM" StartGroup="True" GroupCaption="Auto-Match Thresholds"/>
				<px:PXNumberEdit ID="edMatchThreshold" DataField="MatchThreshold"  runat="server" />
				<px:PXNumberEdit ID="edRelativeMatchThreshold" DataField="RelativeMatchThreshold"  runat="server" />
		...
		<px:PXTabItem Text="Relevance Calculation">
			<Template>
				<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="L" ControlSize="m" />
				<px:PXLayoutRule runat="server" LabelsWidth="L" ControlSize="XM" StartGroup="True" GroupCaption="Payment and Expense Receipt Relevance"/>
				...
				<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Invoice Relevance"/>
				<px:PXNumberEdit ID="edInvoiceRefNbrCompareWeight" DataField="InvoiceRefNbrCompareWeight" CommitChanges="True" runat="server" />
				<px:PXNumberEdit ID="edInvoiceDateCompareWeight" DataField="InvoiceDateCompareWeight" CommitChanges="True" runat="server" />
				<px:PXNumberEdit ID="edInvoicePayeeCompareWeight" DataField="InvoicePayeeCompareWeight" CommitChanges="True" runat="server" />
				<px:PXNumberEdit ID="edAveragePaymentDelay" DataField="AveragePaymentDelay"  runat="server" />
				<px:PXNumberEdit ID="edInvoiceDateSigma" DataField="InvoiceDateSigma"  runat="server" />
			</Template>
		</px:PXTabItem>
