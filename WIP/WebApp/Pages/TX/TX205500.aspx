...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="TxCategory" TypeName="PX.Objects.TX.TaxCategoryMaint" HeaderDescriptionField="Descr">
		<CallbackCommands>
