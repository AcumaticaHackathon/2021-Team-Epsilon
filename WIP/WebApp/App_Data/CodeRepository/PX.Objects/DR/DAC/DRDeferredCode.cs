...
namespace PX.Objects.DR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<DRDeferredCode>.By<deferredCodeID>
		{
			public static DRDeferredCode Find(PXGraph graph, string deferredCodeID) => FindBy(graph, deferredCodeID);
		}
		public static class FK
		{
			public class Account : GL.Account.PK.ForeignKeyOf<DRDeferredCode>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<DRDeferredCode>.By<subID> { }
		}
		#endregion
