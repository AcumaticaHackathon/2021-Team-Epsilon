...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="header" Caption="Document Summary"
        ...
        <Template>
            ...
            <px:PXSelector ID="edUOM1" runat="server" DataField="UOM" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" SkinID="Details" Width="100%" OnRowDataBound="Grid_RowDataBound" SyncPosition="True" >
        <Levels>
            <px:PXGridLevel DataMember="transactions" DataKeyNames="EmployeeID, LineNbr">
                ...
                <Columns>
                    ...
                    <px:PXGridColumn DataField="LaborTime" Width="90px" />   
                    ...
                    <px:PXGridColumn DataField="EmployeeID" Width="115px" />
                    <px:PXGridColumn DataField="ShiftID" Width="81px" />
                    <px:PXGridColumn DataField="Qty" Width="99px" TextAlign="Right" />
                    <px:PXGridColumn DataField="UOM" />
                    <px:PXGridColumn DataField="SiteID" Width="99px" />
                    <px:PXGridColumn DataField="LocationID" Width="99px" NullText="&lt;SPLIT&gt;" />
                    <px:PXGridColumn DataField="CloseFlg" TextAlign="Center" Type="CheckBox" />
                </Columns>
			</px:PXGridLevel>
		</Levels>
