namespace PX.Objects.TX
{
	...
	public partial class TaxHistory : PX.Data.IBqlTable
	{
		...
		{
			public static TaxHistory Find(PXGraph graph, Int32? branchID, Int32? vendorID, Int32? taxReportRevisionID, Int32? accountID, Int32? subID, String taxID, string taxPeriodID, Int32? lineNbr, Int32? revisionID) 
				=> FindBy(graph, branchID, vendorID, taxReportRevisionID, accountID, subID, taxID, taxPeriodID, lineNbr, revisionID);
		}
	...
	public partial class TaxHistorySum : PX.Data.IBqlTable
	{
		...
		{
			public static TaxHistorySum Find(PXGraph graph, Int32? branchID, Int32? vendorID, Int32? taxReportRevisionID, string taxPeriodID, Int32? lineNbr, Int32? revisionID)
				=> FindBy(graph, branchID, vendorID, taxReportRevisionID, taxPeriodID, lineNbr, revisionID);
		}
		public static class FK
		{
