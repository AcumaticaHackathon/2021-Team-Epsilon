...
namespace PX.Objects.AR
{
    ...
    {
      #region Keys
      public new class PK : PrimaryKeyOf<ARTaxTran>.By<tranDate, recordID>
      {
         public static ARTaxTran Find(PXGraph graph, DateTime? tranDate, Int32? recordID) => FindBy(graph, tranDate, recordID);
      }
      public new static class FK
      {
         public class Document : AP.APRegister.PK.ForeignKeyOf<ARTaxTran>.By<tranType, refNbr> { }
         public class Branch : GL.Branch.PK.ForeignKeyOf<ARTaxTran>.By<branchID> { }
         public class Vendor : AP.Vendor.PK.ForeignKeyOf<ARTaxTran>.By<vendorID> { }
         public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<ARTaxTran>.By<taxZoneID> { }
         public class Tax : TX.Tax.PK.ForeignKeyOf<ARTaxTran>.By<taxID> { }
         public class BAccount : CR.BAccount.PK.ForeignKeyOf<ARTaxTran>.By<bAccountID> { }
         public class Account : GL.Account.PK.ForeignKeyOf<ARTaxTran>.By<accountID> { }
         public class Subaccount : GL.Sub.PK.ForeignKeyOf<ARTaxTran>.By<subID> { }
         public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<ARTaxTran>.By<curyInfoID> { }
      }
      #endregion
    ...
    {
      #region Keys
      public new class PK : PrimaryKeyOf<SalesTax>.By<taxID>
      {
         public static SalesTax Find(PXGraph graph, string taxID) => FindBy(graph, taxID);
      }
      #endregion
      #region TaxID
      public new abstract class taxID : PX.Data.BQL.BqlString.Field<taxID> { }
