...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<Ledger>.By<ledgerID>
		{
			public static Ledger Find(PXGraph graph, Int32? ledgerID) => FindBy(graph, ledgerID);
		}
		public class UK : PrimaryKeyOf<Ledger>.By<ledgerCD>
		{
			public static Ledger Find(PXGraph graph, string ledgerCD) => FindBy(graph, ledgerCD);
		}
		public static class FK
		{
			public class Organization : DAC.Organization.PK.ForeignKeyOf<Ledger>.By<organizationID> { }
			public class BaseCurrency : CM.Currency.PK.ForeignKeyOf<Ledger>.By<baseCuryID> { }
		}
		#endregion
