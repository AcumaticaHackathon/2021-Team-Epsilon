...
namespace PX.Objects.AM
{
    ...
    public class WCMaint : PXGraph<WCMaint, AMWC>
    {
        ...
        [PXHidden]
        public PXSelect<AMWCSchd, Where<AMWCSchd.wcID, Equal<Current<AMWC.wcID>>>> WorkCenterScheduleRecords ;

        [PXHidden]
        public PXSelect<AMWCSchdDetail, Where<AMWCSchdDetail.wcID, Equal<Current<AMWC.wcID>>>> WorkCenterScheduleDetailRecords;
        ...
        [PXParent(typeof(Select<AMWC, Where<AMWC.wcID, Equal<Current<AMWCSchd.wcID>>>>))]
        protected virtual void _(Events.CacheAttached<AMWCSchd.wcID> e)
        {
        }

        [PXMergeAttributes(Method = MergeMethod.Append)]
        [PXParent(typeof(Select<AMWC, Where<AMWC.wcID, Equal<Current<AMWCSchdDetail.wcID>>>>))]
        protected virtual void _(Events.CacheAttached<AMWCSchdDetail.wcID> e)
        {
        }
