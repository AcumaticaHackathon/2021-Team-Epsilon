...
namespace PX.Objects.CT
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<ContractBillingSchedule>.By<contractID>
		{
			public static ContractBillingSchedule Find(PXGraph graph, int? contractID) => FindBy(graph, contractID);
		}
		public static class FK
		{
			public class Contract : CT.Contract.PK.ForeignKeyOf<ContractBillingSchedule>.By<contractID> { }
			public class Account : AR.Customer.PK.ForeignKeyOf<ContractBillingSchedule>.By<accountID> { }
			public class Location : CR.Location.PK.ForeignKeyOf<ContractBillingSchedule>.By<accountID, locationID> { }
		}
		#endregion
		#region ContractID
