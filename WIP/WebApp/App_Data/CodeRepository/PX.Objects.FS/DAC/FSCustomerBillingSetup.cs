...
namespace PX.Objects.FS
{
    ...
    public class FSCustomerBillingSetup : PX.Data.IBqlTable
    {
        ...
        {
            public static FSCustomerBillingSetup Find(PXGraph graph, int? cBID) => FindBy(graph, cBID);
        }

        public class UK : PrimaryKeyOf<FSCustomerBillingSetup>.By<customerID, cBID>
        {
            public static FSCustomerBillingSetup Find(PXGraph graph, int? customerID, int? cBID) => FindBy(graph, customerID, cBID);
        }
