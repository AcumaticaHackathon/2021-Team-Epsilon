...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:pxdatasource EnableAttributes="true" id="ds" UDFTypeField="DocType" runat="server" visible="True" width="100%" typename="PX.Objects.AR.ARCashSaleEntry" primaryview="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand CommitChanges="true" Name="CaptureCCPayment" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:pxformview id="form" runat="server" style="z-index: 100" width="100%" datamember="Document" caption="Invoice Summary" noteindicator="True"
		filesindicator="True" activityindicator="True" activityfield="NoteActivity" linkindicator="True" BPEventsIndicator="True"
		...
		<Template>
			...
			<px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="S" />
				...
				<px:PXSelector ID="edRefTranExtNbr" runat="server" DataField="RefTranExtNbr" DataSourceID="ds" AutoRefresh="true" />
		</Template>
	</px:pxformview>
