...
namespace PX.Objects.CR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CRCampaign>.By<campaignID>
		{
			public static CRCampaign Find(PXGraph graph, string campaignID) => FindBy(graph, campaignID);
		}
		public static class FK
		{
			public class Type : CR.CRCampaignType.PK.ForeignKeyOf<CRCampaign>.By<campaignType> { }

			public class Owner : EP.EPEmployee.PK.ForeignKeyOf<CRCampaign>.By<ownerID> { }
			public class Workgroup : TM.EPCompanyTree.PK.ForeignKeyOf<CRCampaign>.By<workgroupID> { }
		}
		#endregion
