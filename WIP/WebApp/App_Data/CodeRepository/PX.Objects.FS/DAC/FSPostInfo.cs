...
{
    [Serializable]
    [PXCacheName(TX.TableName.FSPostInfo)]
    public class FSPostInfo : PX.Data.IBqlTable
	{
        #region Keys
        public class PK : PrimaryKeyOf<FSPostInfo>.By<postID>
        {
            public static FSPostInfo Find(PXGraph graph, int? postID) => FindBy(graph, postID);
        }

        public static class FK
        {
            public class Appointment : FSAppointment.UK.ForeignKeyOf<FSPostInfo>.By<appointmentID> { }
            public class ServiceOrder : FSServiceOrder.UK.ForeignKeyOf<FSPostInfo>.By<sOID> { }
            public class SOOrderType : SO.SOOrderType.PK.ForeignKeyOf<FSPostInfo>.By<sOOrderType> { }
            public class SOOrder : SO.SOOrder.PK.ForeignKeyOf<FSPostInfo>.By<sOOrderType, sOOrderNbr> { }
            public class SOOrderLine : SO.SOLine.PK.ForeignKeyOf<FSPostInfo>.By<sOOrderType, sOOrderNbr, sOLineNbr> { }
            public class ARInvoice : AR.ARInvoice.PK.ForeignKeyOf<FSPostInfo>.By<arDocType, arRefNbr> { }
            public class ARInvoiceLine : AR.ARTran.PK.ForeignKeyOf<FSPostInfo>.By<arDocType, arRefNbr, aRLineNbr> { }
            public class APInvoice : AP.APInvoice.PK.ForeignKeyOf<FSPostInfo>.By<apDocType, apRefNbr> { }
            public class APInvoiceLine : AP.APTran.PK.ForeignKeyOf<FSPostInfo>.By<apDocType, apRefNbr, aPLineNbr> { }
            public class INIssue : IN.INRegister.PK.ForeignKeyOf<FSPostInfo>.By<iNDocType, iNRefNbr> { }
            public class INIssueLine : IN.INTran.PK.ForeignKeyOf<FSPostInfo>.By<iNDocType, iNRefNbr, iNLineNbr> { }
            public class SOInvoice : SO.SOInvoice.PK.ForeignKeyOf<FSPostInfo>.By<sOInvDocType, sOInvRefNbr> { }
            public class SOInvoiceLine : AR.ARTran.PK.ForeignKeyOf<FSPostInfo>.By<sOInvDocType, sOInvRefNbr, sOInvLineNbr> { }
            //public class PMRegister : PM.PMRegister.PK.ForeignKeyOf<FSPostInfo>.By<pMDocType, pMRefNbr> { }
            public class PMRegisterLine : PM.PMTran.PK.ForeignKeyOf<FSPostInfo>.By<pMTranID> { }
        }
