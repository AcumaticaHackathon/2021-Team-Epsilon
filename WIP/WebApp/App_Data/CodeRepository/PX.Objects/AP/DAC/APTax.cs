namespace PX.Objects.AP
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<APTax>.By<tranType, refNbr, lineNbr, taxID>
		{
			public static APTax Find(PXGraph graph, String tranType, String refNbr, Int32? lineNbr, String taxID) => FindBy(graph, tranType, refNbr, lineNbr, taxID);
		}
		public static class FK
		{
			public class Document : AP.APRegister.PK.ForeignKeyOf<APTax>.By<tranType, refNbr> { }
			public class DocumentLine : AP.APTran.PK.ForeignKeyOf<APTax>.By<tranType, refNbr, lineNbr> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<APTax>.By<curyInfoID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<APTax>.By<taxID> { }
		}
		#endregion
