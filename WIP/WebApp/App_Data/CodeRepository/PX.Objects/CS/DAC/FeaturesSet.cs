...
namespace PX.Objects.CS
{
	...
	public class FeaturesSet : IBqlTable
	{
		...
		[FeatureDependency(true,
			typeof(FeaturesSet.branch),
			typeof(FeaturesSet.multicurrency),
			typeof(FeaturesSet.visibilityRestriction))]
		[FeatureMutuallyExclusiveDependency(true,
			typeof(FeaturesSet.expenseManagement),
			typeof(FeaturesSet.contractManagement),
			typeof(FeaturesSet.timeReportingModule),
			typeof(FeaturesSet.distributionModule),
			typeof(FeaturesSet.projectAccounting),
			typeof(FeaturesSet.portalModule),
			typeof(FeaturesSet.defferedRevenue),
			typeof(FeaturesSet.serviceManagementModule),
			typeof(FeaturesSet.payrollModule),
			typeof(FeaturesSet.manufacturing),
			typeof(FeaturesSet.fixedAsset))]
		[Feature(false, typeof(FeaturesSet.financialAdvanced), DisplayName = "Multiple Base Currencies", Visible = false)]
		...
		[Feature(false, typeof(integrationModule), DisplayName = "Commerce Integration")]
		...
		[Feature(false, typeof(FeaturesSet.shopifyIntegration), DisplayName = "Shopify POS")]
        ...
        [Feature(typeof(FeaturesSet.platformModule), DisplayName = "Image Recognition for Business Cards")]
		...
		[Feature(typeof(platformModule), DisplayName = "AP Document Recognition Service")]
