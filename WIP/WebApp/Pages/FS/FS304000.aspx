...
Inherits="Page_FS304000" Title="Untitled Page" %>
    <%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
        <asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
            ...
            HeaderDescriptionField="FormCaptionDescription">
                <CallbackCommands>
        ...
        <asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
            <%--ReassignAppointment--%>
            <px:PXSmartPanel ID="PXRouteAppointmentAssigment" runat="server" AutoReload="True" AutoRepaint="True" Caption="Route Appointment Assignment" CaptionVisible="True" Height="700px" HideAfterAction="False" Key="RouteAppAssignmentFilter" LoadOnDemand="True" ShowMaximizeButton="True" ShowAfterLoad="True" Width="900px" AutoCallBack-Command="Refresh" AutoCallBack-Target="gridAppointmentsInRoute" CloseAfterAction="True" TabIndex="8500">
            ...
            <%--/ReassignAppointment--%>
            <%--Driver Selector--%>
            <px:PXSmartPanel ID="PXSmartPanel2" runat="server" Caption="Driver Selector" CaptionVisible="True" Key="DriverRouteSelected" TabIndex="17900" AutoCallBack-Enabled="true" AutoCallBack-Command="Refresh" AutoCallBack-Target="PXFormView3" ShowAfterLoad="True" Width="540px">
                <px:PXLayoutRule runat="server" StartColumn="True"></px:PXLayoutRule>
                <px:PXFormView ID="PXFormView3" runat="server" DataMember="DriverRouteSelected" DataSourceID="ds" TabIndex="1600" SkinID="Transparent">
                    <Template>
                ...
                <px:PXFormView ID="PXFormView4" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="DriverFilter" TabIndex="2900" AllowCollapse="False">
                    <Template>
                        <px:PXLayoutRule runat="server" GroupCaption="Filter Options" StartGroup="True" StartRow="True"></px:PXLayoutRule>
                        <px:PXCheckBox ID="edShowUnassignedDrivers" runat="server" DataField="ShowUnassignedDrivers" CommitChanges="True" Text="Show Available Drivers for this Route only" AlignLeft="True"></px:PXCheckBox>
                    </Template>
                </px:PXFormView>
                <px:PXGrid ID="PXGrid1" runat="server" DataSourceID="ds" Style="z-index: 100" SkinID="Inquire" TabIndex="2500" PageSize="10" SyncPosition="True" NoteIndicator="False" FilesIndicator="False">
                    <Levels>
            ...
            <%--/Driver Selector--%>
            <%--Vehicle Selector--%>
            <px:PXSmartPanel ID="VehicleSelector" runat="server" Caption="Vehicle Selector" CaptionVisible="True" Key="VehicleRouteSelected" TabIndex="17900" AutoCallBack-Command="Refresh" AutoCallBack-Target="VehicleRouteForm" ShowAfterLoad="True" Width="540px" AllowResize="False" ShowMaximizeButton="True" CloseAfterAction="true">
                <px:PXLayoutRule runat="server" StartColumn="True"></px:PXLayoutRule>
                <px:PXFormView ID="VehicleRouteForm" runat="server" DataMember="VehicleRouteSelected" DataSourceID="ds" TabIndex="1600" SkinID="Transparent">
                    <Template>
                        ...
                        <px:PXLayoutRule runat="server" GroupCaption="Route Info" StartColumn="True" StartGroup="True"  LabelsWidth="S"></px:PXLayoutRule>
                        <px:PXSelector ID="edFSRoute__RouteCD" runat="server" DataField="FSRoute__RouteCD" DataSourceID="ds" Enabled="False"></px:PXSelector>
                        <px:PXDateTimeEdit ID="edDate" runat="server" DataField="Date" Enabled="False"></px:PXDateTimeEdit>
                        <px:PXLayoutRule runat="server" GroupCaption="Current Selection" StartColumn="True" StartGroup="True" ControlSize="SM" LabelsWidth="XS"></px:PXLayoutRule>
                        <px:PXSelector ID="edDriverID" runat="server" DataField="DriverID" DataSourceID="ds" Enabled="False"></px:PXSelector>
                        <px:PXSelector ID="edVehicleID" runat="server" DataField="VehicleID" DataSourceID="ds" Enabled="False"></px:PXSelector>
                    </Template>
                </px:PXFormView>
                <px:PXFormView ID="PXFormView1" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="VehicleFilter" TabIndex="2900" AllowCollapse="False">
                    <Template>
                        ...
                        <px:PXCheckBox ID="edShowUnassignedVehicles" runat="server" CommitChanges="True" DataField="ShowUnassignedVehicles" Text="Show Available Vehicles for this Route only"></px:PXCheckBox>
                    </Template>
                </px:PXFormView>
                <px:PXGrid ID="VehiclesGrid" runat="server" DataSourceID="ds" Style="z-index: 100" SkinID="Inquire" TabIndex="2500" SyncPosition="True" PageSize="10" AutoAdjustColumns="true">
                    <Levels>
            ...
            <%--Service Order Type Filter--%>
                <px:PXSmartPanel ID="ServiceOrderTypeSelector" runat="server" Caption="Select the Service Order type for the new Appointment" CaptionVisible="True" Key="ServiceOrderTypeSelector" TabIndex="17900" ShowAfterLoad="True" Width="400px" AutoCallBack-Command="Refresh" AutoCallBack-Target="ServiceOrderTypeSelectorForm" LoadOnDemand="true">
            ...
            <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="RouteRecords" TabIndex="3700" DefaultControlID="edRouteID" ActivityIndicator="True" NoteIndicator="True" BPEventsIndicator="True" FilesIndicator="True">
                <Template>
                    ...
                    <px:PXDateTimeEdit ID="edTimeBegin_Time" runat="server" DataField="TimeBegin_Time" TimeMode="True" CommitChanges="True" SuppressLabel="True" />
                    ...
                    <px:PXSelector ID="edDriverID" runat="server" DataField="DriverID" AutoRefresh="True" CommitChanges="True" Size="SM"></px:PXSelector>
                    ...
                    <px:PXLayoutRule runat="server" Merge="True" ControlSize="SM" LabelsWidth="SM"/>
                    <px:PXDateTimeEdit ID="edActualStartTimeDate" runat="server" CommitChanges="True" DataField="ActualStartTime_Date" />
                    <px:PXDateTimeEdit ID="edActualStartTimeTime" runat="server" CommitChanges="True" DataField="ActualStartTime_Time" TimeMode="True" SuppressLabel="True" />
                    <px:PXLayoutRule runat="server" EndGroup="True" />

                    <px:PXLayoutRule runat="server" Merge="True" ControlSize="SM" LabelsWidth="SM"/>
                    <px:PXDateTimeEdit ID="edActualEndTimeDate" runat="server" CommitChanges="True" DataField="ActualEndTime_Date" />
                    <px:PXDateTimeEdit ID="edActualEndTimeTime" runat="server" CommitChanges="True" DataField="ActualEndTime_Time" TimeMode="True" SuppressLabel="True" />
                    <px:PXLayoutRule runat="server" EndGroup="True" />

                    <px:PXLayoutRule runat="server" ControlSize="SM" LabelsWidth="SM"/>
                    <px:PXMaskEdit ID="edActualDuration" runat="server" DataField="MemActualDuration" Enabled="False" TextAlign="Left">
                    </px:PXMaskEdit>
                </Template>
            </px:PXFormView>
        </asp:Content>
