...
namespace PX.Objects.FA
{
   ...
   public class FixedAssetStatus
   {
	...
	public partial class FixedAsset : IBqlTable
	{
		...
		public class Events : PXEntityEvent<FixedAsset>.Container<Events>
		{
			public PXEntityEvent<FixedAsset> UpdateStatus;
		...
		#endregion
		#region Keys
		public class PK : PrimaryKeyOf<FixedAsset>.By<assetID>
		{
			public static FixedAsset Find(PXGraph graph, int? assetID) => FindBy(graph, assetID);
		}
		#endregion
		...
		[PXUIEnabled(typeof(Where<FixedAsset.underConstruction, NotEqual<True>, And<
						Where<FixedAsset.recordType, NotEqual<FARecordType.assetType>, 
		...
		public abstract class underConstruction : PX.Data.BQL.BqlBool.Field<underConstruction> { }
		/// <summary>
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<FAClass>.By<assetID>
		{
			public static FAClass Find(PXGraph graph, int? assetID) => FindBy(graph, assetID);
		}
		public class UK : PrimaryKeyOf<FAClass>.By<assetCD>
		{
			public static FAClass Find(PXGraph graph, string assetCD) => FindBy(graph, assetCD);
		}
		#endregion
		...
		public new abstract class underConstruction : PX.Data.BQL.BqlDecimal.Field<underConstruction> { }
