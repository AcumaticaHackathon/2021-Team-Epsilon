...
namespace PX.Objects.EP
{
	...
	public partial class EPTimeCard : IBqlTable, IAssign
	{
		...
		/// Primary Key
		/// </summary>
		public class PK : PrimaryKeyOf<EPTimeCard>.By<timeCardCD>
		{
			public static EPTimeCard Find(PXGraph graph, string timeCardCD) => FindBy(graph, timeCardCD);
		}
		...
		public static class FK
		{
			...
			/// Employee
			/// </summary>
			public class Employee : EPEmployee.PK.ForeignKeyOf<EPTimeCard>.By<employeeID> { }

			/// <summary>
			/// Original/Corrected Timecard
			/// </summary>
			public class OriginalTimecard : EPTimeCard.PK.ForeignKeyOf<EPTimeCard>.By<origTimeCardCD> { }

			/// <summary>
			/// Owner
			/// </summary>
			public class OwnerContact : Contact.PK.ForeignKeyOf<EPTimeCard>.By<ownerID> { }
		}
		#endregion
		#region Events
		public class Events : PXEntityEvent<EPTimeCard>.Container<Events>
		{
	...
	[PXProjection(typeof(Select2<EPTimeCard,
					...
					LeftJoin<TimecardRegularCurrentTotals, On<TimecardRegularCurrentTotals.weekID, Equal<EPTimeCard.weekId>, And<EPTimeCard.isHold, Equal<True>, And<EPEmployeeEx.defContactID, Equal<TimecardRegularCurrentTotals.owner>>>>,
					LeftJoin<TimecardOvertimeCurrentTotals, On<TimecardOvertimeCurrentTotals.weekID, Equal<EPTimeCard.weekId>, And<EPTimeCard.isHold, Equal<True>, And<EPEmployeeEx.defContactID, Equal<TimecardOvertimeCurrentTotals.owner>>>>>>>>))]
	[Serializable]
