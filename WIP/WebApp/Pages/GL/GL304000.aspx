...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" TypeName="PX.Objects.GL.JournalWithSubEntry"
		PrimaryView="BatchModule" HeaderDescriptionField="Description">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
		...
		ActivityIndicator="true" ActivityField="NoteActivity" LinkIndicator="true" BPEventsIndicator="true" EmailingGraph="PX.Objects.CR.CREmailActivityMaint,PX.Objects"
						...
						<Levels>
							<px:PXGridLevel DataMember="GLTranModuleBatNbr" DataKeyNames="Module,BatchNbr,LineNbr"
								...
								<RowTemplate>
									...
									<px:PXSelector ID="edTermsID" runat="server" DataField="TermsID" DataKeyNames="TermsID" DataSourceID="ds" AutoRefresh="true"/>
