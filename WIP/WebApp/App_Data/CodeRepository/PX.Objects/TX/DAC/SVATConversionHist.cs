...
namespace PX.Objects.TX
{
	...
	public partial class SVATConversionHist : IBqlTable
	{
		...
		{
			public static SVATConversionHist Find(PXGraph graph, string module, string adjdDocType, string adjdRefNbr, int? adjdLineNbr, string adjgDocType, string adjgRefNbr, int? adjNbr, int? taxID) 
				=> FindBy(graph, module, adjdDocType, adjdRefNbr, adjdLineNbr, adjgDocType, adjgRefNbr, adjNbr, taxID);
		}
