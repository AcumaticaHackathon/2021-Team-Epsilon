...
namespace PX.Objects.PO
{
	public class POSetupMaint : PXGraph<POSetupMaint>
	{
		...
		public POSetupMaint()
		{
			bool useLegacyWMS = insetup.Current.UseLegacyWMS ?? false;
			ReceivePutAwaySetup.Cache.AdjustUI()
				.For<POReceivePutAwaySetup.showReturningTab>(a => a.Visible = !useLegacyWMS)
				.SameFor<POReceivePutAwaySetup.requestLocationForEachItemInReturn>();
		}
