...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource  EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.GL.JournalEntryImport" PrimaryView="Map" HeaderDescriptionField="Description">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server"   Width="100%" DataMember="Map" Caption="Import Summary" NoteIndicator="True" FilesIndicator="True"
		ActivityIndicator="True" ActivityField="NoteActivity" LinkIndicator="True" BPEventsIndicator="True" DefaultControlID="edImportNbr" EmailingGraph="PX.Objects.CR.CREmailActivityMaint,PX.Objects">
		<Template>
			...
			<px:PXNumberEdit CommitChanges="True" ID="edTotal" runat="server" DataField="TotalBalance" Width="150px" />
			<px:PXCheckBox ID="edEditable" runat="server" DataField="IsEditable" Enabled="False" />
		</Template>
	</px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
	<px:PXTab ID="tab" runat="server" Height="300px" Width="100%">
		<Items>
			...
			<px:PXTabItem Text="Exceptions" LoadOnDemand="true" BindingContext="form" VisibleExp="DataControls[&quot;edEditable&quot;].Value">
				<Template>
