...
namespace PX.Objects.AR
{
	...
	public partial class ARSetup : PX.Data.IBqlTable
	{
		...
		{
			public class DefaultCustomerClass : AR.CustomerClass.PK.ForeignKeyOf<ARSetup>.By<dfltCustomerClassID> { }
			public class GLBatchNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<batchNumberingID> { }
			public class InvoiceNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<invoiceNumberingID> { }
			public class PaymentNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<paymentNumberingID> { }
			public class DebitMemoNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<debitAdjNumberingID> { }
			public class CreditMemoNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<creditAdjNumberingID> { }
			public class WriteOffNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<writeOffNumberingID> { }
			public class OverdueChargeNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<finChargeNumberingID> { }
			public class UsageTransactionNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<usageNumberingID> { }
			public class PriceWorksheetNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<priceWSNumberingID> { }
			public class DunningFeeNumberingSequence : CS.Numbering.PK.ForeignKeyOf<ARSetup>.By<dunningFeeNumberingID> { }

			public class StatementFromBranch : GL.Branch.PK.ForeignKeyOf<ARSetup>.By<statementBranchID> { }
			public class DunningLetterFromBranch : GL.Branch.PK.ForeignKeyOf<ARSetup>.By<dunningLetterBranchID> { }
			public class DunningFeeTerms : CS.Terms.PK.ForeignKeyOf<ARSetup>.By<dunningFeeTermID> { }
		}
		#endregion
		...
		[PXDBBool]
		[PXDefault(false)]
		[PXUIField(DisplayName = "Automatically Release Retainage Documents", Visibility = PXUIVisibility.Visible, FieldClass = nameof(FeaturesSet.Retainage))]
		...
		#region IntercompanySalesAccountDefault
		public abstract class intercompanySalesAccountDefault : PX.Data.BQL.BqlShort.Field<intercompanySalesAccountDefault>
		{
			public class ListAttribute : PXStringListAttribute
			{
				public ListAttribute() : base(
					new string[] { ARAcctSubDefault.MaskLocation, ARAcctSubDefault.MaskItem },
					new string[] { MaskCustomerLocationLabel, Messages.MaskInventoryItem}
					){ }
				...
				public static string MaskCustomerLocationLabel =>
					PXAccess.FeatureInstalled<FeaturesSet.accountLocations>()
						...
						: Messages.MaskCustomer;
			}
		}

		[PXDBString(1, IsFixed = true)]
		[PXDefault(ARAcctSubDefault.MaskLocation)]
		[PXUIField(DisplayName = "Use Intercompany Sales Account From", FieldClass = nameof(FeaturesSet.InterBranch))]
		[intercompanySalesAccountDefault.List]
