...
namespace PX.Objects.PO
{
    ...
    public partial class POOrderDiscountDetail : PX.Data.IBqlTable, IDiscountDetail
    {
		...
		public static class FK
		{
			...
			public class FreeInventoryItem : InventoryItem.PK.ForeignKeyOf<POOrderDiscountDetail>.By<freeItemID> { }
            //todo public class Discount : APDiscount.UK.ForeignKeyOf<POOrderDiscountDetail>.By<discountID> { }
            public class DiscountSequence : AP.VendorDiscountSequence.UK.ForeignKeyOf<POOrderDiscountDetail>.By<discountID, discountSequenceID> { }
            public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<POOrderDiscountDetail>.By<curyInfoID> { }

            [Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use FreeInventoryItem instead.")]
            public class FreeItem : FreeInventoryItem { }
            [Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use DiscountSequence instead.")]
