...
namespace PX.Objects.FS
{
    public class SMEquipmentMaint : PXGraph<SMEquipmentMaint, FSEquipment>
    {
        ...
        [PXCustomizeBaseAttribute(typeof(PXUIFieldAttribute),
                nameof(PXUIFieldAttribute.DisplayName), "Appointment Status")]
        [PXCustomizeBaseAttribute(typeof(PXUIFieldAttribute),
                nameof(PXUIFieldAttribute.Enabled), false)]
        ...
        {
            List<FSEquipment> list = adapter.Get<FSEquipment>().ToList();
            ...
            if (!String.IsNullOrEmpty(reportID))
            {
                ...
                foreach (FSEquipment equipment in list)
                {
                    parameters["FSEquipment.RefNbr"] = equipment.RefNbr;
        ...
        {
            InventoryItem inventoryItemRow = InventoryItem.PK.Find(this, fsEquipmentRow.InventoryID);
        ...
        {
            InventoryItem inventoryItemRow = InventoryItem.PK.Find(this, inventoryID);
        ...
        public virtual void SetComponentValuesFromInventory(PXCache cache, FSEquipmentComponent fsEquipmentComponentRow)
        {
            ...
            InventoryItem inventoryItemRow = InventoryItem.PK.Find(this, fsEquipmentComponentRow.InventoryID);
