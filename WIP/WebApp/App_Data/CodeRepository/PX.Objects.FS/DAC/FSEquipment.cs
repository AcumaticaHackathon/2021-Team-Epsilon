...
namespace PX.Objects.FS
{
    ...
    {
        #region Keys
        public class PK : PrimaryKeyOf<FSEquipment>.By<SMequipmentID>
        {
            public static FSEquipment Find(PXGraph graph, int? SMequipmentID) => FindBy(graph, SMequipmentID);
        }

        public class UK : PrimaryKeyOf<FSEquipment>.By<refNbr>
        {
            public static FSEquipment Find(PXGraph graph, string refNbr) => FindBy(graph, refNbr);
        }

        public static class FK
        {
            public class Manufacturer : FSManufacturer.PK.ForeignKeyOf<FSEquipment>.By<manufacturerID> { }
            public class ManufacturerModel : FSManufacturerModel.PK.ForeignKeyOf<FSEquipment>.By<manufacturerID, manufacturerModelID> { }
            public class EquipmentType : FSEquipmentType.PK.ForeignKeyOf<FSEquipment>.By<equipmentTypeID> { }
            public class Vendor : AP.Vendor.PK.ForeignKeyOf<FSEquipment>.By<vendorID> { }
            public class Customer : AR.Customer.PK.ForeignKeyOf<FSEquipment>.By<customerID> { }
            public class CustomerLocation : CR.Location.PK.ForeignKeyOf<FSEquipment>.By<customerID, customerLocationID> { }
            public class VehicleType : FSVehicleType.PK.ForeignKeyOf<FSEquipment>.By<vehicleTypeID> { }
            public class Site : INSite.PK.ForeignKeyOf<FSEquipment>.By<siteID> { }
            public class Location : INLocation.PK.ForeignKeyOf<FSEquipment>.By<locationID> { }
            public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<FSEquipment>.By<inventoryID> { }
            public class Owner : AR.Customer.PK.ForeignKeyOf<FSEquipment>.By<ownerID> { }
            public class SubItem : INSubItem.PK.ForeignKeyOf<FSEquipment>.By<subItemID> { }
            public class Branch : GL.Branch.PK.ForeignKeyOf<FSEquipment>.By<branchID> { }
            public class BranchLocation : FSBranchLocation.PK.ForeignKeyOf<FSEquipment>.By<branchLocationID> { }
            public class InstallationServiceOrder : FSServiceOrder.PK.ForeignKeyOf<FSEquipment>.By<instSrvOrdType, instServiceOrderRefNbr> { }
            public class InstallationAppointment : FSAppointment.PK.ForeignKeyOf<FSEquipment>.By<instSrvOrdType, instAppointmentRefNbr> { }
            public class ReplacedEquipment : FSEquipment.PK.ForeignKeyOf<FSEquipment>.By<replaceEquipmentID> { }
            public class DisposalServiceOrder : FSServiceOrder.PK.ForeignKeyOf<FSEquipment>.By<dispSrvOrdType, dispServiceOrderRefNbr> { }
            public class DisposalAppointment : FSAppointment.PK.ForeignKeyOf<FSEquipment>.By<dispSrvOrdType, dispAppointmentRefNbr> { }
        }
        #endregion
        ...
        [FSCustomer]
        [PXForeignReference(typeof(AR.Customer.PK.ForeignKeyOf<FSEquipment>.By<customerID>))]
        ...
        [PXUIField(DisplayName = "Customer")]
        [FSCustomer]
        [PXForeignReference(typeof(AR.Customer.PK.ForeignKeyOf<FSEquipment>.By<ownerID>))]
        [PXDefault(PersistingCheck = PXPersistingCheck.Nothing)]
        ...
        #endregion
        #region DispSrvOrdType
        public abstract class dispSrvOrdType : PX.Data.BQL.BqlString.Field<dispSrvOrdType> { }

        [PXDBString(4, IsFixed = true)]
        [PXUIField(DisplayName = "Service Order Type")]
        public virtual string DispSrvOrdType { get; set; }
        #endregion
        #region DispServiceOrderRefNbr
        public abstract class dispServiceOrderRefNbr : PX.Data.BQL.BqlInt.Field<dispServiceOrderRefNbr> { }

        [PXDBString(15, IsUnicode = true)]
        [PXSelector(typeof(Search<FSServiceOrder.refNbr,
                            Where<FSServiceOrder.srvOrdType, Equal<Current<dispSrvOrdType>>>>),
            SubstituteKey = typeof(FSServiceOrder.refNbr),
            DescriptionField = typeof(FSServiceOrder.docDesc))]
        [PXUIField(DisplayName = "Service Order Nbr.", Enabled = false)]
        public virtual string DispServiceOrderRefNbr { get; set; }
        #endregion
        #region DispAppointmentRefNbr
        public abstract class dispAppointmentRefNbr : PX.Data.BQL.BqlInt.Field<dispAppointmentRefNbr> { }

        [PXDBString(20, IsUnicode = true)]
        [PXSelector(typeof(Search<FSAppointment.refNbr,
                            Where<FSAppointment.srvOrdType, Equal<Current<dispSrvOrdType>>>>),
            SubstituteKey = typeof(FSAppointment.refNbr),
            DescriptionField = typeof(FSAppointment.docDesc))]
        [PXUIField(DisplayName = "Appointment Nbr.", Enabled = false)]
