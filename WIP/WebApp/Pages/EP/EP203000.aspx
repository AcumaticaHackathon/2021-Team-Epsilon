...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="Employee" TypeName="PX.Objects.EP.EmployeeMaint">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="AddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,AddressInfo" CommitChanges="true" Visible="false" />
        </CallbackCommands>
    </px:PXDataSource>
</asp:Content>
                ...
                <Template>
                    ...
                    <px:PXFormView ID="ContactInfo" runat="server" Caption="Contact Info" DataMember="Contact" RenderStyle="Fieldset" DataSourceID="ds" TabIndex="200">
                        ...
                        <Template>
                            ...
                            <px:PXDropDown Size="S" ID="edPhone1Type" runat="server" DataField="Phone1Type" SuppressLabel="True"/>
                            <px:PXMaskEdit Width="134px" ID="edPhone1" runat="server" DataField="Phone1"  LabelID="LPhone1"/>
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXLabel ID="LPhone2" runat="server" Size="SM" />
                            <px:PXDropDown Size="S" ID="edPhone2Type" runat="server" DataField="Phone2Type" SelectedIndex="1"  SuppressLabel="True"/>
                            <px:PXMaskEdit Width="134px" ID="edPhone2" runat="server" DataField="Phone2" LabelID="LPhone2" />
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXLabel ID="LPhone3" runat="server" Size="SM" />
                            <px:PXDropDown Size="S" ID="edPhone3Type" runat="server" DataField="Phone3Type" SelectedIndex="5" SuppressLabel="True"/>
                            <px:PXMaskEdit Width="134px" ID="edPhone3" runat="server" DataField="Phone3" LabelID="LPhone3"/>
                            <px:PXLayoutRule runat="server" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXLabel ID="LFax" runat="server" Size="SM" />
                            <px:PXDropDown Size="S" ID="edFaxType" runat="server" DataField="FaxType" SelectedIndex="4"  SuppressLabel="True"/>
                            <px:PXMaskEdit Width="134px" ID="edFax" runat="server" DataField="Fax" LabelID="LFax"/>
                            <px:PXLayoutRule runat="server" />
                    ...
                    <px:PXSelector ID="edDefaultWorkgroupID" runat="server" DataField="DefaultWorkgroupID" AutoRefresh="true" />
					...
					<px:PXCheckBox runat="server" ID="edAMProductionEmployee" DataField="AMProductionEmployee" />
                    <px:PXCheckBox SuppressLabel="True" runat="server" ID="edSDEnabled" DataField="SDEnabled" CommitChanges="True" />
                    <px:PXFormView ID="frmEmployeeContact" CaptionVisible="false" runat="server" DataMember="Contact" DataSourceID="ds" RenderStyle="Simple">
                        <Template>
                            <px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM" StartColumn="True" />
