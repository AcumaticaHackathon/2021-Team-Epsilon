...
namespace PX.Objects.AR
{
	...
	public partial class ARStatement : PX.Data.IBqlTable
	{
		#region Keys
		/// <exclude/>
		public class PK : PrimaryKeyOf<ARStatement>.By<branchID, customerID, curyID, statementDate>
		{
			public static ARStatement Find(PXGraph graph, Int32? branchID, Int32? customerID, String curyID, DateTime? statementDate)
													=> FindBy(graph, branchID, customerID, curyID, statementDate);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<ARStatement>.By<branchID> { }
			public class Customer : AR.Customer.PK.ForeignKeyOf<ARStatement>.By<customerID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<ARStatement>.By<curyID> { }
			public class StatementCustomer : AR.Customer.PK.ForeignKeyOf<ARStatement>.By<statementCustomerID> { }
			public class StatementCycle : AR.ARStatementCycle.PK.ForeignKeyOf<ARStatement>.By<statementCycleId> { }
		}
		#endregion
