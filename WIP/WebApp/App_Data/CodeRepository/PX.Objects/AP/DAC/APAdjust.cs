...
namespace PX.Objects.AP
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<APAdjust>.By<adjgDocType, adjgRefNbr, adjNbr, adjdDocType, adjdRefNbr, adjdLineNbr>
		{
			public static APAdjust Find(PXGraph graph, String adjgDocType, String adjgRefNbr, Int32? adjNbr, String adjdDocType, String adjdRefNbr, Int32? adjdLineNb) 
											=> FindBy(graph, adjgDocType, adjgRefNbr, adjNbr, adjdDocType, adjdRefNbr, adjdLineNb);
		}
		public static class FK
		{
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APAdjust>.By<vendorID> { }
			public class Payment : AP.APRegister.PK.ForeignKeyOf<APAdjust>.By<adjgDocType, adjgRefNbr> { }
			public class PaymentCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<APAdjust>.By<adjgCuryInfoID> { }
			public class PaymentBranch : GL.Branch.PK.ForeignKeyOf<APAdjust>.By<adjgBranchID> { }
			public class Invoice : AP.APRegister.PK.ForeignKeyOf<APAdjust>.By<adjdDocType, adjdRefNbr> { }
			public class InvoiceCurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<APAdjust>.By<adjdCuryInfoID> { }
			public class InvoiceBranch : GL.Branch.PK.ForeignKeyOf<APAdjust>.By<adjdBranchID> { }
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<APAdjust>.By<cashAccountID> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<APAdjust>.By<paymentMethodID> { }
			public class InvoiceWithholdingTaxAccount : GL.Account.PK.ForeignKeyOf<APAdjust>.By<adjdWhTaxAcctID> { }
			public class InvoiceWithholdingTaxSubaccount : GL.Sub.PK.ForeignKeyOf<APAdjust>.By<adjdWhTaxSubID> { }
		}
		#endregion
    ...
    {
		#region Keys
		public new class PK : PrimaryKeyOf<APAdjust2>.By<adjgDocType, adjgRefNbr, adjNbr, adjdDocType, adjdRefNbr, adjdLineNbr>
		{
			public static APAdjust2 Find(PXGraph graph, String adjgDocType, String adjgRefNbr, Int32? adjNbr, String adjdDocType, String adjdRefNbr, Int32? adjdLineNb)
											=> FindBy(graph, adjgDocType, adjgRefNbr, adjNbr, adjdDocType, adjdRefNbr, adjdLineNb);
		}
		public new static class FK
		{
			public class AdjgDoc : AP.APRegister.PK.ForeignKeyOf<APAdjust2>.By<adjgDocType, adjgRefNbr> { }
			public class AdjdDoc : AP.APRegister.PK.ForeignKeyOf<APAdjust2>.By<adjdDocType, adjdRefNbr> { }
		}
		#endregion
	...
	[Serializable]
	[PXHidden]
	public partial class APAdjustReport : APAdjust
	{
		public new abstract class adjdDocType : PX.Data.BQL.BqlString.Field<adjdDocType> { }
