...
namespace PX.Objects.FS
{
    ...
    public class FSRouteContractSchedule : FSSchedule
	{
        ...
        {
            public static FSRouteContractSchedule Find(PXGraph graph, int? entityID, string refNbr) => FindBy(graph, entityID, refNbr);
        }
        ...
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSRouteContractSchedule>.By<dfltProjectTaskID> { }
        }
        #endregion
