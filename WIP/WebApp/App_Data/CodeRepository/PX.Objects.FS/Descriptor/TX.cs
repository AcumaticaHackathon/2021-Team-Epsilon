...
namespace PX.Objects.FS
{
    public static class TX
    {
        ...
        public static class TableName
        {
            ...
            public const string SODET                           = "Service Order Item Detail";
            public const string APPOINTMENTDET                  = "Appointment Item Detail";
            public const string FSApptLineSplit                 = "Appointment Lot/Serial Detail";
            ...
            public const string FSSODetSplit                    = "Service Order Lot/Serial Detail";
            public const string FSPostBatch                     = "Field Service Billing Batch";
            public const string FSBillHistory                   = "Field Service Billing History";
            public const string FSWrkProcess                    = "FSWrkProcess";
            public const string FSCustomerClassBillingSetup     = "FSCustomerClassBillingSetup";
            public const string FSCustomerBillingSetup          = "FSCustomerBillingSetup";
            public const string FSEquipmentComponent            = "FSEquipmentComponent";
            public const string FSPostInfo                      = "FSPostInfo";
            public const string FSScheduleDet                   = "FSScheduleDet";
            public const string FSSOEmployee                    = "FSSOEmployee";
            public const string FSSOResource                    = "FSSOResource";
            public const string FSAppointmentEmployee           = "FSAppointmentEmployee";
            public const string FSServiceTemplateDet            = "FSServiceTemplateDet";
            public const string FSScheduleRoute                 = "FSScheduleRoute";
            public const string FSAppointmentStatusColor        = "Appointment Status Color";
        }
        ...
        public static class Error
        {
            ...
            public const string ROLLBACK_ROUTE_CONTRACT_GENERATION_FAILED                                      = "The last generation process cannot be rolled back because at least one appointment has a status other than " + TX.Status_Appointment.NotStarted + ".";
            ...
            public const string SERVICE_ORDER_CANT_BE_CANCELED_APPOINTMENTS_HAVE_INVALID_STATUS                = "The service order cannot be canceled because some appointments have invalid statuses. To cancel a service order, its appointments must have one of the following statuses: {0} or {1}.";
            ...
            public const string MISSING_CUSTOMER_BILLING_CYCLE                                                 = "The customer has no billing cycle specified for the current service order type. Assign the billing cycle before saving the service order.";
            ...
            public const string AppointmentQtyGreaterThanServiceOrderQty                                       = "The specified quantity ({0}) is greater than the quantity in the associated service order line ({1}).";
            public const string AppointmentQtyWithOtherAppointmentsGreaterThanServiceOrderQty                  = "The specified quantity ({0}) along with the quantity in other appointments ({1}) is greater than the quantity in the associated service order line ({2}).";
            ...
            public const string NotValidFunctionWithInstructionOrCommentLines                                  = "This action cannot be used for a line with the Instruction or Comment type.";
            ...
            public const string LogActionNotAllowedWithCurrentAppointmentStatus                                = "The {0} action is not valid for non-travel items when the appointment status is one of the following: {1} or {2}.";
            ...
            public const string INVALID_DETAIL_LINE_REF_BY_STATUS                                              = "The {0} line cannot be used because it has the {1} status.";
            public const string InvalidStatusChangeForItemLine                                                 = "The status of the {0} line cannot be changed. The status of the {1} lines cannot be changed to {2}.";
            ...
            public const string CANNOT_COMPLETE_FSSODET_LINE                                                   = "The {0} line cannot be completed because one or multiple related lines have the Not Started, In Progress, or Waiting for Purchased Items status in the associated appointments. Select the appropriate status on the Appointments (FS300200) form first.";
            ...
            public const string LOG_START_CANNOT_BE_PRIOR_APPOINTMENT_START                                    = "The log start date and time cannot be earlier than the appointment actual start date and time specified on the Settings tab.";
            public const string LOG_END_CANNOT_BE_GREATER_APPOINTMENT_END                                      = "The log end date and time cannot be later than the appointment actual end date and time specified on the Settings tab.";
            public const string APPOINTMENT_START_CANNOT_BE_GREATER_MIN_LOG_START                              = "The appointment actual start date and time cannot be later than the earliest start date and time on the Log tab.";
            public const string APPOINTMENT_END_CANNOT_BE_PRIOR_MAX_LOG_END                                    = "The appointment actual end date and time cannot be earlier than the latest start date and time on the Log tab.";
            public const string APPOINTMENT_SCHEDULED_END_DATE_CANNOT_BE_PRIOR_SCHEDULED_START_DATE            = "The appointment scheduled end date and time cannot be earlier than the appointment scheduled start date and time.";
            public const string APPOINTMENT_ACTUAL_END_DATE_CANNOT_BE_PRIOR_ACTUAL_START_DATE                  = "The appointment actual end date and time cannot be earlier than the appointment actual start date and time.";
            ...
            public const string DETAIL_LINE_CANNOT_BE_PAUSED                                                   = "The {0} action is not allowed for the {1} line with the {2} status. To perform this action, a selected line must have the In Process status and the selected detail must be a service, travel or non-stock item.";
            public const string DETAIL_LINE_CANNOT_BE_COMPLETED                                                = "The {0} action is not allowed for the {1} line with the {2} status. To perform this action, a selected line must have the In Process status and the document must have the In Process or Paused status.";
            public const string DETAIL_LINE_CANNOT_BE_RESUMED                                                  = "The {0} action is not allowed for the {1} line with the {2} status. To perform this action, a selected line must have the In Process status and the document must have the In Process status.";
            public const string APPOINTMENT_ACTUAL_START_DATE_CANNOT_BE_PRIOR_CONTRACT_PERIOD_START_DATE       = "The appointment actual start date cannot be earlier than the contract period start date.";
            public const string APPOINTMENT_ACTUAL_END_DATE_CANNOT_BE_GREATER_CONTRACT_PERDIO_END_DATE         = "The appointment actual end date cannot be later than the contract period end date.";
            public const string STKITEM_CANNOT_BE_HANDLED_WITH_SRVORDTYPE                                      = "This stock item cannot be handled for current Service Order Type.";
            public const string CannotCompleteAppointmentWithWaitingPOLines                                    = "The appointment cannot be completed because it contains lines with the Waiting for Purchased Items status.";
            public const string CannotChangeMarkForPOInApptLine                                                = "You cannot clear the Mark for PO check box for this line because other appointments have lines that are associated with the service order line related to this line.";
            public const string CannotChangeMarkForPOInSrvOrdLine                                              = "You cannot clear the Mark for PO check box for this line because it has already been added to appointments.";
            public const string CannotEditSplitBecauseItIsReservedForReceiptAllocationInfo                     = "A lot or serial number cannot be selected for stock items with the Not Tracked method and non-stock items.";
            public const string CannotUnselectMarkForPOBecausePOIsAlreadyCreated                               = "You cannot clear the Mark for PO check box for this line because the purchase order for this line has already been created.";
            public const string CannotUnselectMarkForPOBecauseItWasRequestedFromServiceOrder                   = "You cannot clear the Mark for PO check box for this line because the Mark for PO check box has been selected on the Service Orders (FS300100) form for the service order.";
            public const string CannotChangePOSourceBecauseItWasRequestedFromServiceOrder                      = "You cannot change the PO source for this line because the purchase has been requested from the service order.";
            public const string CannotChangePOSourceBecausePOIsAlreadyCreated                                  = "You cannot change the PO source for this line because the purchase order for this line has already been created.";
            public const string CannotChangePOSourcePOInApptLine                                               = "You cannot change the PO source for this line because other appointments have lines that are associated with the service order line related to this line.";
            public const string CannotCompleteLineBecauseLotSerialTotalQtyDoesNotMatchItemLineQty              = "You cannot complete this line, because the quantity on the Lot Serials does not match quantity on the line.";
            public const string XErrorOccurredDuringActionY                                                    = "{0}~Error occurred during action: {1}";
            public const string LotSerialDuplicated                                                            = "This lot or serial number has already been selected in another line.";
            public const string LotSerialNotAvailable                                                          = "The lot or serial number is not available at the specified warehouse.";
            public const string LotSerialNbrOnOtherAppointment                                                 = "The lot or serial number is already used in another appointment.";
            public const string InvalidItemLineStatusForCurrentAppointmentStatus                               = "The {0} status cannot be selected if the appointment has the {1} status.";
            public const string ErrorRunBillingInventoryItemsToAR                                              = "An AR document cannot be generated for service orders or appointments with inventory items. Remove the inventory items from the document or specify another document type in the Generated Billing Documents box on the Service Order Types (FS202300) form for the type of the document.";
            public const string FSRelatedDocumentNotMatchCurrentDocumentBranch                                 = "The document cannot be assigned to the expense receipt because the branch in the document differs from the branch of the expense receipt.";
            public const string FSRelatedDocumentNotMatchCurrentDocumentCustomer                               = "The document cannot be assigned to the expense receipt because the billing customer in the document differs from the customer of the expense receipt.";
            public const string FSRelatedDocumentNotMatchCurrentDocumentLocation                               = "The document cannot be assigned to the expense receipt because the billing location in the document differs from the location of the expense receipt.";
            public const string FSRelatedDocumentNotMatchCurrentDocumentProject                                = "The document cannot be assigned to {0} because its project {1} differs from the {0} project {2}.";
            public const string QtyEnteredXForLotNumberGreaterThanINAvailQtyX                                  = "The quantity entered ({0}) for the lot number is greater than the quantity available in the Inventory ({1}).";
            public const string QtyEnteredXForLotNumberGreaterThanServiceOrderAllocQtyX                        = "The quantity entered ({0}) for the lot number is greater than the quantity allocated in the service order ({1}).";
            public const string QtyEnteredXForLotNumberPlusOtherApptsQtyXGreaterThanServiceOrderAllocQtyX      = "The quantity entered ({0}) for the lot number along with the quantity used in other appointments ({1}) is greater than the quantity allocated in the service order ({2}).";
            public const string TotalLotSerialQtyXExceedsTheQtyRequiredX                                       = "The total quantity of Lots/Serials specified ({0}) exceeds the quantity required by the item line ({1}).";
            public const string QtyMustBeDifferentFromZeroOnAllLotSerialLines                                  = "Quantity must be different from zero on all Lot/Serial lines.";
            public const string ErrorUpdatingTheServiceOrderWithTheMessageX                                    = "An error occurred while updating the service order, with the message: {0}.";
            public const string UpdatingTheServiceOrderLotSerialsEndedInAnAttemptToIncreaseTheLineQty          = "Updating the lot/serial numbers in the service order with the lot/serial numbers in appointment, ended in an attempt to increase the quantity specified on the service order line. If you need to change one lot/serial number for another, please go to the service order and make the change there.";
            ...
            public const string FieldCannotBeNegativeReviewLogs                                                = "{0} cannot be negative. Verify that the logs have been recorded correctly on the Log tab.";
            public const string PMReverseCannotBeCreatedNotRelease                                             = "The bill cannot be reversed because it has an associated unreleased project transaction. Either release the project transaction or delete it.";
            public const string INReverseCannotBeCreatedNotRelease                                             = "The bill cannot be reversed because it has an associated unreleased issue. Either release the issue or delete it.";
            public const string CannotDeleteCreditMemoLineRelatedToFSDocument                                  = "The credit memo line cannot be deleted because it is related to a field service document.";
            public const string CannotUpdateCreditMemoLineRelatedToFSDocument                                  = "The credit memo line cannot be updated because it is related to a field service document.";
            public const string CannotChangeAPFieldBecauseFSDocIsClosedBilled                                  = "{0} cannot be changed because an associated FS document is closed or billed.";
            public const string InventoryItemCannotBeEmptyForAPBill                                            = "The document cannot be added because the inventory ID is empty. Select a non-stock item or a service in the document's Inventory ID box.";
            public const string InventoryItemCannotBeStockItemForAPBill                                        = "The document cannot be added because the inventory ID corresponds to a stock item. Select a non-stock item or a service in the document's Inventory ID box.";
            public const string FieldCannotBeUpdatedBecauseRelatedReleasedTimeActivity                         = "{0} cannot be updated because this record is related to a released or approved time activity.";
            public const string ReleasedTimeActivityCannotBeDeleted                                            = "There is a released or approved time activity related to {0} that cannot be deleted.";
            public const string FSCuryRelatedDocNotMatchCurrentCuryDoc                                         = "The currency in the current document does not match the currency in the source service order.";
            public const string EmailNotificationSetupNotFoundForTheSrvOrdTypeX                                = "Failed to send the email. The [0] notification setting was not found for the [1] service order type.";
            public const string EmailNotificationRecipientListEmpty                                            = "Failed to send the email. The list of email recipients is empty.";
            public const string EmailNotificationEmailBlankForCurrentCustomer                                  = "Failed to send the email. Email address is not specified for the current customer.";
            public const string EmailNotificationEmailBlankForCurrentBillingCustomer                           = "Failed to send the email. Email address is not specified for the current billing customer.";
            public const string EmailNotificationEmailBlankForCurrentSalesperson                               = "Failed to send the email. Email address is not specified for the current salesperson.";
            public const string EmailNotificationEmailBlankForCurrentEmployeeStaff                             = "Failed to send the email. Email address is not specified for the current staff of the Employee type.";
            public const string EmailNotificationEmailBlankForCurrentVendorStaff                               = "Failed to send the email. Email address is not specified for the current staff of the Vendor type.";
            public const string EmailNotificationEmailBlankForCurrentGeoZoneStaff                              = "Failed to send the email. Email address is not specified for the staff in the current geographical zone.";
            public const string EmailNotificationEmailBlankForEmployeeTypeNotificationRecipient                = "Failed to send the email. Email address is not specified for the notification recipient of the Employee type.";
            public const string TheAppointmentXYCannotBeModifiedBecauseItIsClosed                              = "The appointment {0}-{1} cannot be modified because it is closed.";
            public const string TheAppointmentXYCannotBeModifiedBecauseItIsAlreadyBilled                       = "The appointment {0}-{1} cannot be modified because it has already been billed.";
        }
        ...
        public static class Warning
        {
            ...
            public const string APPOINTMENT_WAS_NOT_FINISHED                                              = "Appointment not finished.";
            public const string SIGNED_APP_EMAIL_ACTION_IS_DISABLED                                       = "The Email Signed Appointment action cannot be performed. To perform the action, sign the appointment by using the mobile app.";
			public const string ROUTE_APPROXIMATE_VALUES                                    			  = "[*] Approximate values. Use for reference only.";
            public const string APLineLinkedToFSDocument                                                  = "This line is associated with an appointment or service order. Do you want to delete the line?";
            public const string FSLineLinkedToAPLine                                                      = "This line is associated with an AP bill. Do you want to delete the line?";
            public const string APInvoiceLinkedToFSDocument                                               = "At least one line in this document is associated with a field service document. Do you want to delete this document?";
            public const string FSDocumentLinkedToAPLines                                                 = "This document has at least one line associated with an AP bill. Do you want to delete the document?";
            public const string TheBillingInfoWasUpdated                                                  = "The billing information was updated and requires review.";
            public const string SaveCanceledBecauseTheBillingInfoWasUpdated                               = "The changes have not been saved because the billing information was updated. Review the billing information and click Save again.";
        }

        [PXLocalizable]
        public static class Action
        {
            public const string InsertingLotSerialInServiceOrder                                               = "Inserting Lot/Serial Number {0} specified in Appointment Line {1} to the service order.";
        }
        ...
        public class Status_AppointmentDet
        {
            ...
            public const string CANCELED        = "Canceled";
            public const string WaitingForPO    = "Waiting for Purchased Items";
            public const string RequestForPO    = "Requiring Purchase";
        }
        ...
        public static class Type_Log
        {
            ...
            public const string STAFF = "Staff and Service (If Any)";
        ...
        {
            public const string DAILY               = "Occurs every {0} {1}.";
            public const string WEEKLY              = "Occurs every {0} {1} on {2}.";
            public const string MONTHLY1            = "Occurs every {0} {1} on the {2} {3} of that month.";
            public const string MONTHLY2            = "Occurs every {0} {1} on the {2} {3} and on the {4} {5} of that month.";
            public const string MONTHLY3            = "Occurs every {0} {1} on the {2} {3} and on the {4} {5} and on the {6} {7} of that month.";
            public const string MONTHLY4            = "Occurs every {0} {1} on the {2} {3} and on the {4} {5} and on the {6} {7} and on the {8} {9} of that month.";
            public const string ANNUAL_MONTH        = "Occurs every {0} {1} on {2}, {3}.";
            public const string ANNUAL_WEEK         = "Occurs every {0} {1} on the {2} {3} of {4}.";
        ...
        [PXLocalizable]
        public static class DayOfMonthOrdinalNbr
        {
            public const string Day1 = "1st"; 
            public const string Day2 = "2nd";
            public const string Day3 = "3rd";
            public const string Day4 = "4th";
            public const string Day5 = "5th";
            public const string Day6 = "6th";
            public const string Day7 = "7th";
            public const string Day8 = "8th";
            public const string Day9 = "9th";
            public const string Day10 = "10th";
            public const string Day11 = "11th";
            public const string Day12 = "12th";
            public const string Day13 = "13th";
            public const string Day14 = "14th";
            public const string Day15 = "15th";
            public const string Day16 = "16th";
            public const string Day17 = "17th";
            public const string Day18 = "18th";
            public const string Day19 = "19th";
            public const string Day20 = "20th";
            public const string Day21 = "21st";
            public const string Day22 = "22nd";
            public const string Day23 = "23rd";
            public const string Day24 = "24th";
            public const string Day25 = "25th";
            public const string Day26 = "26th";
            public const string Day27 = "27th";
            public const string Day28 = "28th";
            public const string Day29 = "29th";
            public const string Day30 = "30th";
            public const string Day31 = "31st";
        }
        ...
        public static class Messages
        {
            ...
            public const string ConfirmCancelAppointmentDetails                    = "Will a new appointment be required for scheduling?";
            public const string LotsSerials                                        = "Lot/Serial Nbrs";
            public const string ReverseDescrPrefix                                 = "Reverse {0}";
        }
        ...
        public static class WebDialogTitles
        {
            ...
            public const string ConfirmCancelAppointmentDetails         = "Cancel Appointment Details";
        ...
        [PXLocalizable]
        public static class ServiceOrderTypeBehavior
        {
            public const string RegularAppointment   = "Regular";
            public const string RouteAppointment     = "Route";
            public const string InternalAppointment  = "Internal";
        ...
        {
            public const string MULTI_EMP_CALENDAR  = "Schedule on Calendar";
            public const string SINGLE_EMP_CALENDAR = "Schedule on Staff Calendar";
            public const string ROOM_CALENDAR       = "Schedule on Room Calendar";
        }
        ...
        [PXLocalizable]
        public static class ServiceOrderWorkflowTypes
        {
            public const string Quote = "Quote";
        ...
        [PXLocalizable]
        public static class AppointmentWorkflowTypes
        {
            public const string Simple = "Simple";
        }
        ...
        {
            public static string[] weeksOfMonth = { WeeksOfMonth.FIRST, WeeksOfMonth.SECOND, WeeksOfMonth.THIRD, WeeksOfMonth.FOURTH, WeeksOfMonth.LAST };
            ...
            public static string[] dayOfMonthOrdinals = { DayOfMonthOrdinalNbr.Day1, DayOfMonthOrdinalNbr.Day2, DayOfMonthOrdinalNbr.Day3,
                                                   DayOfMonthOrdinalNbr.Day4, DayOfMonthOrdinalNbr.Day5, DayOfMonthOrdinalNbr.Day6,
                                                   DayOfMonthOrdinalNbr.Day7, DayOfMonthOrdinalNbr.Day8, DayOfMonthOrdinalNbr.Day9,
                                                   DayOfMonthOrdinalNbr.Day10, DayOfMonthOrdinalNbr.Day11, DayOfMonthOrdinalNbr.Day12,
                                                   DayOfMonthOrdinalNbr.Day13, DayOfMonthOrdinalNbr.Day14, DayOfMonthOrdinalNbr.Day15,
                                                   DayOfMonthOrdinalNbr.Day16, DayOfMonthOrdinalNbr.Day17, DayOfMonthOrdinalNbr.Day18,
                                                   DayOfMonthOrdinalNbr.Day19, DayOfMonthOrdinalNbr.Day20, DayOfMonthOrdinalNbr.Day21,
                                                   DayOfMonthOrdinalNbr.Day22, DayOfMonthOrdinalNbr.Day23, DayOfMonthOrdinalNbr.Day24,
                                                   DayOfMonthOrdinalNbr.Day25, DayOfMonthOrdinalNbr.Day26, DayOfMonthOrdinalNbr.Day27,
                                                   DayOfMonthOrdinalNbr.Day28, DayOfMonthOrdinalNbr.Day29, DayOfMonthOrdinalNbr.Day30,
                                                   DayOfMonthOrdinalNbr.Day31};
        }
        #endregion
        ...
        public static class ServiceOrder_Action_Filter
        {
            ...
            public const string UNCLOSE       = "Unclose";
        ...
        [PXLocalizable]
        public class BillHistory_EntityType
        {
            ...
            public const string PMRegister = "Project Transaction";
            public const string INReceipt = "Receipt";
            public const string INIssue = "Issue";
            public const string SOCreditMemo = "SO Credit Memo";
            public const string ARCreditMemo = "AR Credit Memo";
        }
        ...
        public static class CalendarMessages
        {
            ...
            public const string APPOINTMENT_ESTIMATED_START_TIME = "Estimated Start Time";
            public const string APPOINTMENT_ESTIMATED_END_TIME = "Estimated End Time";
            ...
            public const string APPOINTMENT_SCHEDULED_START_DATE = "Scheduled Start Date";
            public const string APPOINTMENT_SCHEDULED_END_DATE = "Scheduled End Date";
            ...
            public const string AGENDA_STARTS_AT = "Starts at";
            public const string AGENDA_ENDS_AT = "Ends at";
            public const string AGENDA_ALL_DAY = "All day";
        ...
        [PXLocalizable]
        public class Linked_Entity_Type
        {
        ...
        [PXLocalizable]
        public class FSPOSource
        {
            public const string PurchaseToServiceOrder = "Purchase to Service Order";
            public const string PurchaseToAppointment = "Purchase to Appointment";
        }
    }
}
