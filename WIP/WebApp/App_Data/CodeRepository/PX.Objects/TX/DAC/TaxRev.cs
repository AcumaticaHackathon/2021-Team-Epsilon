namespace PX.Objects.TX
{
	...
	public partial class TaxRev : PX.Data.IBqlTable
	{
		...
		#region Keys
		public class PK : PrimaryKeyOf<TaxRev>.By<taxID, revisionID>
		{
			public static TaxRev Find(PXGraph graph, String taxID, DateTime? tranDate, Int32? revisionID) => FindBy(graph, taxID, revisionID);
		}
		public static class FK
		{
			public class Tax : TX.Tax.PK.ForeignKeyOf<TaxRev>.By<taxID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<TaxRev>.By<taxVendorID> { }
			public class ReportingGroup : TX.TaxBucket.PK.ForeignKeyOf<TaxRev>.By<taxVendorID, taxBucketID> { }
		}
		#endregion
