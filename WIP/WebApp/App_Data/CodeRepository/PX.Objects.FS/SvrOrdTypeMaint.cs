...
namespace PX.Objects.FS
{
    public class SvrOrdTypeMaint : PXGraph<SvrOrdTypeMaint, FSSrvOrdType>
    {
        ...
        public virtual void SetPostingSettingVisibility(PXCache cache, FSSrvOrdType fsSrvOrdTypeRow, bool isVisible)
        {
            ...
            PXUIFieldAttribute.SetVisible<FSSrvOrdType.enableINPosting>(cache, fsSrvOrdTypeRow, isVisible && fsSrvOrdTypeRow.Behavior == FSSrvOrdType.behavior.Values.RouteAppointment);
        ...
        public virtual void EnableDisableFields(PXCache cache, FSSrvOrdType fsSrvOrdTypeRow)
        {
            ...
            fsSrvOrdTypeRow.BAccountRequired = fsSrvOrdTypeRow.Behavior != FSSrvOrdType.behavior.Values.InternalAppointment;
            fsSrvOrdTypeRow.RequireRoute = fsSrvOrdTypeRow.Behavior == FSSrvOrdType.behavior.Values.RouteAppointment;
            ...
            {
                case FSSrvOrdType.behavior.Values.InternalAppointment:
                    ...
                    break;
                case FSSrvOrdType.behavior.Values.RouteAppointment:
                    ...
                    break;
                case FSSrvOrdType.behavior.Values.Quote:
                default:

                    if (fsSrvOrdTypeRow.Behavior == FSSrvOrdType.behavior.Values.RegularAppointment)
                    {
                        PXUIFieldAttribute.SetEnabled<FSSrvOrdType.requireCustomerSignature>(cache, fsSrvOrdTypeRow, true);
                    }
                    else
                    ...
                    SetPostingSettingVisibility(cache, fsSrvOrdTypeRow, fsSrvOrdTypeRow.Behavior != FSSrvOrdType.behavior.Values.Quote && fsSrvOrdTypeRow.Behavior != FSSrvOrdType.behavior.Values.InternalAppointment);
                    break;
            }
        }
        ...
        protected virtual void _(Events.FieldUpdated<FSSrvOrdType, FSSrvOrdType.behavior> e)
        {
            ...
            if (fsSrvOrdTypeRow.Behavior == FSSrvOrdType.behavior.Values.Quote)
            {
        ...
        protected virtual void _(Events.FieldUpdated<FSSrvOrdType, FSSrvOrdType.postToSOSIPM> e)
        {
            if (e.Row == null)
            {
                return;
            ...
            if (e.Row.PostToSOSIPM != (bool?)e.OldValue)
            {
                e.Cache.SetValuePending<FSSrvOrdType.setLotSerialNbrInAppts>(e.Row, PXCache.NotSetValue);
                e.Cache.SetDefaultExt<FSSrvOrdType.setLotSerialNbrInAppts>(e.Row);
            }
        }
        ...
        protected virtual void _(Events.RowSelected<FSSrvOrdType> e)
        {
            ...
            bool isInventoryModuleEnabled = PXAccess.FeatureInstalled<FeaturesSet.inventory>();
            PXUIFieldAttribute.SetVisible<FSSrvOrdType.setLotSerialNbrInAppts>(cache, fsSrvOrdTypeRow, isInventoryModuleEnabled);
            FSPostTo.SetLineTypeList<FSSrvOrdType.postTo>(e.Cache, e.Row, true, true, fsSrvOrdTypeRow.Behavior == FSSrvOrdType.behavior.Values.RegularAppointment);
        }
