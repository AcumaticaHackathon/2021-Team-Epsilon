<%@ Page Language="C#" MasterPageFile="~/MasterPages/FormDetail.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="IN302020.aspx.cs"
    Inherits="Page_IN302020" Title="Scan and Issue" %>
...
<asp:content id="cont1" contentplaceholderid="phDS" runat="Server">
    ...
    <pxa:DynamicDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INScanIssueHost,PX.Objects.IN.WMS.INScanIssue+Host" PrimaryView="HeaderView">
        <CallbackCommands>
