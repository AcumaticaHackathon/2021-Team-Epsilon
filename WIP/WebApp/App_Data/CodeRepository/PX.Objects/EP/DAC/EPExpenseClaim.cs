...
namespace PX.Objects.EP
{
	...
	public class EPExpenseClaimStatus : ILabelProvider
	{
		...
		public sealed class holdStatus : PX.Data.BQL.BqlString.Constant<holdStatus>
		{
			public holdStatus() : base(HoldStatus) { }
		}
		public sealed class openStatus : PX.Data.BQL.BqlString.Constant<openStatus>
		{
			public openStatus() : base(OpenStatus) { }
		}
		public sealed class approvedStatus : PX.Data.BQL.BqlString.Constant<approvedStatus>
		{
			public approvedStatus() : base(ApprovedStatus) { }
		}
		public sealed class rejectedStatus : PX.Data.BQL.BqlString.Constant<rejectedStatus>
		{
			public rejectedStatus() : base(RejectedStatus) { }
		}
		public sealed class releasedStatus : PX.Data.BQL.BqlString.Constant<releasedStatus>
		{
	...
	public partial class EPExpenseClaim : IBqlTable, PX.Data.EP.IAssign, IAccountable
	{
		...
		/// Primary Key
		/// </summary>
		public class PK : PrimaryKeyOf<EPExpenseClaim>.By<refNbr>
		{
			public static EPExpenseClaim Find(PXGraph graph, string refNbr) => FindBy(graph, refNbr);
		}
		...
		public static class FK
		{
			...
			/// Branch
			/// </summary>
			public class Branch : GL.Branch.PK.ForeignKeyOf<EPExpenseClaim>.By<branchID> { }

			/// <summary>
			/// ClaimedByEmployee 
			/// </summary>
			public class ClaimedByEmployee : EPEmployee.PK.ForeignKeyOf<EPExpenseClaim>.By<employeeID> { }

			/// <summary>
			/// Owner/Approver
			/// </summary>
			public class OwnerContact : Contact.PK.ForeignKeyOf<EPExpenseClaim>.By<approverID> { }

			/// <summary>
			/// Tax Zone
			/// </summary>
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<EPExpenseClaim>.By<taxZoneID> { }

			/// <summary>
			/// Customer
			/// </summary>
			public class Customer : AR.Customer.PK.ForeignKeyOf<EPExpenseClaim>.By<customerID> { }

			/// <summary>
			/// Customer Location
			/// </summary>
			public class CustomerLocation : CR.Location.PK.ForeignKeyOf<EPExpenseClaim>.By<customerID, customerLocationID> { }

			/// <summary>
			/// Department
			/// </summary>
			public class Department : EPDepartment.PK.ForeignKeyOf<EPExpenseClaim>.By<departmentID> { }

			/// <summary>
			/// Claim Location
			/// </summary>
			public class ClaimLocation : CR.Location.PK.ForeignKeyOf<EPExpenseClaim>.By<employeeID, locationID> { }
		}
		#endregion
		#region Events
		public class Events : PXEntityEvent<EPExpenseClaim>.Container<Events>
		{
		...
		/// <summary>
		/// The identifier of the <see cref="Contact">contact</see> responsible for the document approval process.
		/// </summary>
		/// <value>
		...
		[PXDefault(typeof(Search<EPCompanyTreeMember.contactID,
			Where<
				EPCompanyTreeMember.workGroupID, Equal<Current<EPExpenseClaim.workgroupID>>,
		...
		[PXString]
		[PXFormula(typeof(Selector<employeeID, BAccount.acctName>))]
