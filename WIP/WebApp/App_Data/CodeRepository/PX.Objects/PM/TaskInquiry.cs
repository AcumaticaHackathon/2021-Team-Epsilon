...
namespace PX.Objects.PM
{
	...
	public class TaskInquiry : PXGraph<TaskInquiry>
    {
        ...
        public TaskInquiry()
        {
            ...
            PXUIFieldAttribute.SetVisible<PMTask.defaultSalesSubID>(FilteredItems.Cache, null, false);
            PXUIFieldAttribute.SetVisible<PMTask.defaultExpenseSubID>(FilteredItems.Cache, null, false);
