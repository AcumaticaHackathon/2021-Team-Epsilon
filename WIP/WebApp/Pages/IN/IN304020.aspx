...
<asp:content id="cont1" contentplaceholderid="phDS" runat="Server">
    ...
    <pxa:DynamicDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INScanTransferHost,PX.Objects.IN.WMS.INScanTransfer+Host" PrimaryView="HeaderView">
        <CallbackCommands>
