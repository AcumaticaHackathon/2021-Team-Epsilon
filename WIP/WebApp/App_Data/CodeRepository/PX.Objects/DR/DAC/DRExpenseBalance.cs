namespace PX.Objects.DR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<DRExpenseBalance>.By<branchID, acctID, subID, componentID, vendorID, projectID, finPeriodID>
		{
			public static DRExpenseBalance Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? vendorID, Int32? projectID, String finPeriodID) => FindBy(graph, branchID, acctID, subID, componentID, vendorID, projectID, finPeriodID);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<DRExpenseBalance>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<DRExpenseBalance>.By<acctID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<DRExpenseBalance>.By<subID> { }
			public class Component : IN.InventoryItem.PK.ForeignKeyOf<DRExpenseBalance>.By<componentID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<DRExpenseBalance>.By<vendorID> { }
			public class Project : PM.PMProject.PK.ForeignKeyOf<DRExpenseBalance>.By<projectID> { }
		}
		#endregion
		#region BranchID
    ...
    {
		#region Keys
		public class PK : PrimaryKeyOf<DRExpenseBalanceByPeriod>.By<branchID, acctID, subID, componentID, vendorID, projectID, finPeriodID>
		{
			public static DRExpenseBalanceByPeriod Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? vendorID, Int32? projectID, String finPeriodID) => FindBy(graph, branchID, acctID, subID, componentID, vendorID, projectID, finPeriodID);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<DRExpenseBalanceByPeriod>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<DRExpenseBalanceByPeriod>.By<acctID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<DRExpenseBalanceByPeriod>.By<subID> { }
			public class Component : IN.InventoryItem.PK.ForeignKeyOf<DRExpenseBalanceByPeriod>.By<componentID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<DRExpenseBalanceByPeriod>.By<vendorID> { }
			public class Project : PM.PMProject.PK.ForeignKeyOf<DRExpenseBalanceByPeriod>.By<projectID> { }
		}
		#endregion
		#region BranchID
		public abstract class branchID : PX.Data.BQL.BqlInt.Field<branchID> { }
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<DRExpenseBalance2>.By<branchID, acctID, subID, componentID, vendorID, projectID, finPeriodID>
		{
			public static DRExpenseBalance2 Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? vendorID, Int32? projectID, String finPeriodID) => FindBy(graph, branchID, acctID, subID, componentID, vendorID, projectID, finPeriodID);
		}
		public new static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<DRExpenseBalance2>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<DRExpenseBalance2>.By<acctID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<DRExpenseBalance2>.By<subID> { }
			public class Component : IN.InventoryItem.PK.ForeignKeyOf<DRExpenseBalance2>.By<componentID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<DRExpenseBalance2>.By<vendorID> { }
			public class Project : PM.PMProject.PK.ForeignKeyOf<DRExpenseBalance2>.By<projectID> { }
		}
		#endregion
		#region BranchID
