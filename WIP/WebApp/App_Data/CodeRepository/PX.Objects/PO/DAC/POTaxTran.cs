namespace PX.Objects.PO
{
    ...
    public partial class POTaxTran : TaxDetail, PX.Data.IBqlTable
    {
		...
		public static class FK
		{
			...
			public class OrderLine : POLine.PK.ForeignKeyOf<POTaxTran>.By<orderType, orderNbr, lineNbr> { }
			public class POTax : Objects.PO.POTax.PK.ForeignKeyOf<POTaxTran>.By<orderType, orderNbr, lineNbr, taxID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<POTaxTran>.By<taxID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<POTaxTran>.By<curyInfoID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<POTaxTran>.By<taxZoneID> { }
		...
		[PXSelector(typeof(Tax.taxID), DescriptionField = typeof(Tax.descr), IsDirty = true, DirtyRead = true)]
