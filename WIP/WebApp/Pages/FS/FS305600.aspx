...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" 
        ...
        <CallbackCommands>
            <px:PXDSCallbackCommand Name="OpenRouteScheduleProcess" CommitChanges="True"/>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" 
        ...
        <Template>
                ...
                <px:PXDateTimeEdit ID="edLastGeneratedElementDate" runat="server" DataField="LastGeneratedElementDate" Enabled="False">
                </px:PXDateTimeEdit>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
    ...
    <px:PXTab ID="tab" runat="server" Width="100%" Height="550px" DataSourceID="ds" 
        ...
        <Items>
            ...
            <Template>
                    <px:PXGrid ID="PXGridDetails" runat="server" DataSourceID="ds" Style="z-index: 100" 
        ...
        <px:PXTabItem Text="Delivery Notes">
            <Template>
                <px:PXFormView runat="server" DataMember="ScheduleRoutes" RenderStyle="Simple" DataSourceID="ds" 
                            ID="DeliveryNotesForm" TabIndex="30700">
                    <Template>
        ...
        <px:PXTabItem Text="Internal Notes">
            <Template>
                <px:PXFormView runat="server" DataMember="ScheduleRoutes" RenderStyle="Simple" DataSourceID="ds" 
                            ID="InternalNotesForm" TabIndex="30700">
                    <Template>
