...
namespace PX.Commerce.Shopify.API.REST
{
	...
	[CommerceDescription(ShopifyCaptions.Customer)]
	public class CustomerData: BCAPIEntity
	{
		...
		[CommerceDescription(ShopifyCaptions.AcceptsMarketing, FieldFilterStatus.Filterable, FieldMappingStatus.ImportAndExport)]
