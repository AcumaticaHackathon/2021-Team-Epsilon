...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AP.APPriceWorksheetMaint" PrimaryView="Document" HeaderDescriptionField="Descr">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Worksheet Summary" DataMember="Document"
        ...
        <Template>
            ...
            <px:PXLabel runat="server" ID="chkLabel" />
