...
namespace PX.Objects.CA
{
	...
	public partial class CABankTranDetail : IBqlTable, ICATranDetail
	{
		...
		{
			public static CABankTranDetail Find(PXGraph graph, int? bankTranID, string bankTranType, int? lineNbr) => FindBy(graph, bankTranID, bankTranType, lineNbr);
		}
		...
		public static class FK
		{
			...
			public class Task : PMTask.PK.ForeignKeyOf<CABankTranDetail>.By<taskID> { }
