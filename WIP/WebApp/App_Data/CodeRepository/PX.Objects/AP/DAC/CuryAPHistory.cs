...
namespace PX.Objects.AP
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CuryAPHistory>.By<branchID, accountID, subID, curyID, vendorID, finPeriodID>
		{
			public static CuryAPHistory Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, String curyID, Int32? vendorID, String finPeriodID) => FindBy(graph, branchID, accountID, subID, curyID, vendorID, finPeriodID);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<CuryAPHistory>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<CuryAPHistory>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<CuryAPHistory>.By<subID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<CuryAPHistory>.By<curyID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<CuryAPHistory>.By<vendorID> { }
		}
		#endregion
