...
namespace PX.Objects.FS
{
    public class CreatePurchaseOrderProcess : PXGraph<CreatePurchaseOrderProcess>
    {
        ...
        public virtual bool IsThisItemGroupValid(List<POEnabledFSSODet> itemGroup, List<POEnabledFSSODet> originalItemList)
        {
        ...
        public virtual void InitializePOOrderDocument(POOrderEntry graphPOOrderEntry, POOrder poOrderRow, POEnabledFSSODet firstPOEnabledFSSODetRow)
        {
        ...
        public virtual void InsertPOLine(POOrderEntry graphPOOrderEntry, POLine poLineRow, POEnabledFSSODet poEnabledFSSODetRow)
        {
        ...
        public virtual void CopyNotesAndAttachments(PXCache cache, POLine poLineRow, POEnabledFSSODet poEnabledFSSODetRow)
        {
