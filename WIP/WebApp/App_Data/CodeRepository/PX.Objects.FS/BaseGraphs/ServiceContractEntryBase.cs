...
namespace PX.Objects.FS
{
        ...
        where TWhere : class, IBqlWhere, new()
    {
        ...
        public virtual void CalculateBillHistoryUnboundFields(PXCache cache, FSBillHistory fsBillHistoryRow)
        {
            using (new PXConnectionScope())
            {
                ...
                FSContractPeriod fsContractPeriodRow = PXSelectJoin<FSContractPeriod,
                                                       ...
                                                       .Select(cache.Graph, ServiceContractSelected.Current.ServiceContractID, fsBillHistoryRow.ChildDocType, fsBillHistoryRow.ChildRefNbr);
        ...
        protected virtual void _(Events.FieldDefaulting<FSServiceContract, FSServiceContract.endDate> e)
        {
            ...
            if (e.Row.StartDate.HasValue == true
                    && e.Row.ExpirationType == ID.Contract_ExpirationType.EXPIRING)
            {
                e.NewValue = e.Row.StartDate.Value.AddYears(1);
            }
            else
            {
                e.NewValue = null;
        ...
        protected virtual void _(Events.RowSelected<FSServiceContract> e)
        {
            ...
            PXUIFieldAttribute.SetEnabled<FSServiceContract.customerID>(cache, e.Row, fsServiceContractRow.HasSchedule == false);
