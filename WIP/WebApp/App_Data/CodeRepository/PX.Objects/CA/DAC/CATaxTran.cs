...
namespace PX.Objects.CA
{
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<CATaxTran>.By<tranDate, recordID>
		{
			public static CATaxTran Find(PXGraph graph, DateTime? tranDate, Int32? recordID) => FindBy(graph, tranDate, recordID);
		}
		public new static class FK
		{
			public class Tax : TX.Tax.PK.ForeignKeyOf<CATaxTran>.By<taxID> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<CATaxTran>.By<branchID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<CATaxTran>.By<taxZoneID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<CATaxTran>.By<bAccountID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<CATaxTran>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<CATaxTran>.By<subID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<CATaxTran>.By<curyInfoID> { }
		}
		#endregion
		#region Module
