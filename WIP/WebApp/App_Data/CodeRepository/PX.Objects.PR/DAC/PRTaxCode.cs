...
namespace PX.Objects.PR
{
	...
	public class PRTaxCode : PRTaxTypeSettingMapper, IBqlTable
	{
		...
		{
			public static PRTaxCode Find(PXGraph graph, int? taxID) => FindBy(graph, taxID);
		}

		public class UK : PrimaryKeyOf<PRTaxCode>.By<taxCD>
		{
			public static PRTaxCode Find(PXGraph graph, int? taxCD) => FindBy(graph, taxCD);
		}

		public static class FK
		{
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<PRTaxCode>.By<bAccountID> { }
			//public class State : CS.State.PK.ForeignKeyOf<PRTaxCode>.By<LocationConstants.CountryUS, taxState> { }
