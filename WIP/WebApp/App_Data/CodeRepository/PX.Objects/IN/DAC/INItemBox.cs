...
{
	[Serializable]
	[PXCacheName(Messages.INItemBox)]
	public partial class INItemBox : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			//todo public class UnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<INItemBox>.By<inventoryID, uOM> { }
		}
		#endregion
		#region InventoryID
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<INItemBoxEx>.By<inventoryID, boxID>
		{
			public static INItemBoxEx Find(PXGraph graph, int? inventoryID, string boxID) => FindBy(graph, inventoryID, boxID);
		}
		public new static class FK
		{
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<INItemBoxEx>.By<inventoryID> { }
			public class CSBox : CS.CSBox.PK.ForeignKeyOf<INItemBoxEx>.By<boxID> { }
		}
		#endregion
