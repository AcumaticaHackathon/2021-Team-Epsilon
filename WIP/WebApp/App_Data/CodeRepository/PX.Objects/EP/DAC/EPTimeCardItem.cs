...
namespace PX.Objects.EP
{
	...
	public partial class EPTimeCardItem : IBqlTable
	{
		...
		{
			public static EPTimeCardItem Find(PXGraph graph, string timeCardCD, int? lineNbr) => FindBy(graph, timeCardCD, lineNbr);
		}
		...
		public static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<EPTimeCardItem>.By<taskID> { }
