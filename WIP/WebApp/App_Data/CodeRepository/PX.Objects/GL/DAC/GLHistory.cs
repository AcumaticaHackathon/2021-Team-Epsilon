...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLHistory>.By<ledgerID, branchID, accountID, subID, finPeriodID>
		{
			public static GLHistory Find(PXGraph graph, Int32? ledgerID, Int32? branchID, Int32? accountID, Int32? subID, String finPeriodID) => FindBy(graph, ledgerID, branchID, accountID, subID, finPeriodID);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<GLHistory>.By<branchID> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<GLHistory>.By<ledgerID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<GLHistory>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<GLHistory>.By<subID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<GLHistory>.By<curyID> { }
		}
		#endregion
