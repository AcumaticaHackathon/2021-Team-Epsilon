namespace PX.Objects.DR
{
	...
	public partial class DRRevenueProjection : IBqlTable
	{
		...
		{
			public static DRRevenueProjection Find(PXGraph graph, int? branchID, Int32? acctID, Int32? subID, Int32? componentID, Int32? customerID, Int32? projectID, String finPeriodID) => FindBy(graph, branchID, acctID, subID, componentID, customerID, projectID, finPeriodID);
		}
