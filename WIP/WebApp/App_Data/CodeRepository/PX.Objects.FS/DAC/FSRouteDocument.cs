...
namespace PX.Objects.FS
{
	...
	{
        #region Keys
        public class PK : PrimaryKeyOf<FSRouteDocument>.By<routeDocumentID>
        {
            public static FSRouteDocument Find(PXGraph graph, int? routeDocumentID) => FindBy(graph, routeDocumentID);
        }

        public class UK : PrimaryKeyOf<FSRouteDocument>.By<refNbr>
        {
            public static FSRouteDocument Find(PXGraph graph, string refNbr) => FindBy(graph, refNbr);
        }


        public static class FK
        {
            public class Branch : GL.Branch.PK.ForeignKeyOf<FSRouteDocument>.By<branchID> { }
            public class Route : FSRoute.PK.ForeignKeyOf<FSRouteDocument>.By<routeID> { }
            public class Driver : EP.EPEmployee.PK.ForeignKeyOf<FSRouteDocument>.By<driverID> { }
            public class AdditionalDriver : EP.EPEmployee.PK.ForeignKeyOf<FSRouteDocument>.By<additionalDriverID> { }
            public class Vehicle : FSVehicle.PK.ForeignKeyOf<FSRouteDocument>.By<vehicleID> { }
            public class AdditionalVehicle1 : FSVehicle.PK.ForeignKeyOf<FSRouteDocument>.By<additionalVehicleID1> { }
            public class AdditionalVehicle2 : FSVehicle.PK.ForeignKeyOf<FSRouteDocument>.By<additionalVehicleID2> { }
        }
        #endregion
		...
		[PXUIField(DisplayName = "Schedule Start Date", Visibility = PXUIVisibility.SelectorVisible)]
        ...
        [PXRestrictor(typeof(Where<EPEmployeeFSRouteEmployee.vStatus, IsNull,
                    Or<EPEmployeeFSRouteEmployee.vStatus, NotEqual<VendorStatus.inactive>>>),
        ...
        [PXString]
        [PXFormula(typeof(Selector<routeID, FSRoute.descr>))]
        ...
        public virtual string ApproximateValuesLabel
        {
            get
            {
                return PXMessages.LocalizeNoPrefix(TX.Warning.ROUTE_APPROXIMATE_VALUES);
            }
        }
        #endregion
