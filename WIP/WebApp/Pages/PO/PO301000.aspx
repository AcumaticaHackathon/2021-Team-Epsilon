...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
        ...
        <Items>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="SOOrderNbr" AllowShowHide="true" />
                                    <px:PXGridColumn DataField="SOOrderStatus" AllowShowHide="true" />
                                    <px:PXGridColumn DataField="SOLineNbr" AllowShowHide="true" />
                                    <px:PXGridColumn DataField="SOLinkActive" AllowShowHide="true" Type="CheckBox" TextAlign="Center" CommitChanges="True" />
                                    ...
                                    <px:PXGridColumn DataField="ViewDemandEnabled" Type="CheckBox" AllowShowHide="False" Visible="false" SyncVisible="false" />
                                </Columns>
                                <RowTemplate>
                                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S" ControlSize="XM" />
                                    ...
                                    <px:PXSelector runat="server" DataField="SOOrderNbr" AllowEdit="true" ID="edDSSOOrderNbr" />
                                    <px:PXDropDown runat="server" DataField="SOOrderStatus" ID="edSOOrderStatus" />
                                    <px:PXNumberEdit runat="server" DataField="SOLineNbr" ID="edDSSOLineNbr" />
                                    <px:PXCheckBox runat="server" DataField="SOLinkActive" CommitChanges="True" ID="edSOLinkActive" />
            ...
            <px:PXTabItem Text="Shipping">
                <Template>
                    ...
                    <px:PXSelector ID="edSOOrderNbr" runat="server" AllowEdit="True" DataField="SOOrderNbr" />
    ...
    <!--#include file="~\Pages\Includes\AddProjectItemPanel.inc"-->
</asp:Content>
