...
namespace PX.Objects.CA
{
	...
	public partial class CAAdj : IBqlTable, ICADocument, IAssign, IRegister
	{
		...
		public class Events : PXEntityEvent<CAAdj>.Container<Events>
		{
			...
			public PXEntityEvent<CAAdj> UpdateStatus;
		}
		#endregion
		#region Keys
		public class PK : PrimaryKeyOf<CAAdj>.By<adjTranType, adjRefNbr>
		{
			public static CAAdj Find(PXGraph graph, string adjTranType, string adjRefNbr) => FindBy(graph, adjTranType, adjRefNbr);
		}
		...
		/// </summary>
		/// <value>
		/// This field is populated only by the <see cref="CATranEntry"/> graph (corresponds to the Transactions CA.30.40.00 screen).
		/// </value>
		[PXInt]
		...
		[PXDefault(typeof(Search2<CAEntryType.entryTypeId, InnerJoin<CashAccountETDetail, On<CashAccountETDetail.entryTypeID, Equal<CAEntryType.entryTypeId>>>,
									Where<CashAccountETDetail.accountID, Equal<Current<CAAdj.cashAccountID>>, And<CAEntryType.module, Equal<BatchModule.moduleCA>,
