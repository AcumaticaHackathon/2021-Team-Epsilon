...
namespace PX.Objects.PO
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<POAccrualSplit>.By<refNoteID, lineNbr, type, aPDocType, aPRefNbr, aPLineNbr, pOReceiptNbr, pOReceiptLineNbr>
		{
			public static POAccrualSplit Find(PXGraph graph, Guid? refNoteID, int? lineNbr, string type, string aPDocType, string aPRefNbr, int? aPLineNbr, string pOReceiptNbr, int? pOReceiptLineNbr)
				=> FindBy(graph, refNoteID, lineNbr, type, aPDocType, aPRefNbr, aPLineNbr, pOReceiptNbr, pOReceiptLineNbr);
		}
