...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentScheduleBoard : IBqlTable
    {
        ...
        #region StatusUI
        public abstract class statusUI : PX.Data.BQL.BqlString.Field<statusUI> { }

        [PXString]
        public virtual string StatusUI
        { get; set; }
        #endregion
        #region CustomID
        ...
        public abstract class canDeleteAppointment : PX.Data.BQL.BqlInt.Field<canDeleteAppointment> { }
        ...
        [PXFormula(typeof(Switch<
                Case<Where<
                        FSAppointmentScheduleBoard.postingStatusAPARSO, NotEqual<FSAppointmentScheduleBoard.postingStatusAPARSO.Posted>,
                        And<FSAppointmentScheduleBoard.postingStatusIN, NotEqual<FSAppointmentScheduleBoard.postingStatusIN.Posted>>>,
                False>,
                True>))]
        public virtual bool? IsPosted { get; set; }
        #endregion
        #region Resizable
        public abstract class resizable : PX.Data.BQL.BqlBool.Field<resizable> { }
        ...
        #endregion
        #region Draggable
        public abstract class draggable : PX.Data.BQL.BqlBool.Field<draggable> { }
