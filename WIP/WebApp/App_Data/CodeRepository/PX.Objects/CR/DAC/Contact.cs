...
namespace PX.Objects.CR
{
	...
	[PXGroupMask(typeof(LeftJoinSingleTable<BAccount, On<BAccount.bAccountID, Equal<Contact.bAccountID>>>),
	...
	public partial class Contact : IBqlTable, IContactBase, IPersonalContact, IAssign, IPXSelectable, CRDefaultMailToAttribute.IEmailMessageTarget, IConsentable, INotable
	{
		...
		{
			public class Class : CR.CRContactClass.PK.ForeignKeyOf<Contact>.By<classID> { }
			public class BusinessAccount : CR.BAccount.PK.ForeignKeyOf<Contact>.By<bAccountID> { }
			public class ParentBusinessAccount : CR.BAccount.PK.ForeignKeyOf<Contact>.By<parentBAccountID> { }

			public class Address : CR.Address.PK.ForeignKeyOf<Contact>.By<defAddressID> { }

			public class Owner : EP.EPEmployee.PK.ForeignKeyOf<Contact>.By<ownerID> { }
			public class Workgroup : TM.EPCompanyTree.PK.ForeignKeyOf<Contact>.By<workgroupID> { }
			public class User : PX.SM.Users.PK.ForeignKeyOf<Contact>.By<userID> { }
		}
		#endregion
