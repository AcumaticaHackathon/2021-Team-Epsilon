...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" Width="100%" runat="server" TypeName="PX.Objects.PR.PRCertifiedProjectMaint" PrimaryView="CertifiedProject" Visible="True" HeaderDescriptionField="Description" />
</asp:Content>
				...
				<Template>
                    <px:PXFormView ID="formFringeBenefits" runat="server" DataMember="CurrentProject">
                        <Template>
                            ...
                            <px:PXCheckBox ID="edApplyOTMultiplierToFringeRate" runat="server" DataField="ApplyOTMultiplierToFringeRate" />
