...
namespace PX.Objects.TX
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<TaxPeriod>.By<organizationID, vendorID, taxPeriodID>
		{
			public static TaxPeriod Find(PXGraph graph, Int32? organizationID, Int32? vendorID, string finPeriodID) => FindBy(graph, organizationID, vendorID,finPeriodID);
		}
		public static class FK
		{
			public class Organization : GL.DAC.Organization.PK.ForeignKeyOf<TaxPeriod>.By<organizationID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<TaxPeriod>.By<vendorID> { }
			public class FinYear : TX.TaxYear.PK.ForeignKeyOf<TaxPeriod>.By<organizationID, vendorID, taxYear> { }
		}
		#endregion
