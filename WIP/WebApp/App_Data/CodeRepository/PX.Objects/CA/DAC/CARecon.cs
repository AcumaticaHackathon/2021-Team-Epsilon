...
namespace PX.Objects.CA
{
	...
	[PXGroupMask(typeof(InnerJoin<CashAccount, On<CashAccount.cashAccountID, Equal<CARecon.cashAccountID>>,
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CARecon>.By<cashAccountID, reconNbr>
		{
			public static CARecon Find(PXGraph graph, int? cashAccountID, string reconNbr) => FindBy(graph, cashAccountID, reconNbr);
		}

		public static class FK
		{
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CARecon>.By<cashAccountID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<CARecon>.By<curyID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<CARecon>.By<curyInfoID> { }
		}
		...
		#endregion
		#region Events
		public class Events : PXEntityEvent<CARecon>.Container<Events>
		{
			public PXEntityEvent<CARecon> UpdateStatus;
		}
		#endregion
		...
		[PXUIField(DisplayName = "Load Documents Up To", Visibility = PXUIVisibility.Visible, Required = false)]
