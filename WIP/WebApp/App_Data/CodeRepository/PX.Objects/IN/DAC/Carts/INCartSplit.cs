...
namespace PX.Objects.IN
{
	...
	public class INCartSplit : IBqlTable
	{
		...
		public static class FK
		{
			...
			public class SubItem : INSubItem.PK.ForeignKeyOf<INCartSplit>.By<subItemID> { }
			public class FromLocation : INLocation.PK.ForeignKeyOf<INCartSplit>.By<fromLocationID> { }
			public class ToLocation : INLocation.PK.ForeignKeyOf<INCartSplit>.By<toLocationID> { }
			//todo public class UnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<INCartSplit>.By<inventoryID, uOM> { }
		}
		#endregion
