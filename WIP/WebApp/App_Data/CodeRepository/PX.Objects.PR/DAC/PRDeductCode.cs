...
namespace PX.Objects.PR
{
	...
	public class PRDeductCode : IBqlTable
	{
		...
		public static class FK
		{
			...
			//public class State : CS.State.PK.ForeignKeyOf<PRDeductCode>.By<LocationConstants.CountryUS, state> { }
		}
		#endregion
		...
		[ContributionType.List(typeof(isWorkersCompensation), typeof(isPayableBenefit), typeof(isGarnishment))]
