...
namespace PX.Objects.CA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CABankTranMatch>.By<tranID, lineNbr>
		{
			public static CABankTranMatch Find(PXGraph graph, int? tranID, int? lineNbr) => FindBy(graph, tranID, lineNbr);
		}
