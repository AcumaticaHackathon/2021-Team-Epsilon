...
namespace PX.Objects.FS
{
	...
	public class FSRoom : PX.Data.IBqlTable
	{
		...
		{
			public static FSRoom Find(PXGraph graph, int? branchLocationID, string roomID) => FindBy(graph, branchLocationID, roomID);
		}

		public class UK : PrimaryKeyOf<FSRoom>.By<recordID>
        {
            public static FSRoom Find(PXGraph graph, int? recordID) => FindBy(graph, recordID);
        }
