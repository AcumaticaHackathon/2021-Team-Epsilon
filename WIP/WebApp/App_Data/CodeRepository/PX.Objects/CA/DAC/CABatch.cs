...
namespace PX.Objects.CA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CABatch>.By<batchNbr>
		{
			public static CABatch Find(PXGraph graph, string batchNbr) => FindBy(graph, batchNbr);
		}

		public static class FK
		{
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CABatch>.By<cashAccountID> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<CABatch>.By<paymentMethodID> { }
			public class BankBAccount : CR.BAccount.PK.ForeignKeyOf<CABatch>.By<referenceID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<CABatch>.By<curyID> { }
			public class ReconciliationStatement : CA.CARecon.PK.ForeignKeyOf<CABatch>.By<cashAccountID, reconNbr> { }
		}
