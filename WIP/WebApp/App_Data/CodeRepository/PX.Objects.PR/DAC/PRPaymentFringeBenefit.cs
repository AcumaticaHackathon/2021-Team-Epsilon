...
namespace PX.Objects.PR
{
	...
	public class PRPaymentFringeBenefit : IBqlTable
	{
		...
		{
			public static PRPaymentFringeBenefit Find(PXGraph graph, int? recordID) => FindBy(graph, recordID);
		}

		public class UK : PrimaryKeyOf<PRPaymentFringeBenefit>.By<docType, refNbr, projectID, projectTaskID, laborItemID>
		{
			public static PRPaymentFringeBenefit Find(PXGraph graph, string docType, string refNbr, int? projectID, int? projectTaskID, int? laborItemID) =>
				FindBy(graph, docType, refNbr, projectID, projectTaskID, laborItemID);
		}
		...
		public static class FK
		{
			...
			public class ProjectTask : PMTask.PK.ForeignKeyOf<PRPaymentFringeBenefit>.By<projectTaskID> { }
		}
		#endregion
