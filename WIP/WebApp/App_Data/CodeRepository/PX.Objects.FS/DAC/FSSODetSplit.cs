...
{
    [Serializable]
    [PXCacheName(TX.TableName.FSSODetSplit)]
    public class FSSODetSplit : PX.Data.IBqlTable, ILSDetail
    {
        #region Keys
        public class PK : PrimaryKeyOf<FSSODetSplit>.By<srvOrdType, refNbr, lineNbr, splitLineNbr>
        {
            public static FSSODetSplit Find(PXGraph graph, string srvOrdType, string refNbr, int? lineNbr, int? splitLineNbr)
                => FindBy(graph, srvOrdType, refNbr, lineNbr, splitLineNbr);
        }
        public static class FK
        {
            public class ServiceOrder : FSServiceOrder.PK.ForeignKeyOf<FSSODetSplit>.By<srvOrdType, refNbr> { }
            public class ServiceOrderType : FSSrvOrdType.PK.ForeignKeyOf<FSSODetSplit>.By<srvOrdType> { }
            public class SrvOrdLine : FSSODet.PK.ForeignKeyOf<FSSODetSplit>.By<srvOrdType, refNbr, lineNbr> { }
            public class ParenLineSplit : FSSODetSplit.PK.ForeignKeyOf<FSSODetSplit>.By<srvOrdType, refNbr, lineNbr, parentSplitLineNbr> { }
            public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<FSSODetSplit>.By<inventoryID> { }
            public class SubItem : INSubItem.PK.ForeignKeyOf<FSSODetSplit>.By<subItemID> { }
            public class Site : INSite.PK.ForeignKeyOf<FSSODetSplit>.By<siteID> { }
            public class SiteStatus : IN.INSiteStatus.PK.ForeignKeyOf<FSSODetSplit>.By<inventoryID, subItemID, siteID> { }
            public class ToSite : INSite.PK.ForeignKeyOf<FSSODetSplit>.By<toSiteID> { }
            public class ToSiteStatus : IN.INSiteStatus.PK.ForeignKeyOf<FSSODetSplit>.By<inventoryID, subItemID, toSiteID> { }
            public class Location : INLocation.PK.ForeignKeyOf<FSSODetSplit>.By<locationID> { }
            public class LocationStatus : IN.INLocationStatus.PK.ForeignKeyOf<FSSODetSplit>.By<inventoryID, subItemID, siteID, locationID> { }
            public class LotSerialStatus : IN.INLotSerialStatus.PK.ForeignKeyOf<FSSODetSplit>.By<inventoryID, subItemID, siteID, locationID, lotSerialNbr> { }
            public class Shipment : SOShipment.PK.ForeignKeyOf<FSSODetSplit>.By<shipmentNbr> { }
            public class Vendor : AP.Vendor.PK.ForeignKeyOf<FSSODetSplit>.By<vendorID> { }
            public class POSite : INSite.PK.ForeignKeyOf<FSSODetSplit>.By<pOSiteID> { }
            public class POOrder : Objects.PO.POOrder.PK.ForeignKeyOf<FSSODetSplit>.By<pOType, pONbr> { }
            public class POLine : Objects.PO.POLine.PK.ForeignKeyOf<FSSODetSplit>.By<pOType, pONbr, pOLineNbr> { }
            public class POReceipt : Objects.PO.POReceipt.UK.ForeignKeyOf<FSSODetSplit>.By<pOReceiptType, pOReceiptNbr> { }
            public class ItemPlan : INItemPlan.PK.ForeignKeyOf<FSSODetSplit>.By<planID> { }
            //todo public class UnitOfMeasure : INUnit.PK.ForeignKeyOf<SOLineSplit>.By<inventoryID, uOM> { }

            [Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use ServiceOrderType instead.")]
            public class SrvOrdType : ServiceOrderType { }
        }
        #endregion
        ...
        [LocationAvail(typeof(FSSODetSplit.inventoryID), typeof(FSSODetSplit.subItemID), typeof(FSSODetSplit.siteID), typeof(FSSODetSplit.tranType), typeof(FSSODetSplit.invtMult))]
        ...
        [PXBool()]
        [PXUnboundDefault(typeof(Search<SOOrderType.requireShipping, Where<SOOrderType.orderType, Equal<Current<FSSrvOrdType.allocationOrderType>>>>))]
        ...
        [PXBool()]
        [PXUnboundDefault(typeof(Search<SOOrderType.requireAllocation, Where<SOOrderType.orderType, Equal<Current<FSSrvOrdType.allocationOrderType>>>>))]
        ...
        [PXBool()]
        [PXUnboundDefault(typeof(Search<SOOrderType.requireLocation, Where<SOOrderType.orderType, Equal<Current<FSSrvOrdType.allocationOrderType>>>>))]
        ...
        public class PXRefNoteAttribute : PX.Objects.Common.PXRefNoteBaseAttribute
        {
            ...
            public override void CacheAttached(PXCache sender)
            {
                ...
                {
                    PXCache cache = adapter.View.Graph.Caches[typeof(FSSODetSplit)];
                ...
                sender.Graph.Actions[ActionName] = (PXAction)Activator.CreateInstance(typeof(PXNamedAction<>).MakeGenericType(typeof(FSServiceOrder)), new object[] { sender.Graph, ActionName, del, new PXEventSubscriberAttribute[] { new PXUIFieldAttribute { MapEnableRights = PXCacheRights.Select } } });
            }

            public override void FieldSelecting(PXCache sender, PXFieldSelectingEventArgs e)
            {
                FSSODetSplit row = e.Row as FSSODetSplit;
