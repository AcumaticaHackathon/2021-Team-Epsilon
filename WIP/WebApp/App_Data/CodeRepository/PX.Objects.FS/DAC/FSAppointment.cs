...
namespace PX.Objects.FS
{
    ...
    public partial class FSAppointment : PX.Data.IBqlTable
	{
        ...
        {
            public static FSAppointment Find(PXGraph graph, int? appointmentID) => FindBy(graph, appointmentID);
        }
        ...
        public static class FK
        {
            ...
            public class DefaultTask : PMTask.PK.ForeignKeyOf<FSAppointment>.By<dfltProjectTaskID> { }
        ...
        [PXUIEnabled(typeof(Where<Current<FSServiceOrder.sOID>, Less<Zero>,
                              And<Current<FSServiceContract.billingType>, 
                                    NotEqual<FSServiceContract.billingType.StandardizedBillings>>>))]
        ...
        [PXUIField(DisplayName = "Estimated Service Duration", Enabled = false)]
        ...
        [PXUIField(DisplayName = "Actual Service Duration", Enabled = false)]
        [PXDefault(0, PersistingCheck = PXPersistingCheck.Nothing)]
