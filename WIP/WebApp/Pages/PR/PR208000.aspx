...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.PR.PRTaxMaintenance" PrimaryView="Filter">
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXTab ID="tab" runat="server" DataSourceID="ds" Width="100%" DataMember="Filter">
		<Items>
			<px:PXTabItem Text="Tax Maintenance" Visible="false">
				<Template>
					<px:PXFormView ID="fakeFormForImport" runat="server" DataMember="Filter" Caption="Tax Maintenance">
						<Template>
							<px:PXCheckBox ID="fakeFieldForImport" runat="server" DataField="FilterStates" />
						</Template>
					</px:PXFormView>
				</Template>
			</px:PXTabItem>
			<px:PXTabItem Text="Tax Codes">
				<Template>
					<px:PXSplitContainer ID="splitContainerTaxes" runat="server" PositionInPercent="true" SplitterPosition="65" Orientation="Vertical">
						...
						<Template2>
							<px:PXGrid ID="grdTaxAttributes" runat="server" DataSourceID="ds" Width="100%" SkinID="Inquire" MatrixMode="true" Caption="Tax Settings"
								CaptionVisible="true" FilesIndicator="False" CssClass="SettingTable">
								<Levels>
			...
			<px:PXTabItem Text="Company Tax Settings">
				<Template>
					<px:PXFormView ID="filterForm" runat="server" DataMember="Filter">
						<Template>
					...
					<px:PXGrid ID="grdCompanyAttributes" runat="server" DataSourceID="ds" Width="100%" SkinID="Inquire" MatrixMode="True" Style="margin-top: 10px"
						FilesIndicator="False" CssClass="SettingTable">
						<Levels>
