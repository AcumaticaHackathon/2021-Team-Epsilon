...
namespace PX.Objects.FS
{
    public class ServiceSelectionHelper
    {
        ...
        private static IEnumerable<EmployeeGridFilter> PopulateEmployeeFilter(object employeesView)
        {
            ...
            {
                AppointmentEntry.AppointmentServiceEmployees_View appEmployeeView = (AppointmentEntry.AppointmentServiceEmployees_View)employeesView;
            ...
            {
                ServiceOrderEntry.ServiceOrderEmployees_View soEmployeeView = (ServiceOrderEntry.ServiceOrderEmployees_View)employeesView;
