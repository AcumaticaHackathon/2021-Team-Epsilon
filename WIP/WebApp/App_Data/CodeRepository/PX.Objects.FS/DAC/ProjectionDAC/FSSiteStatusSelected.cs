...
namespace PX.Objects.FS
{
	...
	LeftJoin<INUnit,
		...
		Where2<
			Where<CurrentValue<FSServiceOrder.customerID>, IsNotNull,
				...
				Or<CurrentValue<FSSrvOrdType.behavior>, Equal<FSSrvOrdType.behavior.Values.internalAppointment>>>>,
    ...
    public partial class FSSiteStatusSelected : IBqlTable
	{
        ...
        {
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<FSSiteStatusSelected>.By<inventoryID> { }
			public class ItemClass : IN.INItemClass.PK.ForeignKeyOf<FSSiteStatusSelected>.By<itemClassID> { }
			public class PreferredVendor : AP.Vendor.PK.ForeignKeyOf<FSSiteStatusSelected>.By<preferredVendorID> { }
			public class Site : INSite.PK.ForeignKeyOf<FSSiteStatusSelected>.By<siteID> { }
			public class SubItem : INSubItem.PK.ForeignKeyOf<FSSiteStatusSelected>.By<subItemID> { }
			public class PriceClass : INPriceClass.PK.ForeignKeyOf<FSSiteStatusSelected>.By<priceClassID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<FSSiteStatusSelected>.By<curyID> { }
		}
        #endregion
