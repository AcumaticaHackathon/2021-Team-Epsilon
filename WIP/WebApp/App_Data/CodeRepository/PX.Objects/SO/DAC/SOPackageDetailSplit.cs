...
namespace PX.Objects.SO
{
	...
	public partial class SOPackageDetailSplit : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class Shipment : SOShipment.PK.ForeignKeyOf<SOPackageDetailSplit>.By<shipmentNbr> { }
			public class ShipmentLine : SOShipLine.PK.ForeignKeyOf<SOPackageDetailSplit>.By<shipmentNbr, shipmentLineNbr> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<SOPackageDetailSplit>.By<inventoryID> { }
			public class SubItem : INSubItem.PK.ForeignKeyOf<SOPackageDetailSplit>.By<subItemID> { }
			//todo public class UnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<SOPackageDetailSplit>.By<inventoryID, uOM> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use ShipmentLine instead.")]
			public class ShipLine : ShipmentLine { }
		}
		#endregion
