...
namespace PX.Commerce.BigCommerce
{
	...
	public class BCImageProcessor : BCProcessorBulkBase<BCImageProcessor, BCImageEntityBucket, MappedStockItem>, IProcessor
	{
		...
		public override List<BCImageEntityBucket> FetchBucketsImport(List<BCSyncStatus> ids)
		{
			throw new NotImplementedException();
		}
		#endregion
						...
						if (files != null && files.Count() > 0)
						{
							...
							if (productsImageData != null)
							{
								...
								if (imageUploadData != null)
								{
									...
									productImageDataProvider.Delete(productsImageData.Id.ToString(), localObj.ExternalInventoryID);
									productsImageData = productImageDataProvider.Create(imageUploadData, localObj.ExternalInventoryID);
		...
		public override List<BCImageEntityBucket> FetchBucketsExport(List<BCSyncStatus> ids)
		{
