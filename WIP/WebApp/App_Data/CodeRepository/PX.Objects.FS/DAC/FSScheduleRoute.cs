...
namespace PX.Objects.FS
{
    ...
    [PXCacheName(TX.TableName.FSScheduleRoute)]
    public class FSScheduleRoute : PX.Data.IBqlTable
	{
        #region Keys
        public class PK : PrimaryKeyOf<FSScheduleRoute>.By<scheduleID>
        {
            public static FSScheduleRoute Find(PXGraph graph, int? scheduleID) => FindBy(graph, scheduleID);
        }

        public static class FK
        {
            public class Schedule : FSSchedule.PK.ForeignKeyOf<FSScheduleRoute>.By<scheduleID> { }
            public class DfltRoute : FSRoute.PK.ForeignKeyOf<FSScheduleRoute>.By<dfltRouteID> { }
            public class MondayRoute : FSRoute.PK.ForeignKeyOf<FSScheduleRoute>.By<routeIDMonday> { }
            public class TuesdayRoute : FSRoute.PK.ForeignKeyOf<FSScheduleRoute>.By<routeIDTuesday> { }
            public class WednesdayRoute : FSRoute.PK.ForeignKeyOf<FSScheduleRoute>.By<routeIDWednesday> { }
            public class ThursdayRoute : FSRoute.PK.ForeignKeyOf<FSScheduleRoute>.By<routeIDThursday> { }
            public class FridayRoute : FSRoute.PK.ForeignKeyOf<FSScheduleRoute>.By<routeIDFriday> { }
            public class SaturdayRoute : FSRoute.PK.ForeignKeyOf<FSScheduleRoute>.By<routeIDSaturday> { }
            public class SundayRoute : FSRoute.PK.ForeignKeyOf<FSScheduleRoute>.By<routeIDSunday> { }
        }
