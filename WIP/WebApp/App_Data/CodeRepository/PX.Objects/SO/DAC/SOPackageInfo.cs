...
namespace PX.Objects.SO
{
	...
	public partial class SOPackageInfo : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class Box : CSBox.PK.ForeignKeyOf<SOPackageInfo>.By<boxID> { }
			//todo public class UnitOfMeasure : INUnit.PK.ForeignKeyOf<SOPackageInfo>.By<inventoryID, qtyUOM> { }
		}
		#endregion
	...
	public partial class SOCarrierRate : IBqlTable
	{
		...
		public abstract class canBeSelected : PX.Data.BQL.BqlBool.Field<canBeSelected> { }
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<SOPackageInfoEx>.By<orderType, orderNbr, lineNbr>
		{
			public static SOPackageInfoEx Find(PXGraph graph, string orderType, string orderNbr, int? lineNbr)
				=> FindBy(graph, orderType, orderNbr, lineNbr);
		}
		public new static class FK
		{
			public class Order : SOOrder.PK.ForeignKeyOf<SOPackageInfoEx>.By<orderType, orderNbr> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<SOPackageInfoEx>.By<inventoryID> { }
			public class Site : INSite.PK.ForeignKeyOf<SOPackageInfoEx>.By<siteID> { }
			public class Box : CSBox.PK.ForeignKeyOf<SOPackageInfoEx>.By<boxID> { }
			//todo public class UnitOfMeasure : INUnit.PK.ForeignKeyOf<SOPackageInfoEx>.By<inventoryID, qtyUOM> { }
		}
		#endregion
