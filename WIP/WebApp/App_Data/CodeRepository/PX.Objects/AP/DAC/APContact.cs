...
namespace PX.Objects.AP
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<APContact>.By<contactID>
		{
			public static APContact Find(PXGraph graph, Int32? addressID) => FindBy(graph, addressID);
		}
		public static class FK
		{
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APContact>.By<vendorID> { }
			public class VendorContact : CR.Contact.PK.ForeignKeyOf<APContact>.By<vendorContactID> { }
		}
		#endregion
