...
namespace PX.Objects.CR
{
	...
	public class CRLead : Contact
	{
		...
		{
			public class Class : CR.CRCaseClass.PK.ForeignKeyOf<CRLead>.By<classID> { }
			...
			public class Owner : EP.EPEmployee.PK.ForeignKeyOf<CRLead>.By<ownerID> { }
		...
		[PXSelector(typeof(
			...
			.Where<
				...
				>
				.And<BAccount.status.IsNotEqual<AR.CustomerStatus.inactive>>
			>
		...
		[ContactRaw(typeof(CRLead.bAccountID), WithContactDefaultingByBAccount = true, BqlField = typeof(Standalone.CRLead.refContactID))]
