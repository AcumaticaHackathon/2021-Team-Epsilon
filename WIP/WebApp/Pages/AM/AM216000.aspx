...
ValidateRequest="false" CodeFile="AM216000.aspx.cs" Inherits="Page_AM216000"
Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" TypeName="PX.Objects.AM.VisualBOMMaint" PrimaryView="Filter"
                     Visible="True" Width="100%" BorderStyle="NotSet">
                <DataTrees>
            <px:PXTreeDataMember TreeView="Tree" TreeKeys="ProductID, ParentID, OperationID, LineID" />
                    </DataTrees>
        <CallbackCommands>
    ...
    <AutoSize Enabled="true" Container="Window" />
        <Template1>
            <px:PXTreeView ID="edTree1" runat="server" DataSourceID="ds" PopulateOnDemand="True" RootNodeText="BOM" ExpandDepth="10" SelectFirstNode="true"
                ShowRootNode="false" Caption="Features" CaptionVisible="false" AllowCollapse="False" Height="180px" DataMember="Tree" >
                <DataBindings>
                    <px:PXTreeItemBinding DataMember="Tree" TextField="Label" ValueField="ParentID" ImageUrlField="Icon" ToolTipField="ToolTip" />
                </DataBindings>
                <AutoCallBack Command="Refresh" Target="form" ActiveBehavior="true">
                    <Behavior RepaintControlsIDs="form, formOper, gridMatl, gridStep, gridTool, gridOvhd" RepaintControls="All" />
                </AutoCallBack>
                <AutoSize Enabled="True" />
            </px:PXTreeView>
        </Template1>
    <Template2>
                <px:PXFormView ID="formFilter" runat="server" Width="100%" Caption="BOM of Material" DataMember="Filter" DataSourceID="ds" 
                               NotifyIndicator="True" NoteIndicator="true" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity" DefaultControlID="edBOMIDFilter">
                        <Template>
                            <px:PXLayoutRule ID="PXLayoutRule15" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="M" />
                            <px:PXSelector ID="edBOMIDFilter" runat="server" AutoRefresh="True" DataField="BOMID" DataSourceID="ds" CommitChanges="true" FilterByAllFields="True" />
                            <px:PXSelector ID="edRevisionIDFilter" runat="server" DataField="RevisionID" CommitChanges="True" AutoRefresh="True" DataSourceID="ds" />
                            <px:PXDropDown CommitChanges="True" ID="edStatusFilter" runat="server" AllowNull="False" DataField="Status" />
                            <px:PXTextEdit ID="edDescrFilter" runat="server" DataField="Descr" CommitChanges="True" />
                            <px:PXLayoutRule ID="PXLayoutRule3" runat="server" StartColumn="true" LabelsWidth="S" ControlSize="L"/>
                            <px:PXSegmentMask ID="edInventoryIDFilter" runat="server" DataField="InventoryID" DisplayMode="Hint" AllowEdit="True" CommitChanges="True" />
                            <px:PXSegmentMask ID="edSubItemIDFilter" runat="server" DataField="SubItemID" CommitChanges="True" AutoRefresh="True" />
                            <px:PXSelector ID="edSiteIDFilter" runat="server" DataField="SiteID" DisplayMode="Hint" AllowEdit="True" CommitChanges="True" />
                            <px:PXLayoutRule ID="PXLayoutRule1" runat="server" Merge="true" LabelsWidth="S" ControlSize="SM"/>
                            <px:PXDateTimeEdit ID="edEffStartDateFilter" runat="server" DataField="EffStartDate"/>
                            <px:PXDateTimeEdit ID="edEffEndDateFilter" runat="server" DataField="EffEndDate"/>
                        </Template>
                    </px:PXFormView>
                    <px:PXFormView ID="form" runat="server" Width="100%" Caption="BOM of Material" DataMember="BomItemRecords" DataSourceID="ds" 
                               NotifyIndicator="True" NoteIndicator="true" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity">
                        <Template>
                            <px:PXLayoutRule ID="PXLayoutRule15" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="M" />
                        ...
                        <Parameters>
                            <px:PXControlParam ControlID="edTree1" Name="parentID" PropertyName="SelectedValue" />                            
                        </Parameters>
                    </px:PXFormView>
                ...
                <Items>
                    ...
                    <px:PXTabItem Text="Operation" LoadOnDemand="False" RepaintOnDemand="False" >
                        <Template>
                            <px:PXFormView ID="formOper" runat="server" Width="100%" Caption="BOM of Material" DataMember="BomOperRecords" DataSourceID="ds" 
                                   NotifyIndicator="True" NoteIndicator="true" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity" DefaultControlID="edOperationCD">
                                <Template>
                                        <px:PXLayoutRule ID="PXLayoutRule16" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="M" />
                                        ...
                                        <px:PXLayoutRule ID="PXLayoutRule12" runat="server" StartColumn="true" LabelsWidth="S" ControlSize="L"/>
