...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100"
		...
		<Template>
			...
			<px:PXDropDown ID="edFileFormat" runat="server" DataField="FileFormat" CommitChanges="True" />
			...
			<px:PXCheckBox ID="edReportingDirectSalesOnly" runat="server" DataField="ReportingDirectSalesOnly" CommitChanges="true"/>
