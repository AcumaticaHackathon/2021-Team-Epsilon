...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.AR.ARPriceWorksheetMaint" PrimaryView="Document" HeaderDescriptionField="Descr">
		<CallbackCommands>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
		...
		<Levels>
			<px:PXGridLevel DataMember="Details">
				<RowTemplate>
					...
					<px:PXTextEdit ID="edTaxCategoryID" runat="server" DataField="TaxCategoryID" />
				</RowTemplate>
				<Columns>
	...
	<px:PXSmartPanel ID="PanelCalculatePrices" runat="server" CommandSourceID="ds" Caption="Calculate Pending Prices" Key="CalculatePricesSettings" 
         CaptionVisible="true" DesignView="Content" LoadOnDemand="true" ShowAfterLoad="true" 
         AutoCallBack-Enabled="true" AutoCallBack-Target="massUpdateForm" AutoCallBack-Command="Refresh"
         CallBackMode-CommitChanges="True" CallBackMode-PostData="Page"  AcceptButtonID="btnSave2">
		<div style="padding: 5px">
		...
		<px:PXPanel ID="PXPanel2" runat="server" SkinID="Buttons">
			<px:PXButton ID="btnSave2" runat="server" DialogResult="OK" Text="Update" CommandSourceID="ds">
			</px:PXButton>
