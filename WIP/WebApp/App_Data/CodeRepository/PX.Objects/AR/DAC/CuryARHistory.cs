...
namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CuryARHistory>.By<branchID, accountID, subID, curyID, customerID, finPeriodID>
		{
			public static CuryARHistory Find(PXGraph graph, Int32? branchID, Int32? accountID, Int32? subID, String curyID, Int32? customerID, String finPeriodID) => FindBy(graph, branchID, accountID, subID, curyID, customerID, finPeriodID);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<CuryARHistory>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<CuryARHistory>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<CuryARHistory>.By<subID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<CuryARHistory>.By<curyID> { }
			public class Customer : AR.Customer.PK.ForeignKeyOf<CuryARHistory>.By<customerID> { }
		}
		#endregion
