...
namespace PX.Objects.SO
{
	...
	public class SOShipLineSplitPackage : IBqlTable
	{
		...
		{
			public class Shipment : SOShipment.PK.ForeignKeyOf<SOShipLineSplitPackage>.By<shipmentNbr> { }
			public class ShipmentLine : SOShipLine.PK.ForeignKeyOf<SOShipLineSplitPackage>.By<shipmentNbr, shipmentLineNbr> { }
			public class ShipmentLineSplit : Objects.SO.SOShipLineSplit.PK.ForeignKeyOf<SOShipLineSplitPackage>.By<shipmentNbr, shipmentLineNbr, shipmentSplitLineNbr> { }
			public class PackageDetail : Objects.SO.SOPackageDetail.PK.ForeignKeyOf<SOShipLineSplitPackage>.By<shipmentNbr, packageLineNbr> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<SOShipLineSplitPackage>.By<inventoryID> { }
			public class SubItem : INSubItem.PK.ForeignKeyOf<SOShipLineSplitPackage>.By<subItemID> { }
			//todo public class UnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<SOShipLineSplitPackage>.By<inventoryID, uOM> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use PackageDetail instead.")]
			public class SOPackageDetail : PackageDetail { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use ShipmentLineSplit instead.")]
			public class SOShipLineSplit : ShipmentLineSplit { }
		}
		#endregion
