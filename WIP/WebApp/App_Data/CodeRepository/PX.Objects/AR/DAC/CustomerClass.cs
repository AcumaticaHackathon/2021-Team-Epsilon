...
namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CustomerClass>.By<customerClassID>
		{
			public static CustomerClass Find(PXGraph graph, String customerClassID) => FindBy(graph, customerClassID);
		}
		public static class FK
		{
			public class Terms : CS.Terms.PK.ForeignKeyOf<CustomerClass>.By<termsID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<CustomerClass>.By<taxZoneID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<CustomerClass>.By<curyID> { }
			public class CurrencyRateType : CM.CurrencyRateType.PK.ForeignKeyOf<CustomerClass>.By<curyRateTypeID> { }

			public class ARAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<aRAcctID> { }
			public class ARSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<aRSubID> { }

			public class DiscountAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<discountAcctID> { }
			public class DiscountSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<discountSubID> { }

			public class CashDiscountAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<discTakenAcctID> { }
			public class CashDiscountSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<discTakenSubID> { }

			public class SalesAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<salesAcctID> { }
			public class SalesSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<salesSubID> { }

			public class COGSAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<cOGSAcctID> { }
			public class COGSSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<cOGSSubID> { }

			public class FreightAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<freightAcctID> { }
			public class FreightSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<freightSubID> { }

			public class MiscAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<miscAcctID> { }
			public class MiscSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<miscSubID> { }

			public class PrepaymentAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<prepaymentAcctID> { }
			public class PrepaymentSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<prepaymentSubID> { }

			public class UnrealizedGainAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<unrealizedGainAcctID> { }
			public class UnrealizedGainSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<unrealizedGainSubID> { }

			public class UnrealizedLossAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<unrealizedLossAcctID> { }
			public class UnrealizedLossSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<unrealizedLossSubID> { }

			public class RetainageAccount : GL.Account.PK.ForeignKeyOf<CustomerClass>.By<retainageAcctID> { }
			public class RetainageSubaccount : GL.Sub.PK.ForeignKeyOf<CustomerClass>.By<retainageSubID> { }

			public class DefaultPaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<CustomerClass>.By<defPaymentMethodID> { }

			public class StatementCycle : AR.ARStatementCycle.PK.ForeignKeyOf<CustomerClass>.By<statementCycleId> { }

			public class Country : CS.Country.PK.ForeignKeyOf<CustomerClass>.By<countryID> { }

			public class SalesPerson : AR.SalesPerson.PK.ForeignKeyOf<CustomerClass>.By<salesPersonID> { }
		}
		#endregion
		...
		#endregion
		#region SavePaymentProfiles
		public abstract class savePaymentProfiles : PX.Data.BQL.BqlString.Field<savePaymentProfiles> { }
		[PXDBString(1, IsFixed = true)]
		[PXDefault(SavePaymentProfileCode.Allow)]
