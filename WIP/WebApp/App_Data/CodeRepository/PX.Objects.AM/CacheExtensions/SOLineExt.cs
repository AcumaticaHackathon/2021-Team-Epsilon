...
namespace PX.Objects.AM.CacheExtensions
{
    ...
    public sealed class SOLineExt : PXCacheExtension<SOLine>, IMfgConfigOrderLineExtension
    {
        ...
        #endregion
        #region AMSchdNoteID
        public abstract class aMSchdNoteID : PX.Data.BQL.BqlGuid.Field<aMSchdNoteID> { }

        [PXDBGuid]
        public Guid? AMSchdNoteID { get; set; }
        #endregion
        #region AMCTPAccepted
        public abstract class aMCTPAccepted : PX.Data.BQL.BqlBool.Field<aMCTPAccepted> { }

        [PXDBBool]
        [PXDefault(false, PersistingCheck = PXPersistingCheck.Nothing)]
        [PXUIField(DisplayName = "CTP Accepted", Enabled = true)]
        public bool? AMCTPAccepted { get; set; }
        #endregion
        #region AMOrigRequestDate
        public abstract class aMOrigRequestDate : PX.Data.BQL.BqlDateTime.Field<aMOrigRequestDate> { }

        [PXDBDate()]
        [PXUIField(DisplayName = "Original Request Date", Enabled = false)]
        public DateTime? AMOrigRequestDate { get; set; }
        #endregion
