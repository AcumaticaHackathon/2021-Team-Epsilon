...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FABookPeriodSetup>.By<bookID, periodNbr>
		{
			public static FABookPeriodSetup Find(PXGraph graph, Int32? bookID, String periodNbr) => FindBy(graph, bookID, periodNbr);
		}
		public static class FK
		{
			public class Book : FA.FABook.PK.ForeignKeyOf<FABookPeriodSetup>.By<bookID> { }
		}
		#endregion
		#region BookID
