...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="CAReconRecords" TypeName="PX.Objects.CA.CAReconEntry">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Visible="False" CommitChanges="True" Name="releaseAdjustment" DependOnGrid="grid" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXSmartPanel ID="AddFilterPanel" Key="AddFilter" runat="server" Caption="Quick Transaction" CaptionVisible="True" AutoCallBack-Target="AddFilter" AutoCallBack-Command="Refresh" Overflow="Hidden">
        ...
        <px:PXPanel ID="PXPanel1" runat="server" SkinID="Buttons">
            ...
            <px:PXButton ID="Release" runat="server" Text="Release" DialogResult="Yes" SyncVisible="false">
				<AutoCallBack Command="ReleaseAdjustment" Target="ds" />
			</px:PXButton>
    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" Caption="Reconciliation Summary" DataMember="CAReconRecords" NoteIndicator="True" FilesIndicator="True" LinkIndicator="True" BPEventsIndicator="True"
        ...
        <Levels>
            <px:PXGridLevel DataMember="CAReconTranRecords">
                <RowTemplate>
                    ...
                    <px:PXTextEdit ID="edBusinessAccountName" runat="server" DataField="BusinessAccountName" />
                </RowTemplate>
                <Columns>
                    ...
                    <px:PXGridColumn DataField="BusinessAccountName" />
