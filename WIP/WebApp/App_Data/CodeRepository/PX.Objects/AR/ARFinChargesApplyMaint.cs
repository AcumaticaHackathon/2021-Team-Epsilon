...
namespace PX.Objects.AR
{
	...
	public class ARFinChargesApplyMaint : PXGraph<ARFinChargesApplyMaint>
	{
		...
		public partial class ARFinChargesApplyParameters : IBqlTable
		{
			...
			[PXRestrictor(typeof(Where<Customer.status, NotEqual<CustomerStatus.inactive>,
				And<Customer.status, NotEqual<CustomerStatus.hold>>>), Messages.CustomerIsInStatus, typeof(Customer.status), ReplaceInherited = true)]
		...
		public PXSelectJoin<
				...
				Where<
					...
					And<Customer.status, NotEqual<CustomerStatus.hold>,
					And<Match<Current<AccessInfo.userName>>>>>>> CustomersInStatementCycle;
