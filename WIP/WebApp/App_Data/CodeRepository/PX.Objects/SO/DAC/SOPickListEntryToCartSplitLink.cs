...
namespace PX.Objects.SO
{
	...
	public class SOPickListEntryToCartSplitLink : IBqlTable
	{
		...
		{
			public static SOPickListEntryToCartSplitLink Find(PXGraph graph, string worksheetNbr, int? pickerNbr, int? entryNbr, int? siteID, int? cartID, int? cartSplitLineNbr)
				=> FindBy(graph, worksheetNbr, pickerNbr, entryNbr, siteID, cartID, cartSplitLineNbr);
		}
