...
namespace PX.Objects.FS
{
    ...
    public class FSLicense : PX.Data.IBqlTable
    {
        ...
        {
            public static FSLicense Find(PXGraph graph, int? licenseID) => FindBy(graph, licenseID);
        }
        public class UK : PrimaryKeyOf<FSLicense>.By<refNbr>
        {
            public static FSLicense Find(PXGraph graph, string refNbr) => FindBy(graph, refNbr);
        }
