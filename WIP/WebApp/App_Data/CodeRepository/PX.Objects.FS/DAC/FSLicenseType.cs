...
{	
	...
	public class FSLicenseType : PX.Data.IBqlTable
	{
		...
		{
			public static FSLicenseType Find(PXGraph graph, int? licenseTypeID) => FindBy(graph, licenseTypeID);
		}

		public class UK : PrimaryKeyOf<FSLicenseType>.By<licenseTypeCD>
        {
            public static FSLicenseType Find(PXGraph graph, string licenseTypeCD) => FindBy(graph, licenseTypeCD);
        }
		#endregion
