...
namespace PX.Objects.TX
{
	...
	{	
        ...
        protected IEnumerable reportLine()
        {
			...
			TaxBucketAnalizer analyzerTax = new TaxBucketAnalizer(this, Report.Current.VendorID.Value, TaxReportLineType.TaxAmount);
			Dictionary<int, List<int>> taxBucketsDict = analyzerTax.AnalyzeBuckets(showTaxZones);
			TaxBucketAnalizer testAnalyzerTaxable = new TaxBucketAnalizer(this, (int)this.Report.Current.VendorID, TaxReportLineType.TaxableAmount);
        ...
        private void UpdateNet(object row)
		{
			...
			{
				foreach (TaxReportLine reportrow in PXSelect<TaxReportLine, Where<TaxReportLine.vendorID, Equal<Required<TaxReport.vendorID>>>>.Select(this,currow.VendorID))
				{
		...
		protected virtual void TaxReport_RowSelected(PXCache sender, PXRowSelectedEventArgs e)
		{
			...
			CheckReportSettingsEditableAndSetWarningTo<TaxReport.vendorID>(this, sender, vendor, vendor.VendorID);
		}
		...
		public override void Persist()
		{
			...
			CheckReportSettingsEditable(this, Report.Current.VendorID);
