...
namespace PX.Objects.AM
{
	...
	{
		public override void Configure(PXScreenConfiguration config) => Configure(config.GetScreenConfigurationContext<ECRMaint, AMECRItem>());
			...
			context.AddScreenConfigurationFor(screen =>
			{
				return screen
					...
					.WithActions(actions => {
						...
						actions.Add(g => g.CreateECO, c => c.InFolder(FolderType.ActionsFolder));
					});
			});
