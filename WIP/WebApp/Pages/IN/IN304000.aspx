...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.INTransferEntry" PrimaryView="transfer" HeaderDescriptionField="TranDesc">
        <CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Width="100%" Caption="Document Summary" DataMember="transfer"
        ...
        <Template>
            ...
            <px:PXSegmentMask CommitChanges="True" ID="edToSiteID" runat="server" DataField="ToSiteID" AutoRefresh="True" DataSourceID="ds" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
            ...
            <px:PXTabItem Text="Details">
                <Template>
                    <px:PXGrid ID="grid" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100; left: 0px; top: 0px;" Width="100%"
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LSINTran_binLotSerial" CommandSourceID="ds" DependOnGrid="grid" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Style="z-index: 108; left: 252px; position: absolute; top: 531px; height: 500px;"
        Width="764px" Caption="Line Details" DesignView="Hidden" CaptionVisible="True" Key="lsselect" AutoCallBack-Command="Refresh"
