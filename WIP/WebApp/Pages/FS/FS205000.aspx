            ...
            <Levels>
                <px:PXGridLevel 
                    ...
                    <RowTemplate>
                        ...
                        <px:PXSelector runat="server" ID="smInstServiceOrderRefNbr" DataField="InstServiceOrderRefNbr" AllowEdit="true"> 
                        </px:PXSelector>
                        <px:PXSelector runat="server" ID="smInstAppointmentRefNbr" DataField="InstAppointmentRefNbr" AllowEdit="true"> 
                        </px:PXSelector>
                    ...
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="InstServiceOrderRefNbr">
                        </px:PXGridColumn> 
                        <px:PXGridColumn DataField="InstAppointmentRefNbr">
                        </px:PXGridColumn>        
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" MarkRequired="Dynamic"
        ActivityIndicator="True" Width="100%" DataMember="EquipmentRecords" NoteIndicator="True" TabIndex="29900" AllowCollapse="True" DefaultControlID="edDescr">
        <Template>
            ...
            <px:PXGroupBox 
                ...
                <Template>
                    ...
                    <px:PXSegmentMask ID="edOwnerID" runat="server" DataField="OwnerID" AllowEdit="True" AutoRefresh="True" AllowAddNew="True" CommitChanges="true">
                    </px:PXSegmentMask>
                </Template>
            </px:PXGroupBox>
            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="S">
            ...
            <px:PXGroupBox 
                ...
                <Template>
                    ...
                    <px:PXSegmentMask ID="edCustomerID" runat="server" DataField="CustomerID" AllowEdit="True" AllowAddNew="True" AutoRefresh="True" CommitChanges="true">
                    </px:PXSegmentMask>
        ...
        <Items>
            <px:PXTabItem Text="General Info">
                <Template>
                    ...
                    <px:PXSelector ID="edInstServiceOrderRefNbr" runat="server" DataField="InstServiceOrderRefNbr" AllowEdit="True" Enabled="False">
                    </px:PXSelector>
                    <px:PXSelector ID="edInstAppointmentRefNbr" runat="server" DataField="InstAppointmentRefNbr" AllowEdit="True" Enabled="False">
                    </px:PXSelector>
                    ...
                    <px:PXSelector ID="edDispServiceOrderRefNbr" runat="server" DataField="DispServiceOrderRefNbr" AllowEdit="True" Enabled="False">
                    </px:PXSelector>
                    <px:PXSelector ID="edDispAppointmentRefNbr" runat="server" DataField="DispAppointmentRefNbr" AllowEdit="True" Enabled="False">
                    </px:PXSelector>
                        ...
                        <Levels>
                            <px:PXGridLevel 
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSelector runat="server" ID="edInstServiceOrderRefNbr" DataField="InstServiceOrderRefNbr" AllowEdit="true"> 
                                    </px:PXSelector>
                                    <px:PXSelector runat="server" ID="edInstAppointmentRefNbr" DataField="InstAppointmentRefNbr" AllowEdit="true"> 
                                    </px:PXSelector>
