...
namespace PX.Objects.FS
{
    ...
    using ServiceOrderCanBeCompleted = Where<Current<FSServiceOrder.openDoc>, Equal<True>>;
    using ServiceOrderCanBeClosed = Where<Current<FSServiceOrder.completed>, Equal<True>, Or<Current<FSServiceOrder.openDoc>, Equal<True>>>;
    ...
    public class FSSrvOrdQuickProcessParams : SOQuickProcessParameters
    {
        ...
        [PXQuickProcess.Step.IsStartPoint(typeof(ServiceOrderCanBeClosed))]
        [PXQuickProcess.Step.IsInsertedJustBefore(typeof(generateInvoiceFromServiceOrder))]
        [PXQuickProcess.Step.RequiresSteps(typeof(completeServiceOrder))]
