...
namespace PX.Objects.FS
{
    ...
    public class FSScheduleDet : PX.Data.IBqlTable, ISortOrder
    {
        ...
        {
            public static FSScheduleDet Find(PXGraph graph, int? scheduleID, int? lineNbr) => FindBy(graph, scheduleID, lineNbr);
        }
        public class UK : PrimaryKeyOf<FSScheduleDet>.By<scheduleID, scheduleDetID>
        {
            public static FSScheduleDet Find(PXGraph graph, int? scheduleID, int? scheduleDetID) => FindBy(graph, scheduleID, scheduleDetID);
        }
        ...
        public static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSScheduleDet>.By<projectTaskID> { }
