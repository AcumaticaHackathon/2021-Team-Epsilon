...
namespace PX.Objects.DR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<DRSchedule>.By<scheduleID>
		{
			public static DRSchedule Find(PXGraph graph, int? scheduleID) => FindBy(graph, scheduleID);
		}
		public class UK : PrimaryKeyOf<DRSchedule>.By<scheduleNbr>
		{
			public static DRSchedule Find(PXGraph graph, string scheduleNbr) => FindBy(graph, scheduleNbr);
		}
		public static class FK
		{
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<DRSchedule>.By<curyInfoID> { }
			public class Currency : PX.Objects.CM.Currency.PK.ForeignKeyOf<DRSchedule>.By<curyID> { }
			public class BusinessAccount : CR.BAccount.PK.ForeignKeyOf<DRSchedule>.By<bAccountID> { }
			public class Location : CR.Location.PK.ForeignKeyOf<DRSchedule>.By<bAccountID, bAccountLocID> { }
			public class Project : PM.PMProject.PK.ForeignKeyOf<DRSchedule>.By<projectID> { }
			public class ProjectTask : CT.ContractTask.PK.ForeignKeyOf<DRSchedule>.By<projectID, taskID> { }
		}
		#endregion
		#region ScheduleID
