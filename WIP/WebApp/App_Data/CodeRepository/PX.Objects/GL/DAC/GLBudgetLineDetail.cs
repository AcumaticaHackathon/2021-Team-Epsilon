...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLBudgetLineDetail>.By<branchID, ledgerID, groupID, finYear, finPeriodID>
		{
			public static GLBudgetLineDetail Find(PXGraph graph, int? branchID, int? ledgerID, Guid? groupID, string finYear, string finPeriodID) => FindBy(graph, branchID, ledgerID, groupID, finYear, finPeriodID);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<GLBudgetLineDetail>.By<branchID> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<GLBudgetLineDetail>.By<ledgerID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<GLBudgetLineDetail>.By<accountID> { }
			public class Subaccount : GL.Sub.PK.ForeignKeyOf<GLBudgetLineDetail>.By<subID> { }
		}
		#endregion
