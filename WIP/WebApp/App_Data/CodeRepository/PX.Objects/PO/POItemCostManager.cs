...
namespace PX.Objects.PO
{
	...
	public static class POItemCostManager
	{
		...
		private static ItemCost FetchStdCost(PXGraph graph, InventoryItem item, string baseCuryID, DateTime? docDate)
		{
			...
			{
				if ((baseCuryID ?? CurrencyCollection.GetBaseCurrency()?.CuryID) == CurrencyCollection.GetBaseCurrency()?.CuryID)
				{
				...
				else
				{
					InventoryItemCurySettings curySettings =
						InventoryItemCurySettings.PK.Find(graph, item.InventoryID, baseCuryID);
		...
		public static CurrencyInfo FetchCuryInfo<CuryInfoIDField>(PXGraph graph, object row)
			where CuryInfoIDField : IBqlField
		{
			...
			return CurrencyInfoAttribute.GetCurrencyInfo<CuryInfoIDField>(graph.Caches[row.GetType()], row);
		}
		...
		public static decimal? Fetch<InventoryIDField, CuryInfoIDField>(PXGraph graph, object row, int? vendorID, int? vendorLocationID, DateTime? docDate, string curyID, int? inventoryID, int? subItemID, int? siteID, string uom)
			...
			where CuryInfoIDField : IBqlField
		{
			CurrencyInfo info = FetchCuryInfo<CuryInfoIDField>(graph, row);
			ItemCost price = Fetch(graph, vendorID, vendorLocationID, docDate, curyID, info?.BaseCuryID, inventoryID, subItemID, siteID, uom, false);
		...
		public static ItemCost Fetch(PXGraph graph, int? vendorID, int? vendorLocationID, DateTime? docDate,
			string curyID, int? inventoryID, int? subItemID, int? siteID, string uom)
		{
			return Fetch(graph, vendorID, vendorLocationID, docDate, curyID, CurrencyCollection.GetBaseCurrency()?.CuryID, inventoryID, subItemID, siteID, uom, false);
		}
        		
		public static ItemCost Fetch(PXGraph graph, int? vendorID, int? vendorLocationID, DateTime? docDate, string curyID, string baseCuryID, int? inventoryID, int? subItemID, int? siteID, string uom)
		{
			return Fetch(graph, vendorID, vendorLocationID, docDate, curyID, baseCuryID, inventoryID, subItemID, siteID, uom, false);
		}

		public static ItemCost Fetch(PXGraph graph, int? vendorID, int? vendorLocationID, DateTime? docDate,
			string curyID, int? inventoryID, int? subItemID, int? siteID, string uom, bool onlyVendor)
		{
			return Fetch(graph, vendorID, vendorLocationID, docDate, curyID, CurrencyCollection.GetBaseCurrency()?.CuryID, inventoryID, subItemID, siteID, uom, onlyVendor);
		}
		public static ItemCost Fetch(PXGraph graph, int? vendorID, int? vendorLocationID, DateTime? docDate, string curyID, string baseCuryID, int? inventoryID, int? subItemID, int? siteID, string uom, bool onlyVendor)
		{
