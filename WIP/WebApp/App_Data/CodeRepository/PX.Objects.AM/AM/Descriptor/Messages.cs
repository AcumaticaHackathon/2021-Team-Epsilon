...
namespace PX.Objects.AM
{
    ...
    public static class Messages
    {
        ...
        public const string CreatedFromOrderTypeOrderNbr = "The production order has been created from {0} Order {1}";
        public const string LinkedToProdOrderTypeOrderNbr = "The production order has been linked to {0} Order {1}";
        public const string RemovedLinkToSalesOrder = "Link to {0} Order {1} has been removed";
        ...
        public const string ReleasedTransactionExist = "The transaction line contains released related transactions and cannot be deleted.";
        public const string ReleasedBatchExist = "The batch contains released related transactions and cannot be deleted.";
        public const string UnableToGetCTPLineExt = "Unable to get CTPLine extension";
        public const string CTPCreatedFromOrderTypeOrderNbr = "CTP Order created from {0} Order {1}";
        public const string UnableToGetCTPSchdOrder = "Unable to get CTP schedule order";
        public const string RunCTP = "Process CTP";
        public const string Accept = "Accept";
        public const string Reject = "Reject";
        public const string QuantityAvailable = "Quantity Available";
        public const string LocationProductionInvalid = "The selected location cannot be used for production.";
        public const string CTPHasAlreadyBeenAccepted = "CTP has already been accepted.";
        public const string CTPOrderTypeCannotBeManual = "Only production order types with automatically generated order numbers can be used to create orders by CTP.";
        public const string DefaultOrderTypeCannotBeNull = "Specify the production order type for a regular order to be created by CTP.";
        public const string CrewWorkcenterRequired = "The basis for capacity of the work center must be set to crew size.";
        public const string UnabletoUpdateQuantityProd = "The Quantity to Produce on the linked Production Order will not be changed as the Production Order Status is {0}";
        public const string ConfirmRemovalOfSalesOrderLink = "Are you sure you want to remove the link to Order {0} {1}, Line {2}?";
        public const string CTPProcessHasNotBeenRun = "CTP dates have not been estimated for the selected line items yet. Process the lines with the Process CTP action selected.";
        public const string NoDefaultCTPOrderType = "At least one document cannot be processed because no order type is selected in the Capable to Promise Order Type box on the Production Preferences (AM102000) form.";
        public const string UnreleasedBatchExist = "The batch cannot be deleted because the original batch has not been released.";
        public const string LaborTimeGreaterZeroLessEqual24 = "Labor time must be greater than zero and less than or equal to 24 hours.";
        public const string ProductionOrderUnreleasedVendorShipments = "The {0} {1} production order cannot be closed because it has related vendor shipments that are not released.";
        public const string ProductionOrderUnreleasedClockEntries = "The {0} {1} production order cannot be closed because it has related clock entries that are not released.";
        ...
        public const string InventoryCostAdj = "Inventory Cost Adjustment";
        ...
        public const string LinkToSalesOrder = "Link Sales Order";
        public const string RemoveLinkToSales = "Remove Link";
