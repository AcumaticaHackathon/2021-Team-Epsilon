		...
		<Items>
			<px:PXTabItem Text="General Settings" RepaintOnDemand="false">
				<Template>
					...
					<px:PXBranchSelector CommitChanges="True" ID="edOrgBAccountID" runat="server" DataField="OrgBAccountID" InitialExpandLevel="0" />
					...
					<px:PXLayoutRule runat="server" GroupCaption="Credit Card Processing Settings" StartGroup="True" />
					<px:PXLayoutRule runat="server" ControlSize="M" LabelsWidth="M" />
					<px:PXDropDown runat="server" ID="cmbSavePaymentProfiles" DataField="SavePaymentProfiles"></px:PXDropDown>
				</Template>
			</px:PXTabItem>
			<px:PXTabItem Text="GL Accounts">
				<Template>
					...
					<px:PXSegmentMask ID="edARSubID" runat="server" DataField="ARSubID" AutoRefresh="True" CommitChanges="True" >
						<Parameters>
					...
					<px:PXSegmentMask ID="edSalesSubID" runat="server" DataField="SalesSubID" AutoRefresh="True" CommitChanges="True">
						<Parameters>
					...
					<px:PXSegmentMask ID="edDiscountSubID" runat="server" DataField="DiscountSubID" AutoRefresh="True" CommitChanges="True">
						<Parameters>
					...
					<px:PXSegmentMask ID="edFreightSubID" runat="server" DataField="FreightSubID" AutoRefresh="True" CommitChanges="True">
						<Parameters>
					...
					<px:PXSegmentMask ID="edDiscTakenSubID" runat="server" DataField="DiscTakenSubID" AutoRefresh="True" CommitChanges="True">
						<Parameters>
					...
					<px:PXSegmentMask ID="edPrepaymentSubID" runat="server" DataField="PrepaymentSubID"	AutoRefresh="True" CommitChanges="True">
						<Parameters>
					...
					<px:PXSegmentMask ID="edCOGSSubID" runat="server" DataField="COGSSubID" AutoRefresh="True" CommitChanges="True">
						<Parameters>
					...
					<px:PXSegmentMask ID="edMiscSubID" runat="server" DataField="MiscSubID" AutoRefresh="True" CommitChanges="True">
						<Parameters>
					...
					<px:PXSegmentMask ID="edRetainageSubID" runat="server" DataField="RetainageSubID"  CommitChanges="True"/>
				</Template>
			</px:PXTabItem>
