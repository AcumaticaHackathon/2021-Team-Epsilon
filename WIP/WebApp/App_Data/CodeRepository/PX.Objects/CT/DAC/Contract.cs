...
namespace PX.Objects.CT
{
	...
	public partial class Contract : PX.Data.IBqlTable
	{
		...
		{
			public static Contract Find(PXGraph graph, int? contractID) => FindBy(graph, contractID);
		}
		public class UK : PrimaryKeyOf<Contract>.By<baseType, contractCD>
		{
			public static Contract Find(PXGraph graph, string baseType, string contractCD) => FindBy(graph, baseType, contractCD);
		}
