...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentEmployee : PX.Data.IBqlTable
    {
        ...
        {
            public static FSAppointmentEmployee Find(PXGraph graph, string srvOrdType, string refNbr, int? lineNbr) => FindBy(graph, srvOrdType, refNbr, lineNbr);
        }
        ...
        public static class FK
        {
            ...
            public class DefaultTask : PMTask.PK.ForeignKeyOf<FSAppointmentEmployee>.By<dfltProjectTaskID> { }
