...
namespace PX.Objects.IN
{
	public partial class INScanTransfer
	{
		public class INScanTransferCartsSupport : INScanRegisterCartsSupport<INScanTransferCartsSupport, INScanTransfer, Header, INScanTransferHost>
		{
			...
			public override CartsSupport.Header.Mapping GetHeaderMapping()
				=> new CartsSupport.Header.Mapping(typeof(INScanTransfer.Header))
				{
			...
			public override void Initialize()
			{
				...
				HeaderView = new PXSelectExtension<CartsSupport.Header>(Base.HeaderView);
				LinesView = new PXSelectExtension<CartsSupport.Line>(Base.transactions);
				SplitsView = new PXSelectExtension<CartsSupport.Split>(Base.splits);
			}

			protected override bool VerifyConfirmedLine(CartsSupport.Header header, CartsSupport.Line line, Action rollbackAction, out WMSFlowStatus flowStatus)
			{
