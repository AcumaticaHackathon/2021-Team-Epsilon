...
namespace PX.Objects.PM
{
	...
	public partial class PMTaxTran : TaxDetail, IBqlTable
	{
		...
		// Acuminator disable once PX1055 DacKeyFieldsWithIdentityKeyField [Keep current approcah to not break current behaviour]
		...
		[PXParent(typeof(Select<PMProforma, Where<PMProforma.refNbr, Equal<Current<PMTaxTran.refNbr>>,
			And<PMProforma.revisionID, Equal<Current<PMTaxTran.revisionID>>>>>))]
