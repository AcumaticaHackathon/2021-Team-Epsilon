...
namespace PX.Objects.IN
{
	...
	public partial class INKitSpecStkDet : PX.Data.IBqlTable
	{
		...
		{
			public static INKitSpecStkDet Find(PXGraph graph, int? kitInventoryID, string revisionID, int? lineNbr)
		...
		public static class FK
		{
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use ComponentSubItem instead.")]
			public class CompSubItem : ComponentSubItem { }
		}
		#endregion
