...
<asp:Content ID="cont2" ContentPlaceHolderID="phL" runat="Server">
	...
	<px:PXSmartPanel runat="server" ID="ViewBaseMethod" Width="600px" Height="400px" CaptionVisible="True"
		Caption="Add Access Rights for Screen" ShowMaximizeButton="True" Overflow="Hidden"  Key="ScreensWithRoles" AutoRepaint="True">

		<px:PXGrid runat="server" ID="gridAddFile" AllowPaging="false"  DataSourceID="ds" Width="100%" BatchUpdate="True" AutoAdjustColumns="True" SkinID="Details" FilesIndicator="False" NoteIndicator="False">
			<Levels>
				<px:PXGridLevel DataMember="ScreensWithRoles">
					<Columns>
					    <px:PXGridColumn DataField="Selected" Type="CheckBox" Width="50px"/>
					    <px:PXGridColumn DataField="ScreenId" Width="100px"/>
						<px:PXGridColumn DataField="ScreenTitle" Width="300px"/>
