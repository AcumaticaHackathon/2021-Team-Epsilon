...
namespace PX.Objects.FS
{
    public class SM_NonStockItemMaint : PXGraphExtension<NonStockItemMaint>
    {
        ...
        public virtual void PropagateBaseUnitToContracts(PXCache cache, InventoryItem inventoryItemRow, PXTranStatus tranStatus, PXDBOperation operation, bool baseUnitChanged)
        {
        ...
        protected virtual void _(Events.FieldUpdated<InventoryItem, InventoryItem.itemType> e)
        {
            ...
            e.Cache.SetDefaultExt<FSxService.billingRule>(e.Row);
        }

        protected virtual void _(Events.FieldUpdated<InventoryItem, InventoryItem.stkItem> e)
        {
            if (e.Row == null)
            {
                return;
        ...
        protected virtual void _(Events.RowPersisting<InventoryItem> e)
        {
            ...
            if (oldItem != null && e.Operation == PXDBOperation.Update
                   && item.BaseUnit?.Equals(oldItem.BaseUnit) == false
                       && IsServiceRelatedToAnyContract(cache, item.InventoryID) == true)
            {
        ...
        protected virtual void _(Events.RowPersisted<InventoryItem> e)
        {
            ...
            PropagateBaseUnitToContracts(e.Cache, (InventoryItem)e.Row, e.TranStatus, e.Operation, baseUnitChanged);
        }
