...
namespace PX.Objects.EP
{
	...
	public partial class EPTimeCardSummary : IBqlTable
	{
		...
		{
			public static EPTimeCardSummary Find(PXGraph graph,string timeCardCD, int? lineNbr) => FindBy(graph, timeCardCD, lineNbr);
		}
		...
		public static class FK
		{
			...
			/// Project Task
			/// </summary>
			public class ProjectTask : PMTask.PK.ForeignKeyOf<EPTimeCardSummary>.By<projectTaskID> { }
