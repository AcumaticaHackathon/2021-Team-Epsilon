namespace PX.Objects.PO
{
	...
	public partial class POTax : TaxDetail, PX.Data.IBqlTable, ITaxDetailWithAmounts
	{
		...
		{
			public class Order : POOrder.PK.ForeignKeyOf<POTax>.By<orderType, orderNbr> { }
			public class OrderLine : POLine.PK.ForeignKeyOf<POTax>.By<orderType, orderNbr, lineNbr> { }
			public class OrderLineR : POLineR.PK.ForeignKeyOf<POTax>.By<orderType, orderNbr, lineNbr> { }
			public class OrderLineUOpen : POLineUOpen.PK.ForeignKeyOf<POTax>.By<orderType, orderNbr, lineNbr> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<POTax>.By<taxID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<POTax>.By<curyInfoID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<POTax>.By<taxZoneID> { }
			...
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OrderLineR instead.")]
			public class LineR : OrderLineR { }
			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OrderLineUOpen instead.")]
			public class LineUOpen : OrderLineUOpen { }
		}
		#endregion
		#region OrderType
		...
		[PXParent(typeof(FK.OrderLineUOpen))]
