...
namespace PX.Objects.PO
{
	...
	public partial class LandedCostCode : PX.Data.IBqlTable
	{
		...
		public static class FK
		{
			...
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<LandedCostCode>.By<vendorID> { }
			public class VendorLocation : CR.Location.PK.ForeignKeyOf<LandedCostCode>.By<vendorID, vendorLocationID> { }
			public class Terms : CS.Terms.PK.ForeignKeyOf<LandedCostCode>.By<termsID> { }
			public class LandedCostAccrualAccount : Account.PK.ForeignKeyOf<LandedCostCode>.By<lCAccrualAcct> { }
			public class LandedCostAccrualSubaccount : Sub.PK.ForeignKeyOf<LandedCostCode>.By<lCAccrualSub> { }
			public class LandedCostVarianceAccount : Account.PK.ForeignKeyOf<LandedCostCode>.By<lCVarianceAcct> { }
			public class LandedCostVarianceSubaccount : Sub.PK.ForeignKeyOf<LandedCostCode>.By<lCVarianceSub> { }
		...
		[PXDefault()]
		[PXForeignReference(typeof(FK.LandedCostAccrualAccount))]
		...
		[PXDefault()]
		[PXForeignReference(typeof(FK.LandedCostAccrualSubaccount))]
