...
namespace PX.Objects.AP
{
	...
	[PXGroupMask(typeof(InnerJoinSingleTable<Vendor, On<Vendor.bAccountID, Equal<APPayment.vendorID>, And<Match<Vendor, Current<AccessInfo.userName>>>>>))]
	public class APPayment : APRegister, IInvoice, IPrintCheckControlable, IAssign, IApprovable, IApprovalDescription, IReserved
	{
		...
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<APPayment>.By<branchID> { }
			public class Vendor : AP.Vendor.PK.ForeignKeyOf<APPayment>.By<vendorID> { }
			public class VendorLocation : CR.Location.PK.ForeignKeyOf<APPayment>.By<vendorID, vendorLocationID> { }
			public class RemittanceAddress : CR.Address.PK.ForeignKeyOf<APPayment>.By<remitAddressID> { }
			public class RemittanceContact : CR.Contact.PK.ForeignKeyOf<APPayment>.By<remitContactID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<APPayment>.By<curyInfoID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<APPayment>.By<curyID> { }
			public class APAccount : GL.Account.PK.ForeignKeyOf<APPayment>.By<aPAccountID> { }
			public class APSubaccount : GL.Sub.PK.ForeignKeyOf<APPayment>.By<aPSubID> { }
			public class Schedule : GL.Schedule.PK.ForeignKeyOf<APPayment>.By<scheduleID> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<APPayment>.By<paymentMethodID> { }
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<APPayment>.By<cashAccountID> { }
			public class CashAccountTransaction : CA.CATran.PK.ForeignKeyOf<APPayment>.By<cashAccountID, cATranID> { }
		}
		#endregion

		#region Events
		public class Events : PXEntityEvent<APPayment>.Container<Events>
		{
			...
			public PXEntityEvent<APPayment> UpdateStatus;
		}
		#endregion
		...
		/// <summary>
		/// The <see cref="FinPeriod">financial period</see> of payment application.
		/// </summary>
		/// <value>
        ...
        /// <summary>
        /// The <see cref="FinPeriod">financial period</see> of the document corresponding to the <see cref="DocDate">payment date</see>.
        /// </summary>
        /// <value>
...
namespace PX.Objects.AP.Standalone
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<APPayment>.By<docType, refNbr>
		{
			public static APPayment Find(PXGraph graph, string docType, string refNbr) => FindBy(graph, docType, refNbr);
		}
		#endregion
