...
namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<ARContact>.By<contactID>
		{
			public static ARContact Find(PXGraph graph, Int32? contactID) => FindBy(graph, contactID);
		}
		public static class FK
		{
			public class Customer : AP.Vendor.PK.ForeignKeyOf<ARContact>.By<customerID> { }

			public class CustomerContact : CR.Contact.PK.ForeignKeyOf<ARContact>.By<customerContactID> { }
		}
		#endregion
	...
	{
		#region Keys
		public new class PK : PrimaryKeyOf<ARShippingContact>.By<contactID>
		{
			public static ARShippingContact Find(PXGraph graph, Int32? contactID) => FindBy(graph, contactID);
		}
		public new static class FK
		{
			public class Customer : AP.Vendor.PK.ForeignKeyOf<ARShippingContact>.By<customerID> { }
			public class CustomerContact : CR.Contact.PK.ForeignKeyOf<ARShippingContact>.By<customerContactID> { }
		}
		#endregion
