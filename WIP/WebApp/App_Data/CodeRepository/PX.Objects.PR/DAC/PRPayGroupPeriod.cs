...
namespace PX.Objects.PR
{
	...
	public partial class PRPayGroupPeriod : IBqlTable, IPeriod
	{
		...
		#region Keys
		public class PK : PrimaryKeyOf<PRPayGroupPeriod>.By<payGroupID, finPeriodID>
		{
			public static PRPayGroupPeriod Find(PXGraph graph, string payGroupID, string finPeriodID) =>
				FindBy(graph, payGroupID, finPeriodID);
		}

		public static class FK
		{
			public class Organization : GL.DAC.Organization.PK.ForeignKeyOf<PRPayGroupPeriod>.By<organizationID> { }
			public class PayGroupYear : PRPayGroupYear.PK.ForeignKeyOf<PRPayGroupPeriod>.By<payGroupID, finYear> { }
			public class PayGroup : PRPayGroup.PK.ForeignKeyOf<PRPayGroupPeriod>.By<payGroupID> { }
		}
		#endregion
