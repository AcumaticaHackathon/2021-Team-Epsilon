...
namespace PX.Objects.CR
{
	...
	public partial class SMEmail : IBqlTable 
	{
		...
		{
			public static SMEmail Find(PXGraph graph, Guid? noteID) => FindBy(graph, noteID);
		}
	...
	public partial class CRSMEmail : CRActivity
	{
		...
		{
			public static CRSMEmail Find(PXGraph graph, Guid? noteID) => FindBy(graph, noteID);
		}
		public static class FK
		{
			...
			public class Owner : EP.EPEmployee.PK.ForeignKeyOf<CRSMEmail>.By<ownerID> { }
