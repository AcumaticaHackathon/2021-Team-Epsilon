...
namespace PX.Objects.CR
{
	...
	public partial class Location : PX.Data.IBqlTable, IPaymentTypeDetailMaster, ILocation
	{
		...
		{
			public static Location Find(PXGraph graph, Int32? bAccountID, Int32? locationID) => FindBy(graph, bAccountID, locationID);
		}
		public class UK : PrimaryKeyOf<Location>.By<bAccountID, locationCD>
		{
			public static Location Find(PXGraph graph, Int32? bAccountID, string locationCD) => FindBy(graph, bAccountID, locationCD);
		}
