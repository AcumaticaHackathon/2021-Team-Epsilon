...
namespace PX.Objects.PO
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<POReceiptLineS>.By<receiptNbr, lineNbr>
		{
			public static POReceiptLineS Find(PXGraph graph, string receiptNbr, int? lineNbr) => FindBy(graph, receiptNbr, lineNbr);
		}
		public class UK : PrimaryKeyOf<POReceiptLineS>.By<receiptType, receiptNbr, lineNbr>
		{
			public static POReceiptLineS Find(PXGraph graph, string receiptType, string receiptNbr, int? lineNbr) => FindBy(graph, receiptType, receiptNbr, lineNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<POReceiptLineS>.By<branchID> { }
			public class Receipt : POReceipt.PK.ForeignKeyOf<POReceiptLineS>.By<receiptNbr> { }
			...
			public class SiteStatus : IN.INSiteStatus.PK.ForeignKeyOf<POReceiptLineS>.By<inventoryID, subItemID, siteID> { }
			...
			public class Task : PM.PMTask.PK.ForeignKeyOf<POReceiptLineS>.By<taskID> { }
		...
		string IAPTranSource.OrigUOM
		{
			get
			{
				return this.IsDirectReceipt || UseAmountsFromReceipt ? this.UOM : this.OrderUOM;
			}
		}
		...
		public virtual decimal? OrigQty
		{
			get
			{
				return this.IsDirectReceipt || UseAmountsFromReceipt ? this.ReceiptQty : this.OrderQty;
			}
		}
		...
		public virtual decimal? BaseOrigQty
		{
			get
			{
				return this.IsDirectReceipt || UseAmountsFromReceipt ? this.BaseReceiptQty : this.BaseOrderQty;
			}
		}
		...
		Int64? IAPTranSource.CuryInfoID
		{
			get
			{
				return this.IsDirectReceipt || UseAmountsFromReceipt ? this.ReceiptCuryInfoID : this.OrderCuryInfoID;
			}
		}
		...
		decimal? IAPTranSource.DiscPct
		{
			get
			{
				return UseAmountsFromReceipt ? this.ReceiptDiscPct : this.OrderDiscPct;
			}
		}
		...
		decimal? IAPTranSource.CuryDiscAmt
		{
			get
			{
				return UseAmountsFromReceipt ? this.CuryReceiptDiscAmt : this.CuryOrderDiscAmt;
			}
		}
		...
		decimal? IAPTranSource.DiscAmt
		{
			get
			{
				return UseAmountsFromReceipt ? this.ReceiptDiscAmt : this.OrderDiscAmt;
			}
		}
		...
		decimal? IAPTranSource.CuryLineAmt
		{
			get
			{
				return this.IsDirectReceipt || UseAmountsFromReceipt ? this.CuryReceiptExtCost : this.CuryOrderLineAmt;
			}
		}
		...
		decimal? IAPTranSource.LineAmt
		{
			get
			{
				return this.IsDirectReceipt || UseAmountsFromReceipt ? this.ReceiptExtCost : this.OrderLineAmt;
			}
		}
		...
		decimal? IAPTranSource.CuryUnitCost
		{
			get
			{
				return this.IsDirectReceipt || UseAmountsFromReceipt ? this.CuryReceiptUnitCost : this.CuryOrderUnitCost;
			}
		}
		...
		decimal? IAPTranSource.UnitCost
		{
			get
			{
				return this.IsDirectReceipt || UseAmountsFromReceipt ? this.ReceiptUnitCost : this.OrderUnitCost;
			}
		}
