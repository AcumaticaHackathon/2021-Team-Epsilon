...
namespace PX.Objects.AR
{
	...
	public partial class ARAddress : PX.Data.IBqlTable, IAddress, IAddressBase, IAddressLocation
	{
		#region Keys
		public class PK : PrimaryKeyOf<ARAddress>.By<addressID>
		{
			public static ARAddress Find(PXGraph graph, Int32? addressID) => FindBy(graph, addressID);
		}
		public static class FK
		{
			public class Customer : AR.Customer.PK.ForeignKeyOf<ARAddress>.By<customerID> { }
			public class CustomerAddress : CR.Address.PK.ForeignKeyOf<ARAddress>.By<customerAddressID> { }
			public class Country : CS.Country.PK.ForeignKeyOf<ARAddress>.By<countryID> { }
		}
		#endregion
