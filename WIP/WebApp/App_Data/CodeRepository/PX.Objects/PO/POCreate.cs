...
namespace PX.Objects.PO
{
	...
	public class POCreate : PXGraph<POCreate>
	{
		...
		protected virtual IEnumerable fixedDemand()
		{
			...
			foreach (PXResult<POFixedDemand, Vendor, POVendorInventory> demand in query.Select(PXView.Currents, parameters,
		...
		public virtual IEnumerable EnumerateAndPrepareFixedDemands(PXResultset<POFixedDemand> fixedDemands)
		{
			foreach (PXResult<POFixedDemand, Vendor, POVendorInventory> rec in fixedDemands)
			{
                ...
                EnumerateAndPrepareFixedDemandRow(demand, vendor, price);

                yield return rec;
			}
		}

        public virtual void EnumerateAndPrepareFixedDemandRow(POFixedDemand demand, Vendor vendor, POVendorInventory price)
        {
