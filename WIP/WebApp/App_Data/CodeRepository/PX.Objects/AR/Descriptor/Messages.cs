...
namespace PX.Objects.AR
{
	...
	public static class Messages
	{
		...
		public const string IncorrectRetainagePositiveAmount = "A retainage amount cannot be greater than the line amount.";
		public const string IncorrectRetainageNegativeAmount = "A retainage amount cannot be less than the line amount.";
		...
		public const string ReverseRetainageReversingDocument = "The Reverse action cannot be used for credit and debit memos, which reverse original documents with retainage and retainage documents.";
		public const string ReverseApplyRetainageReversingDocument = "The Reverse and Apply to Memo action cannot be used for credit and debit memos, which reverse original documents with retainage and retainage documents.";
