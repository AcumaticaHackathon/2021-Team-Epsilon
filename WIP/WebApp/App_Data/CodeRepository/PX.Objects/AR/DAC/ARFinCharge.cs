...
namespace PX.Objects.AR
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<ARFinCharge>.By<finChargeID>
		{
			public static ARFinCharge Find(PXGraph graph, String finChargeID) => FindBy(graph, finChargeID);
		}
		public static class FK
		{
			public class Terms : CS.Terms.PK.ForeignKeyOf<ARFinCharge>.By<termsID> { }
			public class TaxCategory : TX.TaxCategory.PK.ForeignKeyOf<ARFinCharge>.By<taxCategoryID> { }
			public class OverdueChargeAccount : GL.Account.PK.ForeignKeyOf<ARFinCharge>.By<finChargeAccountID> { }
			public class OverdueChargeSubaccount : GL.Sub.PK.ForeignKeyOf<ARFinCharge>.By<finChargeSubID> { }
			public class FeeAccount : GL.Account.PK.ForeignKeyOf<ARFinCharge>.By<feeAccountID> { }
			public class FeeSubaccount : GL.Sub.PK.ForeignKeyOf<ARFinCharge>.By<feeSubID> { }
		}
		#endregion
