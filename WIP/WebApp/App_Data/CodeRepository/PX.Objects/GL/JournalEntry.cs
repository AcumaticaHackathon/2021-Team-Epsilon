...
namespace PX.Objects.GL
{
	public class JournalEntry : PXGraph<JournalEntry, Batch>, PXImportAttribute.IPXPrepareItems, PX.Objects.GL.IVoucherEntry
	{
		...
		#region Buttons
		public PXAutoAction<Batch> initializeState;
		...
		public virtual IEnumerable BatchRegisterDetails(PXAdapter adapter, string reportID = null)
		{
			...
			{
				throw new PXReportRequiredException(CreateBatchReportParams(), reportID ?? "GL621000", "Batch Register Details");
			}
			return adapter.Get();
		}
		...
		public virtual IEnumerable GLEditDetails(PXAdapter adapter, string reportID = null)
		{
			...
			{
				throw new PXReportRequiredException(CreateBatchReportParams(), reportID ?? "GL610500", "GL Edit Details");
			}
			return adapter.Get();
		}
	...
	public class PostGraph : PXGraph<PostGraph>
	{
		...
		{			
			using (PXTransactionScope ts = new PXTransactionScope())
			{
				...
				{
					b.Hold = false;
					Batch.Events.Select(g=>g.UpdateStatus)
						.FireOn(this, b);
				}
