...
namespace PX.Objects.CM
{
	...
	public partial class CMSetup : PX.Data.IBqlTable
	{
		...
		{
			public class BatchNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CMSetup>.By<batchNumberingID> { }
			public class BatchRefNumberNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CMSetup>.By<extRefNbrNumberingID> { }
			public class TranslationNumberingSequence : CS.Numbering.PK.ForeignKeyOf<CMSetup>.By<translNumberingID> { }
			public class DefaultTranslation : CM.TranslDef.PK.ForeignKeyOf<CMSetup>.By<translDefId> { }
		}
		#endregion
