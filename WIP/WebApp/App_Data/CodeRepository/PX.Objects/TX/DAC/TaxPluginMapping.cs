...
namespace PX.Objects.TX
{
	...
	public partial class TaxPluginMapping : PX.Data.IBqlTable
	{
		#region Keys
		public class PK : PrimaryKeyOf<TaxPluginMapping>.By<taxPluginID, branchID>
		{
			public static TaxPluginMapping Find(PXGraph graph, string taxPluginID, string branchID) => FindBy(graph, taxPluginID, branchID);
		}
