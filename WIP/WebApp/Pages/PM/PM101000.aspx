        ...
        <Items>
            <px:PXTabItem Text="General Settings">
                <Template>
                    ...
                    <px:PXSelector ID="edCostProjectionApprovalMapID" runat="server" DataField="CostProjectionApprovalMapID" AllowEdit="True" AllowAddNew="True" TextField="Name"/>
                    <px:PXSelector ID="edCostProjectionApprovalNotificationID" runat="server" DataField="CostProjectionApprovalNotificationID" AllowEdit="True" AllowAddNew="True" TextField="Name"/>
                    ...
                    <px:PXCheckBox ID="chkMigrationMode" runat="server" DataField="MigrationMode" />
					...
					<px:PXCheckBox runat="server" ID="chkVisibleInPROD" DataField="VisibleInPROD" />
                    ...
                    <px:PXFormView ID="formMarkupGroup" runat="server" datamember="Setup" RenderStyle="Simple">
		                <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="L" ControlSize="L"/>
                    ...
                    <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="GL Settings for Unbilled Remainders" />
                    <px:PXSelector ID="edUnbilledRemainderAccountID" runat="server" DataField="UnbilledRemainderAccountID" CommitChanges="True"/>
                    <px:PXSegmentMask ID="edUnbilledRemainderSubID" runat="server" DataField="UnbilledRemainderSubID" CommitChanges="True"/>
                    <px:PXSelector ID="edUnbilledRemainderOffsetAccountID" runat="server" DataField="UnbilledRemainderOffsetAccountID" CommitChanges="True"/>
                    <px:PXSegmentMask ID="edUnbilledRemainderOffsetSubID" runat="server" DataField="UnbilledRemainderOffsetSubID" CommitChanges="True"/>
                </Template>
            </px:PXTabItem>
