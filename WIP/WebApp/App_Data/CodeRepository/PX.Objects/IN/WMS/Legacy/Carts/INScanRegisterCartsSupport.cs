...
namespace PX.Objects.IN.WMS
{
		...
		where TGraph : PXGraph
	{
		...
		public override CartsSupport.Line.Mapping GetLineMapping()
			=> new CartsSupport.Line.Mapping(typeof(INTran))
			{
		...
		public override CartsSupport.Split.Mapping GetSplitMapping()
			=> new CartsSupport.Split.Mapping(typeof(INTranSplit))
			{
		...
		protected override INRegister SyncWithDocument(CartsSupport.Header header)
		{
		...
		protected override void SyncWithDocumentCart(CartsSupport.Header header, CartsSupport.Line line, INCartSplit cartSplit, decimal? qty)
		{
		...
		protected virtual void SyncWithDocumentCartLine(CartsSupport.Header header, CartsSupport.Line line, INCartSplit cartSplit, decimal? qty)
		{
