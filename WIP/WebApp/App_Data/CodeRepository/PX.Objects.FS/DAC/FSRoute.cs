...
namespace PX.Objects.FS
{
	...
	{
        #region Keys
        public class PK : PrimaryKeyOf<FSRoute>.By<routeID>
        {
            public static FSRoute Find(PXGraph graph, int? routeID) => FindBy(graph, routeID);
        }

        public class UK : PrimaryKeyOf<FSRoute>.By<routeCD>
        {
            public static FSRoute Find(PXGraph graph, string routeCD) => FindBy(graph, routeCD);
        }

        public static class FK
        {
            public class VehicleType : FSVehicleType.PK.ForeignKeyOf<FSRoute>.By<vehicleTypeID> { }
            public class OriginRoute : FSRoute.PK.ForeignKeyOf<FSRoute>.By<originRouteID> { }
            public class BeginBranch : GL.Branch.PK.ForeignKeyOf<FSRoute>.By<beginBranchID> { }
            public class EndBranch : GL.Branch.PK.ForeignKeyOf<FSRoute>.By<endBranchID> { }
            public class BeginBranchLocation : FSBranchLocation.PK.ForeignKeyOf<FSRoute>.By<beginBranchLocationID> { }
            public class EndBranchLocation : FSBranchLocation.PK.ForeignKeyOf<FSRoute>.By<endBranchLocationID> { }
        }
        #endregion
