...
namespace PX.Objects.CA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CASplit>.By<adjTranType, adjRefNbr, lineNbr>
		{
			public static CASplit Find(PXGraph graph, string adjTranType, string adjRefNbr, int? lineNbr) => FindBy(graph, adjTranType, adjRefNbr, lineNbr);
		}

		public static class FK
		{
			public class CashTransaction : CA.CAAdj.PK.ForeignKeyOf<CASplit>.By<adjTranType, adjRefNbr> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<CASplit>.By<branchID> { }
			public class Account : GL.Account.PK.ForeignKeyOf<CASplit>.By<accountID> { }
			public class Subaccount : GL.Account.PK.ForeignKeyOf<CASplit>.By<subID> { }
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CASplit>.By<cashAccountID> { }
			public class TaxCategory : TX.TaxCategory.PK.ForeignKeyOf<CASplit>.By<taxCategoryID> { }
			public class CurrenyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<CASplit>.By<curyInfoID> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<CASplit>.By<inventoryID> { }
			public class Project : PMProject.PK.ForeignKeyOf<CASplit>.By<projectID> { }
			public class Task : PMTask.PK.ForeignKeyOf<CASplit>.By<taskID> { }
			public class CostCode : PMCostCode.PK.ForeignKeyOf<CASplit>.By<costCodeID> { }
		}
		...
		/// </value>
		[ProjectDefault(BatchModule.CA, AccountType = typeof(accountID))]
		[CAActiveProject]
