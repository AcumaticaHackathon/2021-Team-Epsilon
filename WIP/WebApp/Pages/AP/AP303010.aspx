		...
		<Items>
			...
			<px:PXTabItem Text="General">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Other Settings" />
						<px:PXSelector ID="edVBranchID" runat="server" DataField="VBranchID" AllowEdit="True" CommitChanges="true"/>
						<px:PXLayoutRule runat="server" Merge="True" />
			...
			<px:PXTabItem Text="Purchase Settings">
				<Template>
					...
					<px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Shipping Instructions" />
						...
						<px:PXSegmentMask ID="edVSiteIDIntercompany" runat="server" DataField="LocationBranchSettings.VSiteID" AllowEdit="True" />
			...
			<px:PXTabItem Text="GL Accounts">
				<Template>
					...
					<px:PXSegmentMask ID="edVExpenseSubID" runat="server" DataField="VExpenseSubID" CommitChanges="True"  />
					<px:PXSegmentMask ID="edVDiscountAcctID" runat="server" DataField="VDiscountAcctID" CommitChanges="True" />
					<px:PXSegmentMask ID="edVDiscountSubID" runat="server" DataField="VDiscountSubID" CommitChanges="True" />
