...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:PXDataSource EnableAttributes="true" ID="ds" runat="server" Visible="True" Width="100%" PrimaryView="CustomerPaymentMethod" TypeName="PX.Objects.AR.CustomerPaymentMethodMaint" HeaderDescriptionField="Descr">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="AddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,BillAddress" CommitChanges="true" Visible="false" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="CustomerPaymentMethod" Caption="Payment Method Selection" NoteIndicator="True" FilesIndicator="True"
		ActivityIndicator="true" LinkIndicator="true" BPEventsIndicator="true"  DefaultControlID="edBAccountID">
		<Template>
				...
				<Template>
					...
					<px:PXFormView ID="BillAddress" runat="server" DataMember="BillAddress" RenderStyle="Simple" DataSourceID="ds">
						<Template>
							...
							<px:PXButton Size="xs" ID="btnViewBillAddressOnMap" runat="server" CommandName="ViewBillAddressOnMap" CommandSourceID="ds" Text="View on Map" TabIndex="-1" />
