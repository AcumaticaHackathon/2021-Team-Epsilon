        ...
        <Items>
            <px:PXTabItem Text="General Settings">
                <Template>
					...
					<px:PXDropDown runat="server" DataField="AMReplenishmentSource" ID="edAMReplenishmentSource" />
            ...
            <px:PXTabItem Text="Attributes">
                <Template>
                    ...
                    <px:PXPanel ID="PXPanelsdf" runat="server" RenderSimple="True" RenderStyle="Fieldset">
                        <px:PXLayoutRule runat="server" StartRow="true" StartGroup="true" LabelsWidth="S" ControlSize="XM" />
                        <px:PXGrid ID="PXGridIdGenerationRules" runat="server" DataSourceID="ds" Height="150px" Width="650px" SkinID="Details"
                            StatusField="Sample" Caption="Inventory ID Segment Settings" CaptionVisible="true">
                            <!--#include file="~\Pages\Includes\InventoryMatrixIDRules.inc"-->
                        </px:PXGrid>

                        <px:PXLayoutRule runat="server" StartColumn="true"  LabelsWidth="S" ControlSize="XM" />
                        <px:PXGrid ID="PXGridDescriptionGenerationRules" runat="server" DataSourceID="ds" Height="150px" Width="650px" SkinID="Details"
                            StatusField="Sample" Caption="Description Segment Settings" CaptionVisible="true">
