...
{	
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<CATran>.By<cashAccountID, tranID>
		{
			public static CATran Find(PXGraph graph, int? cashAccountID, long? tranID) => FindBy(graph, cashAccountID, tranID);
		}
		public class UK : PrimaryKeyOf<CATran>.By<tranID>
		{
			public static CATran Find(PXGraph graph, long? tranID) => FindBy(graph, tranID);
		}
		public static class FK
		{
			public class CashAccount : CA.CashAccount.PK.ForeignKeyOf<CATran>.By<cashAccountID> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<CATran>.By<branchID> { }
			public class BusinessAccount : CR.BAccount.PK.ForeignKeyOf<CATran>.By<referenceID> { }
			public class Currency : CM.Currency.PK.ForeignKeyOf<CATran>.By<curyID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<CATran>.By<curyInfoID> { }
			public class ReconciliationStatement : CA.CARecon.PK.ForeignKeyOf<CATran>.By<cashAccountID, reconNbr> { }
			public class Batch : GL.Batch.PK.ForeignKeyOf<CATran>.By<origModule, batchNbr> { }
			public class ChildCashAccount : CA.CashAccount.PK.ForeignKeyOf<CATran>.By<refTranAccountID> { }
			public class ChildCashAccountTransaction : CA.CATran.PK.ForeignKeyOf<CATran>.By<refTranAccountID, refTranID> { }
			public class VoidedCashAccountTransaction : CA.CATran.PK.ForeignKeyOf<CATran>.By<cashAccountID, voidedTranID> { }
			public class ARPayment : AR.ARPayment.PK.ForeignKeyOf<CATran>.By<origTranType, origRefNbr> { }
			public class APPayment : AP.APPayment.PK.ForeignKeyOf<CATran>.By<origTranType, origRefNbr> { }
			public class CashTransaction : CA.CAAdj.PK.ForeignKeyOf<CATran>.By<origTranType, origRefNbr> { }
			public class CashAccountDeposit : CA.CADeposit.PK.ForeignKeyOf<CATran>.By<origTranType, origRefNbr> { }
		}
		#endregion
        ...
        #endregion
		#region BusinessAccountName
		public abstract class businessAccountName : Data.BQL.BqlString.Field<businessAccountName> { }
		[PXString]
		[PXFormula(typeof(Switch<
			Case<Where<CATran.origModule, Equal<BatchModule.modulePR>, And<GetSetupValue<PRSetup.hideEmployeeInfo>, Equal<True>>>, Null>,
			Selector<CATran.referenceID, BAccountR.acctName>>))]
		[PXUIField(DisplayName = "Business Account Name")]
