...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    ...
    HeaderDescriptionField="FormCaptionDescription">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="FSBillHistory$ChildDocLink$Link" Visible="False" CommitChanges="True" DependOnGrid="PXGridInvoiceRecords" />
            <px:PXDSCallbackCommand Name="BillReversal" Visible="false" />
            <px:PXDSCallbackCommand Name="openPostBatch" Visible="false" CommitChanges="True" DependOnGrid="PXGridInvoiceRecords" />
            <px:PXDSCallbackCommand Name="AddBill" Visible="False" CommitChanges="true" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <%--/Service Order Type Selector--%>
    <px:PXFormView ID="mainForm" runat="server" DataSourceID="ds" Width="100%" Caption="Service Order" MarkRequired="Dynamic" BPEventsIndicator="True" FilesIndicator="True" NoteIndicator="True" ActivityIndicator="True" DataMember="ServiceOrderRecords" TabIndex="100" DefaultControlID="edCustomerID">
        <Template>
            ...
            <px:PXSelector ID="edBillServiceContractID" runat="server" AutoRefresh="True" CommitChanges="True" DataField="BillServiceContractID" AllowEdit="True" AllowAddNew="True" FilterByAllFields="True">
            </px:PXSelector>
            ...
            <px:PXPanel ID="edThirdColumn" runat="server" RenderStyle="Simple">
                ...
                <px:PXCheckBox ID="edShowInvoicesTab" runat="server" DataField="ShowInvoicesTab">
                </px:PXCheckBox>
            </px:PXPanel>
        </Template>
    </px:PXFormView>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
        ...
        <Items>
            <px:PXTabItem Text="Settings">
                <Template>
                    ...
                    <px:PXFormView ID="edServiceOrder_Contact" runat="server" Caption="Contact" DataMember="ServiceOrder_Contact" DataSourceID="ds" RenderStyle="Fieldset">
                        <Template>
                            ...
                            <px:PXFormView ID="edContactForm" runat="server" DataMember="CurrentServiceOrder" DataSourceID="ds" RenderStyle="Simple">
                                <Template>
                                    <px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM"/>
                                    <px:PXSelector ID="edContactID" runat="server" DataField="ContactID" AllowEdit="True" AutoRefresh="True" CommitChanges="True" OnEditRecord="edContactID_EditRecord">
                                    </px:PXSelector>
                                </Template>
                                <ContentStyle BackColor="Transparent"/>
                            </px:PXFormView>  
                    ...
                    <px:PXFormView ID="edServiceOrder_Address" runat="server" Caption="Address" DataMember="ServiceOrder_Address" DataSourceID="ds" RenderStyle="Fieldset">
                        <Template>
                            <px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="SM"/>
                            <px:PXButton ID="btnAddressLookup"  runat="server" CommandName="AddressLookup"  CommandSourceID="ds" Size="xm" TabIndex="-1" />
                            <px:PXButton ID="btnViewDirectionOnMap" runat="server" CommandName="ViewDirectionOnMap" CommandSourceID="ds"  Text="View On Map" TabIndex="-1" />
                    ...
                    <px:PXGrid ID="PXGridDetails" runat="server" DataSourceID="ds" TabIndex="-12436" SkinID="Details" StatusField="Availability"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ServiceOrderDetails">
                                <RowTemplate>
                                    ...
                                    <px:PXCheckBox ID="edPOCompleted" runat="server" DataField="POCompleted" AllowEdit="True" />
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="LineType" RenderEditorText="True" MatrixMode="True" CommitChanges="True" SkipTabs="True"/>
                                    ...
                                    <px:PXGridColumn DataField="POVendorID" CommitChanges="True" LinkCommand="ViewPOVendor"/>
                                    <px:PXGridColumn DataField="POVendorLocationID" CommitChanges="True" LinkCommand="ViewPOVendorLocation"/>
                        ...
                        <ActionBar ActionsText="False" PagerVisible="False">
                            <CustomItems>
                                ...
                                <px:PXToolBarButton Text="Line Details" Key="cmdLS" CommandName="LSFSSODetLine_binLotSerial" CommandSourceID="ds" DependOnGrid="PXGridDetails">
                                    <AutoCallBack>
                                        <Behavior CommitChanges="True" PostData="Page" />
                                    </AutoCallBack>
                                </px:PXToolBarButton>
                                ...
                                <px:PXToolBarButton Key="cmdAddBill">
                                    <AutoCallBack Command="AddBill" Target="ds" />
                                </px:PXToolBarButton>
                            </CustomItems>
                        </ActionBar>
                    </px:PXGrid>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ServiceOrderAppointments">
                                <RowTemplate>
                                    ...
                                    <px:PXDateTimeEdit ID="ScheduledDateTimeEnd_Date" runat="server"
                                        DataField="ScheduledDateTimeEnd_Date">
                                    </px:PXDateTimeEdit>
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ScheduledDateTimeEnd_Date">
                                    </px:PXGridColumn>
            ...
            <px:PXTabItem Text="Financial Settings">
                <Template>
                    ...
                    <px:PXSegmentMask ID="edBillCustomerID" runat="server" AllowEdit="True" AllowAddNew="True" DataField="BillCustomerID" DataSourceID="ds" CommitChanges="True" AutoRefresh ="True">
                    </px:PXSegmentMask>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ServiceOrderEmployees">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="SrvOrdType" />
                                    <px:PXGridColumn DataField="RefNbr" />
                                    <px:PXGridColumn DataField="EmployeeID" CommitChanges="True" DisplayMode="Hint" LinkCommand="ViewEmployee">
                                    </px:PXGridColumn>
                                    <px:PXGridColumn DataField="Type">
                                    </px:PXGridColumn>
            ...
            <px:PXTabItem Text="Billing Documents" BindingContext="mainForm" LoadOnDemand="True" RepaintOnDemand="False" VisibleExp="DataControls[&quot;edShowInvoicesTab&quot;].Value == true">
                <Template>
                    <px:PXFormView ID="edInvoiceInfoForm2" runat="server" DataMember="CurrentServiceOrder" Style="z-index: 100" Width="100%">
                        <Template>
                    ...
                    <px:PXGrid ID="PXGridInvoiceRecords" runat="server" DataSourceID="ds" SkinID="Inquire" TabIndex="2100" Height="100%" Width="100%">
                        <Levels>
                            <px:PXGridLevel DataMember="InvoiceRecords" DataKeyNames="RecordID">
                                <RowTemplate>
                                    <px:PXSelector ID="edBatchID" runat="server" DataField="BatchID" AllowEdit="True" />
                                    <px:PXDropDown ID="edChildEntityType" runat="server" DataField="ChildEntityType" />
                                    <px:PXTextEdit ID="edChildDocLink" runat="server" DataField="ChildDocLink" />
                                    <px:PXTextEdit ID="edChildDocDesc" runat="server" DataField="ChildDocDesc" />
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ChildDocDesc" />
    ...
    <px:PXSmartPanel ID="PanelLS" runat="server" Width="90%" Height="360px" Caption="Line Details" CaptionVisible="True" Key="lsFSSODetSelect"
