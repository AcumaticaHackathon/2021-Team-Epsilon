...
namespace PX.Objects.GL
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<GLTranDoc>.By<module, batchNbr, lineNbr>
		{
			public static GLTranDoc Find(PXGraph graph, String module, String batchNbr, Int32? lineNbr) => FindBy(graph, module, batchNbr, lineNbr);
		}
		public static class FK
		{
			public class Branch : GL.Branch.PK.ForeignKeyOf<GLTranDoc>.By<branchID> { }
			public class Ledger : GL.Ledger.PK.ForeignKeyOf<GLTranDoc>.By<ledgerID> { }
			public class CurrencyInfo : CM.CurrencyInfo.PK.ForeignKeyOf<GLTranDoc>.By<curyInfoID> { }
			public class JournalVoucher : GL.GLDocBatch.PK.ForeignKeyOf<GLTranDoc>.By<module, batchNbr> { }
			public class BusinessAccount : CR.BAccount.PK.ForeignKeyOf<GLTranDoc>.By<bAccountID> { }
			public class Location : CR.Location.PK.ForeignKeyOf<GLTranDoc>.By<bAccountID, locationID> { }
			public class PaymentMethod : CA.PaymentMethod.PK.ForeignKeyOf<GLTranDoc>.By<paymentMethodID> { }
			public class CustomerPaymentMethod : AR.CustomerPaymentMethod.PK.ForeignKeyOf<GLTranDoc>.By<pMInstanceID> { }
			public class TaxCategory : TX.TaxCategory.PK.ForeignKeyOf<GLTranDoc>.By<taxCategoryID> { }
			public class TaxZone : TX.TaxZone.PK.ForeignKeyOf<GLTranDoc>.By<taxZoneID> { }
			public class Tax : TX.Tax.PK.ForeignKeyOf<GLTranDoc>.By<taxID> { }
			public class CashAccountEntryType : CA.CAEntryType.PK.ForeignKeyOf<GLTranDoc>.By<entryTypeID> { }
			public class JournalVoucherCode : GL.GLTranCode.PK.ForeignKeyOf<GLTranDoc>.By<tranModule, tranType> { }
			public class DebitAccount : GL.Sub.PK.ForeignKeyOf<GLTranDoc>.By<debitAccountID> { }
			public class CreditAccount : GL.Sub.PK.ForeignKeyOf<GLTranDoc>.By<creditAccountID> { }
			public class DebitSubaccount : GL.Sub.PK.ForeignKeyOf<GLTranDoc>.By<debitSubID> { }
			public class CreditSubaccount : GL.Sub.PK.ForeignKeyOf<GLTranDoc>.By<creditSubID> { }
			public class Terms : CS.Terms.PK.ForeignKeyOf<GLTranDoc>.By<termsID> { }
			public class DebitCashAccount : CA.CashAccount.PK.ForeignKeyOf<GLTranDoc>.By<debitCashAccountID> { }
			public class CreditCashAccount : CA.CashAccount.PK.ForeignKeyOf<GLTranDoc>.By<creditCashAccountID> { }
			public class CostCode : PMCostCode.PK.ForeignKeyOf<GLTranDoc>.By<costCodeID> { }
			public class Project : PMProject.PK.ForeignKeyOf<GLTranDoc>.By<projectID> { }
			public class Task : PMTask.PK.ForeignKeyOf<GLTranDoc>.By<taskID> { }
			public class ProjectTransaction : PM.PMTran.PK.ForeignKeyOf<GLTranDoc>.By<pMTranID> { }
			public class ARInvoice : AR.ARInvoice.PK.ForeignKeyOf<GLTranDoc>.By<tranType, refNbr> { }
			public class APBill : AP.APInvoice.PK.ForeignKeyOf<GLTranDoc>.By<tranType, refNbr> { }
			public class ARPayment : AR.ARPayment.PK.ForeignKeyOf<GLTranDoc>.By<tranType, refNbr> { }
			public class APPayment : AP.APPayment.PK.ForeignKeyOf<GLTranDoc>.By<tranType, refNbr> { }
			public class CashTransaction : CA.CAAdj.PK.ForeignKeyOf<GLTranDoc>.By<tranType, refNbr> { }
			public class Batch : GL.Batch.PK.ForeignKeyOf<GLTranDoc>.By<tranModule, refNbr> { }
		}
		#endregion
		...
		[PXSelector(typeof(Search<Terms.termsID, 
			Where<Terms.visibleTo, Equal<TermsVisibleTo.all>,
				Or2<Where<Terms.visibleTo, Equal<TermsVisibleTo.customer>,
					And<Current<GLTranDoc.tranModule>, Equal<BatchModule.moduleAR>>>,
					Or<Where<Terms.visibleTo, Equal<TermsVisibleTo.vendor>,
					And<Current<GLTranDoc.tranModule>, Equal<BatchModule.moduleAP>>>>>>>), DescriptionField = typeof(Terms.descr), Filterable = true)]
