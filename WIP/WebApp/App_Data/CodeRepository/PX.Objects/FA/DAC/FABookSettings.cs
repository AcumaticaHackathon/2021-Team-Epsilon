...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FABookSettings>.By<bookID, assetID>
		{
			public static FABookSettings Find(PXGraph graph, Int32? bookID, Int32? assetID) => FindBy(graph, bookID, assetID);
		}
		public static class FK
		{
			public class Book : FA.FABook.PK.ForeignKeyOf<FABookSettings>.By<bookID> { }
			public class FixedAsset : FA.FixedAsset.PK.ForeignKeyOf<FABookSettings>.By<assetID> { }
			public class DepreciationMethod : FA.FADepreciationMethod.PK.ForeignKeyOf<FABookSettings>.By<depreciationMethodID> { }
		}
		#endregion
		#region BookID
