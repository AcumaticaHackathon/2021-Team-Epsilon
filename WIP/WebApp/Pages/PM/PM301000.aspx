...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" EnableAttributes="true" Visible="True" Width="100%" TypeName="PX.Objects.PM.ProjectEntry" PrimaryView="Project" BorderStyle="NotSet">
        <CallbackCommands>
            ...
            <px:PXDSCallbackCommand Name="CreateChangeOrder" CommitChanges="true" Visible="False" />
            ...
            <px:PXDSCallbackCommand Name="Aia" Visible="false" />
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    ...
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Project" Caption="Project Summary" FilesIndicator="True"
        ...
        <Template>
            ...
            <px:PXCheckBox ID="chkHold" runat="server" DataField="Hold" Visible="false" />
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
        ...
        <Items>
            <px:PXTabItem Text="Summary">
                <Template>
                    ...
                    <px:PXSelector ID="edLocation" runat="server" DataField="LocationID" CommitChanges="true"/>
                    <px:PXSelector ID="edPayrollWorkLocationID" runat="server" DataField="PayrollWorkLocationID" AllowEdit="True" />
                    ...
                    <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" />
                    <px:PXFormView ID="SiteAddressForm" runat="server" Caption="PROJECT ADDRESS" DataMember="Site_Address" RenderStyle="Fieldset">
                        <Template>
                            <px:PXLayoutRule ID="SiteAddressLayoutRule" runat="server" ControlSize="XM" LabelsWidth="SM" StartColumn="True" />
                            <px:PXTextEdit ID="edSiteAddressLine1" runat="server" DataField="AddressLine1" />
                            <px:PXTextEdit runat="server" ID="edSiteCity" CommitChanges="True" DataField="Site_Address.City" />
                            <px:PXSelector runat="server" ID="edSiteCountryId" DataField="CountryId" CommitChanges="True" />
                            <px:PXSelector runat="server" ID="edSiteState" DataField="State" AutoRefresh="True" AllowAddNew="True" CommitChanges="True" />
                            <px:PXLayoutRule runat="server" Merge="True" />
                            <px:PXMaskEdit runat="server" ID="edSitePostalCode" Size="s" CommitChanges="True" DataField="PostalCode" />
                            <px:PXButton runat="server" ID="btnViewAddressOnMap" Text="View on Map" CommandSourceID="ds" CommandName="ViewAddressOnMap" />
                            <px:PXLayoutRule runat="server" />
                            <px:PXNumberEdit runat="server" ID="edSiteLatitude" DataField="Latitude" CommitChanges="True" AllowNull="True" />
                            <px:PXNumberEdit runat="server" ID="edSiteLongitude" DataField="Longitude" CommitChanges="True" AllowNull="True" />
                        </Template>
                    </px:PXFormView>

                    <px:PXLayoutRule runat="server" GroupCaption="Bill-to" StartGroup="True" LabelsWidth="SM" ControlSize="XM" />
                    ...
                    <px:PXLayoutRule runat="server" ID="AIARule1" StartGroup="True" GroupCaption="AIA" />
                    <px:PXDropDown ID="edAIALevel" runat="server" DataField="AIALevel" CommitChanges="True" />
                    <px:PXTextEdit ID="edLastProformaNumber" runat="server" DataField="LastProformaNumber" />
                    <px:PXCheckBox ID="chkIncludeQtyInAIA" runat="server" DataField="IncludeQtyInAIA" CommitChanges="true" />
					...
					<px:PXCheckBox ID="chkVisibleInPROD" runat="server" DataField="VisibleInPROD" />
            ...
            <px:PXTabItem Text="Tasks">
                <Template>
                    <px:PXGrid SyncPosition="True" runat="server" ID="TaskGrid" Width="100%" DataSourceID="ds" Height="100%" SkinID="DetailsInTab">
                        <Levels>
                            <px:PXGridLevel DataMember="Tasks" DataKeyNames="ProjectID,TaskCD">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask Size="s" ID="edDefaultSubID2" runat="server" DataField="DefaultSalesSubID" />
                                    <px:PXSegmentMask Size="s" ID="PXSegmentMask1" runat="server" DataField="DefaultExpenseSubID" />
                                    ...
                                    <px:PXSegmentMask ID="edDefaultSalesAccountID2" runat="server" DataField="DefaultSalesAccountID" />
                                    <px:PXSegmentMask ID="edDefaultExpenseAccountID2" runat="server" DataField="DefaultExpenseAccountID" />
									...
									<px:PXCheckBox ID="chkVisibleInPROD2" runat="server" DataField="VisibleInPROD" />
                                </RowTemplate>
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="DefaultSalesAccountID" />
                                    <px:PXGridColumn DataField="DefaultSalesSubID" />
                                    <px:PXGridColumn DataField="DefaultExpenseAccountID" />
                                    <px:PXGridColumn DataField="DefaultExpenseSubID" />
                        ...
                        <ActionBar >
                            <CustomItems>
								...
								<px:PXToolBarButton Text="Create Prod Order">
									<AutoCallBack Command="CreateProdOrder" Target="ds" />
								</px:PXToolBarButton>
                            </CustomItems>
                        </ActionBar>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="CostBudget">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="CuryCostProjectionCostToComplete" TextAlign="Right" />
                                    <px:PXGridColumn DataField="CuryCostProjectionCostAtCompletion" TextAlign="Right" />
                                    <px:PXGridColumn DataField="CostProjectionQtyToComplete" TextAlign="Right" />
                                    <px:PXGridColumn DataField="CostProjectionQtyAtCompletion" TextAlign="Right" />
                                    <px:PXGridColumn DataField="CostProjectionCompletedPct" TextAlign="Right" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Invoices">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PMProforma__ProjectNbr" />
                         ...
                         <ActionBar >
                            <CustomItems>
                                <px:PXToolBarButton Key="cmdAia" Text="AIA Report">
                                    <AutoCallBack Command="Aia" Target="ds" />
                                </px:PXToolBarButton>
        ...
        <Template>
            ...
            <px:PXTabItem Text="Settings">
                <Template>
                    ...
                    <px:PXSegmentMask ID="edDefaultSalesAccountID" runat="server" DataField="DefaultSalesAccountID"  CommitChanges="true"/>
                    <px:PXSegmentMask ID="edDefaultSalesSubID" runat="server" DataField="DefaultSalesSubID" CommitChanges="true"/>
                    <px:PXSegmentMask ID="edDefaultExpenseAccountID" runat="server" DataField="DefaultExpenseAccountID"  CommitChanges="true"/>
                    <px:PXSegmentMask ID="edDefaultExpenseSubID" runat="server" DataField="DefaultExpenseSubID" CommitChanges="true"/>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="ComplianceDocuments">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="VendorID" CommitChanges="True" LinkCommand="ComplianceViewVendor" />
                                    ...
                                    <px:PXGridColumn DataField="SecondaryVendorID" CommitChanges="True" LinkCommand="ComplianceViewSecondaryVendor" />
            ...
            <px:PXTabItem Text="Contacts">
                <Template>
                    <px:PXGrid runat="server" ID="ProjectContactsGrid" SkinID="DetailsInTab" Height="100%" Width="100%" AllowPaging="True" DataSourceID="ds" AdjustPageSize="Auto" KeepPosition="True" SyncPosition="True">
                        <Levels>
                            <px:PXGridLevel DataMember="ProjectContacts">
                                <RowTemplate>
                                    <px:PXSelector runat="server" ID="edBusinessAccountId" DataField="BusinessAccountId" AutoRefresh="True" />
                                    <px:PXSelector runat="server" ID="edContactId" DataField="ContactId" AutoRefresh="True" />
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="BusinessAccountId" Width="120" CommitChanges="True" DisplayMode="Hint" LinkCommand="Relations_EntityDetails" />
                                    <px:PXGridColumn DataField="ContactId" Width="120" CommitChanges="True" DisplayMode="Text" />
                                    <px:PXGridColumn DataField="Email" Width="100" CommitChanges="True" />
                                    <px:PXGridColumn DataField="Phone" Width="100" CommitChanges="True" />
                                    <px:PXGridColumn DataField="Role" Width="200" />
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
                        <AutoSize Enabled="True" MinHeight="150" />
			...
			<px:PXTabItem Text="Production Orders">
				<Template>
					<px:PXGrid runat="server" ID="ProdOrdersGrid" DataSourceID="ds" SkinID="Inquire" SyncPosition="True" Width="100%" Height="100%">
						<Levels>
							<px:PXGridLevel DataMember="ProjectProdOrders">
								<Columns>
									<px:PXGridColumn DataField="OrderType" Width="70" />
									<px:PXGridColumn DataField="ProdOrdID" Width="90" LinkCommand="ViewProdOrder" />
									<px:PXGridColumn DataField="InventoryID" Width="90" />
									<px:PXGridColumn DataField="SiteID" Width="120" />
									<px:PXGridColumn DataField="LocationID" Width="120" />
									<px:PXGridColumn DataField="ProdDate" Width="90" />
									<px:PXGridColumn DataField="QtytoProd" Width="100" />
									<px:PXGridColumn DataField="QtyComplete" Width="100" />
									<px:PXGridColumn DataField="QtyScrapped" Width="100" />
									<px:PXGridColumn DataField="QtyRemaining" Width="100" />
									<px:PXGridColumn DataField="TaskID" Width="70" />
									<px:PXGridColumn DataField="CostCodeID" Width="70" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<Mode AllowAddNew="False" AllowDelete="False" AllowUpdate="False" />
						<AutoSize Enabled="True" /></px:PXGrid></Template></px:PXTabItem>
			<px:PXTabItem Text="Estimates">
				<Template>
					<px:PXGrid runat="server" ID="EstimatesGrid" DataSourceID="ds" SkinID="Inquire" SyncPosition="True" Width="100%" Height="100%">
						<Levels>
							<px:PXGridLevel DataMember="ProjectEstimates">
								<Columns>
									<px:PXGridColumn DataField="AMEstimateReference__EstimateID" Width="70" />
									<px:PXGridColumn DataField="InventoryCD" Width="70" />
									<px:PXGridColumn DataField="SiteID" Width="120" />
									<px:PXGridColumn DataField="OrderQty" Width="100" />
									<px:PXGridColumn DataField="AMEstimateReference__TaskID" Width="70" />
									<px:PXGridColumn DataField="AMEstimateReference__CostCodeID" Width="70" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<Mode AllowAddNew="False" AllowDelete="False" AllowUpdate="False" />
	...
	<px:PXSmartPanel runat="server" ID="CreateProdOrderPanel" Caption="Create Production Order" CaptionVisible="True" Key="CreateProductionOrderFilter" LoadOnDemand="True" CloseButtonDialogResult="Cancel" AutoReload="True" AutoCallBack-Enabled="True" AutoCallBack-Target="FormCreateProdOrder" AutoCallBack-Command="Refresh">
		<px:PXFormView runat="server" ID="FormCreateProdOrder" DataMember="CreateProductionOrderFilter" DataSourceID="ds" SkinID="Transparent" CaptionVisible="False" Width="100%">
			<Template>
				<px:PXLayoutRule runat="server" StartColumn="True" />
				<px:PXSelector runat="server" ID="edAMOrderType" DataField="OrderType" />
				<px:PXMaskEdit runat="server" ID="edAMProdOrdID" DataField="ProdOrdID" />
				<px:PXSegmentMask runat="server" ID="edAMInventoryID" DataField="InventoryID" CommitChanges="True" />
				<px:PXSegmentMask runat="server" ID="edAMSubItem" DataField="SubItemID" />
				<px:PXSegmentMask runat="server" ID="edAMSiteID" DataField="SiteID" CommitChanges="True" />
				<px:PXSegmentMask runat="server" ID="edAMLocationID" DataField="LocationID" />
				<px:PXLayoutRule runat="server" StartColumn="True" />
				<px:PXDateTimeEdit runat="server" ID="edAMProdDate" DataField="ProdDate" />
				<px:PXNumberEdit runat="server" ID="edAMQtytoProd" DataField="QtytoProd" />
				<px:PXSegmentMask runat="server" ID="edAMProjectID" DataField="ProjectID" />
				<px:PXSegmentMask runat="server" ID="edAMTaskID" DataField="TaskID" />
				<px:PXSegmentMask runat="server" ID="edAMCostCodeID" DataField="CostCodeID" />
			</Template>
		</px:PXFormView>
		<px:PXPanel runat="server" ID="pnlCreateProdButton">
			<px:PXButton runat="server" ID="btnCreate" DialogResult="OK" Text="Create" />
			<px:PXButton runat="server" ID="btnProdCancel" DialogResult="Cancel" Text="Cancel" />
		</px:PXPanel>
	</px:PXSmartPanel>
</asp:Content>
