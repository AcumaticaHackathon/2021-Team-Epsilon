...
namespace PX.Objects.AM
{
    ...
    public class AMEstimateReference : IBqlTable
    {
        ...
        //LEAVE THIS FIELD FOR C# UPGRADE PROCESS - 18R1 upgrades are also obsolete in this version
        [Obsolete(InternalMessages.ClassIsObsoleteAndWillBeRemoved2021R2 + " AMEstimateReference.source has moved to AMEstimateItem.quoteSource in 2018R1")]
        public abstract class source : PX.Data.BQL.BqlInt.Field<source> { }

        protected int? _Source;
        [Obsolete(InternalMessages.PropertyIsObsoleteAndWillBeRemoved2021R2 + " AMEstimateReference.Source has moved to AMEstimateItem.QuoteSource in 2018R1")]
        [PXDBInt]
