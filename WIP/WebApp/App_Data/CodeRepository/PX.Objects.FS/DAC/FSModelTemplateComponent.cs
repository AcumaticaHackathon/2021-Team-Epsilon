...
namespace PX.Objects.FS
{
	...
	public class FSModelTemplateComponent : PX.Data.IBqlTable
	{
        ...
        {
            public static FSModelTemplateComponent Find(PXGraph graph, int? componentID) => FindBy(graph, componentID);
        }
        public class UK : PrimaryKeyOf<FSModelTemplateComponent>.By<modelTemplateID, componentCD>
        {
            public static FSModelTemplateComponent Find(PXGraph graph, int? modelTemplateID, string componentCD) => FindBy(graph, modelTemplateID, componentCD);
        }
