...
namespace PX.Objects.CM
{
	...
	public class CuryRateMaint : PXGraph<CuryRateMaint>
	{
		...
		protected virtual void CurrencyRate_RowUpdating(PXCache cache, PXRowUpdatingEventArgs e)
		{
				...
				cr.CuryRate		!= null)
			{
				...
				if (existRate != null)
				{
					...
					cache.RaiseExceptionHandling<CurrencyRate.curyRate>(cr, cr.CuryRate, new PXSetPropertyException(Messages.SuchRateTypeAlreadyExist, PXErrorLevel.Warning, cr.FromCuryID, cr.ToCuryID, cr.CuryRateType, cr.CuryEffDate));
				}
			}
		}
		...
		public override void Persist()
		{
			...
			{
				throw new PXException(CS.Messages.RequiredConfigurationDataIsNotEnteredOnCurrencyManagementPreferencesForm);
			}
			base.Persist();
		}
	}
