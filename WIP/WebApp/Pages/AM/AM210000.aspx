...
ValidateRequest="false" CodeFile="AM210000.aspx.cs" Inherits="Page_AM210000"
Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPages/FormDetail.master" %>
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" TypeName="PX.Objects.AM.ECRMaint" PrimaryView="Documents"
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
    <px:PXFormView ID="form" runat="server" Width="100%" Caption="ECR" DataMember="Documents" DataSourceID="ds" 
                   NotifyIndicator="True" NoteIndicator="true" FilesIndicator="True" ActivityIndicator="True" ActivityField="NoteActivity" DefaultControlID="edECRID">
        <Template>
            <px:PXLayoutRule ID="PXLayoutRule15" runat="server" StartColumn="True" LabelsWidth="S" ControlSize="M" />
            <px:PXSelector ID="edECRID" runat="server" DataField="ECRID" FilterByAllFields="True" />
            <px:PXTextEdit ID="edRevisionID" runat="server" DataField="RevisionID" />
            <px:PXSelector ID="edBOMID" runat="server" DataField="BOMID" CommitChanges="true" FilterByAllFields="True" />
            ...
            <px:PXSegmentMask ID="edInventoryID" runat="server" DataField="InventoryID" DisplayMode="Hint" />
            <px:PXSegmentMask ID="edSubItemID" runat="server" DataField="SubItemID" />
            <px:PXSelector ID="edSiteID" runat="server" DataField="SiteID" DisplayMode="Hint" />
            ...
            <px:PXSelector ID="edECOID" runat="server" DataField="ECOID" Enabled="False" AllowEdit="True" />
        </Template>
    </px:PXFormView>
</asp:Content>
