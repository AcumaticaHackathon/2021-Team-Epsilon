...
namespace PX.Objects.FS
{
    ...
    public class FSAppointmentLog : FSLog
    {
        ...
        {
            public static FSAppointmentLog Find(PXGraph graph, string docType, string docRefNbr, int? lineNbr) => FindBy(graph, docType, docRefNbr, lineNbr);
        }
        ...
        public new static class FK
        {
            ...
            public class Task : PMTask.PK.ForeignKeyOf<FSAppointmentLog>.By<projectTaskID> { }
