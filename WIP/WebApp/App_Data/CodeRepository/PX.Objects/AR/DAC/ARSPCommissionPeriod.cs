namespace PX.Objects.AR
{
    ...
    public partial class ARSPCommissionPeriod : IBqlTable
    {
      #region Keys
      /// <exclude/>
      public class PK : PrimaryKeyOf<ARSPCommissionPeriod>.By<commnPeriodID>
      {
         public static ARSPCommissionPeriod Find(PXGraph graph, String commnPeriodID) => FindBy(graph, commnPeriodID);
      }
      #endregion
