...
namespace PX.Objects.SO
{
	...
	public partial class SOLine : PX.Data.IBqlTable, ILSPrimary, IHasMinGrossProfit, ISortOrder, IMatrixItemLine
	{
		...
		public static class FK
		{
			...
			public class Task : PMTask.PK.ForeignKeyOf<SOLine>.By<taskID> { }
			...
			//todo public class UnitOfMeasure : INUnit.UK.ByInventory.ForeignKeyOf<SOLine>.By<inventoryID, uOM> { }

			[Obsolete("This foreign key is obsolete and is going to be removed in 2021R1. Use OriginalOrderLine instead.")]
			public class OrigLine : OriginalOrderLine { }
		}
		#endregion
		...
		[PXRestrictor(typeof(Where<AP.Vendor.vStatus, IsNull,
								Or<AP.Vendor.vStatus, Equal<VendorStatus.active>,
								Or<AP.Vendor.vStatus, Equal<VendorStatus.oneTime>>>>), AP.Messages.VendorIsInStatus, typeof(AP.Vendor.vStatus))]
