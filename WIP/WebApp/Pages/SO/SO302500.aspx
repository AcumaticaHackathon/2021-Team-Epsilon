...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
            ...
            <px:PXTabItem Text="Details">
                <Template>
                    <px:PXGrid ID="gridWorksheetLines" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" SyncPosition="true">
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton Text="Line Details" Key="ShowSplits" CommandName="ShowSplits" CommandSourceID="ds" DependOnGrid="gridWorksheetLines" />
                            </CustomItems>
                        </ActionBar>
                        <Levels>
            ...
            <px:PXTabItem Text="Shipments">
                <Template>
                    <px:PXGrid ID="gridShipments" runat="server" DataSourceID="ds" Width="100%" SkinID="DetailsInTab" SyncPosition="true" FilesIndicator="False" NoteIndicator="False">
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="shipmentLinks">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="Unlinked" Type="CheckBox" />
                                </Columns>
                                <RowTemplate>
    ...
    <%-- Allocations Dialog --%>
    <px:PXSmartPanel ID="PanelAllocations" runat="server" Caption="Line Details" CaptionVisible="True" Key="worksheetLineSplits" LoadOnDemand="True" AutoReload="True" AutoRepaint="True" >
