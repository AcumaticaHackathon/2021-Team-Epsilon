        ...
        <Levels>
            <px:PXGridLevel DataMember="FixedDemand">
                ...
                <Columns>
					...
					<px:PXGridColumn DataField="AMProdMatlSplitPlan__OrderType" Width="70" />
					<px:PXGridColumn DataField="AMProdMatlSplitPlan__ProdOrdID" Width="70" LinkCommand="ViewProdDocument" />
