...
namespace PX.Objects.FA
{
	...
	{
		#region Keys
		public class PK : PrimaryKeyOf<FAAccrualTran>.By<tranID>
		{
			public static FAAccrualTran Find(PXGraph graph, Int32? tranID) => FindBy(graph, tranID);
		}
		public static class FK
		{
			public class GLTran : GL.Branch.PK.ForeignKeyOf<FAAccrualTran>.By<gLTranID> { }
			public class GLTranAccount : GL.Account.PK.ForeignKeyOf<FAAccrualTran>.By<gLTranAccountID> { }
			public class GLTranSubaccount : GL.Sub.PK.ForeignKeyOf<FAAccrualTran>.By<gLTranSubID> { }
			public class AssetClass : FA.FAClass.PK.ForeignKeyOf<FAAccrualTran>.By<classID> { }
			public class Branch : GL.Branch.PK.ForeignKeyOf<FAAccrualTran>.By<branchID> { }
			public class GLTranBranch : GL.Branch.PK.ForeignKeyOf<FAAccrualTran>.By<gLTranBranchID> { }
			public class Employee : EP.EPEmployee.PK.ForeignKeyOf<FAAccrualTran>.By<employeeID> { }
			public class Department : EP.EPDepartment.PK.ForeignKeyOf<FAAccrualTran>.By<department> { }
			public class InventoryItem : IN.InventoryItem.PK.ForeignKeyOf<FAAccrualTran>.By<inventoryID> { }
		}
		#endregion
		#region Selected
