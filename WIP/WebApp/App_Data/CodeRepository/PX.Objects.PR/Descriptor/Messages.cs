...
namespace PX.Objects.PR
{
	...
	public static class Messages
	{
		...
		public const string PaymentBatchCreated = "Payment Batch Created";
		#endregion
		...
		public const string NoAccessToAllEmployeesInDDBatch = "You do not have access to all employees in this batch.";
		...
		public const string EPPostingOptionNotDoNotPost = "This option can be used only if Do Not Post is selected in the Time Posting Option box.";
		...
		public const string EmployeeAlreadyAddedToAnotherPaycheckError = "Another regular paycheck ({0}) with the same pay period has already been created for the employee";
		...
		public const string NoAccessToAllEmployeesInPRBatch = "You do not have access to all employees in this batch.";
		...
		public const string ReadyForExport = "Ready for Export";
		public const string WaitingPaycheckCalculation = "Waiting Paycheck Calculation";
		public const string Paid = "Paid";

		#endregion PaymentBatchStatus list attribute

		#region Payment Batch screen
		...
		#endregion Payment Batch screen
		...
		public const string SummaryEarningAmountDoesntMatch = "Summary earning amount for type {0} and location {1} ({2}) doesn't match earning details ({3}).";
		public const string SummaryEarningHoursDontMatch = "Summary earning hours for type {0} and location {1} ({2}) don't match earning details ({3}).";
		public const string SummaryEarningRateDoesntMatch = "Summary earning rate for type {0} and location {1} is not correctly calculated.";
		public const string SummaryEarningMissing = "Summary earning record for type {0} and location {1} is missing.";
		public const string SummaryDeductionDoesntMatch = "Summary deduction amount for {0} ({1}) doesn't match deduction details ({2}).";
		public const string SummaryBenefitDoesntMatch = "Summary benefit amount for {0} ({1}) doesn't match benefit details ({2}).";
		public const string SummaryDeductionMissing = "Summary deduction record for type {0} is missing.";
		public const string TaxDetailsDontMatch = "Tax details' amount for {0} ({1}) doesn't match tax splits ({2}).";
		public const string TaxDetailMissing = "Tax detail for {0} is missing.";
		public const string SummaryTaxAmountDoesntMatch = "Summary tax amount for {0} ({1}) doesn't match tax details ({2}).";
		public const string SummaryTaxHoursDoesntMatch = "Summary tax taxable hours for {0} ({1}) don't match tax splits ({2}).";
		public const string SummaryTaxWagesDontMatch = "Summary tax taxable wages for {0} ({1}) don't match tax splits ({2}).";
		public const string SummaryTaxGrossDoesntMatch = "Summary tax taxable gross for {0} ({1}) doesn't match tax splits ({2}).";
		...
		public const string HeaderEarningAmountDoesntMatch = "The total earning amount in the header ({0}) doesn't match earning summaries ({1}).";
		public const string HeaderEarningHoursDontMatch = "The total earning hours in the header ({0}) don't match earning summaries ({1}).";
		public const string HeaderDeductionAmountDoesntMatch = "The total deduction amount in the header ({0}) doesn't match deduction summaries ({1}).";
		public const string HeaderBenefitAmountDoesntMatch = "The total benefit amount in the header ({0}) doesn't match benefit summaries ({1}).";
		public const string HeaderPayableBenefitAmountDoesntMatch = "The total payable benefit amount in the header ({0}) doesn't match benefit summaries ({1}).";
		public const string HeaderEmployeeTaxAmountDoesntMatch = "The total employee tax amount in the header ({0}) doesn't match tax summaries ({1}).";
		...
		public const string PostFromPayroll = "Post PM Transaction from Payroll";
		public const string PostFromTime = "Post PM to Off-Balance Account Group from Time";
		#endregion
