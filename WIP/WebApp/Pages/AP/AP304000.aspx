...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	<px:pxdatasource EnableAttributes="true" id="ds" UDFTypeField="DocType" runat="server" visible="True" width="100%" typename="PX.Objects.AP.APQuickCheckEntry" primaryview="Document">
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand Name="PrintCheck" />
			...
			<px:PXDSCallbackCommand Name="AddressLookup" SelectControlsIDs="form" RepaintControls="None" RepaintControlsIDs="ds,Remittance_Address" CommitChanges="true" Visible="false" />
		</CallbackCommands>
	</px:pxdatasource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
	<px:pxformview id="form" runat="server" style="z-index: 100" width="100%" datamember="Document" caption="Document Summary" noteindicator="True" filesindicator="True" activityindicator="True" activityfield="NoteActivity"
		linkindicator="True" BPEventsIndicator="True" defaultcontrolid="edDocType" markrequired="Dynamic">
		<CallbackCommands>
			<Save PostData="Self" />
		</CallbackCommands>
		...
		<Template>
			...
			<px:PXLabel ID="lblEmpty" runat="server" Text=" "/> 
