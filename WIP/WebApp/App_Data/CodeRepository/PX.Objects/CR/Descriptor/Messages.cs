...
namespace PX.Objects.CR
{
	...
	public static class Messages
	{
		...
		public const string BusinessAccountStatus = "Business Account is {0}.";
		...
		public const string GIException = "Error in the {0} generic inquiry: ";
		...
		public const string AttachmentIsMissing = "This email does not contain attached invoices.";
		public const string FileAlreadyRecognized = "The file is already recognized.";
		public const string FileNotRecognizedYet = "The file has not been recognized.";
		...
		public const string AddressInvalidWarning = "The address is invalid.";
		public const string AddressInvalidFieldWarning = "Invalid {0} value: '{1}' {2}{3}";
		public const string CountryValidationWarning = "No country is configured for address validation.";
		...
		public const string AutocompleteServiceTestFailed = "The system cannot execute a web request.";
		public const string GoogleAddressLookupCountryLimit = "The Google API allows filtering by up to 5 countries.";
		public const string WrongPluginTypeSelected = "An incorrect plug-in type has been selected for the address lookup plug-in.";
		public const string EmptyRestrictVisibilityTo = "The Restrict Visibility To box is required.";
		public const string ExtensionCannotBeFound = "The {0} extension has not been found for the {1} graph.";

		public const string EmailDoesntExistInRemoteServer = "The specified email does not exist on the remote server. (It has probably been deleted.)";
		#endregion
		...
		public const string ClassDescription = "Class Description";
		...
		public const string CreateAccountRedirect = "Create Account with Redirect";
        public const string CreateContact = "Create Contact";
        public const string CreateContactRedirect = "Create Contact with Redirect";
        public const string CreateOpportunity = "Convert to Opportunity";
        public const string CreateOpportunityRedirect = "Convert to Opportunity with Redirect";
		...
		public const string OutlookNoDefaultEmailAccount = "You cannot add an email because the default email account is not specified. Specify the account in the Default Email Account box of the Email Preferences (SM204001) form.";
		...
		public const string PrimaryContactReassignment = "The current contact was the primary contact of the previously selected business account. Consider changing the primary contact for the previously selected business account before assigning the current contact to a different business account.";
		public const string PinUnpin = "Pin/Unpin";
		...
		public const string CustomerAccountName = "Account Name";
		public const string VendorAccountName = "Account Name";

		public const string ErrorSavingWithDuplicates = "Cannot save the entity because at least one duplicate has been found for this entity.";
		public const string SureToSaveWithDuplicates = "At least one duplicate has been found. Do you want to save the record?";
		#endregion
		...
		public const string ParentBusinessAccount = "Parent Business Account";
		...
		public const string BAccountEmail = "Account Email";
		public const string Class = "Class ID";
		public const string LeadContact = "Lead/Contact";
		public const string Contact = "Contact";
		public const string AccountContact = "Additional Account Info";
		...
		public const string AccountAddress = "Account Address";
		...
		public const string LocationBranchSettings = "Location Settings for Current Branch";
		...
		public const string BusinessAssistant1 = "Assistant";
		public const string BusinessFax = "Fax";
		...
		public const string BusinessAccountType = "Business Account";
		...
		public const string AddressLookupButton = "Select";
		[Obsolete("This message is not used anymore and will be removed in Acumatica 2018R1")]
		...
		public const string SingleDocumentRecognized = "A document has been recognized.";
		public const string MultipleDocumentsRecognized = "{0} documents have been recognized.";
		public const string SingleDuplicateDocument = "Recognition has already been started for another document.";
		public const string MultipleDuplicateDocuments = "Recognition has already been started for another document or documents.";
	...
	public static class MessagesNoPrefix
	{
		...
		public const string CbApi_Attributes_CheckboxAttributeDoesntSupportSpecifiedValue = "The specified value is not valid for the {0} attribute that has the Checkbox type because it cannot be converted to a boolean value.";
		public const string CbApi_Attributes_DatetimeAttributeDoesntSupportSpecifiedValue = "The specified value is not valid for the {0} attribute that has the Datetime type because it cannot be converted to a DateTime value.";
