...
namespace PX.Objects.FA
{
    ...
    public partial class FASetup : PX.Data.IBqlTable
	{
		...
		{
			public class FAAccrualAccount : GL.Account.PK.ForeignKeyOf<FASetup>.By<fAAccrualAcctID> { }
			public class FAAccrualSubaccount : GL.Sub.PK.ForeignKeyOf<FASetup>.By<fAAccrualSubID> { }
			public class ProceedsAccount : GL.Account.PK.ForeignKeyOf<FASetup>.By<proceedsAcctID> { }
			public class ProceedsSubaccount : GL.Sub.PK.ForeignKeyOf<FASetup>.By<proceedsSubID> { }
		}
